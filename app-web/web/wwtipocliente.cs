/*
               File: WWTipoCliente
        Description: Work With Tipo Cliente
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/26/2022 20:15:4.69
...
namespace GeneXus.Programs {
   public class wwtipocliente : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      public wwtipocliente( )
      {
      ...
      public wwtipocliente( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13TipClientDsc, AV19Pgmname, AV14Update, AV15Delete) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202210262015476", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwtipocliente.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vTIPCLIENTDSC", StringUtil.RTrim( AV13TipClientDsc));
         /* Send saved values. */
      ...
      {
         return "WWTipoCliente" ;
      }

      public override String GetPgmdesc( )
      {
         return "Work With Tipo Cliente" ;
      }
      ...
      protected void WB1B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Tipo Clientes", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_WWTipoCliente.htm");
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWTipoCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavTipclientdsc_Internalname, "Tip Client Dsc", "col-sm-3 FilterSearchAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTipclientdsc_Internalname, StringUtil.RTrim( AV13TipClientDsc), StringUtil.RTrim( context.localUtil.Format( AV13TipClientDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Cliente", edtavTipclientdsc_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavTipclientdsc_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_WWTipoCliente.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A55TipClientEst));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START1B2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Work With Tipo Cliente", 0) ;
         }
         context.wjLoc = "";
                        ...
                        if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false;
                                    /* Set Refresh If Tipclientdsc Changed */
                                    if ( StringUtil.StrCmp(cgiGet( "GXH_vTIPCLIENTDSC"), AV13TipClientDsc) != 0 )
                                    {
                                       Rfr0gs = true;
                                    }
                                    if ( ! Rfr0gs )
      ...
      protected void PA1B2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavTipclientdsc_Internalname;
      ...
      protected void RF1B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13TipClientDsc = StringUtil.PadR( StringUtil.RTrim( AV13TipClientDsc), 50, "%");
            /* Using cursor H001B2 */
            pr_default.execute(0, new Object[] {lV13TipClientDsc, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_25_idx), 4, 0)), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               A55TipClientEst = H001B2_A55TipClientEst[0];
               n55TipClientEst = H001B2_n55TipClientEst[0];
               A54TipClientDsc = H001B2_A54TipClientDsc[0];
               n54TipClientDsc = H001B2_n54TipClientDsc[0];
               A4TipClientID = H001B2_A4TipClientID[0];
               E141B2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_TIPCLIENTID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A4TipClientID), "ZZZ9"), context));
      }
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         lV13TipClientDsc = StringUtil.PadR( StringUtil.RTrim( AV13TipClientDsc), 50, "%");
         /* Using cursor H001B3 */
         pr_default.execute(1, new Object[] {lV13TipClientDsc});
      ...
      protected void STRUP1B0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13TipClientDsc = cgiGet( edtavTipclientdsc_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13TipClientDsc", AV13TipClientDsc);
            /* Read saved values. */
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("tipocliente.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A4TipClientID);
         edtavDelete_Link = formatLink("tipocliente.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A4TipClientID);
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("tipocliente.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13TipClientDsc = ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13TipClientDsc", AV13TipClientDsc);
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = AV13TipClientDsc;
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext.gxTpr_Transactionname = "TipoCliente";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202210262015527", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwtipocliente.js", "?202210262015527", false);
         }
      ...
      {
         edtTipClientID_Internalname = "TIPCLIENTID_"+sGXsfl_25_idx;
         edtTipClientDsc_Internalname = "TIPCLIENTDSC_"+sGXsfl_25_idx;
         edtTipClientEst_Internalname = "TIPCLIENTEST_"+sGXsfl_25_idx;
      ...
      {
         edtTipClientID_Internalname = "TIPCLIENTID_"+sGXsfl_25_fel_idx;
         edtTipClientDsc_Internalname = "TIPCLIENTDSC_"+sGXsfl_25_fel_idx;
         edtTipClientEst_Internalname = "TIPCLIENTEST_"+sGXsfl_25_fel_idx;
      ...
      protected void init_default_properties( )
      {
         ...
         edtavTipclientdsc_Internalname = "vTIPCLIENTDSC";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavTipclientdsc_Jsonclick = "";
         edtavTipclientdsc_Enabled = 1;
         Form.Caption = "Work With Tipo Cliente";
         subGrid_Rows = 10;
         edtavDelete_Tooltiptext = "Eliminar";
         edtavUpdate_Tooltiptext = "Modificar";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13TipClientDsc',fld:'vTIPCLIENTDSC',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E141B2',iparms:[{av:'A4TipClientID',fld:'TIPCLIENTID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtTipClientDsc_Link',ctrl:'TIPCLIENTDSC',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E111B2',iparms:[{av:'A4TipClientID',fld:'TIPCLIENTID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13TipClientDsc = "";
         H001B2_A55TipClientEst = new String[] {""} ;
         H001B2_n55TipClientEst = new bool[] {false} ;
         H001B2_A54TipClientDsc = new String[] {""} ;
         H001B2_n54TipClientDsc = new bool[] {false} ;
         H001B2_A4TipClientID = new short[1] ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwtipocliente__default(),
            new Object[][] {
                new Object[] {
               H001B2_A55TipClientEst, H001B2_n55TipClientEst, H001B2_A54TipClientDsc, H001B2_n54TipClientDsc, H001B2_A4TipClientID
               }
               , new Object[] {
      ...
      private int edtavTipclientdsc_Enabled ;
      ...
      private String AV13TipClientDsc ;
      ...
      private String edtavTipclientdsc_Internalname ;
      private String edtavTipclientdsc_Jsonclick ;
      ...
      private String lV13TipClientDsc ;
      ...
      private String[] H001B2_A55TipClientEst ;
      private bool[] H001B2_n55TipClientEst ;
      private String[] H001B2_A54TipClientDsc ;
      private bool[] H001B2_n54TipClientDsc ;
      private short[] H001B2_A4TipClientID ;
   ...
   public class wwtipocliente__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A54TipClientDsc )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13TipClientDsc)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and ([TipClientDsc] like @lV13TipClientDsc)";
            }
            else
            {
               sWhereString = sWhereString + " ([TipClientDsc] like @lV13TipClientDsc)";
            }
         }
         else
         {
         ...
         sOrderString = sOrderString + " ORDER BY [TipClientDsc]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H001B2(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
               case 1 :
                     return conditional_H001B3(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV13TipClientDsc",SqlDbType.Char,50,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H001B2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001B2,11,0,true,false )
             ,new CursorDef("H001B3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001B3,1,0,true,false )
          };
       }
    }
