/*
       ...
       Generated on: 10/29/2022 1:9:32.79
...
namespace GeneXus.Programs {
   public class gx0202 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx0202( )
      {
      ...
      public gx0202( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV10cPrdDescCorta = GetNextPar( );
               AV15cPrdTipPrd = (short)(NumberUtil.Val( GetNextPar( ), "."));
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cPrdCod, AV8cPrdPres, AV9cPrdEstado, AV10cPrdDescCorta, AV15cPrdTipPrd, AV11pEmpID, AV12pAgeID) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102919335", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0202.aspx") + "?" + UrlEncode("" +AV11pEmpID) + "," + UrlEncode("" +AV12pAgeID) + "," + UrlEncode("" +AV13pPrdCod)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCPRDDESCCORTA", AV10cPrdDescCorta);
         GxWebStd.gx_hidden_field( context, "GXH_vCPRDTIPPRD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV15cPrdTipPrd), 1, 0, ",", "")));
         /* Send saved values. */
      ...
      {
         return formatLink("gx0202.aspx") + "?" + UrlEncode("" +AV11pEmpID) + "," + UrlEncode("" +AV12pAgeID) + "," + UrlEncode("" +AV13pPrdCod) ;
      }
      ...
      protected void WB4X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprdcodfilter_Internalname, "ID", "", "", lblLblprdcodfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e114x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0202.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprdcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cPrdCod), 4, 0, ",", "")), ((edtavCprdcod_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6cPrdCod), "ZZZ9")) : context.localUtil.Format( (decimal)(AV6cPrdCod), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprdcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprdcod_Visible, edtavCprdcod_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx0202.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprdpresfilter_Internalname, "Presentacion", "", "", lblLblprdpresfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e124x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0202.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprdpres_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cPrdPres), 2, 0, ",", "")), ((edtavCprdpres_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV8cPrdPres), "Z9")) : context.localUtil.Format( (decimal)(AV8cPrdPres), "Z9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprdpres_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprdpres_Visible, edtavCprdpres_Enabled, 0, "number", "1", 2, "chr", 1, "row", 2, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx0202.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprdestadofilter_Internalname, "Estado", "", "", lblLblprdestadofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e134x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0202.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprdestado_Internalname, StringUtil.RTrim( AV9cPrdEstado), StringUtil.RTrim( context.localUtil.Format( AV9cPrdEstado, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprdestado_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprdestado_Visible, edtavCprdestado_Enabled, 0, "text", "", 1, "chr", 1, "row", 1, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_Gx0202.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprddesccortafilter_Internalname, "Desc Corta", "", "", lblLblprddesccortafilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e144x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0202.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprddesccorta_Internalname, AV10cPrdDescCorta, StringUtil.RTrim( context.localUtil.Format( AV10cPrdDescCorta, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprddesccorta_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprddesccorta_Visible, edtavCprddesccorta_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_Gx0202.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprdtipprdfilter_Internalname, "Tipo Producto", "", "", lblLblprdtipprdfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e154x1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0202.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprdtipprd_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV15cPrdTipPrd), 1, 0, ",", "")), ((edtavCprdtipprd_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV15cPrdTipPrd), "9")) : context.localUtil.Format( (decimal)(AV15cPrdTipPrd), "9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprdtipprd_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprdtipprd_Visible, edtavCprdtipprd_Enabled, 0, "number", "1", 1, "chr", 1, "row", 1, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx0202.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(64), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e164x1_client"+"'", TempTags, "", 2, "HLP_Gx0202.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 64 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(64), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx0202.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCPRDDESCCORTA"), AV10cPrdDescCorta) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Cprdtipprd Changed */
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCPRDTIPPRD"), ",", ".") != Convert.ToDecimal( AV15cPrdTipPrd )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void gxgrGrid1_refresh( int subGrid1_Rows ,
                                        ...
                                        String AV10cPrdDescCorta ,
                                        short AV15cPrdTipPrd ,
                                        short AV11pEmpID ,
                                        short AV12pAgeID )
      {
         initialize_formulas( ) ;
      ...
      protected void RF4X2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV10cPrdDescCorta = StringUtil.Concat( StringUtil.RTrim( AV10cPrdDescCorta), "%", "");
            /* Using cursor H004X2 */
            pr_default.execute(0, new Object[] {AV11pEmpID, AV12pAgeID, AV6cPrdCod, AV8cPrdPres, lV9cPrdEstado, lV10cPrdDescCorta, AV15cPrdTipPrd, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_64_idx = 1;
            sGXsfl_64_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_64_idx), 4, 0)), 4, "0");
            SubsflControlProps_642( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A2AgeID = H004X2_A2AgeID[0];
               A1EmpID = H004X2_A1EmpID[0];
               A31tipoProdID = H004X2_A31tipoProdID[0];
               A308PrdTipPrd = H004X2_A308PrdTipPrd[0];
               n308PrdTipPrd = H004X2_n308PrdTipPrd[0];
               A306PrdDescCorta = H004X2_A306PrdDescCorta[0];
               n306PrdDescCorta = H004X2_n306PrdDescCorta[0];
               A289PrdEstado = H004X2_A289PrdEstado[0];
               n289PrdEstado = H004X2_n289PrdEstado[0];
               A288PrdPres = H004X2_A288PrdPres[0];
               n288PrdPres = H004X2_n288PrdPres[0];
               A286PrdCod = H004X2_A286PrdCod[0];
               /* Execute user event: Load */
               E184X2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         lV10cPrdDescCorta = StringUtil.Concat( StringUtil.RTrim( AV10cPrdDescCorta), "%", "");
         /* Using cursor H004X3 */
         pr_default.execute(1, new Object[] {AV11pEmpID, AV12pAgeID, AV6cPrdCod, AV8cPrdPres, lV9cPrdEstado, lV10cPrdDescCorta, AV15cPrdTipPrd});
      ...
      protected void STRUP4X0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV10cPrdDescCorta = cgiGet( edtavCprddesccorta_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10cPrdDescCorta", AV10cPrdDescCorta);
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCprdtipprd_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCprdtipprd_Internalname), ",", ".") > Convert.ToDecimal( 9 )) ) )
            {
               ...
               wbErr = true;
               AV15cPrdTipPrd = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV15cPrdTipPrd", StringUtil.Str( (decimal)(AV15cPrdTipPrd), 1, 0));
            }
            else
            {
               AV15cPrdTipPrd = (short)(context.localUtil.CToN( cgiGet( edtavCprdtipprd_Internalname), ",", "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV15cPrdTipPrd", StringUtil.Str( (decimal)(AV15cPrdTipPrd), 1, 0));
            }
            /* Read saved values. */
      ...
      protected void E194X2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13pPrdCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13pPrdCod), 4, 0)));
         context.setWebReturnParms(new Object[] {(short)AV13pPrdCod});
         context.setWebReturnParmsMetadata(new Object[] {"AV13pPrdCod"});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022102919376", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0202.js", "?2022102919377", false);
      ...
      protected void SubsflControlProps_642( )
      {
         ...
         edtPrdDescCorta_Internalname = "PRDDESCCORTA_"+sGXsfl_64_idx;
      ...
      protected void SubsflControlProps_fel_642( )
      {
         ...
         edtPrdDescCorta_Internalname = "PRDDESCCORTA_"+sGXsfl_64_fel_idx;
      ...
      protected void sendrow_642( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_64_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A286PrdCod), 4, 0, ",", "")))+"'"+"]);";
            ...
            edtPrdDescCorta_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A286PrdCod), 4, 0, ",", "")))+"'"+"]);";
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtPrdDescCorta_Internalname, "Link", edtPrdDescCorta_Link, !bGXsfl_64_Refreshing);
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtPrdDescCorta_Internalname,(String)A306PrdDescCorta,(String)"",(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)edtPrdDescCorta_Link,(String)"",(String)"",(String)"",(String)edtPrdDescCorta_Jsonclick,(short)0,(String)"DescriptionAttribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)40,(short)0,(short)0,(short)64,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV8cPrdPres',fld:'vCPRDPRES',pic:'Z9'},{av:'AV9cPrdEstado',fld:'vCPRDESTADO',pic:''},{av:'AV10cPrdDescCorta',fld:'vCPRDDESCCORTA',pic:''},{av:'AV15cPrdTipPrd',fld:'vCPRDTIPPRD',pic:'9'},{av:'AV11pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV12pAgeID',fld:'vPAGEID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E164X1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLPRDCODFILTER.CLICK","{handler:'E114X1',iparms:[{av:'divPrdcodfiltercontainer_Class',ctrl:'PRDCODFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRDPRESFILTER.CLICK","{handler:'E124X1',iparms:[{av:'divPrdpresfiltercontainer_Class',ctrl:'PRDPRESFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRDESTADOFILTER.CLICK","{handler:'E134X1',iparms:[{av:'divPrdestadofiltercontainer_Class',ctrl:'PRDESTADOFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRDDESCCORTAFILTER.CLICK","{handler:'E144X1',iparms:[{av:'divPrddesccortafiltercontainer_Class',ctrl:'PRDDESCCORTAFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRDTIPPRDFILTER.CLICK","{handler:'E154X1',iparms:[{av:'divPrdtipprdfiltercontainer_Class',ctrl:'PRDTIPPRDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E194X2',iparms:[{av:'A286PrdCod',fld:'PRDCOD',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV13pPrdCod',fld:'vPPRDCOD',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV8cPrdPres',fld:'vCPRDPRES',pic:'Z9'},{av:'AV9cPrdEstado',fld:'vCPRDESTADO',pic:''},{av:'AV10cPrdDescCorta',fld:'vCPRDDESCCORTA',pic:''},{av:'AV15cPrdTipPrd',fld:'vCPRDTIPPRD',pic:'9'},{av:'AV11pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV12pAgeID',fld:'vPAGEID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV8cPrdPres',fld:'vCPRDPRES',pic:'Z9'},{av:'AV9cPrdEstado',fld:'vCPRDESTADO',pic:''},{av:'AV10cPrdDescCorta',fld:'vCPRDDESCCORTA',pic:''},{av:'AV15cPrdTipPrd',fld:'vCPRDTIPPRD',pic:'9'},{av:'AV11pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV12pAgeID',fld:'vPAGEID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV8cPrdPres',fld:'vCPRDPRES',pic:'Z9'},{av:'AV9cPrdEstado',fld:'vCPRDESTADO',pic:''},{av:'AV10cPrdDescCorta',fld:'vCPRDDESCCORTA',pic:''},{av:'AV15cPrdTipPrd',fld:'vCPRDTIPPRD',pic:'9'},{av:'AV11pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV12pAgeID',fld:'vPAGEID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV8cPrdPres',fld:'vCPRDPRES',pic:'Z9'},{av:'AV9cPrdEstado',fld:'vCPRDESTADO',pic:''},{av:'AV10cPrdDescCorta',fld:'vCPRDDESCCORTA',pic:''},{av:'AV15cPrdTipPrd',fld:'vCPRDTIPPRD',pic:'9'},{av:'AV11pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV12pAgeID',fld:'vPAGEID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         lV9cPrdEstado = "";
         lV10cPrdDescCorta = "";
         H004X2_A2AgeID = new short[1] ;
         H004X2_A1EmpID = new short[1] ;
         H004X2_A31tipoProdID = new short[1] ;
         H004X2_A308PrdTipPrd = new short[1] ;
         H004X2_n308PrdTipPrd = new bool[] {false} ;
         H004X2_A306PrdDescCorta = new String[] {""} ;
         H004X2_n306PrdDescCorta = new bool[] {false} ;
         H004X2_A289PrdEstado = new String[] {""} ;
         H004X2_n289PrdEstado = new bool[] {false} ;
         H004X2_A288PrdPres = new short[1] ;
         H004X2_n288PrdPres = new bool[] {false} ;
         H004X2_A286PrdCod = new short[1] ;
         H004X3_AGRID1_nRecordCount = new long[1] ;
         ...
         sImgUrl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0202__default(),
            new Object[][] {
                new Object[] {
               H004X2_A2AgeID, H004X2_A1EmpID, H004X2_A31tipoProdID, H004X2_A308PrdTipPrd, H004X2_n308PrdTipPrd, H004X2_A306PrdDescCorta, H004X2_n306PrdDescCorta, H004X2_A289PrdEstado, H004X2_n289PrdEstado, H004X2_A288PrdPres,
               H004X2_n288PrdPres, H004X2_A286PrdCod
               }
               , new Object[] {
      ...
      private short[] H004X2_A2AgeID ;
      private short[] H004X2_A1EmpID ;
      private short[] H004X2_A31tipoProdID ;
      private short[] H004X2_A308PrdTipPrd ;
      private bool[] H004X2_n308PrdTipPrd ;
      private String[] H004X2_A306PrdDescCorta ;
      private bool[] H004X2_n306PrdDescCorta ;
      private String[] H004X2_A289PrdEstado ;
      private bool[] H004X2_n289PrdEstado ;
      private short[] H004X2_A288PrdPres ;
      private bool[] H004X2_n288PrdPres ;
      private short[] H004X2_A286PrdCod ;
      private long[] H004X3_AGRID1_nRecordCount ;
   ...
   public class gx0202__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A2AgeID )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " [AgeID], [EmpID], [tipoProdID], [PrdTipPrd], [PrdDescCorta], [PrdEstado], [PrdPres], [PrdCod]";
         sFromString = " FROM [Productos] WITH (NOLOCK)";
         sOrderString = "";
         sWhereString = sWhereString + " WHERE ([EmpID] = @AV11pEmpID and [AgeID] = @AV12pAgeID and [PrdCod] >= @AV6cPrdCod)";
         if ( ! (0==AV8cPrdPres) )
         {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV10cPrdDescCorta)) )
         {
            sWhereString = sWhereString + " and ([PrdDescCorta] like @lV10cPrdDescCorta)";
         }
         else
         {
            GXv_int1[5] = 1;
         ...
         if ( ! (0==AV15cPrdTipPrd) )
         {
            sWhereString = sWhereString + " and ([PrdTipPrd] >= @AV15cPrdTipPrd)";
         }
         else
         {
            GXv_int1[6] = 1;
                                             ...
                                             short A2AgeID )
      {
         ...
         scmdbuf = scmdbuf + " WHERE ([EmpID] = @AV11pEmpID and [AgeID] = @AV12pAgeID and [PrdCod] >= @AV6cPrdCod)";
         if ( ! (0==AV8cPrdPres) )
         {
            sWhereString = sWhereString + " and ([PrdPres] >= @AV8cPrdPres)";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004X2(context, (short)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] , (short)dynConstraints[10] , (short)dynConstraints[11] , (short)dynConstraints[12] );
               case 1 :
                     return conditional_H004X3(context, (short)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] , (short)dynConstraints[10] , (short)dynConstraints[11] , (short)dynConstraints[12] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV10cPrdDescCorta",SqlDbType.VarChar,40,0} ,
          new Object[] {"@AV15cPrdTipPrd",SqlDbType.SmallInt,1,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H004X2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004X2,11,0,false,false )
             ,new CursorDef("H004X3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004X3,1,0,false,false )
          };
       }
    }
