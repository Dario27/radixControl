/*
               File: VendedorOrdenProduccionWC
        Description: Vendedor Orden Produccion WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 1/14/2023 1:15:22.67
...
namespace GeneXus.Programs {
   public class vendedorordenproduccionwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public vendedorordenproduccionwc( )
      {
      ...
      public vendedorordenproduccionwc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV7vendedorID = (short)(NumberUtil.Val( GetNextPar( ), "."));
                  context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7vendedorID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7vendedorID), 4, 0)));
                  setjustcreated();
                  componentprepare(new Object[] {(String)sCompPrefix,(String)sSFPrefix,(short)AV6EmpID,(short)AV7vendedorID});
                  componentstart();
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6EmpID, AV7vendedorID, AV12Update, AV13Delete, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "VendedorOrdenProduccionWC";
               context.Gx_err = 0;
               WS192( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Vendedor Orden Produccion WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231141152279", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("vendedorordenproduccionwc.aspx") + "?" + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +AV7vendedorID)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV7vendedorID", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV7vendedorID), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vEMPID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6EmpID), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vVENDEDORID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7vendedorID), 4, 0, ",", "")));
      ...
      protected void RenderHtmlCloseForm192( )
      {
         ...
         {
            context.AddJavascriptSource("vendedorordenproduccionwc.js", "?20231141152282", false);
         }
      ...
      {
         return "VendedorOrdenProduccionWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Vendedor Orden Produccion WC" ;
      }
      ...
      protected void WB190( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "vendedorordenproduccionwc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 7, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11191_client"+"'", TempTags, "", 2, "HLP_VendedorOrdenProduccionWC.htm");
         ...
         if ( wbEnd == 20 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtvendedorID_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A9vendedorID), 4, 0, ",", "")), ((edtvendedorID_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A9vendedorID), "ZZZ9")) : context.localUtil.Format( (decimal)(A9vendedorID), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtvendedorID_Jsonclick, 0, "Attribute", "", "", "", "", edtvendedorID_Visible, edtvendedorID_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "HLP_VendedorOrdenProduccionWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START192( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Vendedor Orden Produccion WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF192( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00193 */
            pr_default.execute(0, new Object[] {AV6EmpID, AV7vendedorID, GXPagingFrom2, GXPagingTo2});
            nGXsfl_20_idx = 1;
            sGXsfl_20_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_20_idx), 4, 0)), 4, "0");
            SubsflControlProps_202( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               A1EmpID = H00193_A1EmpID[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(A1EmpID), 4, 0)));
               A9vendedorID = H00193_A9vendedorID[0];
               ...
               A401OrdenNroDesp = H00193_A401OrdenNroDesp[0];
               n401OrdenNroDesp = H00193_n401OrdenNroDesp[0];
               A210OrdenUltSec = H00193_A210OrdenUltSec[0];
               n210OrdenUltSec = H00193_n210OrdenUltSec[0];
               A203ordenNroPed = H00193_A203ordenNroPed[0];
               n203ordenNroPed = H00193_n203ordenNroPed[0];
               A195OrdenFacNomb = H00193_A195OrdenFacNomb[0];
               n195OrdenFacNomb = H00193_n195OrdenFacNomb[0];
               A192OrdenPed = H00193_A192OrdenPed[0];
               n192OrdenPed = H00193_n192OrdenPed[0];
               A172OrdenfchEnt = H00193_A172OrdenfchEnt[0];
               n172OrdenfchEnt = H00193_n172OrdenfchEnt[0];
               A133OrdenProceso = H00193_A133OrdenProceso[0];
               n133OrdenProceso = H00193_n133OrdenProceso[0];
               A132OrdenEmpFac = H00193_A132OrdenEmpFac[0];
               n132OrdenEmpFac = H00193_n132OrdenEmpFac[0];
               A25OrdenAnio = H00193_A25OrdenAnio[0];
               A24OrdenPeriodo = H00193_A24OrdenPeriodo[0];
               A117OrdenModeloID = H00193_A117OrdenModeloID[0];
               A26OrdenMarcaID = H00193_A26OrdenMarcaID[0];
               A57ClienteDsc = H00193_A57ClienteDsc[0];
               n57ClienteDsc = H00193_n57ClienteDsc[0];
               A5ClienteID = H00193_A5ClienteID[0];
               A119OrdenFch = H00193_A119OrdenFch[0];
               n119OrdenFch = H00193_n119OrdenFch[0];
               A116OrdenUser = H00193_A116OrdenUser[0];
               n116OrdenUser = H00193_n116OrdenUser[0];
               A115OrdenEst = H00193_A115OrdenEst[0];
               n115OrdenEst = H00193_n115OrdenEst[0];
               A110cantDias = H00193_A110cantDias[0];
               n110cantDias = H00193_n110cantDias[0];
               A109fchVenta = H00193_A109fchVenta[0];
               n109fchVenta = H00193_n109fchVenta[0];
               A69VehiculoChasis = H00193_A69VehiculoChasis[0];
               n69VehiculoChasis = H00193_n69VehiculoChasis[0];
               A68VehiculoPlaca = H00193_A68VehiculoPlaca[0];
               n68VehiculoPlaca = H00193_n68VehiculoPlaca[0];
               A8VehiculoID = H00193_A8VehiculoID[0];
               A74protDsc = H00193_A74protDsc[0];
               n74protDsc = H00193_n74protDsc[0];
               A10protID = H00193_A10protID[0];
               A107representane = H00193_A107representane[0];
               n107representane = H00193_n107representane[0];
               A106facturaNro = H00193_A106facturaNro[0];
               n106facturaNro = H00193_n106facturaNro[0];
               A104tipOrdDsc = H00193_A104tipOrdDsc[0];
               n104tipOrdDsc = H00193_n104tipOrdDsc[0];
               A17tipOrdID = H00193_A17tipOrdID[0];
               A22OrdenID = H00193_A22OrdenID[0];
               A255OrdenObreSuma = H00193_A255OrdenObreSuma[0];
               n255OrdenObreSuma = H00193_n255OrdenObreSuma[0];
               A168OrdenValOtrs = H00193_A168OrdenValOtrs[0];
               n168OrdenValOtrs = H00193_n168OrdenValOtrs[0];
               A167OrdenValEstr = H00193_A167OrdenValEstr[0];
               n167OrdenValEstr = H00193_n167OrdenValEstr[0];
               A166OrdenValPint = H00193_A166OrdenValPint[0];
               n166OrdenValPint = H00193_n166OrdenValPint[0];
               A165OrdenValCal = H00193_A165OrdenValCal[0];
               n165OrdenValCal = H00193_n165OrdenValCal[0];
               A163OrdenValEnrq = H00193_A163OrdenValEnrq[0];
               n163OrdenValEnrq = H00193_n163OrdenValEnrq[0];
               A162OrdenValInds = H00193_A162OrdenValInds[0];
               n162OrdenValInds = H00193_n162OrdenValInds[0];
               A161OrdenSubtotal = H00193_A161OrdenSubtotal[0];
               n161OrdenSubtotal = H00193_n161OrdenSubtotal[0];
               A153OrdenActaPdf = H00193_A153OrdenActaPdf[0];
               context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtOrdenActaPdf_Internalname, "URL", context.PathToRelativeUrl( A153OrdenActaPdf), !bGXsfl_20_Refreshing);
               n153OrdenActaPdf = H00193_n153OrdenActaPdf[0];
               A152OrdenPdf = H00193_A152OrdenPdf[0];
               context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtOrdenPdf_Internalname, "URL", context.PathToRelativeUrl( A152OrdenPdf), !bGXsfl_20_Refreshing);
               n152OrdenPdf = H00193_n152OrdenPdf[0];
               A112documento = H00193_A112documento[0];
               context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtdocumento_Internalname, "URL", context.PathToRelativeUrl( A112documento), !bGXsfl_20_Refreshing);
               n112documento = H00193_n112documento[0];
               A108urlPdf = H00193_A108urlPdf[0];
               context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edturlPdf_Internalname, "URL", context.PathToRelativeUrl( A108urlPdf), !bGXsfl_20_Refreshing);
               n108urlPdf = H00193_n108urlPdf[0];
               A57ClienteDsc = H00193_A57ClienteDsc[0];
               n57ClienteDsc = H00193_n57ClienteDsc[0];
               A69VehiculoChasis = H00193_A69VehiculoChasis[0];
               n69VehiculoChasis = H00193_n69VehiculoChasis[0];
      ...
      {
         /* Using cursor H00195 */
         pr_default.execute(1, new Object[] {AV6EmpID, AV7vendedorID});
      ...
      protected void STRUP190( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV7vendedorID = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV7vendedorID"), ",", "."));
      ...
      protected void E12192( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtvendedorID_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtvendedorID_Visible), 5, 0)), true);
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV7vendedorID), 4, 0);
         AV10TrnContext.gxTpr_Attributes.Add(AV11TrnContextAtt, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV6EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV6EmpID), 4, 0)));
         AV7vendedorID = Convert.ToInt16(getParm(obj,1));
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7vendedorID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7vendedorID), 4, 0)));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV7vendedorID = (String)((String)getParm(obj,1));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "vendedorordenproduccionwc", GetJustCreated( ));
         ...
         else
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV6EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV6EmpID), 4, 0)));
            AV7vendedorID = Convert.ToInt16(getParm(obj,3));
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7vendedorID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7vendedorID), 4, 0)));
         }
         wcpOAV6EmpID = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6EmpID"), ",", "."));
         wcpOAV7vendedorID = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV7vendedorID"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV6EmpID != wcpOAV6EmpID ) || ( AV7vendedorID != wcpOAV7vendedorID ) ) )
         {
            setjustcreated();
         }
         wcpOAV6EmpID = AV6EmpID;
         wcpOAV7vendedorID = AV7vendedorID;
      }
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV7vendedorID = cgiGet( sPrefix+"AV7vendedorID_CTRL");
         if ( StringUtil.Len( sCtrlAV7vendedorID) > 0 )
         {
            AV7vendedorID = (short)(context.localUtil.CToN( cgiGet( sCtrlAV7vendedorID), ",", "."));
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7vendedorID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7vendedorID), 4, 0)));
         }
         else
         {
            AV7vendedorID = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV7vendedorID_PARM"), ",", "."));
         }
      }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AV7vendedorID_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7vendedorID), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV7vendedorID)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV7vendedorID_CTRL", StringUtil.RTrim( sCtrlAV7vendedorID));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20231141152458", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("vendedorordenproduccionwc.js", "?20231141152458", false);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'AV7vendedorID',fld:'vVENDEDORID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E13192',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[]}");
         setEventMetadata("'DOINSERT'","{handler:'E11191',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         AV19Delete_GXI = "";
         scmdbuf = "";
         H00193_A1EmpID = new short[1] ;
         H00193_A9vendedorID = new short[1] ;
         H00193_A401OrdenNroDesp = new int[1] ;
         H00193_n401OrdenNroDesp = new bool[] {false} ;
         H00193_A210OrdenUltSec = new short[1] ;
         H00193_n210OrdenUltSec = new bool[] {false} ;
         H00193_A203ordenNroPed = new int[1] ;
         H00193_n203ordenNroPed = new bool[] {false} ;
         H00193_A195OrdenFacNomb = new String[] {""} ;
         H00193_n195OrdenFacNomb = new bool[] {false} ;
         H00193_A192OrdenPed = new int[1] ;
         H00193_n192OrdenPed = new bool[] {false} ;
         H00193_A172OrdenfchEnt = new DateTime[] {DateTime.MinValue} ;
         H00193_n172OrdenfchEnt = new bool[] {false} ;
         H00193_A133OrdenProceso = new String[] {""} ;
         H00193_n133OrdenProceso = new bool[] {false} ;
         H00193_A132OrdenEmpFac = new short[1] ;
         H00193_n132OrdenEmpFac = new bool[] {false} ;
         H00193_A25OrdenAnio = new short[1] ;
         H00193_A24OrdenPeriodo = new short[1] ;
         H00193_A117OrdenModeloID = new short[1] ;
         H00193_A26OrdenMarcaID = new short[1] ;
         H00193_A57ClienteDsc = new String[] {""} ;
         H00193_n57ClienteDsc = new bool[] {false} ;
         H00193_A5ClienteID = new short[1] ;
         H00193_A119OrdenFch = new DateTime[] {DateTime.MinValue} ;
         H00193_n119OrdenFch = new bool[] {false} ;
         H00193_A116OrdenUser = new String[] {""} ;
         H00193_n116OrdenUser = new bool[] {false} ;
         H00193_A115OrdenEst = new String[] {""} ;
         H00193_n115OrdenEst = new bool[] {false} ;
         H00193_A110cantDias = new short[1] ;
         H00193_n110cantDias = new bool[] {false} ;
         H00193_A109fchVenta = new DateTime[] {DateTime.MinValue} ;
         H00193_n109fchVenta = new bool[] {false} ;
         H00193_A69VehiculoChasis = new String[] {""} ;
         H00193_n69VehiculoChasis = new bool[] {false} ;
         H00193_A68VehiculoPlaca = new String[] {""} ;
         H00193_n68VehiculoPlaca = new bool[] {false} ;
         H00193_A8VehiculoID = new short[1] ;
         H00193_A74protDsc = new String[] {""} ;
         H00193_n74protDsc = new bool[] {false} ;
         H00193_A10protID = new short[1] ;
         H00193_A107representane = new String[] {""} ;
         H00193_n107representane = new bool[] {false} ;
         H00193_A106facturaNro = new int[1] ;
         H00193_n106facturaNro = new bool[] {false} ;
         H00193_A104tipOrdDsc = new String[] {""} ;
         H00193_n104tipOrdDsc = new bool[] {false} ;
         H00193_A17tipOrdID = new short[1] ;
         H00193_A22OrdenID = new short[1] ;
         H00193_A255OrdenObreSuma = new decimal[1] ;
         H00193_n255OrdenObreSuma = new bool[] {false} ;
         H00193_A168OrdenValOtrs = new decimal[1] ;
         H00193_n168OrdenValOtrs = new bool[] {false} ;
         H00193_A167OrdenValEstr = new decimal[1] ;
         H00193_n167OrdenValEstr = new bool[] {false} ;
         H00193_A166OrdenValPint = new decimal[1] ;
         H00193_n166OrdenValPint = new bool[] {false} ;
         H00193_A165OrdenValCal = new decimal[1] ;
         H00193_n165OrdenValCal = new bool[] {false} ;
         H00193_A163OrdenValEnrq = new decimal[1] ;
         H00193_n163OrdenValEnrq = new bool[] {false} ;
         H00193_A162OrdenValInds = new decimal[1] ;
         H00193_n162OrdenValInds = new bool[] {false} ;
         H00193_A161OrdenSubtotal = new decimal[1] ;
         H00193_n161OrdenSubtotal = new bool[] {false} ;
         H00193_A153OrdenActaPdf = new String[] {""} ;
         H00193_n153OrdenActaPdf = new bool[] {false} ;
         H00193_A152OrdenPdf = new String[] {""} ;
         H00193_n152OrdenPdf = new bool[] {false} ;
         H00193_A112documento = new String[] {""} ;
         H00193_n112documento = new bool[] {false} ;
         H00193_A108urlPdf = new String[] {""} ;
         H00193_n108urlPdf = new bool[] {false} ;
         ...
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.vendedorordenproduccionwc__default(),
            new Object[][] {
                new Object[] {
               H00193_A1EmpID, H00193_A9vendedorID, H00193_A401OrdenNroDesp, H00193_n401OrdenNroDesp, H00193_A210OrdenUltSec, H00193_n210OrdenUltSec, H00193_A203ordenNroPed, H00193_n203ordenNroPed, H00193_A195OrdenFacNomb, H00193_n195OrdenFacNomb,
               H00193_A192OrdenPed, H00193_n192OrdenPed, H00193_A172OrdenfchEnt, H00193_n172OrdenfchEnt, H00193_A133OrdenProceso, H00193_n133OrdenProceso, H00193_A132OrdenEmpFac, H00193_n132OrdenEmpFac, H00193_A25OrdenAnio, H00193_A24OrdenPeriodo,
               H00193_A117OrdenModeloID, H00193_A26OrdenMarcaID, H00193_A57ClienteDsc, H00193_n57ClienteDsc, H00193_A5ClienteID, H00193_A119OrdenFch, H00193_n119OrdenFch, H00193_A116OrdenUser, H00193_n116OrdenUser, H00193_A115OrdenEst,
               H00193_n115OrdenEst, H00193_A110cantDias, H00193_n110cantDias, H00193_A109fchVenta, H00193_n109fchVenta, H00193_A69VehiculoChasis, H00193_n69VehiculoChasis, H00193_A68VehiculoPlaca, H00193_n68VehiculoPlaca, H00193_A8VehiculoID,
               H00193_A74protDsc, H00193_n74protDsc, H00193_A10protID, H00193_A107representane, H00193_n107representane, H00193_A106facturaNro, H00193_n106facturaNro, H00193_A104tipOrdDsc, H00193_n104tipOrdDsc, H00193_A17tipOrdID,
               H00193_A22OrdenID, H00193_A255OrdenObreSuma, H00193_n255OrdenObreSuma, H00193_A168OrdenValOtrs, H00193_n168OrdenValOtrs, H00193_A167OrdenValEstr, H00193_n167OrdenValEstr, H00193_A166OrdenValPint, H00193_n166OrdenValPint, H00193_A165OrdenValCal,
               H00193_n165OrdenValCal, H00193_A163OrdenValEnrq, H00193_n163OrdenValEnrq, H00193_A162OrdenValInds, H00193_n162OrdenValInds, H00193_A161OrdenSubtotal, H00193_n161OrdenSubtotal, H00193_A153OrdenActaPdf, H00193_n153OrdenActaPdf, H00193_A152OrdenPdf,
               H00193_n152OrdenPdf, H00193_A112documento, H00193_n112documento, H00193_A108urlPdf, H00193_n108urlPdf
               }
               , new Object[] {
      ...
      private String sCtrlAV7vendedorID ;
      ...
      private short[] H00193_A1EmpID ;
      private short[] H00193_A9vendedorID ;
      private int[] H00193_A401OrdenNroDesp ;
      private bool[] H00193_n401OrdenNroDesp ;
      private short[] H00193_A210OrdenUltSec ;
      private bool[] H00193_n210OrdenUltSec ;
      private int[] H00193_A203ordenNroPed ;
      private bool[] H00193_n203ordenNroPed ;
      private String[] H00193_A195OrdenFacNomb ;
      private bool[] H00193_n195OrdenFacNomb ;
      private int[] H00193_A192OrdenPed ;
      private bool[] H00193_n192OrdenPed ;
      private DateTime[] H00193_A172OrdenfchEnt ;
      private bool[] H00193_n172OrdenfchEnt ;
      private String[] H00193_A133OrdenProceso ;
      private bool[] H00193_n133OrdenProceso ;
      private short[] H00193_A132OrdenEmpFac ;
      private bool[] H00193_n132OrdenEmpFac ;
      private short[] H00193_A25OrdenAnio ;
      private short[] H00193_A24OrdenPeriodo ;
      private short[] H00193_A117OrdenModeloID ;
      private short[] H00193_A26OrdenMarcaID ;
      private String[] H00193_A57ClienteDsc ;
      private bool[] H00193_n57ClienteDsc ;
      private short[] H00193_A5ClienteID ;
      private DateTime[] H00193_A119OrdenFch ;
      private bool[] H00193_n119OrdenFch ;
      private String[] H00193_A116OrdenUser ;
      private bool[] H00193_n116OrdenUser ;
      private String[] H00193_A115OrdenEst ;
      private bool[] H00193_n115OrdenEst ;
      private short[] H00193_A110cantDias ;
      private bool[] H00193_n110cantDias ;
      private DateTime[] H00193_A109fchVenta ;
      private bool[] H00193_n109fchVenta ;
      private String[] H00193_A69VehiculoChasis ;
      private bool[] H00193_n69VehiculoChasis ;
      private String[] H00193_A68VehiculoPlaca ;
      private bool[] H00193_n68VehiculoPlaca ;
      private short[] H00193_A8VehiculoID ;
      private String[] H00193_A74protDsc ;
      private bool[] H00193_n74protDsc ;
      private short[] H00193_A10protID ;
      private String[] H00193_A107representane ;
      private bool[] H00193_n107representane ;
      private int[] H00193_A106facturaNro ;
      private bool[] H00193_n106facturaNro ;
      private String[] H00193_A104tipOrdDsc ;
      private bool[] H00193_n104tipOrdDsc ;
      private short[] H00193_A17tipOrdID ;
      private short[] H00193_A22OrdenID ;
      private decimal[] H00193_A255OrdenObreSuma ;
      private bool[] H00193_n255OrdenObreSuma ;
      private decimal[] H00193_A168OrdenValOtrs ;
      private bool[] H00193_n168OrdenValOtrs ;
      private decimal[] H00193_A167OrdenValEstr ;
      private bool[] H00193_n167OrdenValEstr ;
      private decimal[] H00193_A166OrdenValPint ;
      private bool[] H00193_n166OrdenValPint ;
      private decimal[] H00193_A165OrdenValCal ;
      private bool[] H00193_n165OrdenValCal ;
      private decimal[] H00193_A163OrdenValEnrq ;
      private bool[] H00193_n163OrdenValEnrq ;
      private decimal[] H00193_A162OrdenValInds ;
      private bool[] H00193_n162OrdenValInds ;
      private decimal[] H00193_A161OrdenSubtotal ;
      private bool[] H00193_n161OrdenSubtotal ;
      private String[] H00193_A153OrdenActaPdf ;
      private bool[] H00193_n153OrdenActaPdf ;
      private String[] H00193_A152OrdenPdf ;
      private bool[] H00193_n152OrdenPdf ;
      private String[] H00193_A112documento ;
      private bool[] H00193_n112documento ;
      private String[] H00193_A108urlPdf ;
      private bool[] H00193_n108urlPdf ;
   ...
   public class vendedorordenproduccionwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV7vendedorID",SqlDbType.SmallInt,4,0} ,
          new Object[] {"@GXPagingFrom2",SqlDbType.Int,9,0} ,
          new Object[] {"@GXPagingTo2",SqlDbType.Int,9,0}
          } ;
          String cmdBufferH00193 ;
          cmdBufferH00193=" SELECT T1.[EmpID], T1.[vendedorID], T1.[OrdenNroDesp], T1.[OrdenUltSec], T1.[ordenNroPed], T1.[OrdenFacNomb], T1.[OrdenPed], T1.[OrdenfchEnt], T1.[OrdenProceso], T1.[OrdenEmpFac], T1.[OrdenAnio], T1.[OrdenPeriodo], T1.[OrdenModeloID], T1.[OrdenMarcaID], T2.[ClienteDsc], T1.[ClienteID], T1.[OrdenFch], T1.[OrdenUser], T1.[OrdenEst], T1.[cantDias], T1.[fchVenta], T3.[VehiculoChasis], T3.[VehiculoPlaca], T1.[VehiculoID], T4.[protDsc], T1.[protID], T1.[representane], T1.[facturaNro], T5.[tipOrdDsc], T1.[tipOrdID], T1.[OrdenID], COALESCE( T6.[OrdenObreSuma], 0) AS OrdenObreSuma, T1.[OrdenValOtrs], T1.[OrdenValEstr], T1.[OrdenValPint], T1.[OrdenValCal], T1.[OrdenValEnrq], T1.[OrdenValInds], T1.[OrdenSubtotal], T1.[OrdenActaPdf], T1.[OrdenPdf], T1.[documento], T1.[urlPdf] FROM ((((([OrdenProduccion] T1 WITH (NOLOCK) INNER JOIN [Clientes] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID] AND T2.[ClienteID] = T1.[ClienteID]) INNER JOIN [Vehiculos] T3 WITH (NOLOCK) ON T3.[EmpID] = T1.[EmpID] AND T3.[VehiculoID] = T1.[VehiculoID]) INNER JOIN [Prototipo] T4 WITH (NOLOCK) ON T4.[EmpID] = T1.[EmpID] AND T4.[protID] = T1.[protID]) INNER JOIN [TipoOrdenPro] T5 WITH (NOLOCK) ON T5.[EmpID] = T1.[EmpID] AND T5.[tipOrdID] = T1.[tipOrdID]) LEFT JOIN (SELECT SUM([OrdenObreValor]) AS OrdenObreSuma, [EmpID], [ClienteID], [OrdenPeriodo], [OrdenAnio], [OrdenID] FROM [OrdenProduccionObr] WITH (NOLOCK) GROUP BY [EmpID], [ClienteID], [OrdenPeriodo], [OrdenAnio], [OrdenID] ) T6 ON T6.[EmpID] = T1.[EmpID] AND T6.[ClienteID] = T1.[ClienteID] AND T6.[OrdenPeriodo] = T1.[OrdenPeriodo] AND T6.[OrdenAnio] = T1.[OrdenAnio] AND T6.[OrdenID] = T1.[OrdenID]) WHERE T1.[EmpID] = @AV6EmpID and T1.[vendedorID] = @AV7vendedorID ORDER BY T1.[EmpID], T1.[vendedorID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN "
          ...
          def= new CursorDef[] {
              new CursorDef("H00193", cmdBufferH00193,false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00193,11,0,true,false )
             ,new CursorDef("H00195", "SELECT COUNT(*) FROM ((((([OrdenProduccion] T1 WITH (NOLOCK) INNER JOIN [Clientes] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID] AND T2.[ClienteID] = T1.[ClienteID]) INNER JOIN [Vehiculos] T3 WITH (NOLOCK) ON T3.[EmpID] = T1.[EmpID] AND T3.[VehiculoID] = T1.[VehiculoID]) INNER JOIN [Prototipo] T4 WITH (NOLOCK) ON T4.[EmpID] = T1.[EmpID] AND T4.[protID] = T1.[protID]) INNER JOIN [TipoOrdenPro] T5 WITH (NOLOCK) ON T5.[EmpID] = T1.[EmpID] AND T5.[tipOrdID] = T1.[tipOrdID]) LEFT JOIN (SELECT SUM([OrdenObreValor]) AS OrdenObreSuma, [EmpID], [ClienteID], [OrdenPeriodo], [OrdenAnio], [OrdenID] FROM [OrdenProduccionObr] WITH (NOLOCK) GROUP BY [EmpID], [ClienteID], [OrdenPeriodo], [OrdenAnio], [OrdenID] ) T6 ON T6.[EmpID] = T1.[EmpID] AND T6.[ClienteID] = T1.[ClienteID] AND T6.[OrdenPeriodo] = T1.[OrdenPeriodo] AND T6.[OrdenAnio] = T1.[OrdenAnio] AND T6.[OrdenID] = T1.[OrdenID]) WHERE T1.[EmpID] = @AV6EmpID and T1.[vendedorID] = @AV7vendedorID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00195,1,0,true,false )
          };
       }
    }
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((String[]) buf[43])[0] = rslt.getString(27, 50) ;
