/*
               File: WWAgencias
        Description: Work With Agencias
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 11/19/2022 22:53:53.35
...
namespace GeneXus.Programs {
   public class wwagencias : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      public wwagencias( )
      {
      ...
      public wwagencias( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13AgeDsc, AV19Pgmname, AV14Update, AV15Delete) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022111922535340", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwagencias.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vAGEDSC", StringUtil.RTrim( AV13AgeDsc));
         /* Send saved values. */
      ...
      protected void WB0T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Agencias", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_WWAgencias.htm");
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWAgencias.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavAgedsc_Internalname, "Age Dsc", "col-sm-3 FilterSearchAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavAgedsc_Internalname, StringUtil.RTrim( AV13AgeDsc), StringUtil.RTrim( context.localUtil.Format( AV13AgeDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Dsc", edtavAgedsc_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavAgedsc_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_WWAgencias.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A47AgeEst));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A48AgeDir));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A49AgeTelf));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START0T2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Work With Agencias", 0) ;
         }
         context.wjLoc = "";
                        ...
                        if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false;
                                    /* Set Refresh If Agedsc Changed */
                                    if ( StringUtil.StrCmp(cgiGet( "GXH_vAGEDSC"), AV13AgeDsc) != 0 )
                                    {
                                       Rfr0gs = true;
                                    }
                                    if ( ! Rfr0gs )
      ...
      protected void PA0T2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavAgedsc_Internalname;
      ...
      protected void RF0T2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13AgeDsc = StringUtil.PadR( StringUtil.RTrim( AV13AgeDsc), 50, "%");
            /* Using cursor H000T2 */
            pr_default.execute(0, new Object[] {lV13AgeDsc, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_25_idx), 4, 0)), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               A49AgeTelf = H000T2_A49AgeTelf[0];
               n49AgeTelf = H000T2_n49AgeTelf[0];
               A48AgeDir = H000T2_A48AgeDir[0];
               n48AgeDir = H000T2_n48AgeDir[0];
               A47AgeEst = H000T2_A47AgeEst[0];
               n47AgeEst = H000T2_n47AgeEst[0];
               A46AgeDsc = H000T2_A46AgeDsc[0];
               n46AgeDsc = H000T2_n46AgeDsc[0];
               A2AgeID = H000T2_A2AgeID[0];
               A44empdsc = H000T2_A44empdsc[0];
               n44empdsc = H000T2_n44empdsc[0];
               A1EmpID = H000T2_A1EmpID[0];
               A44empdsc = H000T2_A44empdsc[0];
               n44empdsc = H000T2_n44empdsc[0];
               E140T2 ();
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         lV13AgeDsc = StringUtil.PadR( StringUtil.RTrim( AV13AgeDsc), 50, "%");
         /* Using cursor H000T3 */
         pr_default.execute(1, new Object[] {lV13AgeDsc});
      ...
      protected void STRUP0T0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13AgeDsc = cgiGet( edtavAgedsc_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13AgeDsc", AV13AgeDsc);
            /* Read saved values. */
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("agencias.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A2AgeID);
         edtavDelete_Link = formatLink("agencias.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A2AgeID);
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 25;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("agencias.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13AgeDsc = ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13AgeDsc", AV13AgeDsc);
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = AV13AgeDsc;
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext.gxTpr_Transactionname = "Agencias";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022111922535392", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwagencias.js", "?2022111922535392", false);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtAgeEst_Internalname = "AGEEST_"+sGXsfl_25_idx;
         edtAgeDir_Internalname = "AGEDIR_"+sGXsfl_25_idx;
         edtAgeTelf_Internalname = "AGETELF_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtAgeEst_Internalname = "AGEEST_"+sGXsfl_25_fel_idx;
         edtAgeDir_Internalname = "AGEDIR_"+sGXsfl_25_fel_idx;
         edtAgeTelf_Internalname = "AGETELF_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtAgeEst_Internalname,StringUtil.RTrim( A47AgeEst),(String)"",(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtAgeEst_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)1,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(String)"estado",(String)"left",(bool)true});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtAgeDir_Internalname,StringUtil.RTrim( A48AgeDir),(String)"",(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtAgeDir_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)0,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)100,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtAgeTelf_Internalname,StringUtil.RTrim( A49AgeTelf),(String)"",(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtAgeTelf_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)0,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)20,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void init_default_properties( )
      {
         ...
         edtavAgedsc_Internalname = "vAGEDSC";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavAgedsc_Jsonclick = "";
         edtavAgedsc_Enabled = 1;
         Form.Caption = "Work With Agencias";
         subGrid_Rows = 10;
         edtavDelete_Tooltiptext = "Eliminar";
         edtavUpdate_Tooltiptext = "Modificar";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13AgeDsc',fld:'vAGEDSC',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140T2',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A2AgeID',fld:'AGEID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110T2',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A2AgeID',fld:'AGEID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13AgeDsc = "";
         H000T2_A49AgeTelf = new String[] {""} ;
         H000T2_n49AgeTelf = new bool[] {false} ;
         H000T2_A48AgeDir = new String[] {""} ;
         H000T2_n48AgeDir = new bool[] {false} ;
         H000T2_A47AgeEst = new String[] {""} ;
         H000T2_n47AgeEst = new bool[] {false} ;
         H000T2_A46AgeDsc = new String[] {""} ;
         H000T2_n46AgeDsc = new bool[] {false} ;
         H000T2_A2AgeID = new short[1] ;
         H000T2_A44empdsc = new String[] {""} ;
         H000T2_n44empdsc = new bool[] {false} ;
         H000T2_A1EmpID = new short[1] ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwagencias__default(),
            new Object[][] {
                new Object[] {
               H000T2_A49AgeTelf, H000T2_n49AgeTelf, H000T2_A48AgeDir, H000T2_n48AgeDir, H000T2_A47AgeEst, H000T2_n47AgeEst, H000T2_A46AgeDsc, H000T2_n46AgeDsc, H000T2_A2AgeID, H000T2_A44empdsc,
               H000T2_n44empdsc, H000T2_A1EmpID
               }
               , new Object[] {
      ...
      private int edtavAgedsc_Enabled ;
      ...
      private String edtavAgedsc_Internalname ;
      private String edtavAgedsc_Jsonclick ;
      ...
      private String[] H000T2_A49AgeTelf ;
      private bool[] H000T2_n49AgeTelf ;
      private String[] H000T2_A48AgeDir ;
      private bool[] H000T2_n48AgeDir ;
      private String[] H000T2_A47AgeEst ;
      private bool[] H000T2_n47AgeEst ;
      private String[] H000T2_A46AgeDsc ;
      private bool[] H000T2_n46AgeDsc ;
      private short[] H000T2_A2AgeID ;
      private String[] H000T2_A44empdsc ;
      private bool[] H000T2_n44empdsc ;
      private short[] H000T2_A1EmpID ;
   ...
   public class wwagencias__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A46AgeDsc )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " T1.[AgeTelf], T1.[AgeDir], T1.[AgeEst], T1.[AgeDsc], T1.[AgeID], T2.[empdsc], T1.[EmpID]";
         sFromString = " FROM ([Agencias] T1 WITH (NOLOCK) INNER JOIN [Empresas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13AgeDsc)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and (T1.[AgeDsc] like @lV13AgeDsc)";
            }
            else
            {
               sWhereString = sWhereString + " (T1.[AgeDsc] like @lV13AgeDsc)";
            }
         }
         else
         {
         ...
         sOrderString = sOrderString + " ORDER BY T1.[AgeDsc]";
                                             ...
                                             String A46AgeDsc )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([Agencias] T1 WITH (NOLOCK) INNER JOIN [Empresas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13AgeDsc)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000T2(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
               case 1 :
                     return conditional_H000T3(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV13AgeDsc",SqlDbType.Char,50,0} ,
