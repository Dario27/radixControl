/*
       ...
       Generated on: 10/29/2022 1:8:31.48
...
namespace GeneXus.Programs {
   public class gx0200 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV12cPrdDescCorta = GetNextPar( );
               AV17cPrdTipPrd = (short)(NumberUtil.Val( GetNextPar( ), "."));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cEmpID, AV7cAgeID, AV8cPrdCod, AV10cPrdPres, AV11cPrdEstado, AV12cPrdDescCorta, AV17cPrdTipPrd) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20221029183180", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0200.aspx") + "?" + UrlEncode("" +AV13pEmpID) + "," + UrlEncode("" +AV14pAgeID) + "," + UrlEncode("" +AV15pPrdCod)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCPRDDESCCORTA", AV12cPrdDescCorta);
         GxWebStd.gx_hidden_field( context, "GXH_vCPRDTIPPRD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17cPrdTipPrd), 1, 0, ",", "")));
         /* Send saved values. */
         ...
         GxWebStd.gx_hidden_field( context, "PRDTIPPRDFILTERCONTAINER_Class", StringUtil.RTrim( divPrdtipprdfiltercontainer_Class));
      }
      ...
      {
         return formatLink("gx0200.aspx") + "?" + UrlEncode("" +AV13pEmpID) + "," + UrlEncode("" +AV14pAgeID) + "," + UrlEncode("" +AV15pPrdCod) ;
      }
      ...
      protected void WB4W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblempidfilter_Internalname, "Emp ID", "", "", lblLblempidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e114w1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0200.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCempid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cEmpID), 4, 0, ",", "")), ((edtavCempid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6cEmpID), "ZZZ9")) : context.localUtil.Format( (decimal)(AV6cEmpID), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCempid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCempid_Visible, edtavCempid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx0200.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblageidfilter_Internalname, "Age ID", "", "", lblLblageidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e124w1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0200.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprdcodfilter_Internalname, "ID", "", "", lblLblprdcodfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e134w1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0200.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprdcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cPrdCod), 4, 0, ",", "")), ((edtavCprdcod_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV8cPrdCod), "ZZZ9")) : context.localUtil.Format( (decimal)(AV8cPrdCod), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprdcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprdcod_Visible, edtavCprdcod_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx0200.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprdpresfilter_Internalname, "Presentacion", "", "", lblLblprdpresfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e144w1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0200.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprdpres_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10cPrdPres), 2, 0, ",", "")), ((edtavCprdpres_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10cPrdPres), "Z9")) : context.localUtil.Format( (decimal)(AV10cPrdPres), "Z9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprdpres_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprdpres_Visible, edtavCprdpres_Enabled, 0, "number", "1", 2, "chr", 1, "row", 2, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx0200.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprdestadofilter_Internalname, "Estado", "", "", lblLblprdestadofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e154w1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0200.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprdestado_Internalname, StringUtil.RTrim( AV11cPrdEstado), StringUtil.RTrim( context.localUtil.Format( AV11cPrdEstado, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprdestado_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprdestado_Visible, edtavCprdestado_Enabled, 0, "text", "", 1, "chr", 1, "row", 1, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_Gx0200.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprddesccortafilter_Internalname, "Desc Corta", "", "", lblLblprddesccortafilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e164w1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0200.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprddesccorta_Internalname, AV12cPrdDescCorta, StringUtil.RTrim( context.localUtil.Format( AV12cPrdDescCorta, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprddesccorta_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprddesccorta_Visible, edtavCprddesccorta_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_Gx0200.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divPrdtipprdfiltercontainer_Internalname, 1, 0, "px", 0, "px", divPrdtipprdfiltercontainer_Class, "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprdtipprdfilter_Internalname, "Tipo Producto", "", "", lblLblprdtipprdfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e174w1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0200.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCprdtipprd_Internalname, "Tipo Producto", "col-sm-3 AttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 76,'',false,'" + sGXsfl_84_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCprdtipprd_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17cPrdTipPrd), 1, 0, ",", "")), ((edtavCprdtipprd_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV17cPrdTipPrd), "9")) : context.localUtil.Format( (decimal)(AV17cPrdTipPrd), "9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprdtipprd_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprdtipprd_Visible, edtavCprdtipprd_Enabled, 0, "number", "1", 1, "chr", 1, "row", 1, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx0200.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(84), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e184w1_client"+"'", TempTags, "", 2, "HLP_Gx0200.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 84 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(84), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx0200.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCPRDDESCCORTA"), AV12cPrdDescCorta) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Cprdtipprd Changed */
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCPRDTIPPRD"), ",", ".") != Convert.ToDecimal( AV17cPrdTipPrd )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void gxgrGrid1_refresh( int subGrid1_Rows ,
                                        ...
                                        String AV12cPrdDescCorta ,
                                        short AV17cPrdTipPrd )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void RF4W2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV8cPrdCod } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.BOOLEAN,
            ...
            lV12cPrdDescCorta = StringUtil.Concat( StringUtil.RTrim( AV12cPrdDescCorta), "%", "");
            /* Using cursor H004W2 */
            pr_default.execute(0, new Object[] {AV6cEmpID, AV7cAgeID, AV8cPrdCod, AV10cPrdPres, lV11cPrdEstado, lV12cPrdDescCorta, AV17cPrdTipPrd, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_84_idx = 1;
            sGXsfl_84_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_84_idx), 4, 0)), 4, "0");
            SubsflControlProps_842( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A31tipoProdID = H004W2_A31tipoProdID[0];
               A308PrdTipPrd = H004W2_A308PrdTipPrd[0];
               n308PrdTipPrd = H004W2_n308PrdTipPrd[0];
               A306PrdDescCorta = H004W2_A306PrdDescCorta[0];
               n306PrdDescCorta = H004W2_n306PrdDescCorta[0];
               A289PrdEstado = H004W2_A289PrdEstado[0];
               n289PrdEstado = H004W2_n289PrdEstado[0];
               A288PrdPres = H004W2_A288PrdPres[0];
               n288PrdPres = H004W2_n288PrdPres[0];
               A286PrdCod = H004W2_A286PrdCod[0];
               A2AgeID = H004W2_A2AgeID[0];
               A1EmpID = H004W2_A1EmpID[0];
               /* Execute user event: Load */
               E204W2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         lV12cPrdDescCorta = StringUtil.Concat( StringUtil.RTrim( AV12cPrdDescCorta), "%", "");
         /* Using cursor H004W3 */
         pr_default.execute(1, new Object[] {AV6cEmpID, AV7cAgeID, AV8cPrdCod, AV10cPrdPres, lV11cPrdEstado, lV12cPrdDescCorta, AV17cPrdTipPrd});
         GRID1_nRecordCount = H004W3_AGRID1_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUP4W0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV12cPrdDescCorta = cgiGet( edtavCprddesccorta_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12cPrdDescCorta", AV12cPrdDescCorta);
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCprdtipprd_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCprdtipprd_Internalname), ",", ".") > Convert.ToDecimal( 9 )) ) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "vCPRDTIPPRD");
               GX_FocusControl = edtavCprdtipprd_Internalname;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV17cPrdTipPrd = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV17cPrdTipPrd", StringUtil.Str( (decimal)(AV17cPrdTipPrd), 1, 0));
            }
            else
            {
               AV17cPrdTipPrd = (short)(context.localUtil.CToN( cgiGet( edtavCprdtipprd_Internalname), ",", "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV17cPrdTipPrd", StringUtil.Str( (decimal)(AV17cPrdTipPrd), 1, 0));
            }
            /* Read saved values. */
      ...
      protected void E214W2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV15pPrdCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV15pPrdCod), 4, 0)));
         context.setWebReturnParms(new Object[] {(short)AV13pEmpID,(short)AV14pAgeID,(short)AV15pPrdCod});
         context.setWebReturnParmsMetadata(new Object[] {"AV13pEmpID","AV14pAgeID","AV15pPrdCod"});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20221029183688", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0200.js", "?20221029183688", false);
      ...
      protected void SubsflControlProps_842( )
      {
         ...
         edttipoProdID_Internalname = "TIPOPRODID_"+sGXsfl_84_idx;
      }
      ...
      protected void SubsflControlProps_fel_842( )
      {
         ...
         edttipoProdID_Internalname = "TIPOPRODID_"+sGXsfl_84_fel_idx;
      }
      ...
      protected void sendrow_842( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_84_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A1EmpID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A2AgeID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A286PrdCod), 4, 0, ",", "")))+"'"+"]);";
            ...
            edtPrdDescCorta_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A1EmpID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A2AgeID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A286PrdCod), 4, 0, ",", "")))+"'"+"]);";
      ...
      protected void init_default_properties( )
      {
         ...
         lblLblprdtipprdfilter_Internalname = "LBLPRDTIPPRDFILTER";
         edtavCprdtipprd_Internalname = "vCPRDTIPPRD";
         divPrdtipprdfiltercontainer_Internalname = "PRDTIPPRDFILTERCONTAINER";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavCprdtipprd_Jsonclick = "";
         edtavCprdtipprd_Enabled = 1;
         edtavCprdtipprd_Visible = 1;
         ...
         divPrdtipprdfiltercontainer_Class = "AdvancedContainerItem";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cEmpID',fld:'vCEMPID',pic:'ZZZ9'},{av:'AV7cAgeID',fld:'vCAGEID',pic:'ZZZ9'},{av:'AV8cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV10cPrdPres',fld:'vCPRDPRES',pic:'Z9'},{av:'AV11cPrdEstado',fld:'vCPRDESTADO',pic:''},{av:'AV12cPrdDescCorta',fld:'vCPRDDESCCORTA',pic:''},{av:'AV17cPrdTipPrd',fld:'vCPRDTIPPRD',pic:'9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E184W1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLEMPIDFILTER.CLICK","{handler:'E114W1',iparms:[{av:'divEmpidfiltercontainer_Class',ctrl:'EMPIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLAGEIDFILTER.CLICK","{handler:'E124W1',iparms:[{av:'divAgeidfiltercontainer_Class',ctrl:'AGEIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRDCODFILTER.CLICK","{handler:'E134W1',iparms:[{av:'divPrdcodfiltercontainer_Class',ctrl:'PRDCODFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRDPRESFILTER.CLICK","{handler:'E144W1',iparms:[{av:'divPrdpresfiltercontainer_Class',ctrl:'PRDPRESFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRDESTADOFILTER.CLICK","{handler:'E154W1',iparms:[{av:'divPrdestadofiltercontainer_Class',ctrl:'PRDESTADOFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRDDESCCORTAFILTER.CLICK","{handler:'E164W1',iparms:[{av:'divPrddesccortafiltercontainer_Class',ctrl:'PRDDESCCORTAFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRDTIPPRDFILTER.CLICK","{handler:'E174W1',iparms:[{av:'divPrdtipprdfiltercontainer_Class',ctrl:'PRDTIPPRDFILTERCONTAINER',prop:'Class'}]");
         setEventMetadata("LBLPRDTIPPRDFILTER.CLICK",",oparms:[{av:'divPrdtipprdfiltercontainer_Class',ctrl:'PRDTIPPRDFILTERCONTAINER',prop:'Class'},{av:'edtavCprdtipprd_Visible',ctrl:'vCPRDTIPPRD',prop:'Visible'}]}");
         setEventMetadata("ENTER","{handler:'E214W2',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A2AgeID',fld:'AGEID',pic:'ZZZ9',hsh:true},{av:'A286PrdCod',fld:'PRDCOD',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV13pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV14pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV15pPrdCod',fld:'vPPRDCOD',pic:'ZZZ9'}]}");
      ...
      public override void initialize( )
      {
         ...
         lblLblprdtipprdfilter_Jsonclick = "";
         ClassString = "";
         StyleString = "";
         ...
         lV11cPrdEstado = "";
         lV12cPrdDescCorta = "";
         H004W2_A31tipoProdID = new short[1] ;
         H004W2_A308PrdTipPrd = new short[1] ;
         H004W2_n308PrdTipPrd = new bool[] {false} ;
         H004W2_A306PrdDescCorta = new String[] {""} ;
         H004W2_n306PrdDescCorta = new bool[] {false} ;
         H004W2_A289PrdEstado = new String[] {""} ;
         H004W2_n289PrdEstado = new bool[] {false} ;
         H004W2_A288PrdPres = new short[1] ;
         H004W2_n288PrdPres = new bool[] {false} ;
         H004W2_A286PrdCod = new short[1] ;
         H004W2_A2AgeID = new short[1] ;
         H004W2_A1EmpID = new short[1] ;
         H004W3_AGRID1_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0200__default(),
            new Object[][] {
                new Object[] {
               H004W2_A31tipoProdID, H004W2_A308PrdTipPrd, H004W2_n308PrdTipPrd, H004W2_A306PrdDescCorta, H004W2_n306PrdDescCorta, H004W2_A289PrdEstado, H004W2_n289PrdEstado, H004W2_A288PrdPres, H004W2_n288PrdPres, H004W2_A286PrdCod,
               H004W2_A2AgeID, H004W2_A1EmpID
               }
               , new Object[] {
               H004W3_AGRID1_nRecordCount
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int edtavCprdtipprd_Enabled ;
      private int edtavCprdtipprd_Visible ;
      ...
      private String divPrdtipprdfiltercontainer_Class ;
      ...
      private String divPrdtipprdfiltercontainer_Internalname ;
      private String lblLblprdtipprdfilter_Internalname ;
      private String lblLblprdtipprdfilter_Jsonclick ;
      private String edtavCprdtipprd_Internalname ;
      private String edtavCprdtipprd_Jsonclick ;
      ...
      private short[] H004W2_A31tipoProdID ;
      private short[] H004W2_A308PrdTipPrd ;
      private bool[] H004W2_n308PrdTipPrd ;
      private String[] H004W2_A306PrdDescCorta ;
      private bool[] H004W2_n306PrdDescCorta ;
      private String[] H004W2_A289PrdEstado ;
      private bool[] H004W2_n289PrdEstado ;
      private short[] H004W2_A288PrdPres ;
      private bool[] H004W2_n288PrdPres ;
      private short[] H004W2_A286PrdCod ;
      private short[] H004W2_A2AgeID ;
      private short[] H004W2_A1EmpID ;
      private long[] H004W3_AGRID1_nRecordCount ;
   ...
   public class gx0200__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV8cPrdCod )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " [tipoProdID], [PrdTipPrd], [PrdDescCorta], [PrdEstado], [PrdPres], [PrdCod], [AgeID], [EmpID]";
         sFromString = " FROM [Productos] WITH (NOLOCK)";
         sOrderString = "";
         sWhereString = sWhereString + " WHERE ([EmpID] >= @AV6cEmpID and [AgeID] >= @AV7cAgeID and [PrdCod] >= @AV8cPrdCod)";
         if ( ! (0==AV10cPrdPres) )
         {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV12cPrdDescCorta)) )
         {
            sWhereString = sWhereString + " and ([PrdDescCorta] like @lV12cPrdDescCorta)";
         }
         else
         {
            GXv_int1[5] = 1;
         ...
         if ( ! (0==AV17cPrdTipPrd) )
         {
            sWhereString = sWhereString + " and ([PrdTipPrd] >= @AV17cPrdTipPrd)";
         }
         else
         {
            GXv_int1[6] = 1;
                                             ...
                                             short AV8cPrdCod )
      {
         ...
         scmdbuf = scmdbuf + " WHERE ([EmpID] >= @AV6cEmpID and [AgeID] >= @AV7cAgeID and [PrdCod] >= @AV8cPrdCod)";
         if ( ! (0==AV10cPrdPres) )
         {
            sWhereString = sWhereString + " and ([PrdPres] >= @AV10cPrdPres)";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004W2(context, (short)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] , (short)dynConstraints[10] );
               case 1 :
                     return conditional_H004W3(context, (short)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (String)dynConstraints[5] , (String)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] , (short)dynConstraints[10] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV12cPrdDescCorta",SqlDbType.VarChar,40,0} ,
          new Object[] {"@AV17cPrdTipPrd",SqlDbType.SmallInt,1,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H004W2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004W2,11,0,false,false )
             ,new CursorDef("H004W3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004W3,1,0,false,false )
          };
       }
    }
