/*
               File: EmpresasAgenciasWC
        Description: Empresas Agencias WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 11/19/2022 22:52:55.19
...
namespace GeneXus.Programs {
   public class empresasagenciaswc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public empresasagenciaswc( )
      {
      ...
      public empresasagenciaswc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
                  forbiddenHiddens = sPrefix + "hsh" + "EmpresasAgenciasWC";
                  ...
                  GXUtil.WriteLog("empresasagenciaswc:[SendSecurityCheck value for]"+"EmpID:"+context.localUtil.Format( (decimal)(A1EmpID), "ZZZ9"));
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV16Pgmname = "EmpresasAgenciasWC";
               context.Gx_err = 0;
               WS0D2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Empresas Agencias WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022111922525526", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("empresasagenciaswc.aspx") + "?" + UrlEncode("" +AV6EmpID)+"\">") ;
      ...
      protected void RenderHtmlCloseForm0D2( )
      {
         ...
         {
            context.AddJavascriptSource("empresasagenciaswc.js", "?2022111922525529", false);
         }
      ...
      {
         return "EmpresasAgenciasWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Empresas Agencias WC" ;
      }
      ...
      protected void WB0D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "empresasagenciaswc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EmpresasAgenciasWC.htm");
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtAgeDsc_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START0D2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Empresas Agencias WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF0D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1EmpID = H000D2_A1EmpID[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(A1EmpID), 4, 0)));
               A49AgeTelf = H000D2_A49AgeTelf[0];
               n49AgeTelf = H000D2_n49AgeTelf[0];
               A48AgeDir = H000D2_A48AgeDir[0];
               n48AgeDir = H000D2_n48AgeDir[0];
               A47AgeEst = H000D2_A47AgeEst[0];
               n47AgeEst = H000D2_n47AgeEst[0];
               A46AgeDsc = H000D2_A46AgeDsc[0];
               n46AgeDsc = H000D2_n46AgeDsc[0];
               A2AgeID = H000D2_A2AgeID[0];
               E130D2 ();
      ...
      protected void STRUP0D0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            {
               GXUtil.WriteLog("empresasagenciaswc:[SecurityCheckFailed value for]"+"EmpID:"+context.localUtil.Format( (decimal)(A1EmpID), "ZZZ9"));
               GxWebError = 1;
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("agencias.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A2AgeID);
         edtavDelete_Link = formatLink("agencias.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A2AgeID);
         edtAgeDsc_Link = formatLink("viewagencias.aspx") + "?" + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A2AgeID) + "," + UrlEncode(StringUtil.RTrim(""));
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 20;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("agencias.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Agencias";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "empresasagenciaswc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022111922525576", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("empresasagenciaswc.js", "?2022111922525576", false);
         }
      ...
      protected void SubsflControlProps_202( )
      {
         ...
         edtAgeEst_Internalname = sPrefix+"AGEEST_"+sGXsfl_20_idx;
         edtAgeDir_Internalname = sPrefix+"AGEDIR_"+sGXsfl_20_idx;
         edtAgeTelf_Internalname = sPrefix+"AGETELF_"+sGXsfl_20_idx;
      ...
      protected void SubsflControlProps_fel_202( )
      {
         ...
         edtAgeEst_Internalname = sPrefix+"AGEEST_"+sGXsfl_20_fel_idx;
         edtAgeDir_Internalname = sPrefix+"AGEDIR_"+sGXsfl_20_fel_idx;
         edtAgeTelf_Internalname = sPrefix+"AGETELF_"+sGXsfl_20_fel_idx;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130D2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A2AgeID',fld:'AGEID',pic:'ZZZ9',hsh:true},{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtAgeDsc_Link',ctrl:'AGEDSC',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110D2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A2AgeID',fld:'AGEID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV18Delete_GXI = "";
         scmdbuf = "";
         H000D2_A1EmpID = new short[1] ;
         H000D2_A49AgeTelf = new String[] {""} ;
         H000D2_n49AgeTelf = new bool[] {false} ;
         H000D2_A48AgeDir = new String[] {""} ;
         H000D2_n48AgeDir = new bool[] {false} ;
         H000D2_A47AgeEst = new String[] {""} ;
         H000D2_n47AgeEst = new bool[] {false} ;
         H000D2_A46AgeDsc = new String[] {""} ;
         H000D2_n46AgeDsc = new bool[] {false} ;
         H000D2_A2AgeID = new short[1] ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.empresasagenciaswc__default(),
            new Object[][] {
                new Object[] {
               H000D2_A1EmpID, H000D2_A49AgeTelf, H000D2_n49AgeTelf, H000D2_A48AgeDir, H000D2_n48AgeDir, H000D2_A47AgeEst, H000D2_n47AgeEst, H000D2_A46AgeDsc, H000D2_n46AgeDsc, H000D2_A2AgeID
               }
               , new Object[] {
      ...
      private short[] H000D2_A1EmpID ;
      private String[] H000D2_A49AgeTelf ;
      private bool[] H000D2_n49AgeTelf ;
      private String[] H000D2_A48AgeDir ;
      private bool[] H000D2_n48AgeDir ;
      private String[] H000D2_A47AgeEst ;
      private bool[] H000D2_n47AgeEst ;
      private String[] H000D2_A46AgeDsc ;
      private bool[] H000D2_n46AgeDsc ;
      private short[] H000D2_A2AgeID ;
   ...
   public class empresasagenciaswc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000D2", "SELECT [EmpID], [AgeTelf], [AgeDir], [AgeEst], [AgeDsc], [AgeID] FROM [Agencias] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ORDER BY [EmpID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000D2,11,0,true,false )
             ,new CursorDef("H000D3", "SELECT COUNT(*) FROM [Agencias] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000D3,1,0,true,false )
          };
       }
    }
