/*
               File: CotizadorObrerosWC
        Description: Cotizador Obreros WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/26/2022 20:13:1.45
...
namespace GeneXus.Programs {
   public class cotizadorobreroswc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public cotizadorobreroswc( )
      {
      ...
      public cotizadorobreroswc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6EmpID, AV7CotiID, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV15Pgmname = "CotizadorObrerosWC";
               context.Gx_err = 0;
               WS1U2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Cotizador Obreros WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202210262013149", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("cotizadorobreroswc.aspx") + "?" + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +AV7CotiID)+"\">") ;
      ...
      protected void RenderHtmlCloseForm1U2( )
      {
         ...
         {
            context.AddJavascriptSource("cotizadorobreroswc.js", "?202210262013150", false);
         }
      ...
      {
         return "CotizadorObrerosWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Cotizador Obreros WC" ;
      }
      ...
      protected void WB1U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "cotizadorobreroswc.aspx");
            }
            /* Div Control */
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A38nroSec), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A202ObrDsc);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( A178ObrValor, 10, 2, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
      ...
      protected void START1U2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Cotizador Obreros WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF1U2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               ...
               A178ObrValor = H001U2_A178ObrValor[0];
               n178ObrValor = H001U2_n178ObrValor[0];
               A202ObrDsc = H001U2_A202ObrDsc[0];
               n202ObrDsc = H001U2_n202ObrDsc[0];
               A38nroSec = H001U2_A38nroSec[0];
               E121U2 ();
      ...
      {
         /* Using cursor H001U3 */
         pr_default.execute(1, new Object[] {AV6EmpID, AV7CotiID});
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "cotizadorobreroswc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202210262013189", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("cotizadorobreroswc.js", "?202210262013189", false);
         }
      ...
      {
         edtnroSec_Internalname = sPrefix+"NROSEC_"+sGXsfl_12_idx;
         edtObrDsc_Internalname = sPrefix+"OBRDSC_"+sGXsfl_12_idx;
         edtObrValor_Internalname = sPrefix+"OBRVALOR_"+sGXsfl_12_idx;
      }

      protected void SubsflControlProps_fel_122( )
      {
         edtnroSec_Internalname = sPrefix+"NROSEC_"+sGXsfl_12_fel_idx;
         edtObrDsc_Internalname = sPrefix+"OBRDSC_"+sGXsfl_12_fel_idx;
         edtObrValor_Internalname = sPrefix+"OBRVALOR_"+sGXsfl_12_fel_idx;
      }
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtnroSec_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A38nroSec), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A38nroSec), "ZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtnroSec_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)12,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtObrValor_Internalname,StringUtil.LTrim( StringUtil.NToC( A178ObrValor, 10, 2, ",", "")),context.localUtil.Format( A178ObrValor, "ZZZZZZ9.99"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtObrValor_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)10,(short)0,(short)0,(short)12,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
      ...
      {
         edtnroSec_Internalname = sPrefix+"NROSEC";
         edtObrDsc_Internalname = sPrefix+"OBRDSC";
         edtObrValor_Internalname = sPrefix+"OBRVALOR";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'AV7CotiID',fld:'vCOTIID',pic:'ZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E121U2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'AV7CotiID',fld:'vCOTIID',pic:'ZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'AV7CotiID',fld:'vCOTIID',pic:'ZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'AV7CotiID',fld:'vCOTIID',pic:'ZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'AV7CotiID',fld:'vCOTIID',pic:'ZZZ9'},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H001U2_A1EmpID = new short[1] ;
         H001U2_A34CotiID = new short[1] ;
         H001U2_A178ObrValor = new decimal[1] ;
         H001U2_n178ObrValor = new bool[] {false} ;
         H001U2_A202ObrDsc = new String[] {""} ;
         H001U2_n202ObrDsc = new bool[] {false} ;
         H001U2_A38nroSec = new short[1] ;
         ...
         sCtrlAV7CotiID = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.cotizadorobreroswc__default(),
            new Object[][] {
                new Object[] {
               H001U2_A1EmpID, H001U2_A34CotiID, H001U2_A178ObrValor, H001U2_n178ObrValor, H001U2_A202ObrDsc, H001U2_n202ObrDsc, H001U2_A38nroSec
               }
               , new Object[] {
      ...
      private short[] H001U2_A1EmpID ;
      private short[] H001U2_A34CotiID ;
      private decimal[] H001U2_A178ObrValor ;
      private bool[] H001U2_n178ObrValor ;
      private String[] H001U2_A202ObrDsc ;
      private bool[] H001U2_n202ObrDsc ;
      private short[] H001U2_A38nroSec ;
   ...
   public class cotizadorobreroswc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001U2", "SELECT [EmpID], [CotiID], [ObrValor], [ObrDsc], [nroSec] FROM [CotizadorObreros] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID and [CotiID] = @AV7CotiID ORDER BY [EmpID], [CotiID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001U2,11,0,true,false )
             ,new CursorDef("H001U3", "SELECT COUNT(*) FROM [CotizadorObreros] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID and [CotiID] = @AV7CotiID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001U3,1,0,true,false )
          };
       }
    }
