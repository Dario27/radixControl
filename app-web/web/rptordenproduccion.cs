/*
               File: rptOrdenProduccion
        Description: rpt Orden Produccion
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/26/2022 20:15:26.91
...
namespace GeneXus.Programs {
   public class rptordenproduccion : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public rptordenproduccion( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            if ( ( GxWebError == 0 ) && ! isAjaxCallMode( ) )
            {
               ...
               context.Gx_err = 0;
               GXVvPROCID_html2A2( ) ;
               GXVvCLIENTEID_html2A2( AV9empID) ;
               GXVvVENDID_html2A2( AV9empID) ;
               WS2A2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
                  WE2A2( ) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.SendWebValue( "rpt Orden Produccion") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102620152699", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("rptordenproduccion.aspx") + "?" + UrlEncode("" +AV9empID) + "," + UrlEncode("" +AV5ageID) + "," + UrlEncode(StringUtil.RTrim(AV15userCod))+"\">") ;
      ...
      {
         return "rptOrdenProduccion" ;
      }

      public override String GetPgmdesc( )
      {
         return "rpt Orden Produccion" ;
      }
      ...
      protected void WB2A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "Ordenes al Dia", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Title", 0, "", 1, 1, 0, "HLP_rptOrdenProduccion.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavFchdsd_Internalname, context.localUtil.Format(AV11fchDsd, "99/99/9999"), context.localUtil.Format( AV11fchDsd, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,22);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFchdsd_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFchdsd_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_rptOrdenProduccion.htm");
            GxWebStd.gx_bitmap( context, edtavFchdsd_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFchdsd_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_rptOrdenProduccion.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavFchhasta_Internalname, context.localUtil.Format(AV12fchHasta, "99/99/9999"), context.localUtil.Format( AV12fchHasta, "99/99/9999"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,25);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavFchhasta_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavFchhasta_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_rptOrdenProduccion.htm");
            GxWebStd.gx_bitmap( context, edtavFchhasta_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavFchhasta_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_rptOrdenProduccion.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "Middle", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavProcid, dynavProcid_Internalname, StringUtil.RTrim( AV14procId), 1, dynavProcid_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavProcid.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,45);\"", "", true, "HLP_rptOrdenProduccion.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnok_Internalname, "", "Aceptar", bttBtnok_Jsonclick, 5, "Aceptar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'ACEPTAR\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_rptOrdenProduccion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "", "Cancelar", bttBtncancel_Jsonclick, 7, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e112a1_client"+"'", TempTags, "", 2, "HLP_rptOrdenProduccion.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START2A2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "rpt Orden Produccion", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void GXDLVvCLIENTEID2A2( short AV9empID )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         GXDLVvCLIENTEID_data2A2( AV9empID) ;
         gxdynajaxindex = 1;
      ...
      protected void GXVvCLIENTEID_html2A2( short AV9empID )
      {
      ...
      protected void GXDLVvCLIENTEID_data2A2( short AV9empID )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H002A2_A5ClienteID[0]), 4, 0, ".", "")));
            gxdynajaxctrldescr.Add(StringUtil.RTrim( H002A2_A57ClienteDsc[0]));
            pr_default.readNext(0);
         }
         pr_default.close(0);
      }

      protected void GXDLVvVENDID2A2( short AV9empID )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
      ...
      protected void GXVvVENDID_html2A2( short AV9empID )
      {
         short gxdynajaxvalue ;
         GXDLVvVENDID_data2A2( AV9empID) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvVENDID_data2A2( short AV9empID )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         gxdynajaxctrlcodr.Add(StringUtil.Str( (decimal)(0), 1, 0));
         ...
         {
            gxdynajaxctrlcodr.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(H002A3_A9vendedorID[0]), 4, 0, ".", "")));
            gxdynajaxctrldescr.Add(StringUtil.RTrim( H002A3_A72vendedorDsc[0]));
            pr_default.readNext(1);
         }
         pr_default.close(1);
      }

      protected void GXDLVvPROCID2A2( )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
      ...
      protected void GXVvPROCID_html2A2( )
      {
      ...
      protected void GXDLVvPROCID_data2A2( )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         ...
         {
            gxdynajaxctrlcodr.Add(H002A4_A129ProcAbre[0]);
            gxdynajaxctrldescr.Add(StringUtil.RTrim( H002A4_A128ProcDsc[0]));
      ...
      {
         /* 'Aceptar' Routine */
         new exclistaordenproduccion(context ).execute(  AV9empID,  AV11fchDsd,  AV12fchHasta,  AV7ClienteID,  AV13OrdenID,  AV16vendID,  AV14procId, out  AV6archivo) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9empID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV9empID), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vEMPID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV9empID), "ZZZ9"), context));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11fchDsd", context.localUtil.Format(AV11fchDsd, "99/99/9999"));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12fchHasta", context.localUtil.Format(AV12fchHasta, "99/99/9999"));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022102620152829", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("rptordenproduccion.js", "?2022102620152830", false);
         context.AddJavascriptSource("GXProgressIndicator/javascript/bootstrap-progressbar.js", "", false);
         context.AddJavascriptSource("GXProgressIndicator/GXProgressIndicatorRender.js", "", false);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'CANCELAR'","{handler:'E112A1',iparms:[{av:'dynavProcid'},{av:'AV14procId',fld:'vPROCID',pic:''},{av:'AV9empID',fld:'vEMPID',pic:'ZZZ9',hsh:true},{av:'dynavClienteid'},{av:'AV7ClienteID',fld:'vCLIENTEID',pic:'ZZZ9'},{av:'dynavVendid'},{av:'AV16vendID',fld:'vVENDID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         gxwrpcisep = "";
         scmdbuf = "";
         H002A2_A5ClienteID = new short[1] ;
         H002A2_A57ClienteDsc = new String[] {""} ;
         H002A2_n57ClienteDsc = new bool[] {false} ;
         H002A2_A1EmpID = new short[1] ;
         H002A3_A9vendedorID = new short[1] ;
         H002A3_A72vendedorDsc = new String[] {""} ;
         H002A3_n72vendedorDsc = new bool[] {false} ;
         H002A3_A1EmpID = new short[1] ;
         H002A4_A20ProcID = new short[1] ;
         H002A4_A129ProcAbre = new String[] {""} ;
         H002A4_n129ProcAbre = new bool[] {false} ;
         H002A4_A128ProcDsc = new String[] {""} ;
         H002A4_n128ProcDsc = new bool[] {false} ;
         AV6archivo = "";
         AV8date = DateTime.MinValue;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.rptordenproduccion__default(),
            new Object[][] {
                new Object[] {
               H002A2_A5ClienteID, H002A2_A57ClienteDsc, H002A2_n57ClienteDsc, H002A2_A1EmpID
               }
               , new Object[] {
               H002A3_A9vendedorID, H002A3_A72vendedorDsc, H002A3_n72vendedorDsc, H002A3_A1EmpID
               }
               , new Object[] {
               H002A4_A20ProcID, H002A4_A129ProcAbre, H002A4_n129ProcAbre, H002A4_A128ProcDsc, H002A4_n128ProcDsc
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] H002A2_A5ClienteID ;
      private String[] H002A2_A57ClienteDsc ;
      private bool[] H002A2_n57ClienteDsc ;
      private short[] H002A2_A1EmpID ;
      private short[] H002A3_A9vendedorID ;
      private String[] H002A3_A72vendedorDsc ;
      private bool[] H002A3_n72vendedorDsc ;
      private short[] H002A3_A1EmpID ;
      private short[] H002A4_A20ProcID ;
      private String[] H002A4_A129ProcAbre ;
      private bool[] H002A4_n129ProcAbre ;
      private String[] H002A4_A128ProcDsc ;
      private bool[] H002A4_n128ProcDsc ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class rptordenproduccion__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H002A2", "SELECT [ClienteID], [ClienteDsc], [EmpID] FROM [Clientes] WITH (NOLOCK) WHERE [EmpID] = @AV9empID ORDER BY [ClienteDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002A2,0,0,true,false )
             ,new CursorDef("H002A3", "SELECT [vendedorID], [vendedorDsc], [EmpID] FROM [Vendedor] WITH (NOLOCK) WHERE [EmpID] = @AV9empID ORDER BY [vendedorDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002A3,0,0,true,false )
             ,new CursorDef("H002A4", "SELECT [ProcID], [ProcAbre], [ProcDsc] FROM [Procesos] WITH (NOLOCK) ORDER BY [ProcDsc] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002A4,0,0,true,false )
          };
       }
    }
