/*
               File: EmpresasdetOpFchsWC
        Description: Empresasdet Op Fchs WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/26/2022 20:13:26.54
...
namespace GeneXus.Programs {
   public class empresasdetopfchswc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public empresasdetopfchswc( )
      {
      ...
      public empresasdetopfchswc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV16Pgmname = "EmpresasdetOpFchsWC";
               context.Gx_err = 0;
               WS0J2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Empresasdet Op Fchs WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102620132659", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("empresasdetopfchswc.aspx") + "?" + UrlEncode("" +AV6EmpID)+"\">") ;
      ...
      protected void RenderHtmlCloseForm0J2( )
      {
         ...
         {
            context.AddJavascriptSource("empresasdetopfchswc.js", "?2022102620132661", false);
         }
      ...
      {
         return "EmpresasdetOpFchsWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Empresasdet Op Fchs WC" ;
      }
      ...
      protected void WB0J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "empresasdetopfchswc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EmpresasdetOpFchsWC.htm");
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A18detOpSec), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A22OrdenID), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A19detOpID), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START0J2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Empresasdet Op Fchs WC", 0) ;
            }
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_DETOPSEC", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A18detOpSec), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"DETOPSEC", StringUtil.LTrim( StringUtil.NToC( (decimal)(A18detOpSec), 4, 0, ".", "")));
      }
      ...
      protected void RF0J2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1EmpID = H000J2_A1EmpID[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(A1EmpID), 4, 0)));
               A127detOpFchIni = H000J2_A127detOpFchIni[0];
               n127detOpFchIni = H000J2_n127detOpFchIni[0];
               A126detOpFchFin = H000J2_A126detOpFchFin[0];
               n126detOpFchFin = H000J2_n126detOpFchFin[0];
               A125detOpFchSalida = H000J2_A125detOpFchSalida[0];
               n125detOpFchSalida = H000J2_n125detOpFchSalida[0];
               A124detOpFchIng = H000J2_A124detOpFchIng[0];
               n124detOpFchIng = H000J2_n124detOpFchIng[0];
               A123detOpDsc = H000J2_A123detOpDsc[0];
               n123detOpDsc = H000J2_n123detOpDsc[0];
               A19detOpID = H000J2_A19detOpID[0];
               A22OrdenID = H000J2_A22OrdenID[0];
               A18detOpSec = H000J2_A18detOpSec[0];
               E130J2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_DETOPSEC"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A18detOpSec), "ZZZ9"), context));
      }
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("detopfchs.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A18detOpSec);
         edtavDelete_Link = formatLink("detopfchs.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A18detOpSec);
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 20;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("detopfchs.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "detOpFchs";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "empresasdetopfchswc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022102620132717", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("empresasdetopfchswc.js", "?2022102620132717", false);
         }
      ...
      {
         edtdetOpSec_Internalname = sPrefix+"DETOPSEC_"+sGXsfl_20_idx;
         edtOrdenID_Internalname = sPrefix+"ORDENID_"+sGXsfl_20_idx;
         edtdetOpID_Internalname = sPrefix+"DETOPID_"+sGXsfl_20_idx;
         edtdetOpDsc_Internalname = sPrefix+"DETOPDSC_"+sGXsfl_20_idx;
         edtdetOpFchIng_Internalname = sPrefix+"DETOPFCHING_"+sGXsfl_20_idx;
         edtdetOpFchSalida_Internalname = sPrefix+"DETOPFCHSALIDA_"+sGXsfl_20_idx;
         edtdetOpFchFin_Internalname = sPrefix+"DETOPFCHFIN_"+sGXsfl_20_idx;
         edtdetOpFchIni_Internalname = sPrefix+"DETOPFCHINI_"+sGXsfl_20_idx;
      ...
      {
         edtdetOpSec_Internalname = sPrefix+"DETOPSEC_"+sGXsfl_20_fel_idx;
         edtOrdenID_Internalname = sPrefix+"ORDENID_"+sGXsfl_20_fel_idx;
         edtdetOpID_Internalname = sPrefix+"DETOPID_"+sGXsfl_20_fel_idx;
         edtdetOpDsc_Internalname = sPrefix+"DETOPDSC_"+sGXsfl_20_fel_idx;
         edtdetOpFchIng_Internalname = sPrefix+"DETOPFCHING_"+sGXsfl_20_fel_idx;
         edtdetOpFchSalida_Internalname = sPrefix+"DETOPFCHSALIDA_"+sGXsfl_20_fel_idx;
         edtdetOpFchFin_Internalname = sPrefix+"DETOPFCHFIN_"+sGXsfl_20_fel_idx;
         edtdetOpFchIni_Internalname = sPrefix+"DETOPFCHINI_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtdetOpSec_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A18detOpSec), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A18detOpSec), "ZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtdetOpSec_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"Id",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtdetOpID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A19detOpID), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A19detOpID), "ZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtdetOpID_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"Id",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtdetOpDsc_Internalname,StringUtil.RTrim( A123detOpDsc),StringUtil.RTrim( context.localUtil.Format( A123detOpDsc, "@!")),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtdetOpDsc_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)40,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)-1,(bool)true,(String)"nombres",(String)"left",(bool)true});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtdetOpSec_Internalname = sPrefix+"DETOPSEC";
         edtOrdenID_Internalname = sPrefix+"ORDENID";
         edtdetOpID_Internalname = sPrefix+"DETOPID";
         edtdetOpDsc_Internalname = sPrefix+"DETOPDSC";
         edtdetOpFchIng_Internalname = sPrefix+"DETOPFCHING";
         edtdetOpFchSalida_Internalname = sPrefix+"DETOPFCHSALIDA";
         edtdetOpFchFin_Internalname = sPrefix+"DETOPFCHFIN";
         edtdetOpFchIni_Internalname = sPrefix+"DETOPFCHINI";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130J2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A18detOpSec',fld:'DETOPSEC',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110J2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A18detOpSec',fld:'DETOPSEC',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV18Delete_GXI = "";
         scmdbuf = "";
         H000J2_A1EmpID = new short[1] ;
         H000J2_A127detOpFchIni = new DateTime[] {DateTime.MinValue} ;
         H000J2_n127detOpFchIni = new bool[] {false} ;
         H000J2_A126detOpFchFin = new DateTime[] {DateTime.MinValue} ;
         H000J2_n126detOpFchFin = new bool[] {false} ;
         H000J2_A125detOpFchSalida = new DateTime[] {DateTime.MinValue} ;
         H000J2_n125detOpFchSalida = new bool[] {false} ;
         H000J2_A124detOpFchIng = new DateTime[] {DateTime.MinValue} ;
         H000J2_n124detOpFchIng = new bool[] {false} ;
         H000J2_A123detOpDsc = new String[] {""} ;
         H000J2_n123detOpDsc = new bool[] {false} ;
         H000J2_A19detOpID = new short[1] ;
         H000J2_A22OrdenID = new short[1] ;
         H000J2_A18detOpSec = new short[1] ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.empresasdetopfchswc__default(),
            new Object[][] {
                new Object[] {
               H000J2_A1EmpID, H000J2_A127detOpFchIni, H000J2_n127detOpFchIni, H000J2_A126detOpFchFin, H000J2_n126detOpFchFin, H000J2_A125detOpFchSalida, H000J2_n125detOpFchSalida, H000J2_A124detOpFchIng, H000J2_n124detOpFchIng, H000J2_A123detOpDsc,
               H000J2_n123detOpDsc, H000J2_A19detOpID, H000J2_A22OrdenID, H000J2_A18detOpSec
               }
               , new Object[] {
      ...
      private short[] H000J2_A1EmpID ;
      private DateTime[] H000J2_A127detOpFchIni ;
      private bool[] H000J2_n127detOpFchIni ;
      private DateTime[] H000J2_A126detOpFchFin ;
      private bool[] H000J2_n126detOpFchFin ;
      private DateTime[] H000J2_A125detOpFchSalida ;
      private bool[] H000J2_n125detOpFchSalida ;
      private DateTime[] H000J2_A124detOpFchIng ;
      private bool[] H000J2_n124detOpFchIng ;
      private String[] H000J2_A123detOpDsc ;
      private bool[] H000J2_n123detOpDsc ;
      private short[] H000J2_A19detOpID ;
      private short[] H000J2_A22OrdenID ;
      private short[] H000J2_A18detOpSec ;
   ...
   public class empresasdetopfchswc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000J2", "SELECT [EmpID], [detOpFchIni], [detOpFchFin], [detOpFchSalida], [detOpFchIng], [detOpDsc], [detOpID], [OrdenID], [detOpSec] FROM [detOpFchs] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ORDER BY [EmpID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000J2,11,0,true,false )
             ,new CursorDef("H000J3", "SELECT COUNT(*) FROM [detOpFchs] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000J3,1,0,true,false )
          };
       }
    }
