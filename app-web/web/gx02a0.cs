/*
       ...
       Generated on: 10/28/2022 21:30:56.97
...
namespace GeneXus.Programs {
   public class gx02a0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx02a0( )
      {
      ...
      public gx02a0( IGxContext context )
      {
                           ...
                           out String aP5_pTipoInv )
      {
         ...
         aP5_pTipoInv=this.AV18pTipoInv;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cstockAnio, AV7cstockMes, AV8cEmpID, AV9cAgeID, AV10cBodCod, AV11cTipoInv, AV12cprdStockDsc) ;
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  ...
                  AV18pTipoInv = GetNextPar( );
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV18pTipoInv", AV18pTipoInv);
               }
            }
            if ( context.isSpaRequest( ) )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102821305735", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx02a0.aspx") + "?" + UrlEncode("" +AV13pstockAnio) + "," + UrlEncode("" +AV14pstockMes) + "," + UrlEncode("" +AV15pEmpID) + "," + UrlEncode("" +AV16pAgeID) + "," + UrlEncode("" +AV17pBodCod) + "," + UrlEncode(StringUtil.RTrim(AV18pTipoInv))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCTIPOINV", StringUtil.RTrim( AV11cTipoInv));
         ...
         GxWebStd.gx_hidden_field( context, "vPTIPOINV", StringUtil.RTrim( AV18pTipoInv));
      ...
      {
         return formatLink("gx02a0.aspx") + "?" + UrlEncode("" +AV13pstockAnio) + "," + UrlEncode("" +AV14pstockMes) + "," + UrlEncode("" +AV15pEmpID) + "," + UrlEncode("" +AV16pAgeID) + "," + UrlEncode("" +AV17pBodCod) + "," + UrlEncode(StringUtil.RTrim(AV18pTipoInv)) ;
      }
      ...
      protected void WB5F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblstockaniofilter_Internalname, "Anio", "", "", lblLblstockaniofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e115f1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02A0.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCstockanio_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cstockAnio), 4, 0, ",", "")), ((edtavCstockanio_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6cstockAnio), "ZZZ9")) : context.localUtil.Format( (decimal)(AV6cstockAnio), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCstockanio_Jsonclick, 0, "Attribute", "", "", "", "", edtavCstockanio_Visible, edtavCstockanio_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx02A0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblstockmesfilter_Internalname, "Mes", "", "", lblLblstockmesfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e125f1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02A0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblempidfilter_Internalname, "Emp ID", "", "", lblLblempidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e135f1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02A0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblageidfilter_Internalname, "Age ID", "", "", lblLblageidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e145f1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02A0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblbodcodfilter_Internalname, "Bod Cod", "", "", lblLblbodcodfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e155f1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02A0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbltipoinvfilter_Internalname, "Codigo", "", "", lblLbltipoinvfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e165f1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02A0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCtipoinv_Internalname, StringUtil.RTrim( AV11cTipoInv), StringUtil.RTrim( context.localUtil.Format( AV11cTipoInv, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtipoinv_Jsonclick, 0, "Attribute", "", "", "", "", edtavCtipoinv_Visible, edtavCtipoinv_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_Gx02A0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprdstockdscfilter_Internalname, "Descripcion", "", "", lblLblprdstockdscfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e175f1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02A0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprdstockdsc_Internalname, AV12cprdStockDsc, StringUtil.RTrim( context.localUtil.Format( AV12cprdStockDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprdstockdsc_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprdstockdsc_Visible, edtavCprdstockdsc_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_Gx02A0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(84), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e185f1_client"+"'", TempTags, "", 2, "HLP_Gx02A0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 84 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(84), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx02A0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCTIPOINV"), AV11cTipoInv) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
      ...
      protected void RF5F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV10cBodCod } ,
                                                 new int[]{
                                                 TypeConstants.STRING, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT
                                                 }
            } ) ;
            lV11cTipoInv = StringUtil.PadR( StringUtil.RTrim( AV11cTipoInv), 4, "%");
            lV12cprdStockDsc = StringUtil.Concat( StringUtil.RTrim( AV12cprdStockDsc), "%", "");
            /* Using cursor H005F2 */
            pr_default.execute(0, new Object[] {AV6cstockAnio, AV7cstockMes, AV8cEmpID, AV9cAgeID, AV10cBodCod, lV11cTipoInv, lV12cprdStockDsc, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_84_idx = 1;
            sGXsfl_84_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_84_idx), 4, 0)), 4, "0");
            SubsflControlProps_842( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A293invFisico = H005F2_A293invFisico[0];
               n293invFisico = H005F2_n293invFisico[0];
               A307prdStockDsc = H005F2_A307prdStockDsc[0];
               n307prdStockDsc = H005F2_n307prdStockDsc[0];
               A43TipoInv = H005F2_A43TipoInv[0];
               A42BodCod = H005F2_A42BodCod[0];
               A2AgeID = H005F2_A2AgeID[0];
               A1EmpID = H005F2_A1EmpID[0];
               A291stockMes = H005F2_A291stockMes[0];
               A290stockAnio = H005F2_A290stockAnio[0];
               /* Execute user event: Load */
               E205F2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         lV12cprdStockDsc = StringUtil.Concat( StringUtil.RTrim( AV12cprdStockDsc), "%", "");
         /* Using cursor H005F3 */
         pr_default.execute(1, new Object[] {AV6cstockAnio, AV7cstockMes, AV8cEmpID, AV9cAgeID, AV10cBodCod, lV11cTipoInv, lV12cprdStockDsc});
         GRID1_nRecordCount = H005F3_AGRID1_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUP5F0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11cTipoInv = cgiGet( edtavCtipoinv_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11cTipoInv", AV11cTipoInv);
      ...
      protected void E215F2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV17pBodCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV17pBodCod), 4, 0)));
         AV18pTipoInv = A43TipoInv;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV18pTipoInv", AV18pTipoInv);
         context.setWebReturnParms(new Object[] {(short)AV13pstockAnio,(short)AV14pstockMes,(short)AV15pEmpID,(short)AV16pAgeID,(short)AV17pBodCod,(String)AV18pTipoInv});
         context.setWebReturnParmsMetadata(new Object[] {"AV13pstockAnio","AV14pstockMes","AV15pEmpID","AV16pAgeID","AV17pBodCod","AV18pTipoInv"});
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV17pBodCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV17pBodCod), 4, 0)));
         AV18pTipoInv = (String)getParm(obj,5);
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV18pTipoInv", AV18pTipoInv);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202210282131263", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx02a0.js", "?202210282131264", false);
      ...
      protected void sendrow_842( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_84_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A290stockAnio), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A291stockMes), 2, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A1EmpID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A2AgeID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A42BodCod), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A43TipoInv))+"'"+"]);";
            ...
            edtprdStockDsc_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A290stockAnio), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A291stockMes), 2, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A1EmpID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A2AgeID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A42BodCod), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.RTrim( A43TipoInv))+"'"+"]);";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockAnio',fld:'vCSTOCKANIO',pic:'ZZZ9'},{av:'AV7cstockMes',fld:'vCSTOCKMES',pic:'Z9'},{av:'AV8cEmpID',fld:'vCEMPID',pic:'ZZZ9'},{av:'AV9cAgeID',fld:'vCAGEID',pic:'ZZZ9'},{av:'AV10cBodCod',fld:'vCBODCOD',pic:'ZZZ9'},{av:'AV11cTipoInv',fld:'vCTIPOINV',pic:''},{av:'AV12cprdStockDsc',fld:'vCPRDSTOCKDSC',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E185F1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLSTOCKANIOFILTER.CLICK","{handler:'E115F1',iparms:[{av:'divStockaniofiltercontainer_Class',ctrl:'STOCKANIOFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLSTOCKMESFILTER.CLICK","{handler:'E125F1',iparms:[{av:'divStockmesfiltercontainer_Class',ctrl:'STOCKMESFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLEMPIDFILTER.CLICK","{handler:'E135F1',iparms:[{av:'divEmpidfiltercontainer_Class',ctrl:'EMPIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLAGEIDFILTER.CLICK","{handler:'E145F1',iparms:[{av:'divAgeidfiltercontainer_Class',ctrl:'AGEIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLBODCODFILTER.CLICK","{handler:'E155F1',iparms:[{av:'divBodcodfiltercontainer_Class',ctrl:'BODCODFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLTIPOINVFILTER.CLICK","{handler:'E165F1',iparms:[{av:'divTipoinvfiltercontainer_Class',ctrl:'TIPOINVFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRDSTOCKDSCFILTER.CLICK","{handler:'E175F1',iparms:[{av:'divPrdstockdscfiltercontainer_Class',ctrl:'PRDSTOCKDSCFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E215F2',iparms:[{av:'A290stockAnio',fld:'STOCKANIO',pic:'ZZZ9',hsh:true},{av:'A291stockMes',fld:'STOCKMES',pic:'Z9',hsh:true},{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A2AgeID',fld:'AGEID',pic:'ZZZ9',hsh:true},{av:'A42BodCod',fld:'BODCOD',pic:'ZZZ9',hsh:true},{av:'A43TipoInv',fld:'TIPOINV',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV13pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV14pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV15pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV16pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV17pBodCod',fld:'vPBODCOD',pic:'ZZZ9'},{av:'AV18pTipoInv',fld:'vPTIPOINV',pic:''}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockAnio',fld:'vCSTOCKANIO',pic:'ZZZ9'},{av:'AV7cstockMes',fld:'vCSTOCKMES',pic:'Z9'},{av:'AV8cEmpID',fld:'vCEMPID',pic:'ZZZ9'},{av:'AV9cAgeID',fld:'vCAGEID',pic:'ZZZ9'},{av:'AV10cBodCod',fld:'vCBODCOD',pic:'ZZZ9'},{av:'AV11cTipoInv',fld:'vCTIPOINV',pic:''},{av:'AV12cprdStockDsc',fld:'vCPRDSTOCKDSC',pic:''}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockAnio',fld:'vCSTOCKANIO',pic:'ZZZ9'},{av:'AV7cstockMes',fld:'vCSTOCKMES',pic:'Z9'},{av:'AV8cEmpID',fld:'vCEMPID',pic:'ZZZ9'},{av:'AV9cAgeID',fld:'vCAGEID',pic:'ZZZ9'},{av:'AV10cBodCod',fld:'vCBODCOD',pic:'ZZZ9'},{av:'AV11cTipoInv',fld:'vCTIPOINV',pic:''},{av:'AV12cprdStockDsc',fld:'vCPRDSTOCKDSC',pic:''}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockAnio',fld:'vCSTOCKANIO',pic:'ZZZ9'},{av:'AV7cstockMes',fld:'vCSTOCKMES',pic:'Z9'},{av:'AV8cEmpID',fld:'vCEMPID',pic:'ZZZ9'},{av:'AV9cAgeID',fld:'vCAGEID',pic:'ZZZ9'},{av:'AV10cBodCod',fld:'vCBODCOD',pic:'ZZZ9'},{av:'AV11cTipoInv',fld:'vCTIPOINV',pic:''},{av:'AV12cprdStockDsc',fld:'vCPRDSTOCKDSC',pic:''}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockAnio',fld:'vCSTOCKANIO',pic:'ZZZ9'},{av:'AV7cstockMes',fld:'vCSTOCKMES',pic:'Z9'},{av:'AV8cEmpID',fld:'vCEMPID',pic:'ZZZ9'},{av:'AV9cAgeID',fld:'vCAGEID',pic:'ZZZ9'},{av:'AV10cBodCod',fld:'vCBODCOD',pic:'ZZZ9'},{av:'AV11cTipoInv',fld:'vCTIPOINV',pic:''},{av:'AV12cprdStockDsc',fld:'vCPRDSTOCKDSC',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         lV11cTipoInv = "";
         lV12cprdStockDsc = "";
         H005F2_A293invFisico = new int[1] ;
         H005F2_n293invFisico = new bool[] {false} ;
         H005F2_A307prdStockDsc = new String[] {""} ;
         H005F2_n307prdStockDsc = new bool[] {false} ;
         H005F2_A43TipoInv = new String[] {""} ;
         H005F2_A42BodCod = new short[1] ;
         H005F2_A2AgeID = new short[1] ;
         H005F2_A1EmpID = new short[1] ;
         H005F2_A291stockMes = new short[1] ;
         H005F2_A290stockAnio = new short[1] ;
         H005F3_AGRID1_nRecordCount = new long[1] ;
         ...
         sImgUrl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx02a0__default(),
            new Object[][] {
                new Object[] {
               H005F2_A293invFisico, H005F2_n293invFisico, H005F2_A307prdStockDsc, H005F2_n307prdStockDsc, H005F2_A43TipoInv, H005F2_A42BodCod, H005F2_A2AgeID, H005F2_A1EmpID, H005F2_A291stockMes, H005F2_A290stockAnio
               }
               , new Object[] {
               H005F3_AGRID1_nRecordCount
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private String AV11cTipoInv ;
      private String GXKey ;
      private String AV18pTipoInv ;
      ...
      private int[] H005F2_A293invFisico ;
      private bool[] H005F2_n293invFisico ;
      private String[] H005F2_A307prdStockDsc ;
      private bool[] H005F2_n307prdStockDsc ;
      private String[] H005F2_A43TipoInv ;
      private short[] H005F2_A42BodCod ;
      private short[] H005F2_A2AgeID ;
      private short[] H005F2_A1EmpID ;
      private short[] H005F2_A291stockMes ;
      private short[] H005F2_A290stockAnio ;
      private long[] H005F3_AGRID1_nRecordCount ;
   ...
   public class gx02a0__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV10cBodCod )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " [invFisico], [prdStockDsc], [TipoInv], [BodCod], [AgeID], [EmpID], [stockMes], [stockAnio]";
         sFromString = " FROM [ProdxBodega] WITH (NOLOCK)";
         sOrderString = "";
         sWhereString = sWhereString + " WHERE ([stockAnio] >= @AV6cstockAnio and [stockMes] >= @AV7cstockMes and [EmpID] >= @AV8cEmpID and [AgeID] >= @AV9cAgeID and [BodCod] >= @AV10cBodCod)";
         sWhereString = sWhereString + " and ([TipoInv] like @lV11cTipoInv)";
                                             ...
                                             short AV10cBodCod )
      {
         ...
         scmdbuf = scmdbuf + " WHERE ([stockAnio] >= @AV6cstockAnio and [stockMes] >= @AV7cstockMes and [EmpID] >= @AV8cEmpID and [AgeID] >= @AV9cAgeID and [BodCod] >= @AV10cBodCod)";
         scmdbuf = scmdbuf + " and ([TipoInv] like @lV11cTipoInv)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV12cprdStockDsc)) )
         {
            sWhereString = sWhereString + " and ([prdStockDsc] like @lV12cprdStockDsc)";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005F2(context, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] );
               case 1 :
                     return conditional_H005F3(context, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV11cTipoInv",SqlDbType.Char,4,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H005F2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005F2,11,0,false,false )
             ,new CursorDef("H005F3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005F3,1,0,false,false )
          };
       }
    }
