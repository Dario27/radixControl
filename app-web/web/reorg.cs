/*
       ...
       Generated on: 1/23/2023 0:52:39.81
...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeDespBodegaprd( )
      {
         String cmdBuffer = "" ;
         /* Indices for table DespBodegaprd */
         cmdBuffer=" ALTER TABLE [DespBodegaprd] ADD [DespBodModifItem]  char(1) NULL  "
         ;
      ...
      private void TablesCount( )
      {
         if ( ! IsResumeMode( ) )
         {
            ...
            DespBodegaprdCount = P00012_ADespBodegaprdCount[0];
            pr_default.close(0);
            PrintRecordCount ( "DespBodegaprd" ,  DespBodegaprdCount );
         }
      }
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ColumnExist("DespBodegaprd",sSchemaVar,"DespBodModifItem") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"DespBodModifItem", "DespBodegaprd"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "ReorganizeDespBodegaprd" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_fileupdate", new   object[]  {"DespBodegaprd", ""}) );
      }
      ...
      {
         scmdbuf = "";
         P00012_ADespBodegaprdCount = new int[1] ;
         sSchemaVar = "";
         nsSchemaVar = false;
      ...
      protected int DespBodegaprdCount ;
      ...
      protected int[] P00012_ADespBodegaprdCount ;
   ...
   public class reorg__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00012", "SELECT COUNT(*) FROM [DespBodegaprd] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00012,100,0,true,false )
