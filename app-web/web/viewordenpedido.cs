/*
               File: ViewOrdenPedido
        Description: View Orden Pedido
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/26/2022 20:15:16.17
...
namespace GeneXus.Programs {
   public class viewordenpedido : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      public viewordenpedido( )
      {
      ...
      public viewordenpedido( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               {
                  AV13PedCod = (int)(NumberUtil.Val( GetNextPar( ), "."));
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13PedCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13PedCod), 8, 0)));
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vPEDCOD", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13PedCod), "ZZZZZZZ9"), context));
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102620151620", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewordenpedido.aspx") + "?" + UrlEncode("" +AV12EmpID) + "," + UrlEncode("" +AV13PedCod) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens = "hsh" + "ViewOrdenPedido";
         forbiddenHiddens = forbiddenHiddens + context.localUtil.Format( (decimal)(A39PedCod), "ZZZZZZZ9");
         forbiddenHiddens = forbiddenHiddens + StringUtil.RTrim( context.localUtil.Format( A204PedDescripcion, ""));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens, GXKey));
         GXUtil.WriteLog("viewordenpedido:[SendSecurityCheck value for]"+"PedCod:"+context.localUtil.Format( (decimal)(A39PedCod), "ZZZZZZZ9"));
         GXUtil.WriteLog("viewordenpedido:[SendSecurityCheck value for]"+"PedDescripcion:"+StringUtil.RTrim( context.localUtil.Format( A204PedDescripcion, "")));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPEDCOD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13PedCod), 8, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPEDCOD", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13PedCod), "ZZZZZZZ9"), context));
      ...
      protected void WB1Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Orden Pedido Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewOrdenPedido.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Orden Pedidoes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewOrdenPedido.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPedCod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A39PedCod), 8, 0, ",", "")), ((edtPedCod_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A39PedCod), "ZZZZZZZ9")) : context.localUtil.Format( (decimal)(A39PedCod), "ZZZZZZZ9")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPedCod_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtPedCod_Enabled, 0, "number", "1", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_ViewOrdenPedido.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTabtable_2_Internalname, 1, 0, "px", 0, "px", "ViewTable", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtPedDescripcion_Internalname, StringUtil.RTrim( A204PedDescripcion), StringUtil.RTrim( context.localUtil.Format( A204PedDescripcion, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtPedDescripcion_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtPedDescripcion_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "Descripcion", "left", true, "HLP_ViewOrdenPedido.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "Detalle Pedido", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewOrdenPedido.htm");
            /* Div Control */
      ...
      protected void START1Z2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Orden Pedido", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF1Z2( )
      {
         ...
         {
            /* Using cursor H001Z2 */
            pr_default.execute(0, new Object[] {AV12EmpID, AV13PedCod});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A1EmpID = H001Z2_A1EmpID[0];
               A204PedDescripcion = H001Z2_A204PedDescripcion[0];
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A204PedDescripcion", A204PedDescripcion);
               n204PedDescripcion = H001Z2_n204PedDescripcion[0];
               A39PedCod = H001Z2_A39PedCod[0];
      ...
      protected void STRUP1Z0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13PedCod = (int)(context.localUtil.CToN( cgiGet( "vPEDCOD"), ",", "."));
            ...
            {
               GXUtil.WriteLog("viewordenpedido:[SecurityCheckFailed value for]"+"PedCod:"+context.localUtil.Format( (decimal)(A39PedCod), "ZZZZZZZ9"));
               GXUtil.WriteLog("viewordenpedido:[SecurityCheckFailed value for]"+"PedDescripcion:"+StringUtil.RTrim( context.localUtil.Format( A204PedDescripcion, "")));
               GxWebError = 1;
      ...
      protected void E111Z2( )
      {
         ...
         AV17GXLvl6 = 0;
         /* Using cursor H001Z3 */
         pr_default.execute(1, new Object[] {AV12EmpID, AV13PedCod});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A39PedCod = H001Z3_A39PedCod[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A39PedCod", StringUtil.LTrim( StringUtil.Str( (decimal)(A39PedCod), 8, 0)));
            A1EmpID = H001Z3_A1EmpID[0];
            A204PedDescripcion = H001Z3_A204PedDescripcion[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A204PedDescripcion", A204PedDescripcion);
            n204PedDescripcion = H001Z3_n204PedDescripcion[0];
            AV17GXLvl6 = 1;
            Form.Caption = A204PedDescripcion;
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwordenpedido.aspx") ;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "OrdenPedidoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "ordenpedidogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "OrdenPedidoGeneral";
               WebComp_Generalwc_Component = "OrdenPedidoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0038",(String)"",(short)AV12EmpID,(int)AV13PedCod});
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12EmpID), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vEMPID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmpID), "ZZZ9"), context));
         AV13PedCod = Convert.ToInt32(getParm(obj,1));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13PedCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13PedCod), 8, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vPEDCOD", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13PedCod), "ZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022102620151653", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewordenpedido.js", "?2022102620151653", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      protected void init_default_properties( )
      {
         ...
         divTabtable_2_Internalname = "TABTABLE_2";
      ...
      public override void initialize_properties( )
      {
         ...
         Tab_Pagecount = 1;
         Tab_Class = "WWTab";
         Form.Caption = "View Orden Pedido";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12EmpID',fld:'vEMPID',pic:'ZZZ9',hsh:true},{av:'AV13PedCod',fld:'vPEDCOD',pic:'ZZZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A39PedCod',fld:'PEDCOD',pic:'ZZZZZZZ9'},{av:'A204PedDescripcion',fld:'PEDDESCRIPCION',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H001Z2_A1EmpID = new short[1] ;
         H001Z2_A204PedDescripcion = new String[] {""} ;
         H001Z2_n204PedDescripcion = new bool[] {false} ;
         H001Z2_A39PedCod = new int[1] ;
         hsh = "";
         H001Z3_A39PedCod = new int[1] ;
         H001Z3_A1EmpID = new short[1] ;
         H001Z3_A204PedDescripcion = new String[] {""} ;
         H001Z3_n204PedDescripcion = new bool[] {false} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewordenpedido__default(),
            new Object[][] {
                new Object[] {
               H001Z2_A1EmpID, H001Z2_A204PedDescripcion, H001Z2_n204PedDescripcion, H001Z2_A39PedCod
               }
               , new Object[] {
               H001Z3_A39PedCod, H001Z3_A1EmpID, H001Z3_A204PedDescripcion, H001Z3_n204PedDescripcion
               }
            }
         );
      ...
      private String divTabtable_2_Internalname ;
      ...
      private short[] H001Z2_A1EmpID ;
      private String[] H001Z2_A204PedDescripcion ;
      private bool[] H001Z2_n204PedDescripcion ;
      private int[] H001Z2_A39PedCod ;
      private int[] H001Z3_A39PedCod ;
      private short[] H001Z3_A1EmpID ;
      private String[] H001Z3_A204PedDescripcion ;
      private bool[] H001Z3_n204PedDescripcion ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class viewordenpedido__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV13PedCod",SqlDbType.Int,8,0}
          } ;
          Object[] prmH001Z3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H001Z2", "SELECT [EmpID], [PedDescripcion], [PedCod] FROM [OrdenPedido] WITH (NOLOCK) WHERE [EmpID] = @AV12EmpID and [PedCod] = @AV13PedCod ORDER BY [EmpID], [PedCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z2,1,0,true,true )
             ,new CursorDef("H001Z3", "SELECT [PedCod], [EmpID], [PedDescripcion] FROM [OrdenPedido] WITH (NOLOCK) WHERE ([EmpID] = @AV12EmpID and [PedCod] = @AV13PedCod) AND ([EmpID] = @AV12EmpID and [PedCod] = @AV13PedCod) ORDER BY [EmpID], [PedCod] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001Z3,1,0,false,true )
          };
       }
    }
