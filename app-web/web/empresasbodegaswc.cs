/*
               File: EmpresasBodegasWC
        Description: Empresas Bodegas WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/26/2022 20:13:45.10
...
namespace GeneXus.Programs {
   public class empresasbodegaswc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public empresasbodegaswc( )
      {
      ...
      public empresasbodegaswc( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Empresas Bodegas WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102620134514", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("empresasbodegaswc.aspx") + "?" + UrlEncode("" +AV6EmpID)+"\">") ;
      ...
      protected void RenderHtmlCloseForm0Q2( )
      {
         ...
         {
            context.AddJavascriptSource("empresasbodegaswc.js", "?2022102620134517", false);
         }
      ...
      {
         return "EmpresasBodegasWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Empresas Bodegas WC" ;
      }
      ...
      protected void WB0Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "empresasbodegaswc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EmpresasBodegasWC.htm");
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A218BodEst));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A225BodDireccion);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START0Q2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Empresas Bodegas WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF0Q2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1EmpID = H000Q2_A1EmpID[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(A1EmpID), 4, 0)));
               A225BodDireccion = H000Q2_A225BodDireccion[0];
               n225BodDireccion = H000Q2_n225BodDireccion[0];
               A218BodEst = H000Q2_A218BodEst[0];
               n218BodEst = H000Q2_n218BodEst[0];
               A217BodDsc = H000Q2_A217BodDsc[0];
               n217BodDsc = H000Q2_n217BodDsc[0];
               A42BodCod = H000Q2_A42BodCod[0];
               E130Q2 ();
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("bodegas.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A42BodCod);
         edtavDelete_Link = formatLink("bodegas.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A42BodCod);
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 20;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("bodegas.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Bodegas";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "empresasbodegaswc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022102620134561", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("empresasbodegaswc.js", "?2022102620134561", false);
         }
      ...
      protected void SubsflControlProps_202( )
      {
         ...
         edtBodEst_Internalname = sPrefix+"BODEST_"+sGXsfl_20_idx;
         edtBodDireccion_Internalname = sPrefix+"BODDIRECCION_"+sGXsfl_20_idx;
      ...
      protected void SubsflControlProps_fel_202( )
      {
         ...
         edtBodEst_Internalname = sPrefix+"BODEST_"+sGXsfl_20_fel_idx;
         edtBodDireccion_Internalname = sPrefix+"BODDIRECCION_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtBodDireccion_Internalname,(String)A225BodDireccion,(String)"",(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'","http://maps.google.com/maps?q="+GXUtil.UrlEncode( A225BodDireccion),(String)"_blank",(String)"",(String)"",(String)edtBodDireccion_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)1024,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"GeneXus\\Address",(String)"left",(bool)true});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void init_default_properties( )
      {
         ...
         edtBodEst_Internalname = sPrefix+"BODEST";
         edtBodDireccion_Internalname = sPrefix+"BODDIRECCION";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130Q2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A42BodCod',fld:'BODCOD',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110Q2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A42BodCod',fld:'BODCOD',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV18Delete_GXI = "";
         scmdbuf = "";
         H000Q2_A1EmpID = new short[1] ;
         H000Q2_A225BodDireccion = new String[] {""} ;
         H000Q2_n225BodDireccion = new bool[] {false} ;
         H000Q2_A218BodEst = new String[] {""} ;
         H000Q2_n218BodEst = new bool[] {false} ;
         H000Q2_A217BodDsc = new String[] {""} ;
         H000Q2_n217BodDsc = new bool[] {false} ;
         H000Q2_A42BodCod = new short[1] ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.empresasbodegaswc__default(),
            new Object[][] {
                new Object[] {
               H000Q2_A1EmpID, H000Q2_A225BodDireccion, H000Q2_n225BodDireccion, H000Q2_A218BodEst, H000Q2_n218BodEst, H000Q2_A217BodDsc, H000Q2_n217BodDsc, H000Q2_A42BodCod
               }
               , new Object[] {
      ...
      private String edtBodDireccion_Jsonclick ;
      ...
      private short[] H000Q2_A1EmpID ;
      private String[] H000Q2_A225BodDireccion ;
      private bool[] H000Q2_n225BodDireccion ;
      private String[] H000Q2_A218BodEst ;
      private bool[] H000Q2_n218BodEst ;
      private String[] H000Q2_A217BodDsc ;
      private bool[] H000Q2_n217BodDsc ;
      private short[] H000Q2_A42BodCod ;
   ...
   public class empresasbodegaswc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000Q2", "SELECT [EmpID], [BodDireccion], [BodEst], [BodDsc], [BodCod] FROM [Bodegas] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ORDER BY [EmpID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Q2,11,0,true,false )
             ,new CursorDef("H000Q3", "SELECT COUNT(*) FROM [Bodegas] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Q3,1,0,true,false )
          };
       }
    }
