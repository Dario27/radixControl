/*
               File: MarcaOrdenProduccionWC
        Description: Marca Orden Produccion WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 1/14/2023 1:15:27.30
...
namespace GeneXus.Programs {
   public class marcaordenproduccionwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public marcaordenproduccionwc( )
      {
      ...
      public marcaordenproduccionwc( IGxContext context )
      {
      ...
      public void execute( short aP0_EmpID ,
                           short aP1_OrdenMarcaID )
      {
         this.AV6EmpID = aP0_EmpID;
         this.AV7OrdenMarcaID = aP1_OrdenMarcaID;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV7OrdenMarcaID = (short)(NumberUtil.Val( GetNextPar( ), "."));
                  context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7OrdenMarcaID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7OrdenMarcaID), 4, 0)));
                  setjustcreated();
                  componentprepare(new Object[] {(String)sCompPrefix,(String)sSFPrefix,(short)AV6EmpID,(short)AV7OrdenMarcaID});
                  componentstart();
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6EmpID, AV7OrdenMarcaID, AV12Update, AV13Delete, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "MarcaOrdenProduccionWC";
               context.Gx_err = 0;
               WS142( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Marca Orden Produccion WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231141152743", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("marcaordenproduccionwc.aspx") + "?" + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +AV7OrdenMarcaID)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV7OrdenMarcaID", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV7OrdenMarcaID), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vEMPID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6EmpID), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vORDENMARCAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7OrdenMarcaID), 4, 0, ",", "")));
      ...
      protected void RenderHtmlCloseForm142( )
      {
         ...
         {
            context.AddJavascriptSource("marcaordenproduccionwc.js", "?20231141152747", false);
         }
      ...
      {
         return "MarcaOrdenProduccionWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Marca Orden Produccion WC" ;
      }
      ...
      protected void WB140( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "marcaordenproduccionwc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 7, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e11141_client"+"'", TempTags, "", 2, "HLP_MarcaOrdenProduccionWC.htm");
         ...
         if ( wbEnd == 20 )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtOrdenMarcaID_Internalname, "Marca ID", "col-sm-3 AttributeLabel", 0, true);
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtOrdenMarcaID_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A26OrdenMarcaID), 4, 0, ",", "")), ((edtOrdenMarcaID_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A26OrdenMarcaID), "ZZZ9")) : context.localUtil.Format( (decimal)(A26OrdenMarcaID), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtOrdenMarcaID_Jsonclick, 0, "Attribute", "", "", "", "", edtOrdenMarcaID_Visible, edtOrdenMarcaID_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "Id", "right", false, "HLP_MarcaOrdenProduccionWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START142( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Marca Orden Produccion WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF142( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00143 */
            pr_default.execute(0, new Object[] {AV6EmpID, AV7OrdenMarcaID, GXPagingFrom2, GXPagingTo2});
            nGXsfl_20_idx = 1;
            sGXsfl_20_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_20_idx), 4, 0)), 4, "0");
            SubsflControlProps_202( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               A1EmpID = H00143_A1EmpID[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(A1EmpID), 4, 0)));
               A26OrdenMarcaID = H00143_A26OrdenMarcaID[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A26OrdenMarcaID", StringUtil.LTrim( StringUtil.Str( (decimal)(A26OrdenMarcaID), 4, 0)));
               A401OrdenNroDesp = H00143_A401OrdenNroDesp[0];
               n401OrdenNroDesp = H00143_n401OrdenNroDesp[0];
               A210OrdenUltSec = H00143_A210OrdenUltSec[0];
               n210OrdenUltSec = H00143_n210OrdenUltSec[0];
               A203ordenNroPed = H00143_A203ordenNroPed[0];
               n203ordenNroPed = H00143_n203ordenNroPed[0];
               A195OrdenFacNomb = H00143_A195OrdenFacNomb[0];
               n195OrdenFacNomb = H00143_n195OrdenFacNomb[0];
               A192OrdenPed = H00143_A192OrdenPed[0];
               n192OrdenPed = H00143_n192OrdenPed[0];
               A172OrdenfchEnt = H00143_A172OrdenfchEnt[0];
               n172OrdenfchEnt = H00143_n172OrdenfchEnt[0];
               A133OrdenProceso = H00143_A133OrdenProceso[0];
               n133OrdenProceso = H00143_n133OrdenProceso[0];
               A132OrdenEmpFac = H00143_A132OrdenEmpFac[0];
               n132OrdenEmpFac = H00143_n132OrdenEmpFac[0];
               A25OrdenAnio = H00143_A25OrdenAnio[0];
               A24OrdenPeriodo = H00143_A24OrdenPeriodo[0];
               A116OrdenUser = H00143_A116OrdenUser[0];
               n116OrdenUser = H00143_n116OrdenUser[0];
               A115OrdenEst = H00143_A115OrdenEst[0];
               n115OrdenEst = H00143_n115OrdenEst[0];
               A110cantDias = H00143_A110cantDias[0];
               n110cantDias = H00143_n110cantDias[0];
               A109fchVenta = H00143_A109fchVenta[0];
               n109fchVenta = H00143_n109fchVenta[0];
               A74protDsc = H00143_A74protDsc[0];
               n74protDsc = H00143_n74protDsc[0];
               A10protID = H00143_A10protID[0];
               A107representane = H00143_A107representane[0];
               n107representane = H00143_n107representane[0];
               A106facturaNro = H00143_A106facturaNro[0];
               n106facturaNro = H00143_n106facturaNro[0];
               A72vendedorDsc = H00143_A72vendedorDsc[0];
               n72vendedorDsc = H00143_n72vendedorDsc[0];
               A9vendedorID = H00143_A9vendedorID[0];
               A104tipOrdDsc = H00143_A104tipOrdDsc[0];
               n104tipOrdDsc = H00143_n104tipOrdDsc[0];
               A17tipOrdID = H00143_A17tipOrdID[0];
               A119OrdenFch = H00143_A119OrdenFch[0];
               n119OrdenFch = H00143_n119OrdenFch[0];
               A117OrdenModeloID = H00143_A117OrdenModeloID[0];
               A69VehiculoChasis = H00143_A69VehiculoChasis[0];
               n69VehiculoChasis = H00143_n69VehiculoChasis[0];
               A68VehiculoPlaca = H00143_A68VehiculoPlaca[0];
               n68VehiculoPlaca = H00143_n68VehiculoPlaca[0];
               A8VehiculoID = H00143_A8VehiculoID[0];
               A22OrdenID = H00143_A22OrdenID[0];
               A57ClienteDsc = H00143_A57ClienteDsc[0];
               n57ClienteDsc = H00143_n57ClienteDsc[0];
               A5ClienteID = H00143_A5ClienteID[0];
               A44empdsc = H00143_A44empdsc[0];
               n44empdsc = H00143_n44empdsc[0];
               A255OrdenObreSuma = H00143_A255OrdenObreSuma[0];
               n255OrdenObreSuma = H00143_n255OrdenObreSuma[0];
               A168OrdenValOtrs = H00143_A168OrdenValOtrs[0];
               n168OrdenValOtrs = H00143_n168OrdenValOtrs[0];
               A167OrdenValEstr = H00143_A167OrdenValEstr[0];
               n167OrdenValEstr = H00143_n167OrdenValEstr[0];
               A166OrdenValPint = H00143_A166OrdenValPint[0];
               n166OrdenValPint = H00143_n166OrdenValPint[0];
               A165OrdenValCal = H00143_A165OrdenValCal[0];
               n165OrdenValCal = H00143_n165OrdenValCal[0];
               A163OrdenValEnrq = H00143_A163OrdenValEnrq[0];
               n163OrdenValEnrq = H00143_n163OrdenValEnrq[0];
               A162OrdenValInds = H00143_A162OrdenValInds[0];
               n162OrdenValInds = H00143_n162OrdenValInds[0];
               A161OrdenSubtotal = H00143_A161OrdenSubtotal[0];
               n161OrdenSubtotal = H00143_n161OrdenSubtotal[0];
               A153OrdenActaPdf = H00143_A153OrdenActaPdf[0];
               context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtOrdenActaPdf_Internalname, "URL", context.PathToRelativeUrl( A153OrdenActaPdf), !bGXsfl_20_Refreshing);
               n153OrdenActaPdf = H00143_n153OrdenActaPdf[0];
               A152OrdenPdf = H00143_A152OrdenPdf[0];
               context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtOrdenPdf_Internalname, "URL", context.PathToRelativeUrl( A152OrdenPdf), !bGXsfl_20_Refreshing);
               n152OrdenPdf = H00143_n152OrdenPdf[0];
               A112documento = H00143_A112documento[0];
               context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtdocumento_Internalname, "URL", context.PathToRelativeUrl( A112documento), !bGXsfl_20_Refreshing);
               n112documento = H00143_n112documento[0];
               A108urlPdf = H00143_A108urlPdf[0];
               context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edturlPdf_Internalname, "URL", context.PathToRelativeUrl( A108urlPdf), !bGXsfl_20_Refreshing);
               n108urlPdf = H00143_n108urlPdf[0];
               A44empdsc = H00143_A44empdsc[0];
               n44empdsc = H00143_n44empdsc[0];
               A74protDsc = H00143_A74protDsc[0];
               n74protDsc = H00143_n74protDsc[0];
      ...
      {
         /* Using cursor H00145 */
         pr_default.execute(1, new Object[] {AV6EmpID, AV7OrdenMarcaID});
         GRID_nRecordCount = H00145_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUP140( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV7OrdenMarcaID = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV7OrdenMarcaID"), ",", "."));
      ...
      protected void E12142( )
      {
         ...
         edtOrdenMarcaID_Visible = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtOrdenMarcaID_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtOrdenMarcaID_Visible), 5, 0)), true);
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt = new SdtTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "OrdenMarcaID";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV7OrdenMarcaID), 4, 0);
         AV10TrnContext.gxTpr_Attributes.Add(AV11TrnContextAtt, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV6EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV6EmpID), 4, 0)));
         AV7OrdenMarcaID = Convert.ToInt16(getParm(obj,1));
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7OrdenMarcaID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7OrdenMarcaID), 4, 0)));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV7OrdenMarcaID = (String)((String)getParm(obj,1));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "marcaordenproduccionwc", GetJustCreated( ));
         ...
         else
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV6EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV6EmpID), 4, 0)));
            AV7OrdenMarcaID = Convert.ToInt16(getParm(obj,3));
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7OrdenMarcaID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7OrdenMarcaID), 4, 0)));
         }
         wcpOAV6EmpID = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6EmpID"), ",", "."));
         wcpOAV7OrdenMarcaID = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV7OrdenMarcaID"), ",", "."));
         if ( ! GetJustCreated( ) && ( ( AV6EmpID != wcpOAV6EmpID ) || ( AV7OrdenMarcaID != wcpOAV7OrdenMarcaID ) ) )
         {
            setjustcreated();
         }
         wcpOAV6EmpID = AV6EmpID;
         wcpOAV7OrdenMarcaID = AV7OrdenMarcaID;
      }
      ...
      protected void WCParametersGet( )
      {
         ...
         sCtrlAV7OrdenMarcaID = cgiGet( sPrefix+"AV7OrdenMarcaID_CTRL");
         if ( StringUtil.Len( sCtrlAV7OrdenMarcaID) > 0 )
         {
            AV7OrdenMarcaID = (short)(context.localUtil.CToN( cgiGet( sCtrlAV7OrdenMarcaID), ",", "."));
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7OrdenMarcaID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7OrdenMarcaID), 4, 0)));
         }
         else
         {
            AV7OrdenMarcaID = (short)(context.localUtil.CToN( cgiGet( sPrefix+"AV7OrdenMarcaID_PARM"), ",", "."));
         }
      }
      ...
      protected void WCParametersSet( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"AV7OrdenMarcaID_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7OrdenMarcaID), 4, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV7OrdenMarcaID)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV7OrdenMarcaID_CTRL", StringUtil.RTrim( sCtrlAV7OrdenMarcaID));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20231141152944", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("marcaordenproduccionwc.js", "?20231141152945", false);
         }
      ...
      public override void initialize_properties( )
      {
         ...
         edtOrdenMarcaID_Enabled = 0;
         edtOrdenMarcaID_Visible = 1;
         edtEmpID_Jsonclick = "";
         edtEmpID_Enabled = 0;
         edtEmpID_Visible = 1;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'AV7OrdenMarcaID',fld:'vORDENMARCAID',pic:'ZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E13142',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[]}");
         setEventMetadata("'DOINSERT'","{handler:'E11141',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         AV19Delete_GXI = "";
         scmdbuf = "";
         H00143_A1EmpID = new short[1] ;
         H00143_A26OrdenMarcaID = new short[1] ;
         H00143_A401OrdenNroDesp = new int[1] ;
         H00143_n401OrdenNroDesp = new bool[] {false} ;
         H00143_A210OrdenUltSec = new short[1] ;
         H00143_n210OrdenUltSec = new bool[] {false} ;
         H00143_A203ordenNroPed = new int[1] ;
         H00143_n203ordenNroPed = new bool[] {false} ;
         H00143_A195OrdenFacNomb = new String[] {""} ;
         H00143_n195OrdenFacNomb = new bool[] {false} ;
         H00143_A192OrdenPed = new int[1] ;
         H00143_n192OrdenPed = new bool[] {false} ;
         H00143_A172OrdenfchEnt = new DateTime[] {DateTime.MinValue} ;
         H00143_n172OrdenfchEnt = new bool[] {false} ;
         H00143_A133OrdenProceso = new String[] {""} ;
         H00143_n133OrdenProceso = new bool[] {false} ;
         H00143_A132OrdenEmpFac = new short[1] ;
         H00143_n132OrdenEmpFac = new bool[] {false} ;
         H00143_A25OrdenAnio = new short[1] ;
         H00143_A24OrdenPeriodo = new short[1] ;
         H00143_A116OrdenUser = new String[] {""} ;
         H00143_n116OrdenUser = new bool[] {false} ;
         H00143_A115OrdenEst = new String[] {""} ;
         H00143_n115OrdenEst = new bool[] {false} ;
         H00143_A110cantDias = new short[1] ;
         H00143_n110cantDias = new bool[] {false} ;
         H00143_A109fchVenta = new DateTime[] {DateTime.MinValue} ;
         H00143_n109fchVenta = new bool[] {false} ;
         H00143_A74protDsc = new String[] {""} ;
         H00143_n74protDsc = new bool[] {false} ;
         H00143_A10protID = new short[1] ;
         H00143_A107representane = new String[] {""} ;
         H00143_n107representane = new bool[] {false} ;
         H00143_A106facturaNro = new int[1] ;
         H00143_n106facturaNro = new bool[] {false} ;
         H00143_A72vendedorDsc = new String[] {""} ;
         H00143_n72vendedorDsc = new bool[] {false} ;
         H00143_A9vendedorID = new short[1] ;
         H00143_A104tipOrdDsc = new String[] {""} ;
         H00143_n104tipOrdDsc = new bool[] {false} ;
         H00143_A17tipOrdID = new short[1] ;
         H00143_A119OrdenFch = new DateTime[] {DateTime.MinValue} ;
         H00143_n119OrdenFch = new bool[] {false} ;
         H00143_A117OrdenModeloID = new short[1] ;
         H00143_A69VehiculoChasis = new String[] {""} ;
         H00143_n69VehiculoChasis = new bool[] {false} ;
         H00143_A68VehiculoPlaca = new String[] {""} ;
         H00143_n68VehiculoPlaca = new bool[] {false} ;
         H00143_A8VehiculoID = new short[1] ;
         H00143_A22OrdenID = new short[1] ;
         H00143_A57ClienteDsc = new String[] {""} ;
         H00143_n57ClienteDsc = new bool[] {false} ;
         H00143_A5ClienteID = new short[1] ;
         H00143_A44empdsc = new String[] {""} ;
         H00143_n44empdsc = new bool[] {false} ;
         H00143_A255OrdenObreSuma = new decimal[1] ;
         H00143_n255OrdenObreSuma = new bool[] {false} ;
         H00143_A168OrdenValOtrs = new decimal[1] ;
         H00143_n168OrdenValOtrs = new bool[] {false} ;
         H00143_A167OrdenValEstr = new decimal[1] ;
         H00143_n167OrdenValEstr = new bool[] {false} ;
         H00143_A166OrdenValPint = new decimal[1] ;
         H00143_n166OrdenValPint = new bool[] {false} ;
         H00143_A165OrdenValCal = new decimal[1] ;
         H00143_n165OrdenValCal = new bool[] {false} ;
         H00143_A163OrdenValEnrq = new decimal[1] ;
         H00143_n163OrdenValEnrq = new bool[] {false} ;
         H00143_A162OrdenValInds = new decimal[1] ;
         H00143_n162OrdenValInds = new bool[] {false} ;
         H00143_A161OrdenSubtotal = new decimal[1] ;
         H00143_n161OrdenSubtotal = new bool[] {false} ;
         H00143_A153OrdenActaPdf = new String[] {""} ;
         H00143_n153OrdenActaPdf = new bool[] {false} ;
         H00143_A152OrdenPdf = new String[] {""} ;
         H00143_n152OrdenPdf = new bool[] {false} ;
         H00143_A112documento = new String[] {""} ;
         H00143_n112documento = new bool[] {false} ;
         H00143_A108urlPdf = new String[] {""} ;
         H00143_n108urlPdf = new bool[] {false} ;
         H00145_AGRID_nRecordCount = new long[1] ;
         ...
         sCtrlAV6EmpID = "";
         sCtrlAV7OrdenMarcaID = "";
         ROClassString = "";
         gxblobfileaux = new GxFile(context.GetPhysicalPath());
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.marcaordenproduccionwc__default(),
            new Object[][] {
                new Object[] {
               H00143_A1EmpID, H00143_A26OrdenMarcaID, H00143_A401OrdenNroDesp, H00143_n401OrdenNroDesp, H00143_A210OrdenUltSec, H00143_n210OrdenUltSec, H00143_A203ordenNroPed, H00143_n203ordenNroPed, H00143_A195OrdenFacNomb, H00143_n195OrdenFacNomb,
               H00143_A192OrdenPed, H00143_n192OrdenPed, H00143_A172OrdenfchEnt, H00143_n172OrdenfchEnt, H00143_A133OrdenProceso, H00143_n133OrdenProceso, H00143_A132OrdenEmpFac, H00143_n132OrdenEmpFac, H00143_A25OrdenAnio, H00143_A24OrdenPeriodo,
               H00143_A116OrdenUser, H00143_n116OrdenUser, H00143_A115OrdenEst, H00143_n115OrdenEst, H00143_A110cantDias, H00143_n110cantDias, H00143_A109fchVenta, H00143_n109fchVenta, H00143_A74protDsc, H00143_n74protDsc,
               H00143_A10protID, H00143_A107representane, H00143_n107representane, H00143_A106facturaNro, H00143_n106facturaNro, H00143_A72vendedorDsc, H00143_n72vendedorDsc, H00143_A9vendedorID, H00143_A104tipOrdDsc, H00143_n104tipOrdDsc,
               H00143_A17tipOrdID, H00143_A119OrdenFch, H00143_n119OrdenFch, H00143_A117OrdenModeloID, H00143_A69VehiculoChasis, H00143_n69VehiculoChasis, H00143_A68VehiculoPlaca, H00143_n68VehiculoPlaca, H00143_A8VehiculoID, H00143_A22OrdenID,
               H00143_A57ClienteDsc, H00143_n57ClienteDsc, H00143_A5ClienteID, H00143_A44empdsc, H00143_n44empdsc, H00143_A255OrdenObreSuma, H00143_n255OrdenObreSuma, H00143_A168OrdenValOtrs, H00143_n168OrdenValOtrs, H00143_A167OrdenValEstr,
               H00143_n167OrdenValEstr, H00143_A166OrdenValPint, H00143_n166OrdenValPint, H00143_A165OrdenValCal, H00143_n165OrdenValCal, H00143_A163OrdenValEnrq, H00143_n163OrdenValEnrq, H00143_A162OrdenValInds, H00143_n162OrdenValInds, H00143_A161OrdenSubtotal,
               H00143_n161OrdenSubtotal, H00143_A153OrdenActaPdf, H00143_n153OrdenActaPdf, H00143_A152OrdenPdf, H00143_n152OrdenPdf, H00143_A112documento, H00143_n112documento, H00143_A108urlPdf, H00143_n108urlPdf
               }
               , new Object[] {
               H00145_AGRID_nRecordCount
               }
            }
         );
         AV17Pgmname = "MarcaOrdenProduccionWC";
      ...
      private short AV7OrdenMarcaID ;
      private short wcpOAV6EmpID ;
      private short wcpOAV7OrdenMarcaID ;
      ...
      private int edtOrdenMarcaID_Enabled ;
      private int edtOrdenMarcaID_Visible ;
      ...
      private String sCtrlAV7OrdenMarcaID ;
      ...
      private short[] H00143_A1EmpID ;
      private short[] H00143_A26OrdenMarcaID ;
      private int[] H00143_A401OrdenNroDesp ;
      private bool[] H00143_n401OrdenNroDesp ;
      private short[] H00143_A210OrdenUltSec ;
      private bool[] H00143_n210OrdenUltSec ;
      private int[] H00143_A203ordenNroPed ;
      private bool[] H00143_n203ordenNroPed ;
      private String[] H00143_A195OrdenFacNomb ;
      private bool[] H00143_n195OrdenFacNomb ;
      private int[] H00143_A192OrdenPed ;
      private bool[] H00143_n192OrdenPed ;
      private DateTime[] H00143_A172OrdenfchEnt ;
      private bool[] H00143_n172OrdenfchEnt ;
      private String[] H00143_A133OrdenProceso ;
      private bool[] H00143_n133OrdenProceso ;
      private short[] H00143_A132OrdenEmpFac ;
      private bool[] H00143_n132OrdenEmpFac ;
      private short[] H00143_A25OrdenAnio ;
      private short[] H00143_A24OrdenPeriodo ;
      private String[] H00143_A116OrdenUser ;
      private bool[] H00143_n116OrdenUser ;
      private String[] H00143_A115OrdenEst ;
      private bool[] H00143_n115OrdenEst ;
      private short[] H00143_A110cantDias ;
      private bool[] H00143_n110cantDias ;
      private DateTime[] H00143_A109fchVenta ;
      private bool[] H00143_n109fchVenta ;
      private String[] H00143_A74protDsc ;
      private bool[] H00143_n74protDsc ;
      private short[] H00143_A10protID ;
      private String[] H00143_A107representane ;
      private bool[] H00143_n107representane ;
      private int[] H00143_A106facturaNro ;
      private bool[] H00143_n106facturaNro ;
      private String[] H00143_A72vendedorDsc ;
      private bool[] H00143_n72vendedorDsc ;
      private short[] H00143_A9vendedorID ;
      private String[] H00143_A104tipOrdDsc ;
      private bool[] H00143_n104tipOrdDsc ;
      private short[] H00143_A17tipOrdID ;
      private DateTime[] H00143_A119OrdenFch ;
      private bool[] H00143_n119OrdenFch ;
      private short[] H00143_A117OrdenModeloID ;
      private String[] H00143_A69VehiculoChasis ;
      private bool[] H00143_n69VehiculoChasis ;
      private String[] H00143_A68VehiculoPlaca ;
      private bool[] H00143_n68VehiculoPlaca ;
      private short[] H00143_A8VehiculoID ;
      private short[] H00143_A22OrdenID ;
      private String[] H00143_A57ClienteDsc ;
      private bool[] H00143_n57ClienteDsc ;
      private short[] H00143_A5ClienteID ;
      private String[] H00143_A44empdsc ;
      private bool[] H00143_n44empdsc ;
      private decimal[] H00143_A255OrdenObreSuma ;
      private bool[] H00143_n255OrdenObreSuma ;
      private decimal[] H00143_A168OrdenValOtrs ;
      private bool[] H00143_n168OrdenValOtrs ;
      private decimal[] H00143_A167OrdenValEstr ;
      private bool[] H00143_n167OrdenValEstr ;
      private decimal[] H00143_A166OrdenValPint ;
      private bool[] H00143_n166OrdenValPint ;
      private decimal[] H00143_A165OrdenValCal ;
      private bool[] H00143_n165OrdenValCal ;
      private decimal[] H00143_A163OrdenValEnrq ;
      private bool[] H00143_n163OrdenValEnrq ;
      private decimal[] H00143_A162OrdenValInds ;
      private bool[] H00143_n162OrdenValInds ;
      private decimal[] H00143_A161OrdenSubtotal ;
      private bool[] H00143_n161OrdenSubtotal ;
      private String[] H00143_A153OrdenActaPdf ;
      private bool[] H00143_n153OrdenActaPdf ;
      private String[] H00143_A152OrdenPdf ;
      private bool[] H00143_n152OrdenPdf ;
      private String[] H00143_A112documento ;
      private bool[] H00143_n112documento ;
      private String[] H00143_A108urlPdf ;
      private bool[] H00143_n108urlPdf ;
      private long[] H00145_AGRID_nRecordCount ;
   ...
   public class marcaordenproduccionwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV7OrdenMarcaID",SqlDbType.SmallInt,4,0} ,
          new Object[] {"@GXPagingFrom2",SqlDbType.Int,9,0} ,
          new Object[] {"@GXPagingTo2",SqlDbType.Int,9,0}
          } ;
          String cmdBufferH00143 ;
          cmdBufferH00143=" SELECT T1.[EmpID], T1.[OrdenMarcaID], T1.[OrdenNroDesp], T1.[OrdenUltSec], T1.[ordenNroPed], T1.[OrdenFacNomb], T1.[OrdenPed], T1.[OrdenfchEnt], T1.[OrdenProceso], T1.[OrdenEmpFac], T1.[OrdenAnio], T1.[OrdenPeriodo], T1.[OrdenUser], T1.[OrdenEst], T1.[cantDias], T1.[fchVenta], T3.[protDsc], T1.[protID], T1.[representane], T1.[facturaNro], T4.[vendedorDsc], T1.[vendedorID], T5.[tipOrdDsc], T1.[tipOrdID], T1.[OrdenFch], T1.[OrdenModeloID], T6.[VehiculoChasis], T6.[VehiculoPlaca], T1.[VehiculoID], T1.[OrdenID], T7.[ClienteDsc], T1.[ClienteID], T2.[empdsc], COALESCE( T8.[OrdenObreSuma], 0) AS OrdenObreSuma, T1.[OrdenValOtrs], T1.[OrdenValEstr], T1.[OrdenValPint], T1.[OrdenValCal], T1.[OrdenValEnrq], T1.[OrdenValInds], T1.[OrdenSubtotal], T1.[OrdenActaPdf], T1.[OrdenPdf], T1.[documento], T1.[urlPdf] FROM ((((((([OrdenProduccion] T1 WITH (NOLOCK) INNER JOIN [Empresas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID]) INNER JOIN [Prototipo] T3 WITH (NOLOCK) ON T3.[EmpID] = T1.[EmpID] AND T3.[protID] = T1.[protID]) INNER JOIN [Vendedor] T4 WITH (NOLOCK) ON T4.[EmpID] = T1.[EmpID] AND T4.[vendedorID] = T1.[vendedorID]) INNER JOIN [TipoOrdenPro] T5 WITH (NOLOCK) ON T5.[EmpID] = T1.[EmpID] AND T5.[tipOrdID] = T1.[tipOrdID]) INNER JOIN [Vehiculos] T6 WITH (NOLOCK) ON T6.[EmpID] = T1.[EmpID] AND T6.[VehiculoID] = T1.[VehiculoID]) INNER JOIN [Clientes] T7 WITH (NOLOCK) ON T7.[EmpID] = T1.[EmpID] AND T7.[ClienteID] = T1.[ClienteID]) LEFT JOIN (SELECT SUM([OrdenObreValor]) AS OrdenObreSuma, [EmpID], [ClienteID], [OrdenPeriodo], [OrdenAnio], [OrdenID] FROM [OrdenProduccionObr] WITH (NOLOCK) GROUP BY [EmpID], [ClienteID], [OrdenPeriodo], [OrdenAnio], [OrdenID] ) T8 ON T8.[EmpID] = T1.[EmpID] AND T8.[ClienteID] = T1.[ClienteID] AND T8.[OrdenPeriodo] = T1.[OrdenPeriodo] AND T8.[OrdenAnio] = T1.[OrdenAnio] "
          + " AND T8.[OrdenID] = T1.[OrdenID]) WHERE T1.[EmpID] = @AV6EmpID and T1.[OrdenMarcaID] = @AV7OrdenMarcaID ORDER BY T1.[EmpID], T1.[OrdenMarcaID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY" ;
          Object[] prmH00145 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H00143", cmdBufferH00143,false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00143,11,0,true,false )
             ,new CursorDef("H00145", "SELECT COUNT(*) FROM ((((((([OrdenProduccion] T1 WITH (NOLOCK) INNER JOIN [Empresas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID]) INNER JOIN [Prototipo] T6 WITH (NOLOCK) ON T6.[EmpID] = T1.[EmpID] AND T6.[protID] = T1.[protID]) INNER JOIN [Vendedor] T5 WITH (NOLOCK) ON T5.[EmpID] = T1.[EmpID] AND T5.[vendedorID] = T1.[vendedorID]) INNER JOIN [TipoOrdenPro] T7 WITH (NOLOCK) ON T7.[EmpID] = T1.[EmpID] AND T7.[tipOrdID] = T1.[tipOrdID]) INNER JOIN [Vehiculos] T4 WITH (NOLOCK) ON T4.[EmpID] = T1.[EmpID] AND T4.[VehiculoID] = T1.[VehiculoID]) INNER JOIN [Clientes] T3 WITH (NOLOCK) ON T3.[EmpID] = T1.[EmpID] AND T3.[ClienteID] = T1.[ClienteID]) LEFT JOIN (SELECT SUM([OrdenObreValor]) AS OrdenObreSuma, [EmpID], [ClienteID], [OrdenPeriodo], [OrdenAnio], [OrdenID] FROM [OrdenProduccionObr] WITH (NOLOCK) GROUP BY [EmpID], [ClienteID], [OrdenPeriodo], [OrdenAnio], [OrdenID] ) T8 ON T8.[EmpID] = T1.[EmpID] AND T8.[ClienteID] = T1.[ClienteID] AND T8.[OrdenPeriodo] = T1.[OrdenPeriodo] AND T8.[OrdenAnio] = T1.[OrdenAnio] AND T8.[OrdenID] = T1.[OrdenID]) WHERE T1.[EmpID] = @AV6EmpID and T1.[OrdenMarcaID] = @AV7OrdenMarcaID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00145,1,0,true,false )
          };
       }
    }
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((short[]) buf[43])[0] = rslt.getShort(26) ;
                ...
                ((String[]) buf[50])[0] = rslt.getString(31, 50) ;
                ...
                ((decimal[]) buf[67])[0] = rslt.getDecimal(40) ;
                ((bool[]) buf[68])[0] = rslt.wasNull(40);
                ((decimal[]) buf[69])[0] = rslt.getDecimal(41) ;
                ((bool[]) buf[70])[0] = rslt.wasNull(41);
                ((String[]) buf[71])[0] = rslt.getBLOBFile(42, ".pdf", "") ;
                ((bool[]) buf[72])[0] = rslt.wasNull(42);
                ((String[]) buf[73])[0] = rslt.getBLOBFile(43, ".pdf", "") ;
                ((bool[]) buf[74])[0] = rslt.wasNull(43);
                ((String[]) buf[75])[0] = rslt.getBLOBFile(44, "tmp", "") ;
                ((bool[]) buf[76])[0] = rslt.wasNull(44);
                ((String[]) buf[77])[0] = rslt.getBLOBFile(45, "tmp", "") ;
