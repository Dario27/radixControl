/*
       ...
       Generated on: 10/26/2022 20:13:8.44
...
namespace GeneXus.Programs {
   public class tabbedview : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202210262013847", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm092( )
      {
         ...
         {
            context.AddJavascriptSource("tabbedview.js", "?202210262013851", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202210262013873", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("tabbedview.js", "?202210262013873", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      {
         AV18Tabs = new GXBaseCollection<SdtTabOptions_TabOptionsItem>( context, "TabOptionsItem", "KBCalpesa22");
         wcpOAV15TabCode = "";
         Historymanager_Hash = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
