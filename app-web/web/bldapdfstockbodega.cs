...
using System.IO;
public class bldapdfstockbodega : GxBaseBuilder
{
   string cs_path = "." ;
   public bldapdfstockbodega( ) : base()
   {
   }
   ...
   {
      bldapdfstockbodega x = new bldapdfstockbodega() ;
      x.SetMainSourceFile( "apdfstockbodega.cs");
