/*
               File: ViewVendedor
        Description: View Vendedor
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 1/14/2023 1:15:52.22
...
namespace GeneXus.Programs {
   public class viewvendedor : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      public viewvendedor( )
      {
                           ...
                           String aP2_TabCode )
      {
         ...
         this.AV13vendedorID = aP1_vendedorID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               {
                  AV13vendedorID = (short)(NumberUtil.Val( GetNextPar( ), "."));
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13vendedorID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13vendedorID), 4, 0)));
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vVENDEDORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13vendedorID), "ZZZ9"), context));
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231141155226", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewvendedor.aspx") + "?" + UrlEncode("" +AV12EmpID) + "," + UrlEncode("" +AV13vendedorID) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens = "hsh" + "ViewVendedor";
         forbiddenHiddens = forbiddenHiddens + StringUtil.RTrim( context.localUtil.Format( A72vendedorDsc, ""));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens, GXKey));
         GXUtil.WriteLog("viewvendedor:[SendSecurityCheck value for]"+"vendedorDsc:"+StringUtil.RTrim( context.localUtil.Format( A72vendedorDsc, "")));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vVENDEDORID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13vendedorID), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vVENDEDORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13vendedorID), "ZZZ9"), context));
      ...
      protected void WB1A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Vendedor Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewVendedor.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Vendedors", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewVendedor.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtvendedorDsc_Internalname, StringUtil.RTrim( A72vendedorDsc), StringUtil.RTrim( context.localUtil.Format( A72vendedorDsc, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtvendedorDsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtvendedorDsc_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "Descripcion", "left", true, "HLP_ViewVendedor.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewVendedor.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblOrdenproduccion_title_Internalname, "Orden Produccion", "", "", lblOrdenproduccion_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewVendedor.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void RF1A2( )
      {
         ...
         {
            /* Using cursor H001A2 */
            pr_default.execute(0, new Object[] {AV12EmpID, AV13vendedorID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A9vendedorID = H001A2_A9vendedorID[0];
               A1EmpID = H001A2_A1EmpID[0];
               A72vendedorDsc = H001A2_A72vendedorDsc[0];
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A72vendedorDsc", A72vendedorDsc);
               n72vendedorDsc = H001A2_n72vendedorDsc[0];
               /* Execute user event: Load */
               E121A2 ();
      ...
      protected void STRUP1A0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13vendedorID = (short)(context.localUtil.CToN( cgiGet( "vVENDEDORID"), ",", "."));
            ...
            {
               GXUtil.WriteLog("viewvendedor:[SecurityCheckFailed value for]"+"vendedorDsc:"+StringUtil.RTrim( context.localUtil.Format( A72vendedorDsc, "")));
               GxWebError = 1;
      ...
      protected void E111A2( )
      {
         ...
         AV17GXLvl6 = 0;
         /* Using cursor H001A3 */
         pr_default.execute(1, new Object[] {AV12EmpID, AV13vendedorID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A9vendedorID = H001A3_A9vendedorID[0];
            A1EmpID = H001A3_A1EmpID[0];
            A72vendedorDsc = H001A3_A72vendedorDsc[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A72vendedorDsc", A72vendedorDsc);
            n72vendedorDsc = H001A3_n72vendedorDsc[0];
            AV17GXLvl6 = 1;
            Form.Caption = A72vendedorDsc;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               ...
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0030",(String)"",(short)AV12EmpID,(short)AV13vendedorID});
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Ordenproduccionwc_Component), StringUtil.Lower( "VendedorOrdenProduccionWC")) != 0 )
            {
               WebComp_Ordenproduccionwc = getWebComponent(GetType(), "GeneXus.Programs", "vendedorordenproduccionwc", new Object[] {context} );
               WebComp_Ordenproduccionwc.ComponentInit();
               WebComp_Ordenproduccionwc.Name = "VendedorOrdenProduccionWC";
               WebComp_Ordenproduccionwc_Component = "VendedorOrdenProduccionWC";
            }
            if ( StringUtil.Len( WebComp_Ordenproduccionwc_Component) != 0 )
            {
               WebComp_Ordenproduccionwc.setjustcreated();
               WebComp_Ordenproduccionwc.componentprepare(new Object[] {(String)"W0038",(String)"",(short)AV12EmpID,(short)AV13vendedorID});
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12EmpID), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vEMPID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmpID), "ZZZ9"), context));
         AV13vendedorID = Convert.ToInt16(getParm(obj,1));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13vendedorID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13vendedorID), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vVENDEDORID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13vendedorID), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20231141155299", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewvendedor.js", "?20231141155299", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12EmpID',fld:'vEMPID',pic:'ZZZ9',hsh:true},{av:'AV13vendedorID',fld:'vVENDEDORID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A72vendedorDsc',fld:'VENDEDORDSC',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H001A2_A9vendedorID = new short[1] ;
         H001A2_A1EmpID = new short[1] ;
         H001A2_A72vendedorDsc = new String[] {""} ;
         H001A2_n72vendedorDsc = new bool[] {false} ;
         hsh = "";
         H001A3_A9vendedorID = new short[1] ;
         H001A3_A1EmpID = new short[1] ;
         H001A3_A72vendedorDsc = new String[] {""} ;
         H001A3_n72vendedorDsc = new bool[] {false} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewvendedor__default(),
            new Object[][] {
                new Object[] {
               H001A2_A9vendedorID, H001A2_A1EmpID, H001A2_A72vendedorDsc, H001A2_n72vendedorDsc
               }
               , new Object[] {
               H001A3_A9vendedorID, H001A3_A1EmpID, H001A3_A72vendedorDsc, H001A3_n72vendedorDsc
               }
            }
         );
      ...
      private short AV13vendedorID ;
      private short wcpOAV12EmpID ;
      private short wcpOAV13vendedorID ;
      ...
      private short[] H001A2_A9vendedorID ;
      private short[] H001A2_A1EmpID ;
      private String[] H001A2_A72vendedorDsc ;
      private bool[] H001A2_n72vendedorDsc ;
      private short[] H001A3_A9vendedorID ;
      private short[] H001A3_A1EmpID ;
      private String[] H001A3_A72vendedorDsc ;
      private bool[] H001A3_n72vendedorDsc ;
   ...
   public class viewvendedor__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV13vendedorID",SqlDbType.SmallInt,4,0}
          } ;
          Object[] prmH001A3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H001A2", "SELECT [vendedorID], [EmpID], [vendedorDsc] FROM [Vendedor] WITH (NOLOCK) WHERE [EmpID] = @AV12EmpID and [vendedorID] = @AV13vendedorID ORDER BY [EmpID], [vendedorID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001A2,1,0,true,true )
             ,new CursorDef("H001A3", "SELECT [vendedorID], [EmpID], [vendedorDsc] FROM [Vendedor] WITH (NOLOCK) WHERE ([EmpID] = @AV12EmpID and [vendedorID] = @AV13vendedorID) AND ([EmpID] = @AV12EmpID and [vendedorID] = @AV13vendedorID) ORDER BY [EmpID], [vendedorID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001A3,1,0,false,true )
          };
       }
    }
