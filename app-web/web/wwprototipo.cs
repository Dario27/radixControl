/*
               File: WWPrototipo
        Description: Work With Prototipo
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 1/14/2023 1:15:47.46
...
namespace GeneXus.Programs {
   public class wwprototipo : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      public wwprototipo( )
      {
      ...
      public wwprototipo( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13protDsc, AV19Pgmname, AV14Update, AV15Delete) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231141154753", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwprototipo.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vPROTDSC", StringUtil.RTrim( AV13protDsc));
         /* Send saved values. */
      ...
      protected void WB0W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Prototipoes", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_WWPrototipo.htm");
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPrototipo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavProtdsc_Internalname, "prot Dsc", "col-sm-3 FilterSearchAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavProtdsc_Internalname, StringUtil.RTrim( AV13protDsc), StringUtil.RTrim( context.localUtil.Format( AV13protDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Prototipo", edtavProtdsc_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavProtdsc_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_WWPrototipo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A75protEst));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A76protObserv);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START0W2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Work With Prototipo", 0) ;
         }
         context.wjLoc = "";
                        ...
                        if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false;
                                    /* Set Refresh If Protdsc Changed */
                                    if ( StringUtil.StrCmp(cgiGet( "GXH_vPROTDSC"), AV13protDsc) != 0 )
                                    {
                                       Rfr0gs = true;
                                    }
                                    if ( ! Rfr0gs )
      ...
      protected void PA0W2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavProtdsc_Internalname;
      ...
      protected void RF0W2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13protDsc = StringUtil.PadR( StringUtil.RTrim( AV13protDsc), 50, "%");
            /* Using cursor H000W2 */
            pr_default.execute(0, new Object[] {lV13protDsc, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_25_idx), 4, 0)), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               A76protObserv = H000W2_A76protObserv[0];
               n76protObserv = H000W2_n76protObserv[0];
               A75protEst = H000W2_A75protEst[0];
               n75protEst = H000W2_n75protEst[0];
               A74protDsc = H000W2_A74protDsc[0];
               n74protDsc = H000W2_n74protDsc[0];
               A10protID = H000W2_A10protID[0];
               A44empdsc = H000W2_A44empdsc[0];
               n44empdsc = H000W2_n44empdsc[0];
               A1EmpID = H000W2_A1EmpID[0];
               A44empdsc = H000W2_A44empdsc[0];
               n44empdsc = H000W2_n44empdsc[0];
               E140W2 ();
      ...
      protected void send_integrity_lvl_hashes0W2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_PROTID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A10protID), "ZZZ9"), context));
      }
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         lV13protDsc = StringUtil.PadR( StringUtil.RTrim( AV13protDsc), 50, "%");
         /* Using cursor H000W3 */
         pr_default.execute(1, new Object[] {lV13protDsc});
      ...
      protected void STRUP0W0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13protDsc = cgiGet( edtavProtdsc_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13protDsc", AV13protDsc);
            /* Read saved values. */
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("prototipo.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A10protID);
         edtavDelete_Link = formatLink("prototipo.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A10protID);
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 25;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("prototipo.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13protDsc = ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13protDsc", AV13protDsc);
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = AV13protDsc;
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext.gxTpr_Transactionname = "Prototipo";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20231141154817", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwprototipo.js", "?20231141154818", false);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtprotID_Internalname = "PROTID_"+sGXsfl_25_idx;
         edtprotDsc_Internalname = "PROTDSC_"+sGXsfl_25_idx;
         edtprotEst_Internalname = "PROTEST_"+sGXsfl_25_idx;
         edtprotObserv_Internalname = "PROTOBSERV_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtprotID_Internalname = "PROTID_"+sGXsfl_25_fel_idx;
         edtprotDsc_Internalname = "PROTDSC_"+sGXsfl_25_fel_idx;
         edtprotEst_Internalname = "PROTEST_"+sGXsfl_25_fel_idx;
         edtprotObserv_Internalname = "PROTOBSERV_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtprotID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A10protID), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A10protID), "ZZZ9"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtprotID_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(String)"Id",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtprotObserv_Internalname,(String)A76protObserv,(String)"",(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtprotObserv_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)0,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)200,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void init_default_properties( )
      {
         ...
         edtavProtdsc_Internalname = "vPROTDSC";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavProtdsc_Jsonclick = "";
         edtavProtdsc_Enabled = 1;
         Form.Caption = "Work With Prototipo";
         subGrid_Rows = 10;
         edtavDelete_Tooltiptext = "Eliminar";
         edtavUpdate_Tooltiptext = "Modificar";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13protDsc',fld:'vPROTDSC',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140W2',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A10protID',fld:'PROTID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110W2',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A10protID',fld:'PROTID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13protDsc = "";
         H000W2_A76protObserv = new String[] {""} ;
         H000W2_n76protObserv = new bool[] {false} ;
         H000W2_A75protEst = new String[] {""} ;
         H000W2_n75protEst = new bool[] {false} ;
         H000W2_A74protDsc = new String[] {""} ;
         H000W2_n74protDsc = new bool[] {false} ;
         H000W2_A10protID = new short[1] ;
         H000W2_A44empdsc = new String[] {""} ;
         H000W2_n44empdsc = new bool[] {false} ;
         H000W2_A1EmpID = new short[1] ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwprototipo__default(),
            new Object[][] {
                new Object[] {
               H000W2_A76protObserv, H000W2_n76protObserv, H000W2_A75protEst, H000W2_n75protEst, H000W2_A74protDsc, H000W2_n74protDsc, H000W2_A10protID, H000W2_A44empdsc, H000W2_n44empdsc, H000W2_A1EmpID
               }
               , new Object[] {
      ...
      private int edtavProtdsc_Enabled ;
      ...
      private String edtavProtdsc_Internalname ;
      private String edtavProtdsc_Jsonclick ;
      ...
      private String edtprotObserv_Jsonclick ;
      ...
      private String[] H000W2_A76protObserv ;
      private bool[] H000W2_n76protObserv ;
      private String[] H000W2_A75protEst ;
      private bool[] H000W2_n75protEst ;
      private String[] H000W2_A74protDsc ;
      private bool[] H000W2_n74protDsc ;
      private short[] H000W2_A10protID ;
      private String[] H000W2_A44empdsc ;
      private bool[] H000W2_n44empdsc ;
      private short[] H000W2_A1EmpID ;
   ...
   public class wwprototipo__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A74protDsc )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " T1.[protObserv], T1.[protEst], T1.[protDsc], T1.[protID], T2.[empdsc], T1.[EmpID]";
         sFromString = " FROM ([Prototipo] T1 WITH (NOLOCK) INNER JOIN [Empresas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13protDsc)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and (T1.[protDsc] like @lV13protDsc)";
            }
            else
            {
               sWhereString = sWhereString + " (T1.[protDsc] like @lV13protDsc)";
            }
         }
         else
         {
         ...
         sOrderString = sOrderString + " ORDER BY T1.[protID]";
                                             ...
                                             String A74protDsc )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([Prototipo] T1 WITH (NOLOCK) INNER JOIN [Empresas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13protDsc)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV13protDsc",SqlDbType.Char,50,0} ,
