/*
       ...
       Generated on: 9/10/2022 16:31:31.54
...
namespace GeneXus.Programs {
   public class gx01v0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public void execute( out short aP0_pEmpID ,
                           out DateTime aP1_pfecha ,
                           out short aP2_pPrdCod )
      {
         this.AV13pEmpID = 0 ;
         this.AV14pfecha = DateTime.MinValue ;
         this.AV15pPrdCod = 0 ;
         executePrivate();
         aP0_pEmpID=this.AV13pEmpID;
         aP1_pfecha=this.AV14pfecha;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV7cfecha = context.localUtil.ParseDateParm( GetNextPar( ));
               AV8cPrdCod = (short)(NumberUtil.Val( GetNextPar( ), "."));
               AV9ccategID = (short)(NumberUtil.Val( GetNextPar( ), "."));
               AV10cvalAnt = NumberUtil.Val( GetNextPar( ), ".");
               AV11cvaloAct = NumberUtil.Val( GetNextPar( ), ".");
               AV12cUsuCod = GetNextPar( );
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cEmpID, AV7cfecha, AV8cPrdCod, AV9ccategID, AV10cvalAnt, AV11cvaloAct, AV12cUsuCod) ;
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               {
                  AV14pfecha = context.localUtil.ParseDateParm( GetNextPar( ));
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV14pfecha", context.localUtil.Format(AV14pfecha, "99/99/99"));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202291016313159", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx01v0.aspx") + "?" + UrlEncode("" +AV13pEmpID) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV14pfecha)) + "," + UrlEncode("" +AV15pPrdCod)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCFECHA", context.localUtil.Format(AV7cfecha, "99/99/99"));
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCVALANT", StringUtil.LTrim( StringUtil.NToC( AV10cvalAnt, 10, 2, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCVALOACT", StringUtil.LTrim( StringUtil.NToC( AV11cvaloAct, 10, 2, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCUSUCOD", StringUtil.RTrim( AV12cUsuCod));
         /* Send saved values. */
         ...
         GxWebStd.gx_hidden_field( context, "vPFECHA", context.localUtil.DToC( AV14pfecha, 0, "/"));
      ...
      {
         return formatLink("gx01v0.aspx") + "?" + UrlEncode("" +AV13pEmpID) + "," + UrlEncode(DateTimeUtil.FormatDateParm(AV14pfecha)) + "," + UrlEncode("" +AV15pPrdCod) ;
      }
      ...
      protected void WB4O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblempidfilter_Internalname, "Emp ID", "", "", lblLblempidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e114o1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01V0.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCempid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cEmpID), 4, 0, ",", "")), ((edtavCempid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6cEmpID), "ZZZ9")) : context.localUtil.Format( (decimal)(AV6cEmpID), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCempid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCempid_Visible, edtavCempid_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01V0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblfechafilter_Internalname, "fecha", "", "", lblLblfechafilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e124o1_client"+"'", "", "WWAdvancedLabel WWDateFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01V0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCfecha_Internalname, context.localUtil.Format(AV7cfecha, "99/99/99"), context.localUtil.Format( AV7cfecha, "99/99/99"), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 8,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCfecha_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCfecha_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01V0.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprdcodfilter_Internalname, "ID", "", "", lblLblprdcodfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e134o1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01V0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprdcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cPrdCod), 4, 0, ",", "")), ((edtavCprdcod_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV8cPrdCod), "ZZZ9")) : context.localUtil.Format( (decimal)(AV8cPrdCod), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprdcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprdcod_Visible, edtavCprdcod_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01V0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcategidfilter_Internalname, "Categ.ID", "", "", lblLblcategidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e144o1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01V0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcategid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9ccategID), 4, 0, ",", "")), ((edtavCcategid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV9ccategID), "ZZZ9")) : context.localUtil.Format( (decimal)(AV9ccategID), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcategid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcategid_Visible, edtavCcategid_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01V0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblvalantfilter_Internalname, "Precio Anterior", "", "", lblLblvalantfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e154o1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01V0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCvalant_Internalname, StringUtil.LTrim( StringUtil.NToC( AV10cvalAnt, 13, 2, ",", "")), ((edtavCvalant_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( AV10cvalAnt, "ZZ,ZZZ,ZZZ.ZZ")) : context.localUtil.Format( AV10cvalAnt, "ZZ,ZZZ,ZZZ.ZZ")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, '.',',','2');"+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCvalant_Jsonclick, 0, "Attribute", "", "", "", "", edtavCvalant_Visible, edtavCvalant_Enabled, 0, "text", "", 13, "chr", 1, "row", 13, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01V0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblvaloactfilter_Internalname, "Precio Actual", "", "", lblLblvaloactfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e164o1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01V0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCvaloact_Internalname, StringUtil.LTrim( StringUtil.NToC( AV11cvaloAct, 13, 2, ",", "")), ((edtavCvaloact_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( AV11cvaloAct, "ZZ,ZZZ,ZZZ.ZZ")) : context.localUtil.Format( AV11cvaloAct, "ZZ,ZZZ,ZZZ.ZZ")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, '.',',','2');"+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCvaloact_Jsonclick, 0, "Attribute", "", "", "", "", edtavCvaloact_Visible, edtavCvaloact_Enabled, 0, "text", "", 13, "chr", 1, "row", 13, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01V0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblusucodfilter_Internalname, "Nombre de Usuario", "", "", lblLblusucodfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e174o1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01V0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCusucod_Internalname, StringUtil.RTrim( AV12cUsuCod), StringUtil.RTrim( context.localUtil.Format( AV12cUsuCod, "")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCusucod_Jsonclick, 0, "Attribute", "", "", "", "", edtavCusucod_Visible, edtavCusucod_Enabled, 0, "text", "", 15, "chr", 1, "row", 15, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_Gx01V0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(84), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e184o1_client"+"'", TempTags, "", 2, "HLP_Gx01V0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 84 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(84), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx01V0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( context.localUtil.CToT( cgiGet( "GXH_vCFECHA"), 0) != AV7cfecha )
                                       {
                                          Rfr0gs = true;
                                       }
                                       ...
                                       if ( context.localUtil.CToN( cgiGet( "GXH_vCVALANT"), ",", ".") != AV10cvalAnt )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Cvaloact Changed */
                                       if ( context.localUtil.CToN( cgiGet( "GXH_vCVALOACT"), ",", ".") != AV11cvaloAct )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Cusucod Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCUSUCOD"), AV12cUsuCod) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void RF4O2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV8cPrdCod } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.DECIMAL, TypeConstants.DECIMAL, TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.DECIMAL, TypeConstants.BOOLEAN, TypeConstants.DECIMAL, TypeConstants.BOOLEAN, TypeConstants.STRING,
                                                 TypeConstants.SHORT, TypeConstants.DATE, TypeConstants.SHORT
                                                 }
            } ) ;
            lV12cUsuCod = StringUtil.PadR( StringUtil.RTrim( AV12cUsuCod), 15, "%");
            /* Using cursor H004O2 */
            pr_default.execute(0, new Object[] {AV6cEmpID, AV7cfecha, AV8cPrdCod, AV9ccategID, AV10cvalAnt, AV11cvaloAct, lV12cUsuCod, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_84_idx = 1;
            sGXsfl_84_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_84_idx), 4, 0)), 4, "0");
            SubsflControlProps_842( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A3UsuCod = H004O2_A3UsuCod[0];
               A304valoAct = H004O2_A304valoAct[0];
               n304valoAct = H004O2_n304valoAct[0];
               A303valAnt = H004O2_A303valAnt[0];
               n303valAnt = H004O2_n303valAnt[0];
               A32categID = H004O2_A32categID[0];
               A286PrdCod = H004O2_A286PrdCod[0];
               A302fecha = H004O2_A302fecha[0];
               A1EmpID = H004O2_A1EmpID[0];
               /* Execute user event: Load */
               E204O2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         lV12cUsuCod = StringUtil.PadR( StringUtil.RTrim( AV12cUsuCod), 15, "%");
         /* Using cursor H004O3 */
         pr_default.execute(1, new Object[] {AV6cEmpID, AV7cfecha, AV8cPrdCod, AV9ccategID, AV10cvalAnt, AV11cvaloAct, lV12cUsuCod});
      ...
      protected void STRUP4O0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.VCDate( cgiGet( edtavCfecha_Internalname), 2) == 0 )
            {
               ...
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV7cfecha = DateTime.MinValue;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cfecha", context.localUtil.Format(AV7cfecha, "99/99/99"));
            }
            else
            {
               AV7cfecha = context.localUtil.CToD( cgiGet( edtavCfecha_Internalname), 2);
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7cfecha", context.localUtil.Format(AV7cfecha, "99/99/99"));
            }
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCvalant_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCvalant_Internalname), ",", ".") > 9999999.99m ) ) )
            {
               ...
               wbErr = true;
               AV10cvalAnt = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10cvalAnt", StringUtil.LTrim( StringUtil.Str( AV10cvalAnt, 10, 2)));
            }
            else
            {
               AV10cvalAnt = context.localUtil.CToN( cgiGet( edtavCvalant_Internalname), ",", ".");
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10cvalAnt", StringUtil.LTrim( StringUtil.Str( AV10cvalAnt, 10, 2)));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCvaloact_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCvaloact_Internalname), ",", ".") > 9999999.99m ) ) )
            {
               ...
               wbErr = true;
               AV11cvaloAct = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11cvaloAct", StringUtil.LTrim( StringUtil.Str( AV11cvaloAct, 10, 2)));
            }
            else
            {
               AV11cvaloAct = context.localUtil.CToN( cgiGet( edtavCvaloact_Internalname), ",", ".");
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11cvaloAct", StringUtil.LTrim( StringUtil.Str( AV11cvaloAct, 10, 2)));
            }
            AV12cUsuCod = cgiGet( edtavCusucod_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12cUsuCod", AV12cUsuCod);
            /* Read saved values. */
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vCFECHA"), 2) != AV7cfecha )
            {
               GRID1_nFirstRecordOnPage = 0;
            }
            if ( ( context.localUtil.CToN( cgiGet( "GXH_vCPRDCOD"), ",", ".") != Convert.ToDecimal( AV8cPrdCod )) )
      ...
      {
         /* Start Routine */
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "Prod Precio", "", "", "", "", "", "", "", "");
      ...
      protected void E214O2( )
      {
         ...
         AV13pEmpID = A1EmpID;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13pEmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13pEmpID), 4, 0)));
         AV14pfecha = A302fecha;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV14pfecha", context.localUtil.Format(AV14pfecha, "99/99/99"));
         AV15pPrdCod = A286PrdCod;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV15pPrdCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV15pPrdCod), 4, 0)));
         context.setWebReturnParms(new Object[] {(short)AV13pEmpID,context.localUtil.Format( AV14pfecha, "99/99/99"),(short)AV15pPrdCod});
         context.setWebReturnParmsMetadata(new Object[] {"AV13pEmpID","AV14pfecha","AV15pPrdCod"});
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13pEmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13pEmpID), 4, 0)));
         AV14pfecha = (DateTime)getParm(obj,1);
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV14pfecha", context.localUtil.Format(AV14pfecha, "99/99/99"));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202291016313254", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx01v0.js", "?202291016313254", false);
      ...
      protected void sendrow_842( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_84_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A1EmpID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( context.localUtil.Format(A302fecha, "99/99/99"))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A286PrdCod), 4, 0, ",", "")))+"'"+"]);";
            ...
            edtvalAnt_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A1EmpID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( context.localUtil.Format(A302fecha, "99/99/99"))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A286PrdCod), 4, 0, ",", "")))+"'"+"]);";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cEmpID',fld:'vCEMPID',pic:'ZZZ9'},{av:'AV7cfecha',fld:'vCFECHA',pic:''},{av:'AV8cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV9ccategID',fld:'vCCATEGID',pic:'ZZZ9'},{av:'AV10cvalAnt',fld:'vCVALANT',pic:'ZZ,ZZZ,ZZZ.ZZ'},{av:'AV11cvaloAct',fld:'vCVALOACT',pic:'ZZ,ZZZ,ZZZ.ZZ'},{av:'AV12cUsuCod',fld:'vCUSUCOD',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E184O1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLEMPIDFILTER.CLICK","{handler:'E114O1',iparms:[{av:'divEmpidfiltercontainer_Class',ctrl:'EMPIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLFECHAFILTER.CLICK","{handler:'E124O1',iparms:[{av:'divFechafiltercontainer_Class',ctrl:'FECHAFILTERCONTAINER',prop:'Class'}]");
         setEventMetadata("LBLFECHAFILTER.CLICK",",oparms:[{av:'divFechafiltercontainer_Class',ctrl:'FECHAFILTERCONTAINER',prop:'Class'}]}");
         setEventMetadata("LBLPRDCODFILTER.CLICK","{handler:'E134O1',iparms:[{av:'divPrdcodfiltercontainer_Class',ctrl:'PRDCODFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLCATEGIDFILTER.CLICK","{handler:'E144O1',iparms:[{av:'divCategidfiltercontainer_Class',ctrl:'CATEGIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLVALANTFILTER.CLICK","{handler:'E154O1',iparms:[{av:'divValantfiltercontainer_Class',ctrl:'VALANTFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLVALOACTFILTER.CLICK","{handler:'E164O1',iparms:[{av:'divValoactfiltercontainer_Class',ctrl:'VALOACTFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLUSUCODFILTER.CLICK","{handler:'E174O1',iparms:[{av:'divUsucodfiltercontainer_Class',ctrl:'USUCODFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E214O2',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A302fecha',fld:'FECHA',pic:'',hsh:true},{av:'A286PrdCod',fld:'PRDCOD',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV13pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV14pfecha',fld:'vPFECHA',pic:''},{av:'AV15pPrdCod',fld:'vPPRDCOD',pic:'ZZZ9'}]}");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV12cUsuCod = "";
         H004O2_A3UsuCod = new String[] {""} ;
         H004O2_A304valoAct = new decimal[1] ;
         H004O2_n304valoAct = new bool[] {false} ;
         H004O2_A303valAnt = new decimal[1] ;
         H004O2_n303valAnt = new bool[] {false} ;
         H004O2_A32categID = new short[1] ;
         H004O2_A286PrdCod = new short[1] ;
         H004O2_A302fecha = new DateTime[] {DateTime.MinValue} ;
         H004O2_A1EmpID = new short[1] ;
         H004O3_AGRID1_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx01v0__default(),
            new Object[][] {
                new Object[] {
               H004O2_A3UsuCod, H004O2_A304valoAct, H004O2_n304valoAct, H004O2_A303valAnt, H004O2_n303valAnt, H004O2_A32categID, H004O2_A286PrdCod, H004O2_A302fecha, H004O2_A1EmpID
               }
               , new Object[] {
      ...
      private decimal AV10cvalAnt ;
      private decimal AV11cvaloAct ;
      ...
      private DateTime AV7cfecha ;
      private DateTime AV14pfecha ;
      ...
      private String[] H004O2_A3UsuCod ;
      private decimal[] H004O2_A304valoAct ;
      private bool[] H004O2_n304valoAct ;
      private decimal[] H004O2_A303valAnt ;
      private bool[] H004O2_n303valAnt ;
      private short[] H004O2_A32categID ;
      private short[] H004O2_A286PrdCod ;
      private DateTime[] H004O2_A302fecha ;
      private short[] H004O2_A1EmpID ;
      private long[] H004O3_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short aP0_pEmpID ;
      private DateTime aP1_pfecha ;
   ...
   public class gx01v0__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV8cPrdCod )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " [UsuCod], [valoAct], [valAnt], [categID], [PrdCod], [fecha], [EmpID]";
         sFromString = " FROM [ProdPrecio] WITH (NOLOCK)";
         sOrderString = "";
         sWhereString = sWhereString + " WHERE ([EmpID] >= @AV6cEmpID and [fecha] >= @AV7cfecha and [PrdCod] >= @AV8cPrdCod)";
         if ( ! (0==AV9ccategID) )
         {
         ...
         if ( ! (Convert.ToDecimal(0)==AV10cvalAnt) )
         {
            sWhereString = sWhereString + " and ([valAnt] >= @AV10cvalAnt)";
         }
         else
         {
            GXv_int1[4] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV11cvaloAct) )
         {
            sWhereString = sWhereString + " and ([valoAct] >= @AV11cvaloAct)";
         }
         else
         {
            GXv_int1[5] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV12cUsuCod)) )
         {
            sWhereString = sWhereString + " and ([UsuCod] like @lV12cUsuCod)";
         }
         else
         {
            GXv_int1[6] = 1;
         }
         sOrderString = sOrderString + " ORDER BY [EmpID], [fecha], [PrdCod]";
                                             ...
                                             short AV8cPrdCod )
      {
         ...
         scmdbuf = scmdbuf + " WHERE ([EmpID] >= @AV6cEmpID and [fecha] >= @AV7cfecha and [PrdCod] >= @AV8cPrdCod)";
         if ( ! (0==AV9ccategID) )
         {
            sWhereString = sWhereString + " and ([categID] >= @AV9ccategID)";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004O2(context, (short)dynConstraints[0] , (decimal)dynConstraints[1] , (decimal)dynConstraints[2] , (String)dynConstraints[3] , (short)dynConstraints[4] , (decimal)dynConstraints[5] , (decimal)dynConstraints[6] , (String)dynConstraints[7] , (short)dynConstraints[8] , (DateTime)dynConstraints[9] , (short)dynConstraints[10] );
               case 1 :
                     return conditional_H004O3(context, (short)dynConstraints[0] , (decimal)dynConstraints[1] , (decimal)dynConstraints[2] , (String)dynConstraints[3] , (short)dynConstraints[4] , (decimal)dynConstraints[5] , (decimal)dynConstraints[6] , (String)dynConstraints[7] , (short)dynConstraints[8] , (DateTime)dynConstraints[9] , (short)dynConstraints[10] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV7cfecha",SqlDbType.DateTime,8,0} ,
          new Object[] {"@AV8cPrdCod",SqlDbType.SmallInt,4,0} ,
          new Object[] {"@AV9ccategID",SqlDbType.SmallInt,4,0} ,
          new Object[] {"@AV10cvalAnt",SqlDbType.Decimal,10,2} ,
          new Object[] {"@AV11cvaloAct",SqlDbType.Decimal,10,2} ,
          new Object[] {"@lV12cUsuCod",SqlDbType.Char,15,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H004O2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004O2,11,0,false,false )
             ,new CursorDef("H004O3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004O3,1,0,false,false )
          };
       }
    }
