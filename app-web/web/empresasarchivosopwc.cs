/*
               File: EmpresasArchivosOPWC
        Description: Empresas Archivos OPWC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/26/2022 20:13:30.74
...
namespace GeneXus.Programs {
   public class empresasarchivosopwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public empresasarchivosopwc( )
      {
      ...
      public empresasarchivosopwc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV16Pgmname = "EmpresasArchivosOPWC";
               context.Gx_err = 0;
               WS0L2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Empresas Archivos OPWC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102620133078", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("empresasarchivosopwc.aspx") + "?" + UrlEncode("" +AV6EmpID)+"\">") ;
      ...
      protected void RenderHtmlCloseForm0L2( )
      {
         ...
         {
            context.AddJavascriptSource("empresasarchivosopwc.js", "?2022102620133081", false);
         }
      ...
      {
         return "EmpresasArchivosOPWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Empresas Archivos OPWC" ;
      }
      ...
      protected void WB0L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "empresasarchivosopwc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EmpresasArchivosOPWC.htm");
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A27ArchSec), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A22OrdenID), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A28ArchClienteID), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A134ArchUrl);
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A135ArchUser));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A137ArchName));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START0L2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Empresas Archivos OPWC", 0) ;
            }
            context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              A28ArchClienteID = (short)(context.localUtil.CToN( cgiGet( edtArchClienteID_Internalname), ",", "."));
                              A134ArchUrl = cgiGet( edtArchUrl_Internalname);
                              n134ArchUrl = false;
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtArchUrl_Internalname, "URL", context.PathToRelativeUrl( A134ArchUrl), !bGXsfl_20_Refreshing);
                              A135ArchUser = StringUtil.Upper( cgiGet( edtArchUser_Internalname));
                              n135ArchUser = false;
                              A137ArchName = StringUtil.Upper( cgiGet( edtArchName_Internalname));
                              n137ArchName = false;
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ARCHSEC", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A27ArchSec), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"ARCHSEC", StringUtil.LTrim( StringUtil.NToC( (decimal)(A27ArchSec), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ORDENID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A22OrdenID), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"ORDENID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A22OrdenID), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ARCHCLIENTEID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A28ArchClienteID), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"ARCHCLIENTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A28ArchClienteID), 4, 0, ".", "")));
      }
      ...
      protected void RF0L2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1EmpID = H000L2_A1EmpID[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(A1EmpID), 4, 0)));
               A137ArchName = H000L2_A137ArchName[0];
               n137ArchName = H000L2_n137ArchName[0];
               A135ArchUser = H000L2_A135ArchUser[0];
               n135ArchUser = H000L2_n135ArchUser[0];
               A28ArchClienteID = H000L2_A28ArchClienteID[0];
               A22OrdenID = H000L2_A22OrdenID[0];
               A27ArchSec = H000L2_A27ArchSec[0];
               A134ArchUrl = H000L2_A134ArchUrl[0];
               context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtArchUrl_Internalname, "URL", context.PathToRelativeUrl( A134ArchUrl), !bGXsfl_20_Refreshing);
               n134ArchUrl = H000L2_n134ArchUrl[0];
               E130L2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ARCHSEC"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A27ArchSec), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ORDENID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A22OrdenID), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_ARCHCLIENTEID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A28ArchClienteID), "ZZZ9"), context));
      }
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("archivosop.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A27ArchSec) + "," + UrlEncode("" +A22OrdenID) + "," + UrlEncode("" +A28ArchClienteID);
         edtavDelete_Link = formatLink("archivosop.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A27ArchSec) + "," + UrlEncode("" +A22OrdenID) + "," + UrlEncode("" +A28ArchClienteID);
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 20;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("archivosop.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0) + "," + UrlEncode("" +0) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "ArchivosOP";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "empresasarchivosopwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022102620133127", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("empresasarchivosopwc.js", "?2022102620133127", false);
         }
      ...
      {
         edtArchSec_Internalname = sPrefix+"ARCHSEC_"+sGXsfl_20_idx;
         edtOrdenID_Internalname = sPrefix+"ORDENID_"+sGXsfl_20_idx;
         edtArchClienteID_Internalname = sPrefix+"ARCHCLIENTEID_"+sGXsfl_20_idx;
         edtArchUrl_Internalname = sPrefix+"ARCHURL_"+sGXsfl_20_idx;
         edtArchUser_Internalname = sPrefix+"ARCHUSER_"+sGXsfl_20_idx;
         edtArchName_Internalname = sPrefix+"ARCHNAME_"+sGXsfl_20_idx;
      ...
      {
         edtArchSec_Internalname = sPrefix+"ARCHSEC_"+sGXsfl_20_fel_idx;
         edtOrdenID_Internalname = sPrefix+"ORDENID_"+sGXsfl_20_fel_idx;
         edtArchClienteID_Internalname = sPrefix+"ARCHCLIENTEID_"+sGXsfl_20_fel_idx;
         edtArchUrl_Internalname = sPrefix+"ARCHURL_"+sGXsfl_20_fel_idx;
         edtArchUser_Internalname = sPrefix+"ARCHUSER_"+sGXsfl_20_fel_idx;
         edtArchName_Internalname = sPrefix+"ARCHNAME_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtArchSec_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A27ArchSec), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A27ArchSec), "ZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtArchSec_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"Id",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtArchClienteID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A28ArchClienteID), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A28ArchClienteID), "ZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtArchClienteID_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"Id",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtArchUrl_Internalname, "Filetype", edtArchUrl_Filetype, !bGXsfl_20_Refreshing);
            ...
            GridRow.AddColumnProperties("blob", 2, isAjaxCallMode( ), new Object[] {(String)edtArchUrl_Internalname,StringUtil.RTrim( A134ArchUrl),context.PathToRelativeUrl( A134ArchUrl),(String.IsNullOrEmpty(StringUtil.RTrim( edtArchUrl_Contenttype)) ? context.GetContentType( (String.IsNullOrEmpty(StringUtil.RTrim( edtArchUrl_Filetype)) ? A134ArchUrl : edtArchUrl_Filetype)) : edtArchUrl_Contenttype),(bool)false,(String)"",(String)edtArchUrl_Parameters,(short)0,(short)0,(short)-1,(String)"",(String)"",(short)0,(short)-1,(short)0,(String)"px",(short)60,(String)"px",(short)0,(short)0,(short)0,(String)edtArchUrl_Jsonclick,(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)StyleString,(String)ClassString,(String)"WWColumn WWOptionalColumn",(String)"",(String)""+"",(String)"",(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtArchUser_Internalname,StringUtil.RTrim( A135ArchUser),StringUtil.RTrim( context.localUtil.Format( A135ArchUser, "@!")),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtArchUser_Jsonclick,(short)0,(String)"DescriptionAttribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)40,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)-1,(bool)true,(String)"nombres",(String)"left",(bool)true});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtArchName_Internalname,StringUtil.RTrim( A137ArchName),StringUtil.RTrim( context.localUtil.Format( A137ArchName, "@!")),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtArchName_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)40,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)-1,(bool)true,(String)"nombres",(String)"left",(bool)true});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void init_default_properties( )
      {
         ...
         edtArchSec_Internalname = sPrefix+"ARCHSEC";
         edtOrdenID_Internalname = sPrefix+"ORDENID";
         edtArchClienteID_Internalname = sPrefix+"ARCHCLIENTEID";
         edtArchUrl_Internalname = sPrefix+"ARCHURL";
         edtArchUser_Internalname = sPrefix+"ARCHUSER";
         edtArchName_Internalname = sPrefix+"ARCHNAME";
      ...
      public override void initialize_properties( )
      {
         ...
         init_default_properties( ) ;
         edtArchName_Jsonclick = "";
         edtArchUser_Jsonclick = "";
         edtArchUrl_Jsonclick = "";
         edtArchUrl_Parameters = "";
         edtArchUrl_Contenttype = "";
         edtArchUrl_Filetype = "";
         edtArchClienteID_Jsonclick = "";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130L2',iparms:[{av:'A27ArchSec',fld:'ARCHSEC',pic:'ZZZ9',hsh:true},{av:'A22OrdenID',fld:'ORDENID',pic:'ZZZ9',hsh:true},{av:'A28ArchClienteID',fld:'ARCHCLIENTEID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110L2',iparms:[{av:'A27ArchSec',fld:'ARCHSEC',pic:'ZZZ9',hsh:true},{av:'A22OrdenID',fld:'ORDENID',pic:'ZZZ9',hsh:true},{av:'A28ArchClienteID',fld:'ARCHCLIENTEID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV18Delete_GXI = "";
         scmdbuf = "";
         H000L2_A1EmpID = new short[1] ;
         H000L2_A137ArchName = new String[] {""} ;
         H000L2_n137ArchName = new bool[] {false} ;
         H000L2_A135ArchUser = new String[] {""} ;
         H000L2_n135ArchUser = new bool[] {false} ;
         H000L2_A28ArchClienteID = new short[1] ;
         H000L2_A22OrdenID = new short[1] ;
         H000L2_A27ArchSec = new short[1] ;
         H000L2_A134ArchUrl = new String[] {""} ;
         H000L2_n134ArchUrl = new bool[] {false} ;
         ...
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.empresasarchivosopwc__default(),
            new Object[][] {
                new Object[] {
               H000L2_A1EmpID, H000L2_A137ArchName, H000L2_n137ArchName, H000L2_A135ArchUser, H000L2_n135ArchUser, H000L2_A28ArchClienteID, H000L2_A22OrdenID, H000L2_A27ArchSec, H000L2_A134ArchUrl, H000L2_n134ArchUrl
               }
               , new Object[] {
      ...
      private String edtArchClienteID_Internalname ;
      private String edtArchUrl_Internalname ;
      private String edtArchUser_Internalname ;
      private String edtArchName_Internalname ;
      ...
      private String edtArchClienteID_Jsonclick ;
      ...
      private String edtArchUser_Jsonclick ;
      private String edtArchName_Jsonclick ;
      ...
      private short[] H000L2_A1EmpID ;
      private String[] H000L2_A137ArchName ;
      private bool[] H000L2_n137ArchName ;
      private String[] H000L2_A135ArchUser ;
      private bool[] H000L2_n135ArchUser ;
      private short[] H000L2_A28ArchClienteID ;
      private short[] H000L2_A22OrdenID ;
      private short[] H000L2_A27ArchSec ;
      private String[] H000L2_A134ArchUrl ;
      private bool[] H000L2_n134ArchUrl ;
   ...
   public class empresasarchivosopwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000L2", "SELECT [EmpID], [ArchName], [ArchUser], [ArchClienteID], [OrdenID], [ArchSec], [ArchUrl] FROM [ArchivosOP] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ORDER BY [EmpID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000L2,11,0,true,false )
             ,new CursorDef("H000L3", "SELECT COUNT(*) FROM [ArchivosOP] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000L3,1,0,true,false )
          };
       }
    }
