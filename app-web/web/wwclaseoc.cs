/*
               File: WWClaseOC
        Description: Clase OCs
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 11/19/2022 22:54:11.46
...
namespace GeneXus.Programs {
   public class wwclaseoc : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      public wwclaseoc( )
      {
      ...
      public wwclaseoc( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13ClaOCDsc, AV19Pgmname, AV14Update, AV15Delete) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022111922541149", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwclaseoc.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCLAOCDSC", StringUtil.RTrim( AV13ClaOCDsc));
         /* Send saved values. */
      ...
      protected void WB500( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Clase OCs", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_WWClaseOC.htm");
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWClaseOC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavClaocdsc_Internalname, "Cla OCDsc", "col-sm-3 FilterSearchAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavClaocdsc_Internalname, StringUtil.RTrim( AV13ClaOCDsc), StringUtil.RTrim( context.localUtil.Format( AV13ClaOCDsc, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Descripcion", edtavClaocdsc_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavClaocdsc_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_WWClaseOC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A321ClaOCCod));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A322ClaOCDsc));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A323ClaOCEst));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START502( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Clase OCs", 0) ;
         }
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV14Update)) ? AV20Update_GXI : context.convertURL( context.PathToRelativeUrl( AV14Update))), !bGXsfl_25_Refreshing);
                           ...
                           context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV15Delete)) ? AV21Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV15Delete))), !bGXsfl_25_Refreshing);
                           ...
                           if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false;
                                    /* Set Refresh If Claocdsc Changed */
                                    if ( StringUtil.StrCmp(cgiGet( "GXH_vCLAOCDSC"), AV13ClaOCDsc) != 0 )
                                    {
                                       Rfr0gs = true;
                                    }
                                    if ( ! Rfr0gs )
      ...
      protected void PA502( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavClaocdsc_Internalname;
      ...
      protected void RF502( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13ClaOCDsc = StringUtil.PadR( StringUtil.RTrim( AV13ClaOCDsc), 40, "%");
            /* Using cursor H00502 */
            pr_default.execute(0, new Object[] {lV13ClaOCDsc, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_25_idx), 4, 0)), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               A323ClaOCEst = H00502_A323ClaOCEst[0];
               n323ClaOCEst = H00502_n323ClaOCEst[0];
               A322ClaOCDsc = H00502_A322ClaOCDsc[0];
               n322ClaOCDsc = H00502_n322ClaOCDsc[0];
               A321ClaOCCod = H00502_A321ClaOCCod[0];
               A46AgeDsc = H00502_A46AgeDsc[0];
               n46AgeDsc = H00502_n46AgeDsc[0];
               A2AgeID = H00502_A2AgeID[0];
               A44empdsc = H00502_A44empdsc[0];
               n44empdsc = H00502_n44empdsc[0];
               A1EmpID = H00502_A1EmpID[0];
               A44empdsc = H00502_A44empdsc[0];
               n44empdsc = H00502_n44empdsc[0];
               A46AgeDsc = H00502_A46AgeDsc[0];
               n46AgeDsc = H00502_n46AgeDsc[0];
      ...
      protected void send_integrity_lvl_hashes502( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_AGEID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A2AgeID), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "gxhash_CLAOCCOD"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, StringUtil.RTrim( context.localUtil.Format( A321ClaOCCod, "")), context));
      }
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         lV13ClaOCDsc = StringUtil.PadR( StringUtil.RTrim( AV13ClaOCDsc), 40, "%");
         /* Using cursor H00503 */
         pr_default.execute(1, new Object[] {lV13ClaOCDsc});
      ...
      protected void STRUP500( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13ClaOCDsc = StringUtil.Upper( cgiGet( edtavClaocdsc_Internalname));
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13ClaOCDsc", AV13ClaOCDsc);
            /* Read saved values. */
      ...
      protected void E12502( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV14Update)) ? AV20Update_GXI : context.convertURL( context.PathToRelativeUrl( AV14Update))), !bGXsfl_25_Refreshing);
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV14Update), true);
         AV20Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "984dbb7e-3105-4d21-aee3-84a29ade1d38", "", context.GetTheme( )));
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV14Update)) ? AV20Update_GXI : context.convertURL( context.PathToRelativeUrl( AV14Update))), !bGXsfl_25_Refreshing);
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV14Update), true);
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV15Delete)) ? AV21Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV15Delete))), !bGXsfl_25_Refreshing);
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV15Delete), true);
         AV21Delete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "67c03cc7-261d-4b2f-aa3f-5825ef4786ff", "", context.GetTheme( )));
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV15Delete)) ? AV21Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV15Delete))), !bGXsfl_25_Refreshing);
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "SrcSet", context.GetImageSrcSet( AV15Delete), true);
         edtavDelete_Tooltiptext = "Eliminar";
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext, !bGXsfl_25_Refreshing);
         Form.Caption = "Clase OCs";
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("claseoc.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A2AgeID) + "," + UrlEncode(StringUtil.RTrim(A321ClaOCCod));
         edtavDelete_Link = formatLink("claseoc.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A2AgeID) + "," + UrlEncode(StringUtil.RTrim(A321ClaOCCod));
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 25;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("claseoc.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0) + "," + UrlEncode("" +0) + "," + UrlEncode(StringUtil.RTrim("")));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13ClaOCDsc = ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13ClaOCDsc", AV13ClaOCDsc);
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = AV13ClaOCDsc;
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext.gxTpr_Transactionname = "ClaseOC";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022111922541190", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwclaseoc.js", "?2022111922541191", false);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtClaOCCod_Internalname = "CLAOCCOD_"+sGXsfl_25_idx;
         edtClaOCDsc_Internalname = "CLAOCDSC_"+sGXsfl_25_idx;
         edtClaOCEst_Internalname = "CLAOCEST_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtClaOCCod_Internalname = "CLAOCCOD_"+sGXsfl_25_fel_idx;
         edtClaOCDsc_Internalname = "CLAOCDSC_"+sGXsfl_25_fel_idx;
         edtClaOCEst_Internalname = "CLAOCEST_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtClaOCCod_Internalname,StringUtil.RTrim( A321ClaOCCod),(String)"",(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtClaOCCod_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)3,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtClaOCDsc_Internalname,StringUtil.RTrim( A322ClaOCDsc),StringUtil.RTrim( context.localUtil.Format( A322ClaOCDsc, "@!")),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtClaOCDsc_Jsonclick,(short)0,(String)"DescriptionAttribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)40,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(String)"nombres",(String)"left",(bool)true});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            StyleString = "";
            AV14Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV14Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV20Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV14Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV14Update)) ? AV20Update_GXI : context.PathToRelativeUrl( AV14Update));
            ...
            ClassString = "ImageAttribute";
            StyleString = "";
            AV15Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV15Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV21Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV15Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV15Delete)) ? AV21Delete_GXI : context.PathToRelativeUrl( AV15Delete));
      ...
      protected void init_default_properties( )
      {
         ...
         edtavClaocdsc_Internalname = "vCLAOCDSC";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavClaocdsc_Jsonclick = "";
         edtavClaocdsc_Enabled = 1;
         Form.Caption = "Clase OCs";
         subGrid_Rows = 10;
         edtavDelete_Tooltiptext = "Eliminar";
         edtavUpdate_Tooltiptext = "Modificar";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13ClaOCDsc',fld:'vCLAOCDSC',pic:'@!'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E14502',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A2AgeID',fld:'AGEID',pic:'ZZZ9',hsh:true},{av:'A321ClaOCCod',fld:'CLAOCCOD',pic:'',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E11502',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A2AgeID',fld:'AGEID',pic:'ZZZ9',hsh:true},{av:'A321ClaOCCod',fld:'CLAOCCOD',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13ClaOCDsc = "";
         H00502_A323ClaOCEst = new String[] {""} ;
         H00502_n323ClaOCEst = new bool[] {false} ;
         H00502_A322ClaOCDsc = new String[] {""} ;
         H00502_n322ClaOCDsc = new bool[] {false} ;
         H00502_A321ClaOCCod = new String[] {""} ;
         H00502_A46AgeDsc = new String[] {""} ;
         H00502_n46AgeDsc = new bool[] {false} ;
         H00502_A2AgeID = new short[1] ;
         H00502_A44empdsc = new String[] {""} ;
         H00502_n44empdsc = new bool[] {false} ;
         H00502_A1EmpID = new short[1] ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwclaseoc__default(),
            new Object[][] {
                new Object[] {
               H00502_A323ClaOCEst, H00502_n323ClaOCEst, H00502_A322ClaOCDsc, H00502_n322ClaOCDsc, H00502_A321ClaOCCod, H00502_A46AgeDsc, H00502_n46AgeDsc, H00502_A2AgeID, H00502_A44empdsc, H00502_n44empdsc,
               H00502_A1EmpID
               }
               , new Object[] {
      ...
      private int edtavClaocdsc_Enabled ;
      ...
      private String edtavClaocdsc_Internalname ;
      private String edtavClaocdsc_Jsonclick ;
      ...
      private String[] H00502_A323ClaOCEst ;
      private bool[] H00502_n323ClaOCEst ;
      private String[] H00502_A322ClaOCDsc ;
      private bool[] H00502_n322ClaOCDsc ;
      private String[] H00502_A321ClaOCCod ;
      private String[] H00502_A46AgeDsc ;
      private bool[] H00502_n46AgeDsc ;
      private short[] H00502_A2AgeID ;
      private String[] H00502_A44empdsc ;
      private bool[] H00502_n44empdsc ;
      private short[] H00502_A1EmpID ;
   ...
   public class wwclaseoc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A322ClaOCDsc )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " T1.[ClaOCEst], T1.[ClaOCDsc], T1.[ClaOCCod], T3.[AgeDsc], T1.[AgeID], T2.[empdsc], T1.[EmpID]";
         sFromString = " FROM (([ClaseOC] T1 WITH (NOLOCK) INNER JOIN [Empresas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID]) INNER JOIN [Agencias] T3 WITH (NOLOCK) ON T3.[EmpID] = T1.[EmpID] AND T3.[AgeID] = T1.[AgeID])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13ClaOCDsc)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and (T1.[ClaOCDsc] like @lV13ClaOCDsc)";
            }
            else
            {
               sWhereString = sWhereString + " (T1.[ClaOCDsc] like @lV13ClaOCDsc)";
            }
         }
         else
         {
         ...
         sOrderString = sOrderString + " ORDER BY T1.[ClaOCDsc]";
                                             ...
                                             String A322ClaOCDsc )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (([ClaseOC] T1 WITH (NOLOCK) INNER JOIN [Empresas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID]) INNER JOIN [Agencias] T3 WITH (NOLOCK) ON T3.[EmpID] = T1.[EmpID] AND T3.[AgeID] = T1.[AgeID])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13ClaOCDsc)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00502(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
               case 1 :
                     return conditional_H00503(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV13ClaOCDsc",SqlDbType.Char,40,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00502", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00502,11,0,true,false )
             ,new CursorDef("H00503", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00503,1,0,true,false )
          };
       }
    }
