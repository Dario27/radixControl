/*
               File: ClientesOrdenProduccionWC
        Description: Clientes Orden Produccion WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 1/21/2023 19:12:46.51
...
namespace GeneXus.Programs {
   public class clientesordenproduccionwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public clientesordenproduccionwc( )
      {
      ...
      public clientesordenproduccionwc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "ClientesOrdenProduccionWC";
               context.Gx_err = 0;
               WS1H2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Clientes Orden Produccion WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202312119124667", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("clientesordenproduccionwc.aspx") + "?" + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +AV7ClienteID)+"\">") ;
      ...
      protected void RenderHtmlCloseForm1H2( )
      {
         ...
         {
            context.AddJavascriptSource("clientesordenproduccionwc.js", "?202312119124671", false);
         }
      ...
      {
         return "ClientesOrdenProduccionWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Clientes Orden Produccion WC" ;
      }
      ...
      protected void WB1H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "clientesordenproduccionwc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 7, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e111h1_client"+"'", TempTags, "", 2, "HLP_ClientesOrdenProduccionWC.htm");
      ...
      protected void START1H2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Clientes Orden Produccion WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF1H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               ...
               A401OrdenNroDesp = H001H3_A401OrdenNroDesp[0];
               n401OrdenNroDesp = H001H3_n401OrdenNroDesp[0];
               A210OrdenUltSec = H001H3_A210OrdenUltSec[0];
               n210OrdenUltSec = H001H3_n210OrdenUltSec[0];
               A203ordenNroPed = H001H3_A203ordenNroPed[0];
               n203ordenNroPed = H001H3_n203ordenNroPed[0];
               A195OrdenFacNomb = H001H3_A195OrdenFacNomb[0];
               n195OrdenFacNomb = H001H3_n195OrdenFacNomb[0];
               A192OrdenPed = H001H3_A192OrdenPed[0];
               n192OrdenPed = H001H3_n192OrdenPed[0];
               A172OrdenfchEnt = H001H3_A172OrdenfchEnt[0];
               n172OrdenfchEnt = H001H3_n172OrdenfchEnt[0];
               A133OrdenProceso = H001H3_A133OrdenProceso[0];
               n133OrdenProceso = H001H3_n133OrdenProceso[0];
               A132OrdenEmpFac = H001H3_A132OrdenEmpFac[0];
               n132OrdenEmpFac = H001H3_n132OrdenEmpFac[0];
               A25OrdenAnio = H001H3_A25OrdenAnio[0];
               A24OrdenPeriodo = H001H3_A24OrdenPeriodo[0];
               A117OrdenModeloID = H001H3_A117OrdenModeloID[0];
               A26OrdenMarcaID = H001H3_A26OrdenMarcaID[0];
               A116OrdenUser = H001H3_A116OrdenUser[0];
               n116OrdenUser = H001H3_n116OrdenUser[0];
               A115OrdenEst = H001H3_A115OrdenEst[0];
               n115OrdenEst = H001H3_n115OrdenEst[0];
               A110cantDias = H001H3_A110cantDias[0];
               n110cantDias = H001H3_n110cantDias[0];
               A109fchVenta = H001H3_A109fchVenta[0];
               n109fchVenta = H001H3_n109fchVenta[0];
               A69VehiculoChasis = H001H3_A69VehiculoChasis[0];
               n69VehiculoChasis = H001H3_n69VehiculoChasis[0];
               A68VehiculoPlaca = H001H3_A68VehiculoPlaca[0];
               n68VehiculoPlaca = H001H3_n68VehiculoPlaca[0];
               A8VehiculoID = H001H3_A8VehiculoID[0];
               A74protDsc = H001H3_A74protDsc[0];
               n74protDsc = H001H3_n74protDsc[0];
               A10protID = H001H3_A10protID[0];
               A107representane = H001H3_A107representane[0];
               n107representane = H001H3_n107representane[0];
               A106facturaNro = H001H3_A106facturaNro[0];
               n106facturaNro = H001H3_n106facturaNro[0];
               A72vendedorDsc = H001H3_A72vendedorDsc[0];
               n72vendedorDsc = H001H3_n72vendedorDsc[0];
               A9vendedorID = H001H3_A9vendedorID[0];
               A104tipOrdDsc = H001H3_A104tipOrdDsc[0];
               n104tipOrdDsc = H001H3_n104tipOrdDsc[0];
               A17tipOrdID = H001H3_A17tipOrdID[0];
               A119OrdenFch = H001H3_A119OrdenFch[0];
               n119OrdenFch = H001H3_n119OrdenFch[0];
               A22OrdenID = H001H3_A22OrdenID[0];
               A255OrdenObreSuma = H001H3_A255OrdenObreSuma[0];
               n255OrdenObreSuma = H001H3_n255OrdenObreSuma[0];
               A168OrdenValOtrs = H001H3_A168OrdenValOtrs[0];
               n168OrdenValOtrs = H001H3_n168OrdenValOtrs[0];
               A167OrdenValEstr = H001H3_A167OrdenValEstr[0];
               n167OrdenValEstr = H001H3_n167OrdenValEstr[0];
               A166OrdenValPint = H001H3_A166OrdenValPint[0];
               n166OrdenValPint = H001H3_n166OrdenValPint[0];
               A165OrdenValCal = H001H3_A165OrdenValCal[0];
               n165OrdenValCal = H001H3_n165OrdenValCal[0];
               A163OrdenValEnrq = H001H3_A163OrdenValEnrq[0];
               n163OrdenValEnrq = H001H3_n163OrdenValEnrq[0];
               A162OrdenValInds = H001H3_A162OrdenValInds[0];
               n162OrdenValInds = H001H3_n162OrdenValInds[0];
               A161OrdenSubtotal = H001H3_A161OrdenSubtotal[0];
               n161OrdenSubtotal = H001H3_n161OrdenSubtotal[0];
               A153OrdenActaPdf = H001H3_A153OrdenActaPdf[0];
               context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtOrdenActaPdf_Internalname, "URL", context.PathToRelativeUrl( A153OrdenActaPdf), !bGXsfl_20_Refreshing);
               n153OrdenActaPdf = H001H3_n153OrdenActaPdf[0];
               A152OrdenPdf = H001H3_A152OrdenPdf[0];
               context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtOrdenPdf_Internalname, "URL", context.PathToRelativeUrl( A152OrdenPdf), !bGXsfl_20_Refreshing);
               n152OrdenPdf = H001H3_n152OrdenPdf[0];
               A112documento = H001H3_A112documento[0];
               context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtdocumento_Internalname, "URL", context.PathToRelativeUrl( A112documento), !bGXsfl_20_Refreshing);
               n112documento = H001H3_n112documento[0];
               A108urlPdf = H001H3_A108urlPdf[0];
               context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edturlPdf_Internalname, "URL", context.PathToRelativeUrl( A108urlPdf), !bGXsfl_20_Refreshing);
               n108urlPdf = H001H3_n108urlPdf[0];
               A69VehiculoChasis = H001H3_A69VehiculoChasis[0];
               n69VehiculoChasis = H001H3_n69VehiculoChasis[0];
               A68VehiculoPlaca = H001H3_A68VehiculoPlaca[0];
               n68VehiculoPlaca = H001H3_n68VehiculoPlaca[0];
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         GRID_nRecordCount = H001H5_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "clientesordenproduccionwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202312119124885", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("clientesordenproduccionwc.js", "?202312119124886", false);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E131H2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[]}");
         setEventMetadata("'DOINSERT'","{handler:'E111H1',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         AV19Delete_GXI = "";
         scmdbuf = "";
         H001H3_A1EmpID = new short[1] ;
         H001H3_A5ClienteID = new short[1] ;
         H001H3_A401OrdenNroDesp = new int[1] ;
         H001H3_n401OrdenNroDesp = new bool[] {false} ;
         H001H3_A210OrdenUltSec = new short[1] ;
         H001H3_n210OrdenUltSec = new bool[] {false} ;
         H001H3_A203ordenNroPed = new int[1] ;
         H001H3_n203ordenNroPed = new bool[] {false} ;
         H001H3_A195OrdenFacNomb = new String[] {""} ;
         H001H3_n195OrdenFacNomb = new bool[] {false} ;
         H001H3_A192OrdenPed = new int[1] ;
         H001H3_n192OrdenPed = new bool[] {false} ;
         H001H3_A172OrdenfchEnt = new DateTime[] {DateTime.MinValue} ;
         H001H3_n172OrdenfchEnt = new bool[] {false} ;
         H001H3_A133OrdenProceso = new String[] {""} ;
         H001H3_n133OrdenProceso = new bool[] {false} ;
         H001H3_A132OrdenEmpFac = new short[1] ;
         H001H3_n132OrdenEmpFac = new bool[] {false} ;
         H001H3_A25OrdenAnio = new short[1] ;
         H001H3_A24OrdenPeriodo = new short[1] ;
         H001H3_A117OrdenModeloID = new short[1] ;
         H001H3_A26OrdenMarcaID = new short[1] ;
         H001H3_A116OrdenUser = new String[] {""} ;
         H001H3_n116OrdenUser = new bool[] {false} ;
         H001H3_A115OrdenEst = new String[] {""} ;
         H001H3_n115OrdenEst = new bool[] {false} ;
         H001H3_A110cantDias = new short[1] ;
         H001H3_n110cantDias = new bool[] {false} ;
         H001H3_A109fchVenta = new DateTime[] {DateTime.MinValue} ;
         H001H3_n109fchVenta = new bool[] {false} ;
         H001H3_A69VehiculoChasis = new String[] {""} ;
         H001H3_n69VehiculoChasis = new bool[] {false} ;
         H001H3_A68VehiculoPlaca = new String[] {""} ;
         H001H3_n68VehiculoPlaca = new bool[] {false} ;
         H001H3_A8VehiculoID = new short[1] ;
         H001H3_A74protDsc = new String[] {""} ;
         H001H3_n74protDsc = new bool[] {false} ;
         H001H3_A10protID = new short[1] ;
         H001H3_A107representane = new String[] {""} ;
         H001H3_n107representane = new bool[] {false} ;
         H001H3_A106facturaNro = new int[1] ;
         H001H3_n106facturaNro = new bool[] {false} ;
         H001H3_A72vendedorDsc = new String[] {""} ;
         H001H3_n72vendedorDsc = new bool[] {false} ;
         H001H3_A9vendedorID = new short[1] ;
         H001H3_A104tipOrdDsc = new String[] {""} ;
         H001H3_n104tipOrdDsc = new bool[] {false} ;
         H001H3_A17tipOrdID = new short[1] ;
         H001H3_A119OrdenFch = new DateTime[] {DateTime.MinValue} ;
         H001H3_n119OrdenFch = new bool[] {false} ;
         H001H3_A22OrdenID = new short[1] ;
         H001H3_A255OrdenObreSuma = new decimal[1] ;
         H001H3_n255OrdenObreSuma = new bool[] {false} ;
         H001H3_A168OrdenValOtrs = new decimal[1] ;
         H001H3_n168OrdenValOtrs = new bool[] {false} ;
         H001H3_A167OrdenValEstr = new decimal[1] ;
         H001H3_n167OrdenValEstr = new bool[] {false} ;
         H001H3_A166OrdenValPint = new decimal[1] ;
         H001H3_n166OrdenValPint = new bool[] {false} ;
         H001H3_A165OrdenValCal = new decimal[1] ;
         H001H3_n165OrdenValCal = new bool[] {false} ;
         H001H3_A163OrdenValEnrq = new decimal[1] ;
         H001H3_n163OrdenValEnrq = new bool[] {false} ;
         H001H3_A162OrdenValInds = new decimal[1] ;
         H001H3_n162OrdenValInds = new bool[] {false} ;
         H001H3_A161OrdenSubtotal = new decimal[1] ;
         H001H3_n161OrdenSubtotal = new bool[] {false} ;
         H001H3_A153OrdenActaPdf = new String[] {""} ;
         H001H3_n153OrdenActaPdf = new bool[] {false} ;
         H001H3_A152OrdenPdf = new String[] {""} ;
         H001H3_n152OrdenPdf = new bool[] {false} ;
         H001H3_A112documento = new String[] {""} ;
         H001H3_n112documento = new bool[] {false} ;
         H001H3_A108urlPdf = new String[] {""} ;
         H001H3_n108urlPdf = new bool[] {false} ;
         H001H5_AGRID_nRecordCount = new long[1] ;
         ...
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.clientesordenproduccionwc__default(),
            new Object[][] {
                new Object[] {
               H001H3_A1EmpID, H001H3_A5ClienteID, H001H3_A401OrdenNroDesp, H001H3_n401OrdenNroDesp, H001H3_A210OrdenUltSec, H001H3_n210OrdenUltSec, H001H3_A203ordenNroPed, H001H3_n203ordenNroPed, H001H3_A195OrdenFacNomb, H001H3_n195OrdenFacNomb,
               H001H3_A192OrdenPed, H001H3_n192OrdenPed, H001H3_A172OrdenfchEnt, H001H3_n172OrdenfchEnt, H001H3_A133OrdenProceso, H001H3_n133OrdenProceso, H001H3_A132OrdenEmpFac, H001H3_n132OrdenEmpFac, H001H3_A25OrdenAnio, H001H3_A24OrdenPeriodo,
               H001H3_A117OrdenModeloID, H001H3_A26OrdenMarcaID, H001H3_A116OrdenUser, H001H3_n116OrdenUser, H001H3_A115OrdenEst, H001H3_n115OrdenEst, H001H3_A110cantDias, H001H3_n110cantDias, H001H3_A109fchVenta, H001H3_n109fchVenta,
               H001H3_A69VehiculoChasis, H001H3_n69VehiculoChasis, H001H3_A68VehiculoPlaca, H001H3_n68VehiculoPlaca, H001H3_A8VehiculoID, H001H3_A74protDsc, H001H3_n74protDsc, H001H3_A10protID, H001H3_A107representane, H001H3_n107representane,
               H001H3_A106facturaNro, H001H3_n106facturaNro, H001H3_A72vendedorDsc, H001H3_n72vendedorDsc, H001H3_A9vendedorID, H001H3_A104tipOrdDsc, H001H3_n104tipOrdDsc, H001H3_A17tipOrdID, H001H3_A119OrdenFch, H001H3_n119OrdenFch,
               H001H3_A22OrdenID, H001H3_A255OrdenObreSuma, H001H3_n255OrdenObreSuma, H001H3_A168OrdenValOtrs, H001H3_n168OrdenValOtrs, H001H3_A167OrdenValEstr, H001H3_n167OrdenValEstr, H001H3_A166OrdenValPint, H001H3_n166OrdenValPint, H001H3_A165OrdenValCal,
               H001H3_n165OrdenValCal, H001H3_A163OrdenValEnrq, H001H3_n163OrdenValEnrq, H001H3_A162OrdenValInds, H001H3_n162OrdenValInds, H001H3_A161OrdenSubtotal, H001H3_n161OrdenSubtotal, H001H3_A153OrdenActaPdf, H001H3_n153OrdenActaPdf, H001H3_A152OrdenPdf,
               H001H3_n152OrdenPdf, H001H3_A112documento, H001H3_n112documento, H001H3_A108urlPdf, H001H3_n108urlPdf
               }
               , new Object[] {
               H001H5_AGRID_nRecordCount
               }
            }
         );
         AV17Pgmname = "ClientesOrdenProduccionWC";
      ...
      private short[] H001H3_A1EmpID ;
      private short[] H001H3_A5ClienteID ;
      private int[] H001H3_A401OrdenNroDesp ;
      private bool[] H001H3_n401OrdenNroDesp ;
      private short[] H001H3_A210OrdenUltSec ;
      private bool[] H001H3_n210OrdenUltSec ;
      private int[] H001H3_A203ordenNroPed ;
      private bool[] H001H3_n203ordenNroPed ;
      private String[] H001H3_A195OrdenFacNomb ;
      private bool[] H001H3_n195OrdenFacNomb ;
      private int[] H001H3_A192OrdenPed ;
      private bool[] H001H3_n192OrdenPed ;
      private DateTime[] H001H3_A172OrdenfchEnt ;
      private bool[] H001H3_n172OrdenfchEnt ;
      private String[] H001H3_A133OrdenProceso ;
      private bool[] H001H3_n133OrdenProceso ;
      private short[] H001H3_A132OrdenEmpFac ;
      private bool[] H001H3_n132OrdenEmpFac ;
      private short[] H001H3_A25OrdenAnio ;
      private short[] H001H3_A24OrdenPeriodo ;
      private short[] H001H3_A117OrdenModeloID ;
      private short[] H001H3_A26OrdenMarcaID ;
      private String[] H001H3_A116OrdenUser ;
      private bool[] H001H3_n116OrdenUser ;
      private String[] H001H3_A115OrdenEst ;
      private bool[] H001H3_n115OrdenEst ;
      private short[] H001H3_A110cantDias ;
      private bool[] H001H3_n110cantDias ;
      private DateTime[] H001H3_A109fchVenta ;
      private bool[] H001H3_n109fchVenta ;
      private String[] H001H3_A69VehiculoChasis ;
      private bool[] H001H3_n69VehiculoChasis ;
      private String[] H001H3_A68VehiculoPlaca ;
      private bool[] H001H3_n68VehiculoPlaca ;
      private short[] H001H3_A8VehiculoID ;
      private String[] H001H3_A74protDsc ;
      private bool[] H001H3_n74protDsc ;
      private short[] H001H3_A10protID ;
      private String[] H001H3_A107representane ;
      private bool[] H001H3_n107representane ;
      private int[] H001H3_A106facturaNro ;
      private bool[] H001H3_n106facturaNro ;
      private String[] H001H3_A72vendedorDsc ;
      private bool[] H001H3_n72vendedorDsc ;
      private short[] H001H3_A9vendedorID ;
      private String[] H001H3_A104tipOrdDsc ;
      private bool[] H001H3_n104tipOrdDsc ;
      private short[] H001H3_A17tipOrdID ;
      private DateTime[] H001H3_A119OrdenFch ;
      private bool[] H001H3_n119OrdenFch ;
      private short[] H001H3_A22OrdenID ;
      private decimal[] H001H3_A255OrdenObreSuma ;
      private bool[] H001H3_n255OrdenObreSuma ;
      private decimal[] H001H3_A168OrdenValOtrs ;
      private bool[] H001H3_n168OrdenValOtrs ;
      private decimal[] H001H3_A167OrdenValEstr ;
      private bool[] H001H3_n167OrdenValEstr ;
      private decimal[] H001H3_A166OrdenValPint ;
      private bool[] H001H3_n166OrdenValPint ;
      private decimal[] H001H3_A165OrdenValCal ;
      private bool[] H001H3_n165OrdenValCal ;
      private decimal[] H001H3_A163OrdenValEnrq ;
      private bool[] H001H3_n163OrdenValEnrq ;
      private decimal[] H001H3_A162OrdenValInds ;
      private bool[] H001H3_n162OrdenValInds ;
      private decimal[] H001H3_A161OrdenSubtotal ;
      private bool[] H001H3_n161OrdenSubtotal ;
      private String[] H001H3_A153OrdenActaPdf ;
      private bool[] H001H3_n153OrdenActaPdf ;
      private String[] H001H3_A152OrdenPdf ;
      private bool[] H001H3_n152OrdenPdf ;
      private String[] H001H3_A112documento ;
      private bool[] H001H3_n112documento ;
      private String[] H001H3_A108urlPdf ;
      private bool[] H001H3_n108urlPdf ;
      private long[] H001H5_AGRID_nRecordCount ;
   ...
   public class clientesordenproduccionwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          String cmdBufferH001H3 ;
          cmdBufferH001H3=" SELECT T1.[EmpID], T1.[ClienteID], T1.[OrdenNroDesp], T1.[OrdenUltSec], T1.[ordenNroPed], T1.[OrdenFacNomb], T1.[OrdenPed], T1.[OrdenfchEnt], T1.[OrdenProceso], T1.[OrdenEmpFac], T1.[OrdenAnio], T1.[OrdenPeriodo], T1.[OrdenModeloID], T1.[OrdenMarcaID], T1.[OrdenUser], T1.[OrdenEst], T1.[cantDias], T1.[fchVenta], T2.[VehiculoChasis], T2.[VehiculoPlaca], T1.[VehiculoID], T3.[protDsc], T1.[protID], T1.[representane], T1.[facturaNro], T4.[vendedorDsc], T1.[vendedorID], T5.[tipOrdDsc], T1.[tipOrdID], T1.[OrdenFch], T1.[OrdenID], COALESCE( T6.[OrdenObreSuma], 0) AS OrdenObreSuma, T1.[OrdenValOtrs], T1.[OrdenValEstr], T1.[OrdenValPint], T1.[OrdenValCal], T1.[OrdenValEnrq], T1.[OrdenValInds], T1.[OrdenSubtotal], T1.[OrdenActaPdf], T1.[OrdenPdf], T1.[documento], T1.[urlPdf] FROM ((((([OrdenProduccion] T1 WITH (NOLOCK) INNER JOIN [Vehiculos] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID] AND T2.[VehiculoID] = T1.[VehiculoID]) INNER JOIN [Prototipo] T3 WITH (NOLOCK) ON T3.[EmpID] = T1.[EmpID] AND T3.[protID] = T1.[protID]) INNER JOIN [Vendedor] T4 WITH (NOLOCK) ON T4.[EmpID] = T1.[EmpID] AND T4.[vendedorID] = T1.[vendedorID]) INNER JOIN [TipoOrdenPro] T5 WITH (NOLOCK) ON T5.[EmpID] = T1.[EmpID] AND T5.[tipOrdID] = T1.[tipOrdID]) LEFT JOIN (SELECT SUM([OrdenObreValor]) AS OrdenObreSuma, [EmpID], [ClienteID], [OrdenPeriodo], [OrdenAnio], [OrdenID] FROM [OrdenProduccionObr] WITH (NOLOCK) GROUP BY [EmpID], [ClienteID], [OrdenPeriodo], [OrdenAnio], [OrdenID] ) T6 ON T6.[EmpID] = T1.[EmpID] AND T6.[ClienteID] = T1.[ClienteID] AND T6.[OrdenPeriodo] = T1.[OrdenPeriodo] AND T6.[OrdenAnio] = T1.[OrdenAnio] AND T6.[OrdenID] = T1.[OrdenID]) WHERE T1.[EmpID] = @AV6EmpID and T1.[ClienteID] = @AV7ClienteID ORDER BY T1.[EmpID], T1.[ClienteID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN "
          + " @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY" ;
          Object[] prmH001H5 ;
          prmH001H5 = new Object[] {
          new Object[] {"@AV6EmpID",SqlDbType.SmallInt,4,0} ,
          new Object[] {"@AV7ClienteID",SqlDbType.SmallInt,4,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H001H3", cmdBufferH001H3,false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001H3,11,0,true,false )
             ,new CursorDef("H001H5", "SELECT COUNT(*) FROM ((((([OrdenProduccion] T1 WITH (NOLOCK) INNER JOIN [Vehiculos] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID] AND T2.[VehiculoID] = T1.[VehiculoID]) INNER JOIN [Prototipo] T4 WITH (NOLOCK) ON T4.[EmpID] = T1.[EmpID] AND T4.[protID] = T1.[protID]) INNER JOIN [Vendedor] T3 WITH (NOLOCK) ON T3.[EmpID] = T1.[EmpID] AND T3.[vendedorID] = T1.[vendedorID]) INNER JOIN [TipoOrdenPro] T5 WITH (NOLOCK) ON T5.[EmpID] = T1.[EmpID] AND T5.[tipOrdID] = T1.[tipOrdID]) LEFT JOIN (SELECT SUM([OrdenObreValor]) AS OrdenObreSuma, [EmpID], [ClienteID], [OrdenPeriodo], [OrdenAnio], [OrdenID] FROM [OrdenProduccionObr] WITH (NOLOCK) GROUP BY [EmpID], [ClienteID], [OrdenPeriodo], [OrdenAnio], [OrdenID] ) T6 ON T6.[EmpID] = T1.[EmpID] AND T6.[ClienteID] = T1.[ClienteID] AND T6.[OrdenPeriodo] = T1.[OrdenPeriodo] AND T6.[OrdenAnio] = T1.[OrdenAnio] AND T6.[OrdenID] = T1.[OrdenID]) WHERE T1.[EmpID] = @AV6EmpID and T1.[ClienteID] = @AV7ClienteID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001H5,1,0,true,false )
          };
       }
    }
