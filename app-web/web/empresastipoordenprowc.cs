/*
               File: EmpresasTipoOrdenProWC
        Description: Empresas Tipo Orden Pro WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/26/2022 20:13:25.65
...
namespace GeneXus.Programs {
   public class empresastipoordenprowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public empresastipoordenprowc( )
      {
      ...
      public empresastipoordenprowc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV16Pgmname = "EmpresasTipoOrdenProWC";
               context.Gx_err = 0;
               WS0I2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Empresas Tipo Orden Pro WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102620132571", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("empresastipoordenprowc.aspx") + "?" + UrlEncode("" +AV6EmpID)+"\">") ;
      ...
      protected void RenderHtmlCloseForm0I2( )
      {
         ...
         {
            context.AddJavascriptSource("empresastipoordenprowc.js", "?2022102620132572", false);
         }
      ...
      {
         return "EmpresasTipoOrdenProWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Empresas Tipo Orden Pro WC" ;
      }
      ...
      protected void WB0I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "empresastipoordenprowc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EmpresasTipoOrdenProWC.htm");
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A105tipOrdEst));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START0I2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Empresas Tipo Orden Pro WC", 0) ;
            }
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_TIPORDID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A17tipOrdID), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"TIPORDID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A17tipOrdID), 4, 0, ".", "")));
      }
      ...
      protected void RF0I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1EmpID = H000I2_A1EmpID[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(A1EmpID), 4, 0)));
               A105tipOrdEst = H000I2_A105tipOrdEst[0];
               n105tipOrdEst = H000I2_n105tipOrdEst[0];
               A104tipOrdDsc = H000I2_A104tipOrdDsc[0];
               n104tipOrdDsc = H000I2_n104tipOrdDsc[0];
               A17tipOrdID = H000I2_A17tipOrdID[0];
               E130I2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_TIPORDID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A17tipOrdID), "ZZZ9"), context));
      }
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("tipoordenpro.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A17tipOrdID);
         edtavDelete_Link = formatLink("tipoordenpro.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A17tipOrdID);
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 20;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("tipoordenpro.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "TipoOrdenPro";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "empresastipoordenprowc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022102620132619", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("empresastipoordenprowc.js", "?2022102620132619", false);
         }
      ...
      protected void SubsflControlProps_202( )
      {
         ...
         edttipOrdEst_Internalname = sPrefix+"TIPORDEST_"+sGXsfl_20_idx;
      ...
      protected void SubsflControlProps_fel_202( )
      {
         ...
         edttipOrdEst_Internalname = sPrefix+"TIPORDEST_"+sGXsfl_20_fel_idx;
      ...
      protected void init_default_properties( )
      {
         ...
         edttipOrdEst_Internalname = sPrefix+"TIPORDEST";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130I2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A17tipOrdID',fld:'TIPORDID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110I2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A17tipOrdID',fld:'TIPORDID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV18Delete_GXI = "";
         scmdbuf = "";
         H000I2_A1EmpID = new short[1] ;
         H000I2_A105tipOrdEst = new String[] {""} ;
         H000I2_n105tipOrdEst = new bool[] {false} ;
         H000I2_A104tipOrdDsc = new String[] {""} ;
         H000I2_n104tipOrdDsc = new bool[] {false} ;
         H000I2_A17tipOrdID = new short[1] ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.empresastipoordenprowc__default(),
            new Object[][] {
                new Object[] {
               H000I2_A1EmpID, H000I2_A105tipOrdEst, H000I2_n105tipOrdEst, H000I2_A104tipOrdDsc, H000I2_n104tipOrdDsc, H000I2_A17tipOrdID
               }
               , new Object[] {
      ...
      private short[] H000I2_A1EmpID ;
      private String[] H000I2_A105tipOrdEst ;
      private bool[] H000I2_n105tipOrdEst ;
      private String[] H000I2_A104tipOrdDsc ;
      private bool[] H000I2_n104tipOrdDsc ;
      private short[] H000I2_A17tipOrdID ;
   ...
   public class empresastipoordenprowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000I2", "SELECT [EmpID], [tipOrdEst], [tipOrdDsc], [tipOrdID] FROM [TipoOrdenPro] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ORDER BY [EmpID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000I2,11,0,true,false )
             ,new CursorDef("H000I3", "SELECT COUNT(*) FROM [TipoOrdenPro] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000I3,1,0,true,false )
          };
       }
    }
