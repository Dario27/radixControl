/*
       ...
       Generated on: 9/7/2022 0:20:43.56
...
namespace GeneXus.Programs {
   public class gx01j0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public void execute( out short aP0_pEmpID ,
                           ...
                           out short aP2_pdetTipoProdID ,
                           out short aP3_pcategID )
      {
         this.AV13pEmpID = 0 ;
         this.AV14pPrdCod = 0 ;
         this.AV15pdetTipoProdID = 0 ;
         this.AV16pcategID = 0 ;
         executePrivate();
         aP0_pEmpID=this.AV13pEmpID;
         aP1_pPrdCod=this.AV14pPrdCod;
         aP2_pdetTipoProdID=this.AV15pdetTipoProdID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV8cdetTipoProdID = (short)(NumberUtil.Val( GetNextPar( ), "."));
               AV9ccategID = (short)(NumberUtil.Val( GetNextPar( ), "."));
               AV10cPrdDesc = GetNextPar( );
               AV11cPrdPres = (short)(NumberUtil.Val( GetNextPar( ), "."));
               AV12cPrdEstado = GetNextPar( );
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cEmpID, AV7cPrdCod, AV8cdetTipoProdID, AV9ccategID, AV10cPrdDesc, AV11cPrdPres, AV12cPrdEstado) ;
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               {
                  AV14pPrdCod = (short)(NumberUtil.Val( GetNextPar( ), "."));
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV14pPrdCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV14pPrdCod), 4, 0)));
                  AV15pdetTipoProdID = (short)(NumberUtil.Val( GetNextPar( ), "."));
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV15pdetTipoProdID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV15pdetTipoProdID), 4, 0)));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022970204363", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx01j0.aspx") + "?" + UrlEncode("" +AV13pEmpID) + "," + UrlEncode("" +AV14pPrdCod) + "," + UrlEncode("" +AV15pdetTipoProdID) + "," + UrlEncode("" +AV16pcategID)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCDETTIPOPRODID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cdetTipoProdID), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCCATEGID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9ccategID), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCPRDDESC", AV10cPrdDesc);
         GxWebStd.gx_hidden_field( context, "GXH_vCPRDPRES", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11cPrdPres), 2, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCPRDESTADO", StringUtil.RTrim( AV12cPrdEstado));
         /* Send saved values. */
         ...
         GxWebStd.gx_hidden_field( context, "vPPRDCOD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV14pPrdCod), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vPDETTIPOPRODID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV15pdetTipoProdID), 4, 0, ",", "")));
      ...
      {
         return formatLink("gx01j0.aspx") + "?" + UrlEncode("" +AV13pEmpID) + "," + UrlEncode("" +AV14pPrdCod) + "," + UrlEncode("" +AV15pdetTipoProdID) + "," + UrlEncode("" +AV16pcategID) ;
      }
      ...
      protected void WB4F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblempidfilter_Internalname, "Emp ID", "", "", lblLblempidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e114f1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01J0.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCempid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cEmpID), 4, 0, ",", "")), ((edtavCempid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6cEmpID), "ZZZ9")) : context.localUtil.Format( (decimal)(AV6cEmpID), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCempid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCempid_Visible, edtavCempid_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprdcodfilter_Internalname, "ID", "", "", lblLblprdcodfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e124f1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprdcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7cPrdCod), 4, 0, ",", "")), ((edtavCprdcod_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV7cPrdCod), "ZZZ9")) : context.localUtil.Format( (decimal)(AV7cPrdCod), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprdcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprdcod_Visible, edtavCprdcod_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbldettipoprodidfilter_Internalname, "Tipo Prod", "", "", lblLbldettipoprodidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e134f1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCdettipoprodid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cdetTipoProdID), 4, 0, ",", "")), ((edtavCdettipoprodid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV8cdetTipoProdID), "ZZZ9")) : context.localUtil.Format( (decimal)(AV8cdetTipoProdID), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCdettipoprodid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCdettipoprodid_Visible, edtavCdettipoprodid_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcategidfilter_Internalname, "Categ.ID", "", "", lblLblcategidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e144f1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcategid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9ccategID), 4, 0, ",", "")), ((edtavCcategid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV9ccategID), "ZZZ9")) : context.localUtil.Format( (decimal)(AV9ccategID), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcategid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcategid_Visible, edtavCcategid_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprddescfilter_Internalname, "Prd Desc", "", "", lblLblprddescfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e154f1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprddesc_Internalname, AV10cPrdDesc, StringUtil.RTrim( context.localUtil.Format( AV10cPrdDesc, "")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprddesc_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprddesc_Visible, edtavCprddesc_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_Gx01J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprdpresfilter_Internalname, "Presentacion", "", "", lblLblprdpresfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e164f1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprdpres_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11cPrdPres), 2, 0, ",", "")), ((edtavCprdpres_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV11cPrdPres), "Z9")) : context.localUtil.Format( (decimal)(AV11cPrdPres), "Z9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprdpres_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprdpres_Visible, edtavCprdpres_Enabled, 0, "text", "", 2, "chr", 1, "row", 2, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprdestadofilter_Internalname, "Estado", "", "", lblLblprdestadofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e174f1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprdestado_Internalname, StringUtil.RTrim( AV12cPrdEstado), StringUtil.RTrim( context.localUtil.Format( AV12cPrdEstado, "")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprdestado_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprdestado_Visible, edtavCprdestado_Enabled, 0, "text", "", 1, "chr", 1, "row", 1, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_Gx01J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(84), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e184f1_client"+"'", TempTags, "", 2, "HLP_Gx01J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 84 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(84), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx01J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCDETTIPOPRODID"), ",", ".") != Convert.ToDecimal( AV8cdetTipoProdID )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       ...
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCPRDDESC"), AV10cPrdDesc) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Cprdpres Changed */
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCPRDPRES"), ",", ".") != Convert.ToDecimal( AV11cPrdPres )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Cprdestado Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCPRDESTADO"), AV12cPrdEstado) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void gxgrGrid1_refresh( int subGrid1_Rows ,
                                        short AV6cEmpID ,
                                        short AV7cPrdCod ,
                                        short AV8cdetTipoProdID ,
                                        short AV9ccategID ,
                                        String AV10cPrdDesc ,
                                        short AV11cPrdPres ,
                                        String AV12cPrdEstado )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void RF4F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV9ccategID } ,
                                                 new int[]{
                                                 TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.STRING, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.SHORT,
                                                 TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT
                                                 }
            } ) ;
            lV10cPrdDesc = StringUtil.Concat( StringUtil.RTrim( AV10cPrdDesc), "%", "");
            lV12cPrdEstado = StringUtil.PadR( StringUtil.RTrim( AV12cPrdEstado), 1, "%");
            /* Using cursor H004F2 */
            pr_default.execute(0, new Object[] {AV6cEmpID, AV7cPrdCod, AV8cdetTipoProdID, AV9ccategID, lV10cPrdDesc, AV11cPrdPres, lV12cPrdEstado, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_84_idx = 1;
            sGXsfl_84_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_84_idx), 4, 0)), 4, "0");
            SubsflControlProps_842( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A289PrdEstado = H004F2_A289PrdEstado[0];
               n289PrdEstado = H004F2_n289PrdEstado[0];
               A288PrdPres = H004F2_A288PrdPres[0];
               n288PrdPres = H004F2_n288PrdPres[0];
               A287PrdDesc = H004F2_A287PrdDesc[0];
               n287PrdDesc = H004F2_n287PrdDesc[0];
               A32categID = H004F2_A32categID[0];
               A36detTipoProdID = H004F2_A36detTipoProdID[0];
               A286PrdCod = H004F2_A286PrdCod[0];
               A1EmpID = H004F2_A1EmpID[0];
               /* Execute user event: Load */
               E204F2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         lV12cPrdEstado = StringUtil.PadR( StringUtil.RTrim( AV12cPrdEstado), 1, "%");
         /* Using cursor H004F3 */
         pr_default.execute(1, new Object[] {AV6cEmpID, AV7cPrdCod, AV8cdetTipoProdID, AV9ccategID, lV10cPrdDesc, AV11cPrdPres, lV12cPrdEstado});
         GRID1_nRecordCount = H004F3_AGRID1_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUP4F0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCdettipoprodid_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCdettipoprodid_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV8cdetTipoProdID = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cdetTipoProdID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV8cdetTipoProdID), 4, 0)));
            }
            else
            {
               AV8cdetTipoProdID = (short)(context.localUtil.CToN( cgiGet( edtavCdettipoprodid_Internalname), ",", "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cdetTipoProdID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV8cdetTipoProdID), 4, 0)));
            }
            ...
            AV10cPrdDesc = cgiGet( edtavCprddesc_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10cPrdDesc", AV10cPrdDesc);
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCprdpres_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCprdpres_Internalname), ",", ".") > Convert.ToDecimal( 99 )) ) )
            {
               ...
               wbErr = true;
               AV11cPrdPres = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11cPrdPres", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11cPrdPres), 2, 0)));
            }
            else
            {
               AV11cPrdPres = (short)(context.localUtil.CToN( cgiGet( edtavCprdpres_Internalname), ",", "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11cPrdPres", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11cPrdPres), 2, 0)));
            }
            AV12cPrdEstado = cgiGet( edtavCprdestado_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12cPrdEstado", AV12cPrdEstado);
            /* Read saved values. */
      ...
      protected void E214F2( )
      {
         ...
         AV13pEmpID = A1EmpID;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13pEmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13pEmpID), 4, 0)));
         AV14pPrdCod = A286PrdCod;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV14pPrdCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV14pPrdCod), 4, 0)));
         AV15pdetTipoProdID = A36detTipoProdID;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV15pdetTipoProdID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV15pdetTipoProdID), 4, 0)));
         AV16pcategID = A32categID;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV16pcategID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV16pcategID), 4, 0)));
         context.setWebReturnParms(new Object[] {(short)AV13pEmpID,(short)AV14pPrdCod,(short)AV15pdetTipoProdID,(short)AV16pcategID});
         context.setWebReturnParmsMetadata(new Object[] {"AV13pEmpID","AV14pPrdCod","AV15pdetTipoProdID","AV16pcategID"});
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13pEmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13pEmpID), 4, 0)));
         AV14pPrdCod = Convert.ToInt16(getParm(obj,1));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV14pPrdCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV14pPrdCod), 4, 0)));
         AV15pdetTipoProdID = Convert.ToInt16(getParm(obj,2));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV15pdetTipoProdID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV15pdetTipoProdID), 4, 0)));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022970204494", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx01j0.js", "?2022970204494", false);
      ...
      protected void sendrow_842( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_84_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A1EmpID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A286PrdCod), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A36detTipoProdID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A32categID), 4, 0, ",", "")))+"'"+"]);";
            ...
            edtPrdDesc_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A1EmpID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A286PrdCod), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A36detTipoProdID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A32categID), 4, 0, ",", "")))+"'"+"]);";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cEmpID',fld:'vCEMPID',pic:'ZZZ9'},{av:'AV7cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV8cdetTipoProdID',fld:'vCDETTIPOPRODID',pic:'ZZZ9'},{av:'AV9ccategID',fld:'vCCATEGID',pic:'ZZZ9'},{av:'AV10cPrdDesc',fld:'vCPRDDESC',pic:''},{av:'AV11cPrdPres',fld:'vCPRDPRES',pic:'Z9'},{av:'AV12cPrdEstado',fld:'vCPRDESTADO',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E184F1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLEMPIDFILTER.CLICK","{handler:'E114F1',iparms:[{av:'divEmpidfiltercontainer_Class',ctrl:'EMPIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRDCODFILTER.CLICK","{handler:'E124F1',iparms:[{av:'divPrdcodfiltercontainer_Class',ctrl:'PRDCODFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLDETTIPOPRODIDFILTER.CLICK","{handler:'E134F1',iparms:[{av:'divDettipoprodidfiltercontainer_Class',ctrl:'DETTIPOPRODIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLCATEGIDFILTER.CLICK","{handler:'E144F1',iparms:[{av:'divCategidfiltercontainer_Class',ctrl:'CATEGIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRDDESCFILTER.CLICK","{handler:'E154F1',iparms:[{av:'divPrddescfiltercontainer_Class',ctrl:'PRDDESCFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRDPRESFILTER.CLICK","{handler:'E164F1',iparms:[{av:'divPrdpresfiltercontainer_Class',ctrl:'PRDPRESFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRDESTADOFILTER.CLICK","{handler:'E174F1',iparms:[{av:'divPrdestadofiltercontainer_Class',ctrl:'PRDESTADOFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E214F2',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A286PrdCod',fld:'PRDCOD',pic:'ZZZ9',hsh:true},{av:'A36detTipoProdID',fld:'DETTIPOPRODID',pic:'ZZZ9',hsh:true},{av:'A32categID',fld:'CATEGID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV13pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV14pPrdCod',fld:'vPPRDCOD',pic:'ZZZ9'},{av:'AV15pdetTipoProdID',fld:'vPDETTIPOPRODID',pic:'ZZZ9'},{av:'AV16pcategID',fld:'vPCATEGID',pic:'ZZZ9'}]}");
      ...
      public override void initialize( )
      {
         ...
         lV10cPrdDesc = "";
         lV12cPrdEstado = "";
         H004F2_A289PrdEstado = new String[] {""} ;
         H004F2_n289PrdEstado = new bool[] {false} ;
         H004F2_A288PrdPres = new short[1] ;
         H004F2_n288PrdPres = new bool[] {false} ;
         H004F2_A287PrdDesc = new String[] {""} ;
         H004F2_n287PrdDesc = new bool[] {false} ;
         H004F2_A32categID = new short[1] ;
         H004F2_A36detTipoProdID = new short[1] ;
         H004F2_A286PrdCod = new short[1] ;
         H004F2_A1EmpID = new short[1] ;
         H004F3_AGRID1_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx01j0__default(),
            new Object[][] {
                new Object[] {
               H004F2_A289PrdEstado, H004F2_n289PrdEstado, H004F2_A288PrdPres, H004F2_n288PrdPres, H004F2_A287PrdDesc, H004F2_n287PrdDesc, H004F2_A32categID, H004F2_A36detTipoProdID, H004F2_A286PrdCod, H004F2_A1EmpID
               }
               , new Object[] {
               H004F3_AGRID1_nRecordCount
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short AV8cdetTipoProdID ;
      private short AV9ccategID ;
      private short AV11cPrdPres ;
      private short AV13pEmpID ;
      private short AV14pPrdCod ;
      private short AV15pdetTipoProdID ;
      ...
      private String[] H004F2_A289PrdEstado ;
      private bool[] H004F2_n289PrdEstado ;
      private short[] H004F2_A288PrdPres ;
      private bool[] H004F2_n288PrdPres ;
      private String[] H004F2_A287PrdDesc ;
      private bool[] H004F2_n287PrdDesc ;
      private short[] H004F2_A32categID ;
      private short[] H004F2_A36detTipoProdID ;
      private short[] H004F2_A286PrdCod ;
      private short[] H004F2_A1EmpID ;
      private long[] H004F3_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short aP0_pEmpID ;
      private short aP1_pPrdCod ;
      private short aP2_pdetTipoProdID ;
   ...
   {
      protected Object[] conditional_H004F2( IGxContext context ,
                                             String AV10cPrdDesc ,
                                             short AV11cPrdPres ,
                                             String AV12cPrdEstado ,
                                             String A287PrdDesc ,
                                             ...
                                             short AV9ccategID )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " [PrdEstado], [PrdPres], [PrdDesc], [categID], [detTipoProdID], [PrdCod], [EmpID]";
         sFromString = " FROM [Productos] WITH (NOLOCK)";
         sOrderString = "";
         sWhereString = sWhereString + " WHERE ([EmpID] >= @AV6cEmpID and [PrdCod] >= @AV7cPrdCod and [detTipoProdID] >= @AV8cdetTipoProdID and [categID] >= @AV9ccategID)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV10cPrdDesc)) )
         {
            sWhereString = sWhereString + " and ([PrdDesc] like @lV10cPrdDesc)";
         }
         else
         {
            GXv_int1[4] = 1;
         ...
         if ( ! (0==AV11cPrdPres) )
         {
            sWhereString = sWhereString + " and ([PrdPres] >= @AV11cPrdPres)";
         }
         else
         {
            GXv_int1[5] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV12cPrdEstado)) )
         {
            sWhereString = sWhereString + " and ([PrdEstado] like @lV12cPrdEstado)";
         }
         else
         {
            GXv_int1[6] = 1;
         }
         sOrderString = sOrderString + " ORDER BY [EmpID], [PrdCod], [detTipoProdID], [categID]";
                                             ...
                                             short AV9ccategID )
      {
         ...
         scmdbuf = scmdbuf + " WHERE ([EmpID] >= @AV6cEmpID and [PrdCod] >= @AV7cPrdCod and [detTipoProdID] >= @AV8cdetTipoProdID and [categID] >= @AV9ccategID)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV10cPrdDesc)) )
         {
            sWhereString = sWhereString + " and ([PrdDesc] like @lV10cPrdDesc)";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004F2(context, (String)dynConstraints[0] , (short)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (short)dynConstraints[4] , (String)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] );
               case 1 :
                     return conditional_H004F3(context, (String)dynConstraints[0] , (short)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (short)dynConstraints[4] , (String)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV8cdetTipoProdID",SqlDbType.SmallInt,4,0} ,
          new Object[] {"@AV9ccategID",SqlDbType.SmallInt,4,0} ,
          new Object[] {"@lV10cPrdDesc",SqlDbType.VarChar,80,0} ,
          new Object[] {"@AV11cPrdPres",SqlDbType.SmallInt,2,0} ,
          new Object[] {"@lV12cPrdEstado",SqlDbType.Char,1,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H004F2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004F2,11,0,false,false )
             ,new CursorDef("H004F3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004F3,1,0,false,false )
          };
       }
    }
