/*
               File: WWEmpresas
        Description: Work With Empresas
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/26/2022 20:14:52.38
...
namespace GeneXus.Programs {
   public class wwempresas : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      public wwempresas( )
      {
      ...
      public wwempresas( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13empdsc, AV19Pgmname, AV14Update, AV15Delete) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102620145244", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwempresas.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vEMPDSC", AV13empdsc);
         /* Send saved values. */
      ...
      protected void WB0B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Empresas", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_WWEmpresas.htm");
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWEmpresas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavEmpdsc_Internalname, "empdsc", "col-sm-3 FilterSearchAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavEmpdsc_Internalname, AV13empdsc, StringUtil.RTrim( context.localUtil.Format( AV13empdsc, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Empresa", edtavEmpdsc_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavEmpdsc_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_WWEmpresas.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A45EmpEst));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A97emplogo));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
                        ...
                        if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false;
                                    /* Set Refresh If Empdsc Changed */
                                    if ( StringUtil.StrCmp(cgiGet( "GXH_vEMPDSC"), AV13empdsc) != 0 )
                                    {
                                       Rfr0gs = true;
                                    }
                                    if ( ! Rfr0gs )
      ...
      protected void PA0B2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavEmpdsc_Internalname;
      ...
      protected void RF0B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13empdsc = StringUtil.Concat( StringUtil.RTrim( AV13empdsc), "%", "");
            /* Using cursor H000B2 */
            pr_default.execute(0, new Object[] {lV13empdsc, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_25_idx), 4, 0)), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               A97emplogo = H000B2_A97emplogo[0];
               n97emplogo = H000B2_n97emplogo[0];
               A45EmpEst = H000B2_A45EmpEst[0];
               n45EmpEst = H000B2_n45EmpEst[0];
               A44empdsc = H000B2_A44empdsc[0];
               n44empdsc = H000B2_n44empdsc[0];
               A1EmpID = H000B2_A1EmpID[0];
               E140B2 ();
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         lV13empdsc = StringUtil.Concat( StringUtil.RTrim( AV13empdsc), "%", "");
         /* Using cursor H000B3 */
         pr_default.execute(1, new Object[] {lV13empdsc});
      ...
      protected void STRUP0B0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13empdsc = StringUtil.Upper( cgiGet( edtavEmpdsc_Internalname));
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13empdsc", AV13empdsc);
            /* Read saved values. */
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("empresas.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A1EmpID);
         edtavDelete_Link = formatLink("empresas.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A1EmpID);
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 25;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("empresas.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13empdsc = ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13empdsc", AV13empdsc);
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = AV13empdsc;
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext.gxTpr_Transactionname = "Empresas";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022102620145295", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwempresas.js", "?2022102620145295", false);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtEmpEst_Internalname = "EMPEST_"+sGXsfl_25_idx;
         edtemplogo_Internalname = "EMPLOGO_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtEmpEst_Internalname = "EMPEST_"+sGXsfl_25_fel_idx;
         edtemplogo_Internalname = "EMPLOGO_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtemplogo_Internalname,StringUtil.RTrim( A97emplogo),(String)"",(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtemplogo_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)80,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void init_default_properties( )
      {
         ...
         edtavEmpdsc_Internalname = "vEMPDSC";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavEmpdsc_Jsonclick = "";
         edtavEmpdsc_Enabled = 1;
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13empdsc = "";
         H000B2_A97emplogo = new String[] {""} ;
         H000B2_n97emplogo = new bool[] {false} ;
         H000B2_A45EmpEst = new String[] {""} ;
         H000B2_n45EmpEst = new bool[] {false} ;
         H000B2_A44empdsc = new String[] {""} ;
         H000B2_n44empdsc = new bool[] {false} ;
         H000B2_A1EmpID = new short[1] ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwempresas__default(),
            new Object[][] {
                new Object[] {
               H000B2_A97emplogo, H000B2_n97emplogo, H000B2_A45EmpEst, H000B2_n45EmpEst, H000B2_A44empdsc, H000B2_n44empdsc, H000B2_A1EmpID
               }
               , new Object[] {
      ...
      private int edtavEmpdsc_Enabled ;
      ...
      private String edtavEmpdsc_Internalname ;
      private String edtavEmpdsc_Jsonclick ;
      ...
      private String[] H000B2_A97emplogo ;
      private bool[] H000B2_n97emplogo ;
      private String[] H000B2_A45EmpEst ;
      private bool[] H000B2_n45EmpEst ;
      private String[] H000B2_A44empdsc ;
      private bool[] H000B2_n44empdsc ;
      private short[] H000B2_A1EmpID ;
   ...
   public class wwempresas__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A44empdsc )
      {
         ...
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13empdsc)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and ([empdsc] like @lV13empdsc)";
            }
            else
            {
               sWhereString = sWhereString + " ([empdsc] like @lV13empdsc)";
            }
         }
         else
         {
         ...
         sOrderString = sOrderString + " ORDER BY [empdsc]";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV13empdsc",SqlDbType.VarChar,100,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000B2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B2,11,0,true,false )
             ,new CursorDef("H000B3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B3,1,0,true,false )
          };
       }
    }
