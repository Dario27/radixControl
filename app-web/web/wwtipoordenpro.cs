/*
               File: WWTipoOrdenPro
        Description: Work With Tipo Orden
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/26/2022 20:15:5.70
...
namespace GeneXus.Programs {
   public class wwtipoordenpro : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      public wwtipoordenpro( )
      {
      ...
      public wwtipoordenpro( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV16tipOrdDsc, AV23Pgmname, AV19Update, AV7Delete, AV20usuCod) ;
            ...
            {
               AV8empID = (short)(NumberUtil.Val( gxfirstwebparm, "."));
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202210262015578", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwtipoordenpro.aspx") + "?" + UrlEncode("" +AV8empID) + "," + UrlEncode("" +AV6ageID) + "," + UrlEncode(StringUtil.RTrim(AV20usuCod))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vTIPORDDSC", StringUtil.RTrim( AV16tipOrdDsc));
         /* Send saved values. */
      ...
      {
         return "WWTipoOrdenPro" ;
      }

      public override String GetPgmdesc( )
      {
         return "Work With Tipo Orden" ;
      }
      ...
      protected void WB1J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Tipo Ordenes", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_WWTipoOrdenPro.htm");
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWTipoOrdenPro.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavTiporddsc_Internalname, "tip Ord Dsc", "col-sm-3 FilterSearchAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTiporddsc_Internalname, StringUtil.RTrim( AV16tipOrdDsc), StringUtil.RTrim( context.localUtil.Format( AV16tipOrdDsc, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Descripcion", edtavTiporddsc_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavTiporddsc_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_WWTipoOrdenPro.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START1J2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Work With Tipo Orden", 0) ;
         }
         context.wjLoc = "";
                        ...
                        if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false;
                                    /* Set Refresh If Tiporddsc Changed */
                                    if ( StringUtil.StrCmp(cgiGet( "GXH_vTIPORDDSC"), AV16tipOrdDsc) != 0 )
                                    {
                                       Rfr0gs = true;
                                    }
                                    if ( ! Rfr0gs )
      ...
      protected void PA1J2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavTiporddsc_Internalname;
      ...
      protected void RF1J2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV16tipOrdDsc = StringUtil.PadR( StringUtil.RTrim( AV16tipOrdDsc), 40, "%");
            /* Using cursor H001J2 */
            pr_default.execute(0, new Object[] {lV16tipOrdDsc, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_25_idx), 4, 0)), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               A105tipOrdEst = H001J2_A105tipOrdEst[0];
               n105tipOrdEst = H001J2_n105tipOrdEst[0];
               A104tipOrdDsc = H001J2_A104tipOrdDsc[0];
               n104tipOrdDsc = H001J2_n104tipOrdDsc[0];
               A17tipOrdID = H001J2_A17tipOrdID[0];
               A44empdsc = H001J2_A44empdsc[0];
               n44empdsc = H001J2_n44empdsc[0];
               A1EmpID = H001J2_A1EmpID[0];
               A44empdsc = H001J2_A44empdsc[0];
               n44empdsc = H001J2_n44empdsc[0];
               E141J2 ();
      ...
      protected void send_integrity_lvl_hashes1J2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_TIPORDID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A17tipOrdID), "ZZZ9"), context));
      }
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         lV16tipOrdDsc = StringUtil.PadR( StringUtil.RTrim( AV16tipOrdDsc), 40, "%");
         /* Using cursor H001J3 */
         pr_default.execute(1, new Object[] {lV16tipOrdDsc});
      ...
      protected void STRUP1J0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV16tipOrdDsc = StringUtil.Upper( cgiGet( edtavTiporddsc_Internalname));
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV16tipOrdDsc", AV16tipOrdDsc);
            /* Read saved values. */
      ...
      protected void E121J2( )
      {
         ...
         GXt_char1 = AV14rolUser;
         new obtrolusuario(context ).execute(  AV20usuCod, out  GXt_char1) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV20usuCod", AV20usuCod);
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vUSUCOD", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV20usuCod, "")), context));
         AV14rolUser = GXt_char1;
         if ( StringUtil.StrCmp(AV14rolUser, "VEND") != 0 )
         {
            AV19Update = "Modificar";
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, edtavUpdate_Internalname, AV19Update);
         }
         AV7Delete = "Eliminar";
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, edtavDelete_Internalname, AV7Delete);
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("tipoordenpro.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A17tipOrdID);
         edtavDelete_Link = formatLink("tipoordenpro.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A17tipOrdID);
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 25;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("tipoordenpro.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S122( )
      {
         ...
         {
            AV10GridState.FromXml(AV15Session.Get(AV23Pgmname+"GridState"), null, "GridState", "KBCalpesa22");
            if ( AV10GridState.gxTpr_Filtervalues.Count >= 1 )
            {
               AV16tipOrdDsc = ((SdtGridState_FilterValue)AV10GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV16tipOrdDsc", AV16tipOrdDsc);
            }
            if ( AV10GridState.gxTpr_Currentpage > 0 )
            {
               AV9GridPageCount = subGrid_Pagecount( );
               if ( ( AV9GridPageCount > 0 ) && ( AV9GridPageCount < AV10GridState.gxTpr_Currentpage ) )
               {
      ...
      protected void S132( )
      {
         ...
         AV11GridStateFilterValue.gxTpr_Value = AV16tipOrdDsc;
         AV10GridState.gxTpr_Filtervalues.Add(AV11GridStateFilterValue, 0);
         AV15Session.Set(AV23Pgmname+"GridState", AV10GridState.ToXml(false, true, "GridState", "KBCalpesa22"));
      }
      ...
      protected void S112( )
      {
         ...
         AV17TrnContext.gxTpr_Callerurl = AV12HTTPRequest.ScriptName+"?"+AV12HTTPRequest.QueryString;
         AV17TrnContext.gxTpr_Transactionname = "TipoOrdenPro";
         AV15Session.Set("TrnContext", AV17TrnContext.ToXml(false, true, "TransactionContext", "KBCalpesa22"));
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV8empID = Convert.ToInt16(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8empID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV8empID), 4, 0)));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202210262015631", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwtipoordenpro.js", "?202210262015631", false);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edttipOrdID_Internalname = "TIPORDID_"+sGXsfl_25_idx;
         edttipOrdDsc_Internalname = "TIPORDDSC_"+sGXsfl_25_idx;
         edttipOrdEst_Internalname = "TIPORDEST_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edttipOrdID_Internalname = "TIPORDID_"+sGXsfl_25_fel_idx;
         edttipOrdDsc_Internalname = "TIPORDDSC_"+sGXsfl_25_fel_idx;
         edttipOrdEst_Internalname = "TIPORDEST_"+sGXsfl_25_fel_idx;
      ...
      protected void init_default_properties( )
      {
         ...
         edtavTiporddsc_Internalname = "vTIPORDDSC";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavTiporddsc_Jsonclick = "";
         edtavTiporddsc_Enabled = 1;
         Form.Caption = "Work With Tipo Orden";
         subGrid_Rows = 10;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV19Update',fld:'vUPDATE',pic:''},{av:'AV7Delete',fld:'vDELETE',pic:''},{av:'AV23Pgmname',fld:'vPGMNAME',pic:''},{av:'AV16tipOrdDsc',fld:'vTIPORDDSC',pic:'@!'},{av:'AV20usuCod',fld:'vUSUCOD',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E141J2',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A17tipOrdID',fld:'TIPORDID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E111J2',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A17tipOrdID',fld:'TIPORDID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV19Update',fld:'vUPDATE',pic:''},{av:'AV7Delete',fld:'vDELETE',pic:''},{av:'AV20usuCod',fld:'vUSUCOD',pic:'',hsh:true},{av:'AV23Pgmname',fld:'vPGMNAME',pic:''},{av:'AV16tipOrdDsc',fld:'vTIPORDDSC',pic:'@!'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV16tipOrdDsc = "";
         H001J2_A105tipOrdEst = new String[] {""} ;
         H001J2_n105tipOrdEst = new bool[] {false} ;
         H001J2_A104tipOrdDsc = new String[] {""} ;
         H001J2_n104tipOrdDsc = new bool[] {false} ;
         H001J2_A17tipOrdID = new short[1] ;
         H001J2_A44empdsc = new String[] {""} ;
         H001J2_n44empdsc = new bool[] {false} ;
         H001J2_A1EmpID = new short[1] ;
         H001J3_AGRID_nRecordCount = new long[1] ;
         AV14rolUser = "";
         GXt_char1 = "";
         GridRow = new GXWebRow();
         AV12HTTPRequest = new GxHttpRequest( context);
         AV10GridState = new SdtGridState(context);
         ...
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwtipoordenpro__default(),
            new Object[][] {
                new Object[] {
               H001J2_A105tipOrdEst, H001J2_n105tipOrdEst, H001J2_A104tipOrdDsc, H001J2_n104tipOrdDsc, H001J2_A17tipOrdID, H001J2_A44empdsc, H001J2_n44empdsc, H001J2_A1EmpID
               }
               , new Object[] {
      ...
      private int edtavTiporddsc_Enabled ;
      ...
      private String edtavTiporddsc_Internalname ;
      private String edtavTiporddsc_Jsonclick ;
      ...
      private String lV16tipOrdDsc ;
      private String AV14rolUser ;
      ...
      private String[] H001J2_A105tipOrdEst ;
      private bool[] H001J2_n105tipOrdEst ;
      private String[] H001J2_A104tipOrdDsc ;
      private bool[] H001J2_n104tipOrdDsc ;
      private short[] H001J2_A17tipOrdID ;
      private String[] H001J2_A44empdsc ;
      private bool[] H001J2_n44empdsc ;
      private short[] H001J2_A1EmpID ;
      private long[] H001J3_AGRID_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GxHttpRequest AV12HTTPRequest ;
      private SdtGridState AV10GridState ;
      private SdtGridState_FilterValue AV11GridStateFilterValue ;
      private SdtTransactionContext AV17TrnContext ;
   }

   public class wwtipoordenpro__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A104tipOrdDsc )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " T1.[tipOrdEst], T1.[tipOrdDsc], T1.[tipOrdID], T2.[empdsc], T1.[EmpID]";
         sFromString = " FROM ([TipoOrdenPro] T1 WITH (NOLOCK) INNER JOIN [Empresas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16tipOrdDsc)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and (T1.[tipOrdDsc] like @lV16tipOrdDsc)";
            }
            else
            {
               sWhereString = sWhereString + " (T1.[tipOrdDsc] like @lV16tipOrdDsc)";
            }
         }
         else
         {
         ...
         sOrderString = sOrderString + " ORDER BY T1.[tipOrdID]";
                                             ...
                                             String A104tipOrdDsc )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([TipoOrdenPro] T1 WITH (NOLOCK) INNER JOIN [Empresas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV16tipOrdDsc)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV16tipOrdDsc",SqlDbType.Char,40,0} ,
