/*
               File: ClientesDespBodegaWC
        Description: Clientes Desp Bodega WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 1/23/2023 1:6:29.23
...
namespace GeneXus.Programs {
   public class clientesdespbodegawc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public clientesdespbodegawc( )
      {
      ...
      public clientesdespbodegawc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "ClientesDespBodegaWC";
               context.Gx_err = 0;
               WS5V2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Clientes Desp Bodega WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2023123162929", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("clientesdespbodegawc.aspx") + "?" + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +AV7ClienteID)+"\">") ;
      ...
      protected void RenderHtmlCloseForm5V2( )
      {
         ...
         {
            context.AddJavascriptSource("clientesdespbodegawc.js", "?2023123162932", false);
         }
      ...
      {
         return "ClientesDespBodegaWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Clientes Desp Bodega WC" ;
      }
      ...
      protected void WB5V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "clientesdespbodegawc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ClientesDespBodegaWC.htm");
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A353DespBodNro), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A22OrdenID), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A399DespBodUltReg), 6, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A402DespachadoOK));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START5V2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Clientes Desp Bodega WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_DESPBODNRO", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A353DespBodNro), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"DESPBODNRO", StringUtil.LTrim( StringUtil.NToC( (decimal)(A353DespBodNro), 4, 0, ".", "")));
      ...
      protected void RF5V2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               ...
               A402DespachadoOK = H005V2_A402DespachadoOK[0];
               n402DespachadoOK = H005V2_n402DespachadoOK[0];
               A399DespBodUltReg = H005V2_A399DespBodUltReg[0];
               n399DespBodUltReg = H005V2_n399DespBodUltReg[0];
               A22OrdenID = H005V2_A22OrdenID[0];
               A353DespBodNro = H005V2_A353DespBodNro[0];
               A217BodDsc = H005V2_A217BodDsc[0];
               n217BodDsc = H005V2_n217BodDsc[0];
               A42BodCod = H005V2_A42BodCod[0];
               A46AgeDsc = H005V2_A46AgeDsc[0];
               n46AgeDsc = H005V2_n46AgeDsc[0];
               A2AgeID = H005V2_A2AgeID[0];
               A217BodDsc = H005V2_A217BodDsc[0];
               n217BodDsc = H005V2_n217BodDsc[0];
               A46AgeDsc = H005V2_A46AgeDsc[0];
               n46AgeDsc = H005V2_n46AgeDsc[0];
      ...
      protected void send_integrity_lvl_hashes5V2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_DESPBODNRO"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A353DespBodNro), "ZZZ9"), context));
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("despbodega.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A2AgeID) + "," + UrlEncode("" +A353DespBodNro) + "," + UrlEncode("" +A22OrdenID) + "," + UrlEncode("" +AV7ClienteID);
         edtavDelete_Link = formatLink("despbodega.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A2AgeID) + "," + UrlEncode("" +A353DespBodNro) + "," + UrlEncode("" +A22OrdenID) + "," + UrlEncode("" +AV7ClienteID);
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 20;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("despbodega.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +0) + "," + UrlEncode("" +0) + "," + UrlEncode("" +0) + "," + UrlEncode("" +AV7ClienteID));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "DespBodega";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "clientesdespbodegawc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2023123162992", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("clientesdespbodegawc.js", "?2023123162992", false);
         }
      ...
      protected void SubsflControlProps_202( )
      {
         ...
         edtAgeDsc_Internalname = sPrefix+"AGEDSC_"+sGXsfl_20_idx;
         edtBodCod_Internalname = sPrefix+"BODCOD_"+sGXsfl_20_idx;
         edtBodDsc_Internalname = sPrefix+"BODDSC_"+sGXsfl_20_idx;
         edtDespBodNro_Internalname = sPrefix+"DESPBODNRO_"+sGXsfl_20_idx;
         edtOrdenID_Internalname = sPrefix+"ORDENID_"+sGXsfl_20_idx;
         edtDespBodUltReg_Internalname = sPrefix+"DESPBODULTREG_"+sGXsfl_20_idx;
         edtDespachadoOK_Internalname = sPrefix+"DESPACHADOOK_"+sGXsfl_20_idx;
      ...
      protected void SubsflControlProps_fel_202( )
      {
         ...
         edtAgeDsc_Internalname = sPrefix+"AGEDSC_"+sGXsfl_20_fel_idx;
         edtBodCod_Internalname = sPrefix+"BODCOD_"+sGXsfl_20_fel_idx;
         edtBodDsc_Internalname = sPrefix+"BODDSC_"+sGXsfl_20_fel_idx;
         edtDespBodNro_Internalname = sPrefix+"DESPBODNRO_"+sGXsfl_20_fel_idx;
         edtOrdenID_Internalname = sPrefix+"ORDENID_"+sGXsfl_20_fel_idx;
         edtDespBodUltReg_Internalname = sPrefix+"DESPBODULTREG_"+sGXsfl_20_fel_idx;
         edtDespachadoOK_Internalname = sPrefix+"DESPACHADOOK_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtDespBodUltReg_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A399DespBodUltReg), 6, 0, ",", "")),context.localUtil.Format( (decimal)(A399DespBodUltReg), "ZZZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtDespBodUltReg_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)6,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtDespBodUltReg_Internalname = sPrefix+"DESPBODULTREG";
         edtDespachadoOK_Internalname = sPrefix+"DESPACHADOOK";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E135V2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A2AgeID',fld:'AGEID',pic:'ZZZ9',hsh:true},{av:'A353DespBodNro',fld:'DESPBODNRO',pic:'ZZZ9',hsh:true},{av:'A22OrdenID',fld:'ORDENID',pic:'ZZZ9',hsh:true},{av:'AV7ClienteID',fld:'vCLIENTEID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E115V2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A2AgeID',fld:'AGEID',pic:'ZZZ9',hsh:true},{av:'A353DespBodNro',fld:'DESPBODNRO',pic:'ZZZ9',hsh:true},{av:'A22OrdenID',fld:'ORDENID',pic:'ZZZ9',hsh:true},{av:'AV7ClienteID',fld:'vCLIENTEID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV19Delete_GXI = "";
         scmdbuf = "";
         H005V2_A1EmpID = new short[1] ;
         H005V2_A5ClienteID = new short[1] ;
         H005V2_A402DespachadoOK = new String[] {""} ;
         H005V2_n402DespachadoOK = new bool[] {false} ;
         H005V2_A399DespBodUltReg = new int[1] ;
         H005V2_n399DespBodUltReg = new bool[] {false} ;
         H005V2_A22OrdenID = new short[1] ;
         H005V2_A353DespBodNro = new short[1] ;
         H005V2_A217BodDsc = new String[] {""} ;
         H005V2_n217BodDsc = new bool[] {false} ;
         H005V2_A42BodCod = new short[1] ;
         H005V2_A46AgeDsc = new String[] {""} ;
         H005V2_n46AgeDsc = new bool[] {false} ;
         H005V2_A2AgeID = new short[1] ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.clientesdespbodegawc__default(),
            new Object[][] {
                new Object[] {
               H005V2_A1EmpID, H005V2_A5ClienteID, H005V2_A402DespachadoOK, H005V2_n402DespachadoOK, H005V2_A399DespBodUltReg, H005V2_n399DespBodUltReg, H005V2_A22OrdenID, H005V2_A353DespBodNro, H005V2_A217BodDsc, H005V2_n217BodDsc,
               H005V2_A42BodCod, H005V2_A46AgeDsc, H005V2_n46AgeDsc, H005V2_A2AgeID
               }
               , new Object[] {
      ...
      private short[] H005V2_A1EmpID ;
      private short[] H005V2_A5ClienteID ;
      private String[] H005V2_A402DespachadoOK ;
      private bool[] H005V2_n402DespachadoOK ;
      private int[] H005V2_A399DespBodUltReg ;
      private bool[] H005V2_n399DespBodUltReg ;
      private short[] H005V2_A22OrdenID ;
      private short[] H005V2_A353DespBodNro ;
      private String[] H005V2_A217BodDsc ;
      private bool[] H005V2_n217BodDsc ;
      private short[] H005V2_A42BodCod ;
      private String[] H005V2_A46AgeDsc ;
      private bool[] H005V2_n46AgeDsc ;
      private short[] H005V2_A2AgeID ;
   ...
   public class clientesdespbodegawc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H005V2", "SELECT T1.[EmpID], T1.[ClienteID], T1.[DespachadoOK], T1.[DespBodUltReg], T1.[OrdenID], T1.[DespBodNro], T2.[BodDsc], T1.[BodCod], T3.[AgeDsc], T1.[AgeID] FROM (([DespBodega] T1 WITH (NOLOCK) INNER JOIN [Bodegas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID] AND T2.[BodCod] = T1.[BodCod]) INNER JOIN [Agencias] T3 WITH (NOLOCK) ON T3.[EmpID] = T1.[EmpID] AND T3.[AgeID] = T1.[AgeID]) WHERE T1.[EmpID] = @AV6EmpID and T1.[ClienteID] = @AV7ClienteID ORDER BY T1.[EmpID], T1.[ClienteID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005V2,11,0,true,false )
             ,new CursorDef("H005V3", "SELECT COUNT(*) FROM (([DespBodega] T1 WITH (NOLOCK) INNER JOIN [Bodegas] T3 WITH (NOLOCK) ON T3.[EmpID] = T1.[EmpID] AND T3.[BodCod] = T1.[BodCod]) INNER JOIN [Agencias] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID] AND T2.[AgeID] = T1.[AgeID]) WHERE T1.[EmpID] = @AV6EmpID and T1.[ClienteID] = @AV7ClienteID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005V3,1,0,true,false )
          };
       }
    }
