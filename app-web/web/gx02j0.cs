/*
       ...
       Generated on: 1/12/2023 22:36:39.22
...
namespace GeneXus.Programs {
   public class gx02j0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx02j0( )
      {
      ...
      public gx02j0( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV11cClienteID = (short)(NumberUtil.Val( GetNextPar( ), "."));
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cEmpID, AV7cAgeID, AV8cDespBodNro, AV9cOrdenID, AV10cBodCod, AV11cClienteID, AV12cDespBodUltReg) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202311222363963", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx02j0.aspx") + "?" + UrlEncode("" +AV13pEmpID) + "," + UrlEncode("" +AV14pAgeID) + "," + UrlEncode("" +AV15pDespBodNro) + "," + UrlEncode("" +AV16pOrdenID)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCCLIENTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11cClienteID), 4, 0, ",", "")));
      ...
      {
         return formatLink("gx02j0.aspx") + "?" + UrlEncode("" +AV13pEmpID) + "," + UrlEncode("" +AV14pAgeID) + "," + UrlEncode("" +AV15pDespBodNro) + "," + UrlEncode("" +AV16pOrdenID) ;
      }
      ...
      protected void WB5W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblempidfilter_Internalname, "Emp ID", "", "", lblLblempidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e115w1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02J0.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCempid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cEmpID), 4, 0, ",", "")), ((edtavCempid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6cEmpID), "ZZZ9")) : context.localUtil.Format( (decimal)(AV6cEmpID), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCempid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCempid_Visible, edtavCempid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx02J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblageidfilter_Internalname, "Age ID", "", "", lblLblageidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e125w1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbldespbodnrofilter_Internalname, "Desp Bod Nro", "", "", lblLbldespbodnrofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e135w1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblordenidfilter_Internalname, "Orden ID", "", "", lblLblordenidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e145w1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblbodcodfilter_Internalname, "Bod Cod", "", "", lblLblbodcodfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e155w1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblclienteidfilter_Internalname, "Cliente ID", "", "", lblLblclienteidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e165w1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCclienteid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11cClienteID), 4, 0, ",", "")), ((edtavCclienteid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV11cClienteID), "ZZZ9")) : context.localUtil.Format( (decimal)(AV11cClienteID), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCclienteid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCclienteid_Visible, edtavCclienteid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx02J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbldespbodultregfilter_Internalname, "Desp Bod Ult Reg", "", "", lblLbldespbodultregfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e175w1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(84), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e185w1_client"+"'", TempTags, "", 2, "HLP_Gx02J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 84 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(84), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx02J0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF5W2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV9cOrdenID } ,
                                                 new int[]{
                                                 TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.INT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.INT, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT,
                                                 TypeConstants.SHORT
                                                 }
            } ) ;
            /* Using cursor H005W2 */
            pr_default.execute(0, new Object[] {AV6cEmpID, AV7cAgeID, AV8cDespBodNro, AV9cOrdenID, AV10cBodCod, AV11cClienteID, AV12cDespBodUltReg, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_84_idx = 1;
            sGXsfl_84_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_84_idx), 4, 0)), 4, "0");
            SubsflControlProps_842( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A399DespBodUltReg = H005W2_A399DespBodUltReg[0];
               n399DespBodUltReg = H005W2_n399DespBodUltReg[0];
               A5ClienteID = H005W2_A5ClienteID[0];
               A42BodCod = H005W2_A42BodCod[0];
               A22OrdenID = H005W2_A22OrdenID[0];
               A353DespBodNro = H005W2_A353DespBodNro[0];
               A2AgeID = H005W2_A2AgeID[0];
               A1EmpID = H005W2_A1EmpID[0];
               /* Execute user event: Load */
               E205W2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         /* Using cursor H005W3 */
         pr_default.execute(1, new Object[] {AV6cEmpID, AV7cAgeID, AV8cDespBodNro, AV9cOrdenID, AV10cBodCod, AV11cClienteID, AV12cDespBodUltReg});
         GRID1_nRecordCount = H005W3_AGRID1_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUP5W0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCclienteid_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCclienteid_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV11cClienteID = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11cClienteID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11cClienteID), 4, 0)));
            }
            else
            {
               AV11cClienteID = (short)(context.localUtil.CToN( cgiGet( edtavCclienteid_Internalname), ",", "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11cClienteID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11cClienteID), 4, 0)));
            }
      ...
      protected void E215W2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV16pOrdenID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV16pOrdenID), 4, 0)));
         context.setWebReturnParms(new Object[] {(short)AV13pEmpID,(short)AV14pAgeID,(short)AV15pDespBodNro,(short)AV16pOrdenID});
         context.setWebReturnParmsMetadata(new Object[] {"AV13pEmpID","AV14pAgeID","AV15pDespBodNro","AV16pOrdenID"});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202311222364624", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx02j0.js", "?202311222364625", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cEmpID',fld:'vCEMPID',pic:'ZZZ9'},{av:'AV7cAgeID',fld:'vCAGEID',pic:'ZZZ9'},{av:'AV8cDespBodNro',fld:'vCDESPBODNRO',pic:'ZZZ9'},{av:'AV9cOrdenID',fld:'vCORDENID',pic:'ZZZ9'},{av:'AV10cBodCod',fld:'vCBODCOD',pic:'ZZZ9'},{av:'AV11cClienteID',fld:'vCCLIENTEID',pic:'ZZZ9'},{av:'AV12cDespBodUltReg',fld:'vCDESPBODULTREG',pic:'ZZZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E185W1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLEMPIDFILTER.CLICK","{handler:'E115W1',iparms:[{av:'divEmpidfiltercontainer_Class',ctrl:'EMPIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLAGEIDFILTER.CLICK","{handler:'E125W1',iparms:[{av:'divAgeidfiltercontainer_Class',ctrl:'AGEIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLDESPBODNROFILTER.CLICK","{handler:'E135W1',iparms:[{av:'divDespbodnrofiltercontainer_Class',ctrl:'DESPBODNROFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLORDENIDFILTER.CLICK","{handler:'E145W1',iparms:[{av:'divOrdenidfiltercontainer_Class',ctrl:'ORDENIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLBODCODFILTER.CLICK","{handler:'E155W1',iparms:[{av:'divBodcodfiltercontainer_Class',ctrl:'BODCODFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLCLIENTEIDFILTER.CLICK","{handler:'E165W1',iparms:[{av:'divClienteidfiltercontainer_Class',ctrl:'CLIENTEIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLDESPBODULTREGFILTER.CLICK","{handler:'E175W1',iparms:[{av:'divDespbodultregfiltercontainer_Class',ctrl:'DESPBODULTREGFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E215W2',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A2AgeID',fld:'AGEID',pic:'ZZZ9',hsh:true},{av:'A353DespBodNro',fld:'DESPBODNRO',pic:'ZZZ9',hsh:true},{av:'A22OrdenID',fld:'ORDENID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV13pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV14pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV15pDespBodNro',fld:'vPDESPBODNRO',pic:'ZZZ9'},{av:'AV16pOrdenID',fld:'vPORDENID',pic:'ZZZ9'}]}");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H005W2_A399DespBodUltReg = new int[1] ;
         H005W2_n399DespBodUltReg = new bool[] {false} ;
         H005W2_A5ClienteID = new short[1] ;
         H005W2_A42BodCod = new short[1] ;
         H005W2_A22OrdenID = new short[1] ;
         H005W2_A353DespBodNro = new short[1] ;
         H005W2_A2AgeID = new short[1] ;
         H005W2_A1EmpID = new short[1] ;
         H005W3_AGRID1_nRecordCount = new long[1] ;
         ...
         sImgUrl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx02j0__default(),
            new Object[][] {
                new Object[] {
               H005W2_A399DespBodUltReg, H005W2_n399DespBodUltReg, H005W2_A5ClienteID, H005W2_A42BodCod, H005W2_A22OrdenID, H005W2_A353DespBodNro, H005W2_A2AgeID, H005W2_A1EmpID
               }
               , new Object[] {
               H005W3_AGRID1_nRecordCount
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int[] H005W2_A399DespBodUltReg ;
      private bool[] H005W2_n399DespBodUltReg ;
      private short[] H005W2_A5ClienteID ;
      private short[] H005W2_A42BodCod ;
      private short[] H005W2_A22OrdenID ;
      private short[] H005W2_A353DespBodNro ;
      private short[] H005W2_A2AgeID ;
      private short[] H005W2_A1EmpID ;
      private long[] H005W3_AGRID1_nRecordCount ;
   ...
   public class gx02j0__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV9cOrdenID )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " [DespBodUltReg], [ClienteID], [BodCod], [OrdenID], [DespBodNro], [AgeID], [EmpID]";
         sFromString = " FROM [DespBodega] WITH (NOLOCK)";
         sOrderString = "";
         sWhereString = sWhereString + " WHERE ([EmpID] >= @AV6cEmpID and [AgeID] >= @AV7cAgeID and [DespBodNro] >= @AV8cDespBodNro and [OrdenID] >= @AV9cOrdenID)";
         if ( ! (0==AV10cBodCod) )
         {
         ...
         if ( ! (0==AV11cClienteID) )
         {
            sWhereString = sWhereString + " and ([ClienteID] >= @AV11cClienteID)";
         }
         else
         {
            GXv_int1[5] = 1;
         ...
         sOrderString = sOrderString + " ORDER BY [EmpID], [AgeID], [DespBodNro], [OrdenID]";
                                             ...
                                             short AV9cOrdenID )
      {
         ...
         scmdbuf = scmdbuf + " WHERE ([EmpID] >= @AV6cEmpID and [AgeID] >= @AV7cAgeID and [DespBodNro] >= @AV8cDespBodNro and [OrdenID] >= @AV9cOrdenID)";
         if ( ! (0==AV10cBodCod) )
         {
            sWhereString = sWhereString + " and ([BodCod] >= @AV10cBodCod)";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005W2(context, (short)dynConstraints[0] , (short)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (int)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] );
               case 1 :
                     return conditional_H005W3(context, (short)dynConstraints[0] , (short)dynConstraints[1] , (int)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (int)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV11cClienteID",SqlDbType.SmallInt,4,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H005W2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005W2,11,0,false,false )
             ,new CursorDef("H005W3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005W3,1,0,false,false )
          };
       }
    }
