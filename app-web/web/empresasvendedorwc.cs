/*
               File: EmpresasVendedorWC
        Description: Empresas Vendedor WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/26/2022 20:13:22.79
...
namespace GeneXus.Programs {
   public class empresasvendedorwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public empresasvendedorwc( )
      {
      ...
      public empresasvendedorwc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
                  forbiddenHiddens = sPrefix + "hsh" + "EmpresasVendedorWC";
                  ...
                  GXUtil.WriteLog("empresasvendedorwc:[SendSecurityCheck value for]"+"EmpID:"+context.localUtil.Format( (decimal)(A1EmpID), "ZZZ9"));
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV16Pgmname = "EmpresasVendedorWC";
               context.Gx_err = 0;
               WS0G2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Empresas Vendedor WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102620132285", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("empresasvendedorwc.aspx") + "?" + UrlEncode("" +AV6EmpID)+"\">") ;
      ...
      protected void RenderHtmlCloseForm0G2( )
      {
         ...
         {
            context.AddJavascriptSource("empresasvendedorwc.js", "?2022102620132287", false);
         }
      ...
      {
         return "EmpresasVendedorWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Empresas Vendedor WC" ;
      }
      ...
      protected void WB0G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "empresasvendedorwc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EmpresasVendedorWC.htm");
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtvendedorDsc_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A73vendedorEst));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START0G2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Empresas Vendedor WC", 0) ;
            }
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_VENDEDORID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A9vendedorID), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"VENDEDORID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A9vendedorID), 4, 0, ".", "")));
      }
      ...
      protected void RF0G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1EmpID = H000G2_A1EmpID[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(A1EmpID), 4, 0)));
               A121VendedorSiglas = H000G2_A121VendedorSiglas[0];
               n121VendedorSiglas = H000G2_n121VendedorSiglas[0];
               A73vendedorEst = H000G2_A73vendedorEst[0];
               n73vendedorEst = H000G2_n73vendedorEst[0];
               A72vendedorDsc = H000G2_A72vendedorDsc[0];
               n72vendedorDsc = H000G2_n72vendedorDsc[0];
               A9vendedorID = H000G2_A9vendedorID[0];
               E130G2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_VENDEDORID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A9vendedorID), "ZZZ9"), context));
      }
      ...
      protected void STRUP0G0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            {
               GXUtil.WriteLog("empresasvendedorwc:[SecurityCheckFailed value for]"+"EmpID:"+context.localUtil.Format( (decimal)(A1EmpID), "ZZZ9"));
               GxWebError = 1;
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("vendedor.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A9vendedorID);
         edtavDelete_Link = formatLink("vendedor.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A9vendedorID);
         edtvendedorDsc_Link = formatLink("viewvendedor.aspx") + "?" + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A9vendedorID) + "," + UrlEncode(StringUtil.RTrim(""));
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 20;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("vendedor.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "empresasvendedorwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022102620132338", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("empresasvendedorwc.js", "?2022102620132339", false);
         }
      ...
      protected void SubsflControlProps_202( )
      {
         ...
         edtvendedorEst_Internalname = sPrefix+"VENDEDOREST_"+sGXsfl_20_idx;
         edtVendedorSiglas_Internalname = sPrefix+"VENDEDORSIGLAS_"+sGXsfl_20_idx;
      ...
      protected void SubsflControlProps_fel_202( )
      {
         ...
         edtvendedorEst_Internalname = sPrefix+"VENDEDOREST_"+sGXsfl_20_fel_idx;
         edtVendedorSiglas_Internalname = sPrefix+"VENDEDORSIGLAS_"+sGXsfl_20_fel_idx;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130G2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A9vendedorID',fld:'VENDEDORID',pic:'ZZZ9',hsh:true},{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtvendedorDsc_Link',ctrl:'VENDEDORDSC',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110G2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A9vendedorID',fld:'VENDEDORID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV18Delete_GXI = "";
         scmdbuf = "";
         H000G2_A1EmpID = new short[1] ;
         H000G2_A121VendedorSiglas = new String[] {""} ;
         H000G2_n121VendedorSiglas = new bool[] {false} ;
         H000G2_A73vendedorEst = new String[] {""} ;
         H000G2_n73vendedorEst = new bool[] {false} ;
         H000G2_A72vendedorDsc = new String[] {""} ;
         H000G2_n72vendedorDsc = new bool[] {false} ;
         H000G2_A9vendedorID = new short[1] ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.empresasvendedorwc__default(),
            new Object[][] {
                new Object[] {
               H000G2_A1EmpID, H000G2_A121VendedorSiglas, H000G2_n121VendedorSiglas, H000G2_A73vendedorEst, H000G2_n73vendedorEst, H000G2_A72vendedorDsc, H000G2_n72vendedorDsc, H000G2_A9vendedorID
               }
               , new Object[] {
      ...
      private short[] H000G2_A1EmpID ;
      private String[] H000G2_A121VendedorSiglas ;
      private bool[] H000G2_n121VendedorSiglas ;
      private String[] H000G2_A73vendedorEst ;
      private bool[] H000G2_n73vendedorEst ;
      private String[] H000G2_A72vendedorDsc ;
      private bool[] H000G2_n72vendedorDsc ;
      private short[] H000G2_A9vendedorID ;
   ...
   public class empresasvendedorwc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000G2", "SELECT [EmpID], [VendedorSiglas], [vendedorEst], [vendedorDsc], [vendedorID] FROM [Vendedor] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ORDER BY [EmpID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000G2,11,0,true,false )
             ,new CursorDef("H000G3", "SELECT COUNT(*) FROM [Vendedor] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000G3,1,0,true,false )
          };
       }
    }
