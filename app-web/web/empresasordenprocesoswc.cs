/*
               File: EmpresasOrdenProcesosWC
        Description: Empresas Orden Procesos WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/26/2022 20:13:8.40
...
namespace GeneXus.Programs {
   public class empresasordenprocesoswc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public empresasordenprocesoswc( )
      {
      ...
      public empresasordenprocesoswc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6EmpID, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV14Pgmname = "EmpresasOrdenProcesosWC";
               context.Gx_err = 0;
               WS0K2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Empresas Orden Procesos WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202210262013844", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("empresasordenprocesoswc.aspx") + "?" + UrlEncode("" +AV6EmpID)+"\">") ;
      ...
      protected void RenderHtmlCloseForm0K2( )
      {
         ...
         {
            context.AddJavascriptSource("empresasordenprocesoswc.js", "?202210262013846", false);
         }
      ...
      {
         return "EmpresasOrdenProcesosWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Empresas Orden Procesos WC" ;
      }
      ...
      protected void WB0K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "empresasordenprocesoswc.aspx");
            }
            /* Div Control */
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A21secuencia), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A22OrdenID), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A131OrdPrcEst);
               GridContainer.AddColumnProperties(GridColumn);
      ...
      protected void START0K2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Empresas Orden Procesos WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF0K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1EmpID = H000K2_A1EmpID[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(A1EmpID), 4, 0)));
               A131OrdPrcEst = H000K2_A131OrdPrcEst[0];
               n131OrdPrcEst = H000K2_n131OrdPrcEst[0];
               A22OrdenID = H000K2_A22OrdenID[0];
               A21secuencia = H000K2_A21secuencia[0];
               E120K2 ();
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "empresasordenprocesoswc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202210262013876", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("empresasordenprocesoswc.js", "?202210262013876", false);
         }
      ...
      {
         edtsecuencia_Internalname = sPrefix+"SECUENCIA_"+sGXsfl_12_idx;
         edtOrdenID_Internalname = sPrefix+"ORDENID_"+sGXsfl_12_idx;
         edtOrdPrcEst_Internalname = sPrefix+"ORDPRCEST_"+sGXsfl_12_idx;
      }

      protected void SubsflControlProps_fel_122( )
      {
         edtsecuencia_Internalname = sPrefix+"SECUENCIA_"+sGXsfl_12_fel_idx;
         edtOrdenID_Internalname = sPrefix+"ORDENID_"+sGXsfl_12_fel_idx;
         edtOrdPrcEst_Internalname = sPrefix+"ORDPRCEST_"+sGXsfl_12_fel_idx;
      }
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtsecuencia_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A21secuencia), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A21secuencia), "ZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtsecuencia_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)12,(short)1,(short)-1,(short)0,(bool)true,(String)"Id",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtOrdPrcEst_Internalname,(String)A131OrdPrcEst,(String)"",(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtOrdPrcEst_Jsonclick,(short)0,(String)"DescriptionAttribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)5,(short)0,(short)0,(short)12,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true});
      ...
      {
         edtsecuencia_Internalname = sPrefix+"SECUENCIA";
         edtOrdenID_Internalname = sPrefix+"ORDENID";
         edtOrdPrcEst_Internalname = sPrefix+"ORDPRCEST";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E120K2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000K2_A1EmpID = new short[1] ;
         H000K2_A131OrdPrcEst = new String[] {""} ;
         H000K2_n131OrdPrcEst = new bool[] {false} ;
         H000K2_A22OrdenID = new short[1] ;
         H000K2_A21secuencia = new short[1] ;
         ...
         sCtrlAV6EmpID = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.empresasordenprocesoswc__default(),
            new Object[][] {
                new Object[] {
               H000K2_A1EmpID, H000K2_A131OrdPrcEst, H000K2_n131OrdPrcEst, H000K2_A22OrdenID, H000K2_A21secuencia
               }
               , new Object[] {
      ...
      private short[] H000K2_A1EmpID ;
      private String[] H000K2_A131OrdPrcEst ;
      private bool[] H000K2_n131OrdPrcEst ;
      private short[] H000K2_A22OrdenID ;
      private short[] H000K2_A21secuencia ;
      private long[] H000K3_AGRID_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class empresasordenprocesoswc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000K2", "SELECT [EmpID], [OrdPrcEst], [OrdenID], [secuencia] FROM [OrdenProcesos] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ORDER BY [EmpID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000K2,11,0,true,false )
             ,new CursorDef("H000K3", "SELECT COUNT(*) FROM [OrdenProcesos] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000K3,1,0,true,false )
          };
       }
    }
