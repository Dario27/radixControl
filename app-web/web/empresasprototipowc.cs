/*
               File: EmpresasPrototipoWC
        Description: Empresas Prototipo WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/26/2022 20:13:24.52
...
namespace GeneXus.Programs {
   public class empresasprototipowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public empresasprototipowc( )
      {
      ...
      public empresasprototipowc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
                  forbiddenHiddens = sPrefix + "hsh" + "EmpresasPrototipoWC";
                  ...
                  GXUtil.WriteLog("empresasprototipowc:[SendSecurityCheck value for]"+"EmpID:"+context.localUtil.Format( (decimal)(A1EmpID), "ZZZ9"));
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV16Pgmname = "EmpresasPrototipoWC";
               context.Gx_err = 0;
               WS0H2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Empresas Prototipo WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102620132457", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("empresasprototipowc.aspx") + "?" + UrlEncode("" +AV6EmpID)+"\">") ;
      ...
      protected void RenderHtmlCloseForm0H2( )
      {
         ...
         {
            context.AddJavascriptSource("empresasprototipowc.js", "?2022102620132458", false);
         }
      ...
      {
         return "EmpresasPrototipoWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Empresas Prototipo WC" ;
      }
      ...
      protected void WB0H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "empresasprototipowc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EmpresasPrototipoWC.htm");
      ...
      protected void START0H2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Empresas Prototipo WC", 0) ;
            }
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PROTID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A10protID), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"PROTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A10protID), 4, 0, ".", "")));
      }
      ...
      protected void RF0H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1EmpID = H000H2_A1EmpID[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(A1EmpID), 4, 0)));
               A122protSiglas = H000H2_A122protSiglas[0];
               n122protSiglas = H000H2_n122protSiglas[0];
               A76protObserv = H000H2_A76protObserv[0];
               n76protObserv = H000H2_n76protObserv[0];
               A75protEst = H000H2_A75protEst[0];
               n75protEst = H000H2_n75protEst[0];
               A74protDsc = H000H2_A74protDsc[0];
               n74protDsc = H000H2_n74protDsc[0];
               A10protID = H000H2_A10protID[0];
               E130H2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_PROTID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A10protID), "ZZZ9"), context));
      }
      ...
      protected void STRUP0H0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            {
               GXUtil.WriteLog("empresasprototipowc:[SecurityCheckFailed value for]"+"EmpID:"+context.localUtil.Format( (decimal)(A1EmpID), "ZZZ9"));
               GxWebError = 1;
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("prototipo.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A10protID);
         edtavDelete_Link = formatLink("prototipo.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A10protID);
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("prototipo.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Prototipo";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "empresasprototipowc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202210262013257", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("empresasprototipowc.js", "?202210262013257", false);
         }
      ...
      protected void SubsflControlProps_202( )
      {
         ...
         edtprotEst_Internalname = sPrefix+"PROTEST_"+sGXsfl_20_idx;
         edtprotObserv_Internalname = sPrefix+"PROTOBSERV_"+sGXsfl_20_idx;
         edtprotSiglas_Internalname = sPrefix+"PROTSIGLAS_"+sGXsfl_20_idx;
      ...
      protected void SubsflControlProps_fel_202( )
      {
         ...
         edtprotEst_Internalname = sPrefix+"PROTEST_"+sGXsfl_20_fel_idx;
         edtprotObserv_Internalname = sPrefix+"PROTOBSERV_"+sGXsfl_20_fel_idx;
         edtprotSiglas_Internalname = sPrefix+"PROTSIGLAS_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtprotObserv_Internalname,(String)A76protObserv,(String)"",(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtprotObserv_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)200,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130H2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A10protID',fld:'PROTID',pic:'ZZZ9',hsh:true},{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtprotDsc_Link',ctrl:'PROTDSC',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110H2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A10protID',fld:'PROTID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV18Delete_GXI = "";
         scmdbuf = "";
         H000H2_A1EmpID = new short[1] ;
         H000H2_A122protSiglas = new String[] {""} ;
         H000H2_n122protSiglas = new bool[] {false} ;
         H000H2_A76protObserv = new String[] {""} ;
         H000H2_n76protObserv = new bool[] {false} ;
         H000H2_A75protEst = new String[] {""} ;
         H000H2_n75protEst = new bool[] {false} ;
         H000H2_A74protDsc = new String[] {""} ;
         H000H2_n74protDsc = new bool[] {false} ;
         H000H2_A10protID = new short[1] ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.empresasprototipowc__default(),
            new Object[][] {
                new Object[] {
               H000H2_A1EmpID, H000H2_A122protSiglas, H000H2_n122protSiglas, H000H2_A76protObserv, H000H2_n76protObserv, H000H2_A75protEst, H000H2_n75protEst, H000H2_A74protDsc, H000H2_n74protDsc, H000H2_A10protID
               }
               , new Object[] {
      ...
      private short[] H000H2_A1EmpID ;
      private String[] H000H2_A122protSiglas ;
      private bool[] H000H2_n122protSiglas ;
      private String[] H000H2_A76protObserv ;
      private bool[] H000H2_n76protObserv ;
      private String[] H000H2_A75protEst ;
      private bool[] H000H2_n75protEst ;
      private String[] H000H2_A74protDsc ;
      private bool[] H000H2_n74protDsc ;
      private short[] H000H2_A10protID ;
   ...
   public class empresasprototipowc__default : DataStoreHelperBase, IDataStoreHelper
   {
