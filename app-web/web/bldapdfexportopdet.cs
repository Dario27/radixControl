...
using System.IO;
public class bldapdfexportopdet : GxBaseBuilder
{
   string cs_path = "." ;
   public bldapdfexportopdet( ) : base()
   {
   }
   ...
   {
      bldapdfexportopdet x = new bldapdfexportopdet() ;
      x.SetMainSourceFile( "apdfexportopdet.cs");
