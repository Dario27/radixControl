/*
               File: EmpresasTipoProductoWC
        Description: Empresas Tipo Producto WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/26/2022 20:13:32.13
...
namespace GeneXus.Programs {
   public class empresastipoproductowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public empresastipoproductowc( )
      {
      ...
      public empresastipoproductowc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV16Pgmname = "EmpresasTipoProductoWC";
               context.Gx_err = 0;
               WS0M2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Empresas Tipo Producto WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102620133219", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("empresastipoproductowc.aspx") + "?" + UrlEncode("" +AV6EmpID)+"\">") ;
      ...
      protected void RenderHtmlCloseForm0M2( )
      {
         ...
         {
            context.AddJavascriptSource("empresastipoproductowc.js", "?2022102620133219", false);
         }
      ...
      {
         return "EmpresasTipoProductoWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Empresas Tipo Producto WC" ;
      }
      ...
      protected void WB0M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "empresastipoproductowc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EmpresasTipoProductoWC.htm");
      ...
      protected void START0M2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Empresas Tipo Producto WC", 0) ;
            }
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_TIPOPRODID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A31tipoProdID), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"TIPOPRODID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A31tipoProdID), 4, 0, ".", "")));
      }
      ...
      protected void RF0M2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1EmpID = H000M2_A1EmpID[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(A1EmpID), 4, 0)));
               A145tipoProdEst = H000M2_A145tipoProdEst[0];
               n145tipoProdEst = H000M2_n145tipoProdEst[0];
               A144tipoProdDsc = H000M2_A144tipoProdDsc[0];
               n144tipoProdDsc = H000M2_n144tipoProdDsc[0];
               A31tipoProdID = H000M2_A31tipoProdID[0];
               E130M2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_TIPOPRODID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A31tipoProdID), "ZZZ9"), context));
      }
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("tipoproducto.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A31tipoProdID);
         edtavDelete_Link = formatLink("tipoproducto.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A31tipoProdID);
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 20;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("tipoproducto.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "TipoProducto";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "empresastipoproductowc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022102620133265", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("empresastipoproductowc.js", "?2022102620133265", false);
         }
      ...
      protected void SubsflControlProps_202( )
      {
         ...
         edttipoProdEst_Internalname = sPrefix+"TIPOPRODEST_"+sGXsfl_20_idx;
      ...
      protected void SubsflControlProps_fel_202( )
      {
         ...
         edttipoProdEst_Internalname = sPrefix+"TIPOPRODEST_"+sGXsfl_20_fel_idx;
      ...
      protected void init_default_properties( )
      {
         ...
         edttipoProdEst_Internalname = sPrefix+"TIPOPRODEST";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130M2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A31tipoProdID',fld:'TIPOPRODID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110M2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A31tipoProdID',fld:'TIPOPRODID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV18Delete_GXI = "";
         scmdbuf = "";
         H000M2_A1EmpID = new short[1] ;
         H000M2_A145tipoProdEst = new String[] {""} ;
         H000M2_n145tipoProdEst = new bool[] {false} ;
         H000M2_A144tipoProdDsc = new String[] {""} ;
         H000M2_n144tipoProdDsc = new bool[] {false} ;
         H000M2_A31tipoProdID = new short[1] ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.empresastipoproductowc__default(),
            new Object[][] {
                new Object[] {
               H000M2_A1EmpID, H000M2_A145tipoProdEst, H000M2_n145tipoProdEst, H000M2_A144tipoProdDsc, H000M2_n144tipoProdDsc, H000M2_A31tipoProdID
               }
               , new Object[] {
      ...
      private short[] H000M2_A1EmpID ;
      private String[] H000M2_A145tipoProdEst ;
      private bool[] H000M2_n145tipoProdEst ;
      private String[] H000M2_A144tipoProdDsc ;
      private bool[] H000M2_n144tipoProdDsc ;
      private short[] H000M2_A31tipoProdID ;
   ...
   public class empresastipoproductowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000M2", "SELECT [EmpID], [tipoProdEst], [tipoProdDsc], [tipoProdID] FROM [TipoProducto] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ORDER BY [EmpID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000M2,11,0,true,false )
             ,new CursorDef("H000M3", "SELECT COUNT(*) FROM [TipoProducto] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000M3,1,0,true,false )
          };
       }
    }
