/*
               File: ViewPrototipo
        Description: View Prototipo
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 1/14/2023 1:15:46.86
...
namespace GeneXus.Programs {
   public class viewprototipo : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      public viewprototipo( )
      {
      ...
      public viewprototipo( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               {
                  AV13protID = (short)(NumberUtil.Val( GetNextPar( ), "."));
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13protID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13protID), 4, 0)));
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vPROTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13protID), "ZZZ9"), context));
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231141154689", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewprototipo.aspx") + "?" + UrlEncode("" +AV12EmpID) + "," + UrlEncode("" +AV13protID) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens = "hsh" + "ViewPrototipo";
         forbiddenHiddens = forbiddenHiddens + StringUtil.RTrim( context.localUtil.Format( A74protDsc, ""));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens, GXKey));
         GXUtil.WriteLog("viewprototipo:[SendSecurityCheck value for]"+"protDsc:"+StringUtil.RTrim( context.localUtil.Format( A74protDsc, "")));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPROTID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13protID), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vPROTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13protID), "ZZZ9"), context));
      ...
      protected void RenderHtmlCloseForm102( )
      {
         ...
         if ( ! ( WebComp_Cotizadorwc == null ) )
         {
            WebComp_Cotizadorwc.componentjscripts();
         }
         context.AddJavascriptSource("bootstrap/js/bootstrap.min.js", "?"+context.GetBuildNumber( 126726), false);
      ...
      protected void WB100( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Prototipo Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewPrototipo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Prototipoes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewPrototipo.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtprotDsc_Internalname, StringUtil.RTrim( A74protDsc), StringUtil.RTrim( context.localUtil.Format( A74protDsc, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtprotDsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtprotDsc_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "Descripcion", "left", true, "HLP_ViewPrototipo.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewPrototipo.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblOrdenproduccion_title_Internalname, "Orden Produccion", "", "", lblOrdenproduccion_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewPrototipo.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCotizador_title_Internalname, "Cotizador", "", "", lblCotizador_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewPrototipo.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            context.WriteHtmlText( "Cotizador") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABContainer"+"panel3"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablecotizador_Internalname, 1, 0, "px", 0, "px", "TabsFormContainer", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0046"+"", StringUtil.RTrim( WebComp_Cotizadorwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0046"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Cotizadorwc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldCotizadorwc), StringUtil.Lower( WebComp_Cotizadorwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0046"+"");
                  }
                  WebComp_Cotizadorwc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldCotizadorwc), StringUtil.Lower( WebComp_Cotizadorwc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START102( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Prototipo", 0) ;
         }
         context.wjLoc = "";
            ...
            if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) && ! wbErr )
            {
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                  {
                     ...
                     {
                        OldCotizadorwc = cgiGet( "W0046");
                        if ( ( StringUtil.Len( OldCotizadorwc) == 0 ) || ( StringUtil.StrCmp(OldCotizadorwc, WebComp_Cotizadorwc_Component) != 0 ) )
                        {
                           WebComp_Cotizadorwc = getWebComponent(GetType(), "GeneXus.Programs", OldCotizadorwc, new Object[] {context} );
                           WebComp_Cotizadorwc.ComponentInit();
                           WebComp_Cotizadorwc.Name = "OldCotizadorwc";
                           WebComp_Cotizadorwc_Component = OldCotizadorwc;
                        }
                        if ( StringUtil.Len( WebComp_Cotizadorwc_Component) != 0 )
                        {
                           WebComp_Cotizadorwc.componentprocess("W0046", "", sEvt);
                        }
                        WebComp_Cotizadorwc_Component = OldCotizadorwc;
                     }
                  }
      ...
      protected void RF102( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Cotizadorwc_Component) != 0 )
               {
                  WebComp_Cotizadorwc.componentstart();
               }
            }
         }
         ...
         {
            /* Using cursor H00102 */
            pr_default.execute(0, new Object[] {AV12EmpID, AV13protID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A10protID = H00102_A10protID[0];
               A1EmpID = H00102_A1EmpID[0];
               A74protDsc = H00102_A74protDsc[0];
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A74protDsc", A74protDsc);
               n74protDsc = H00102_n74protDsc[0];
               /* Execute user event: Load */
               E12102 ();
      ...
      protected void STRUP100( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13protID = (short)(context.localUtil.CToN( cgiGet( "vPROTID"), ",", "."));
            ...
            {
               GXUtil.WriteLog("viewprototipo:[SecurityCheckFailed value for]"+"protDsc:"+StringUtil.RTrim( context.localUtil.Format( A74protDsc, "")));
               GxWebError = 1;
      ...
      protected void E11102( )
      {
         ...
         AV17GXLvl6 = 0;
         /* Using cursor H00103 */
         pr_default.execute(1, new Object[] {AV12EmpID, AV13protID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A10protID = H00103_A10protID[0];
            A1EmpID = H00103_A1EmpID[0];
            A74protDsc = H00103_A74protDsc[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A74protDsc", A74protDsc);
            n74protDsc = H00103_n74protDsc[0];
            AV17GXLvl6 = 1;
            Form.Caption = A74protDsc;
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwprototipo.aspx") ;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "PrototipoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "prototipogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "PrototipoGeneral";
               WebComp_Generalwc_Component = "PrototipoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0030",(String)"",(short)AV12EmpID,(short)AV13protID});
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Ordenproduccionwc_Component), StringUtil.Lower( "PrototipoOrdenProduccionWC")) != 0 )
            {
               WebComp_Ordenproduccionwc = getWebComponent(GetType(), "GeneXus.Programs", "prototipoordenproduccionwc", new Object[] {context} );
               WebComp_Ordenproduccionwc.ComponentInit();
               WebComp_Ordenproduccionwc.Name = "PrototipoOrdenProduccionWC";
               WebComp_Ordenproduccionwc_Component = "PrototipoOrdenProduccionWC";
            }
            if ( StringUtil.Len( WebComp_Ordenproduccionwc_Component) != 0 )
            {
               WebComp_Ordenproduccionwc.setjustcreated();
               WebComp_Ordenproduccionwc.componentprepare(new Object[] {(String)"W0038",(String)"",(short)AV12EmpID,(short)AV13protID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Cotizador") == 0 ) )
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Cotizadorwc_Component), StringUtil.Lower( "PrototipoCotizadorWC")) != 0 )
            {
               WebComp_Cotizadorwc = getWebComponent(GetType(), "GeneXus.Programs", "prototipocotizadorwc", new Object[] {context} );
               WebComp_Cotizadorwc.ComponentInit();
               WebComp_Cotizadorwc.Name = "PrototipoCotizadorWC";
               WebComp_Cotizadorwc_Component = "PrototipoCotizadorWC";
            }
            if ( StringUtil.Len( WebComp_Cotizadorwc_Component) != 0 )
            {
               WebComp_Cotizadorwc.setjustcreated();
               WebComp_Cotizadorwc.componentprepare(new Object[] {(String)"W0046",(String)"",(short)AV12EmpID,(short)AV13protID});
               WebComp_Cotizadorwc.componentbind(new Object[] {(String)"",(String)""});
            }
            if ( isFullAjaxMode( ) )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0046"+"");
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12EmpID), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vEMPID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmpID), "ZZZ9"), context));
         AV13protID = Convert.ToInt16(getParm(obj,1));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13protID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13protID), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vPROTID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13protID), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Cotizadorwc == null ) )
         {
            if ( StringUtil.Len( WebComp_Cotizadorwc_Component) != 0 )
            {
               WebComp_Cotizadorwc.componentthemes();
            }
         }
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20231141154726", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewprototipo.js", "?20231141154726", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      protected void init_default_properties( )
      {
         ...
         lblCotizador_title_Internalname = "COTIZADOR_TITLE";
         divTablecotizador_Internalname = "TABLECOTIZADOR";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12EmpID',fld:'vEMPID',pic:'ZZZ9',hsh:true},{av:'AV13protID',fld:'vPROTID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A74protDsc',fld:'PROTDSC',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         lblCotizador_title_Jsonclick = "";
         WebComp_Cotizadorwc_Component = "";
         OldCotizadorwc = "";
         Form = new GXWebForm();
         sEvt = "";
         EvtGridId = "";
         ...
         sEvtType = "";
         scmdbuf = "";
         H00102_A10protID = new short[1] ;
         H00102_A1EmpID = new short[1] ;
         H00102_A74protDsc = new String[] {""} ;
         H00102_n74protDsc = new bool[] {false} ;
         hsh = "";
         H00103_A10protID = new short[1] ;
         H00103_A1EmpID = new short[1] ;
         H00103_A74protDsc = new String[] {""} ;
         H00103_n74protDsc = new bool[] {false} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewprototipo__default(),
            new Object[][] {
                new Object[] {
               H00102_A10protID, H00102_A1EmpID, H00102_A74protDsc, H00102_n74protDsc
               }
               , new Object[] {
               H00103_A10protID, H00103_A1EmpID, H00103_A74protDsc, H00103_n74protDsc
               }
            }
         );
         WebComp_Generalwc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Ordenproduccionwc = new GeneXus.Http.GXNullWebComponent();
         WebComp_Cotizadorwc = new GeneXus.Http.GXNullWebComponent();
         AV16Pgmname = "ViewPrototipo";
         /* GeneXus formulas. */
         AV16Pgmname = "ViewPrototipo";
         context.Gx_err = 0;
      ...
      private short AV13protID ;
      private short wcpOAV12EmpID ;
      private short wcpOAV13protID ;
      ...
      private String lblCotizador_title_Internalname ;
      private String lblCotizador_title_Jsonclick ;
      private String divTablecotizador_Internalname ;
      private String WebComp_Cotizadorwc_Component ;
      private String OldCotizadorwc ;
      private String sEvt ;
      ...
      private GXWebComponent WebComp_Cotizadorwc ;
      private GXWebForm Form ;
      private IGxDataStore dsDefault ;
      private IDataStoreProvider pr_default ;
      private short[] H00102_A10protID ;
      private short[] H00102_A1EmpID ;
      private String[] H00102_A74protDsc ;
      private bool[] H00102_n74protDsc ;
      private short[] H00103_A10protID ;
      private short[] H00103_A1EmpID ;
      private String[] H00103_A74protDsc ;
      private bool[] H00103_n74protDsc ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class viewprototipo__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV13protID",SqlDbType.SmallInt,4,0}
          } ;
          Object[] prmH00103 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H00102", "SELECT [protID], [EmpID], [protDsc] FROM [Prototipo] WITH (NOLOCK) WHERE [EmpID] = @AV12EmpID and [protID] = @AV13protID ORDER BY [EmpID], [protID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00102,1,0,true,true )
             ,new CursorDef("H00103", "SELECT [protID], [EmpID], [protDsc] FROM [Prototipo] WITH (NOLOCK) WHERE ([EmpID] = @AV12EmpID and [protID] = @AV13protID) AND ([EmpID] = @AV12EmpID and [protID] = @AV13protID) ORDER BY [EmpID], [protID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00103,1,0,false,true )
          };
       }
    }
