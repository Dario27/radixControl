/*
       ...
       Generated on: 10/28/2022 21:30:52.96
...
namespace GeneXus.Programs {
   public class gx02b6 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx02b6( )
      {
      ...
      public gx02b6( IGxContext context )
      {
                           ...
                           out short aP6_pstockDetID )
      {
         ...
         this.AV12pTipoInv = aP5_pTipoInv;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cstockDetID, AV7pstockAnio, AV8pstockMes, AV9pEmpID, AV10pAgeID, AV11pBodCod, AV12pTipoInv) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102821305317", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx02b6.aspx") + "?" + UrlEncode("" +AV7pstockAnio) + "," + UrlEncode("" +AV8pstockMes) + "," + UrlEncode("" +AV9pEmpID) + "," + UrlEncode("" +AV10pAgeID) + "," + UrlEncode("" +AV11pBodCod) + "," + UrlEncode(StringUtil.RTrim(AV12pTipoInv)) + "," + UrlEncode("" +AV13pstockDetID)+"\">") ;
      ...
      {
         return formatLink("gx02b6.aspx") + "?" + UrlEncode("" +AV7pstockAnio) + "," + UrlEncode("" +AV8pstockMes) + "," + UrlEncode("" +AV9pEmpID) + "," + UrlEncode("" +AV10pAgeID) + "," + UrlEncode("" +AV11pBodCod) + "," + UrlEncode(StringUtil.RTrim(AV12pTipoInv)) + "," + UrlEncode("" +AV13pstockDetID) ;
      }
      ...
      protected void WB5G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblstockdetidfilter_Internalname, "stock Det ID", "", "", lblLblstockdetidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e115g1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02B6.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e125g1_client"+"'", TempTags, "", 2, "HLP_Gx02B6.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 24 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx02B6.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF5G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H005G2 */
            pr_default.execute(0, new Object[] {AV7pstockAnio, AV8pstockMes, AV9pEmpID, AV10pAgeID, AV11pBodCod, AV12pTipoInv, AV6cstockDetID, GXPagingFrom2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_24_idx), 4, 0)), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A43TipoInv = H005G2_A43TipoInv[0];
               A42BodCod = H005G2_A42BodCod[0];
               A2AgeID = H005G2_A2AgeID[0];
               A1EmpID = H005G2_A1EmpID[0];
               A291stockMes = H005G2_A291stockMes[0];
               A290stockAnio = H005G2_A290stockAnio[0];
               A298costo = H005G2_A298costo[0];
               n298costo = H005G2_n298costo[0];
               A297stock = H005G2_A297stock[0];
               n297stock = H005G2_n297stock[0];
               A296cantidad = H005G2_A296cantidad[0];
               n296cantidad = H005G2_n296cantidad[0];
               A286PrdCod = H005G2_A286PrdCod[0];
               A348stockDetID = H005G2_A348stockDetID[0];
               /* Execute user event: Load */
               E145G2 ();
      ...
      {
         /* Using cursor H005G3 */
         pr_default.execute(1, new Object[] {AV7pstockAnio, AV8pstockMes, AV9pEmpID, AV10pAgeID, AV11pBodCod, AV12pTipoInv, AV6cstockDetID});
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11pBodCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11pBodCod), 4, 0)));
         AV12pTipoInv = (String)getParm(obj,5);
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12pTipoInv", AV12pTipoInv);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022102821305514", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx02b6.js", "?2022102821305514", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockDetID',fld:'vCSTOCKDETID',pic:'ZZZ9'},{av:'AV7pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV8pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV9pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV10pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV11pBodCod',fld:'vPBODCOD',pic:'ZZZ9'},{av:'AV12pTipoInv',fld:'vPTIPOINV',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E125G1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLSTOCKDETIDFILTER.CLICK","{handler:'E115G1',iparms:[{av:'divStockdetidfiltercontainer_Class',ctrl:'STOCKDETIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E155G2',iparms:[{av:'A348stockDetID',fld:'STOCKDETID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV13pstockDetID',fld:'vPSTOCKDETID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockDetID',fld:'vCSTOCKDETID',pic:'ZZZ9'},{av:'AV7pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV8pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV9pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV10pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV11pBodCod',fld:'vPBODCOD',pic:'ZZZ9'},{av:'AV12pTipoInv',fld:'vPTIPOINV',pic:''}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockDetID',fld:'vCSTOCKDETID',pic:'ZZZ9'},{av:'AV7pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV8pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV9pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV10pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV11pBodCod',fld:'vPBODCOD',pic:'ZZZ9'},{av:'AV12pTipoInv',fld:'vPTIPOINV',pic:''}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockDetID',fld:'vCSTOCKDETID',pic:'ZZZ9'},{av:'AV7pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV8pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV9pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV10pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV11pBodCod',fld:'vPBODCOD',pic:'ZZZ9'},{av:'AV12pTipoInv',fld:'vPTIPOINV',pic:''}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockDetID',fld:'vCSTOCKDETID',pic:'ZZZ9'},{av:'AV7pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV8pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV9pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV10pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV11pBodCod',fld:'vPBODCOD',pic:'ZZZ9'},{av:'AV12pTipoInv',fld:'vPTIPOINV',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H005G2_A43TipoInv = new String[] {""} ;
         H005G2_A42BodCod = new short[1] ;
         H005G2_A2AgeID = new short[1] ;
         H005G2_A1EmpID = new short[1] ;
         H005G2_A291stockMes = new short[1] ;
         H005G2_A290stockAnio = new short[1] ;
         H005G2_A298costo = new decimal[1] ;
         H005G2_n298costo = new bool[] {false} ;
         H005G2_A297stock = new decimal[1] ;
         H005G2_n297stock = new bool[] {false} ;
         H005G2_A296cantidad = new decimal[1] ;
         H005G2_n296cantidad = new bool[] {false} ;
         H005G2_A286PrdCod = new short[1] ;
         H005G2_A348stockDetID = new short[1] ;
         ...
         sImgUrl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx02b6__default(),
            new Object[][] {
                new Object[] {
               H005G2_A43TipoInv, H005G2_A42BodCod, H005G2_A2AgeID, H005G2_A1EmpID, H005G2_A291stockMes, H005G2_A290stockAnio, H005G2_A298costo, H005G2_n298costo, H005G2_A297stock, H005G2_n297stock,
               H005G2_A296cantidad, H005G2_n296cantidad, H005G2_A286PrdCod, H005G2_A348stockDetID
               }
               , new Object[] {
      ...
      private String wcpOAV12pTipoInv ;
      ...
      private String[] H005G2_A43TipoInv ;
      private short[] H005G2_A42BodCod ;
      private short[] H005G2_A2AgeID ;
      private short[] H005G2_A1EmpID ;
      private short[] H005G2_A291stockMes ;
      private short[] H005G2_A290stockAnio ;
      private decimal[] H005G2_A298costo ;
      private bool[] H005G2_n298costo ;
      private decimal[] H005G2_A297stock ;
      private bool[] H005G2_n297stock ;
      private decimal[] H005G2_A296cantidad ;
      private bool[] H005G2_n296cantidad ;
      private short[] H005G2_A286PrdCod ;
      private short[] H005G2_A348stockDetID ;
   ...
   public class gx02b6__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV12pTipoInv",SqlDbType.Char,4,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H005G2", "SELECT [TipoInv], [BodCod], [AgeID], [EmpID], [stockMes], [stockAnio], [costo], [stock], [cantidad], [PrdCod], [stockDetID] FROM [ProdxBodegaTipo] WITH (NOLOCK) WHERE [stockAnio] = @AV7pstockAnio and [stockMes] = @AV8pstockMes and [EmpID] = @AV9pEmpID and [AgeID] = @AV10pAgeID and [BodCod] = @AV11pBodCod and [TipoInv] = @AV12pTipoInv and [stockDetID] >= @AV6cstockDetID ORDER BY [stockAnio], [stockMes], [EmpID], [AgeID], [BodCod], [TipoInv], [stockDetID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005G2,11,0,false,false )
             ,new CursorDef("H005G3", "SELECT COUNT(*) FROM [ProdxBodegaTipo] WITH (NOLOCK) WHERE [stockAnio] = @AV7pstockAnio and [stockMes] = @AV8pstockMes and [EmpID] = @AV9pEmpID and [AgeID] = @AV10pAgeID and [BodCod] = @AV11pBodCod and [TipoInv] = @AV12pTipoInv and [stockDetID] >= @AV6cstockDetID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005G3,1,0,false,false )
          };
       }
    }
