/*
       ...
       Generated on: 10/30/2022 0:48:54.7
...
namespace GeneXus.Programs {
   public class gx02c0 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx02c0( )
      {
      ...
      public gx02c0( IGxContext context )
      {
      ...
      public void execute( out short aP0_pstockAnio ,
                           ...
                           out short aP4_pBodCod ,
                           out short aP5_pPrdCod )
      {
         ...
         aP4_pBodCod=this.AV17pBodCod;
         aP5_pPrdCod=this.AV18pPrdCod;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV11cPrdCod = (short)(NumberUtil.Val( GetNextPar( ), "."));
               AV12cprdStockDsc = GetNextPar( );
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cstockAnio, AV7cstockMes, AV8cEmpID, AV9cAgeID, AV10cBodCod, AV11cPrdCod, AV12cprdStockDsc) ;
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  ...
                  AV17pBodCod = (short)(NumberUtil.Val( GetNextPar( ), "."));
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV17pBodCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV17pBodCod), 4, 0)));
                  AV18pPrdCod = (short)(NumberUtil.Val( GetNextPar( ), "."));
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV18pPrdCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV18pPrdCod), 4, 0)));
               }
            }
            if ( context.isSpaRequest( ) )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202210300485440", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx02c0.aspx") + "?" + UrlEncode("" +AV13pstockAnio) + "," + UrlEncode("" +AV14pstockMes) + "," + UrlEncode("" +AV15pEmpID) + "," + UrlEncode("" +AV16pAgeID) + "," + UrlEncode("" +AV17pBodCod) + "," + UrlEncode("" +AV18pPrdCod)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCPRDCOD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11cPrdCod), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCPRDSTOCKDSC", AV12cprdStockDsc);
         /* Send saved values. */
         ...
         GxWebStd.gx_hidden_field( context, "vPBODCOD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17pBodCod), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "vPPRDCOD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV18pPrdCod), 4, 0, ",", "")));
         ...
         GxWebStd.gx_hidden_field( context, "PRDSTOCKDSCFILTERCONTAINER_Class", StringUtil.RTrim( divPrdstockdscfiltercontainer_Class));
      }
      ...
      {
         return formatLink("gx02c0.aspx") + "?" + UrlEncode("" +AV13pstockAnio) + "," + UrlEncode("" +AV14pstockMes) + "," + UrlEncode("" +AV15pEmpID) + "," + UrlEncode("" +AV16pAgeID) + "," + UrlEncode("" +AV17pBodCod) + "," + UrlEncode("" +AV18pPrdCod) ;
      }
      ...
      protected void WB5J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblstockaniofilter_Internalname, "Anio", "", "", lblLblstockaniofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e115j1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02C0.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCstockanio_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cstockAnio), 4, 0, ",", "")), ((edtavCstockanio_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6cstockAnio), "ZZZ9")) : context.localUtil.Format( (decimal)(AV6cstockAnio), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCstockanio_Jsonclick, 0, "Attribute", "", "", "", "", edtavCstockanio_Visible, edtavCstockanio_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx02C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblstockmesfilter_Internalname, "Mes", "", "", lblLblstockmesfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e125j1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCstockmes_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7cstockMes), 2, 0, ",", "")), ((edtavCstockmes_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV7cstockMes), "Z9")) : context.localUtil.Format( (decimal)(AV7cstockMes), "Z9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCstockmes_Jsonclick, 0, "Attribute", "", "", "", "", edtavCstockmes_Visible, edtavCstockmes_Enabled, 0, "number", "1", 2, "chr", 1, "row", 2, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx02C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblempidfilter_Internalname, "Emp ID", "", "", lblLblempidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e135j1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblageidfilter_Internalname, "Age ID", "", "", lblLblageidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e145j1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCageid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV9cAgeID), 4, 0, ",", "")), ((edtavCageid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV9cAgeID), "ZZZ9")) : context.localUtil.Format( (decimal)(AV9cAgeID), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCageid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCageid_Visible, edtavCageid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx02C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblbodcodfilter_Internalname, "Bod Cod", "", "", lblLblbodcodfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e155j1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprdcodfilter_Internalname, "ID", "", "", lblLblprdcodfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e165j1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprdcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11cPrdCod), 4, 0, ",", "")), ((edtavCprdcod_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV11cPrdCod), "ZZZ9")) : context.localUtil.Format( (decimal)(AV11cPrdCod), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprdcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprdcod_Visible, edtavCprdcod_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx02C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divPrdstockdscfiltercontainer_Internalname, 1, 0, "px", 0, "px", divPrdstockdscfiltercontainer_Class, "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprdstockdscfilter_Internalname, "Descripcion", "", "", lblLblprdstockdscfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e175j1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCprdstockdsc_Internalname, "Descripcion", "col-sm-3 AttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 76,'',false,'" + sGXsfl_84_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavCprdstockdsc_Internalname, AV12cprdStockDsc, StringUtil.RTrim( context.localUtil.Format( AV12cprdStockDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprdstockdsc_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprdstockdsc_Visible, edtavCprdstockdsc_Enabled, 0, "text", "", 80, "chr", 1, "row", 80, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_Gx02C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(84), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e185j1_client"+"'", TempTags, "", 2, "HLP_Gx02C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            else
            {
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", A307prdStockDsc);
               Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtprdStockDsc_Link));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( A293invFisico, 6, 2, ".", "")));
               Grid1Container.AddColumnProperties(Grid1Column);
         ...
         if ( wbEnd == 84 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(84), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx02C0.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCPRDCOD"), ",", ".") != Convert.ToDecimal( AV11cPrdCod )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Cprdstockdsc Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCPRDSTOCKDSC"), AV12cprdStockDsc) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void RF5J2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV11cPrdCod } ,
                                                 new int[]{
                                                 TypeConstants.STRING, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT
                                                 }
            } ) ;
            lV12cprdStockDsc = StringUtil.Concat( StringUtil.RTrim( AV12cprdStockDsc), "%", "");
            /* Using cursor H005J2 */
            pr_default.execute(0, new Object[] {AV6cstockAnio, AV7cstockMes, AV8cEmpID, AV9cAgeID, AV10cBodCod, AV11cPrdCod, lV12cprdStockDsc, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_84_idx = 1;
            sGXsfl_84_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_84_idx), 4, 0)), 4, "0");
            SubsflControlProps_842( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A293invFisico = H005J2_A293invFisico[0];
               n293invFisico = H005J2_n293invFisico[0];
               A307prdStockDsc = H005J2_A307prdStockDsc[0];
               n307prdStockDsc = H005J2_n307prdStockDsc[0];
               A286PrdCod = H005J2_A286PrdCod[0];
               A42BodCod = H005J2_A42BodCod[0];
               A2AgeID = H005J2_A2AgeID[0];
               A1EmpID = H005J2_A1EmpID[0];
               A291stockMes = H005J2_A291stockMes[0];
               A290stockAnio = H005J2_A290stockAnio[0];
               /* Execute user event: Load */
               E205J2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         lV12cprdStockDsc = StringUtil.Concat( StringUtil.RTrim( AV12cprdStockDsc), "%", "");
         /* Using cursor H005J3 */
         pr_default.execute(1, new Object[] {AV6cstockAnio, AV7cstockMes, AV8cEmpID, AV9cAgeID, AV10cBodCod, AV11cPrdCod, lV12cprdStockDsc});
      ...
      protected void STRUP5J0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCprdcod_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCprdcod_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV11cPrdCod = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11cPrdCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11cPrdCod), 4, 0)));
            }
            else
            {
               AV11cPrdCod = (short)(context.localUtil.CToN( cgiGet( edtavCprdcod_Internalname), ",", "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11cPrdCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11cPrdCod), 4, 0)));
            }
            AV12cprdStockDsc = cgiGet( edtavCprdstockdsc_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12cprdStockDsc", AV12cprdStockDsc);
            /* Read saved values. */
      ...
      protected void E215J2( )
      {
         ...
         AV16pAgeID = A2AgeID;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV16pAgeID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV16pAgeID), 4, 0)));
         AV17pBodCod = A42BodCod;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV17pBodCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV17pBodCod), 4, 0)));
         AV18pPrdCod = A286PrdCod;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV18pPrdCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV18pPrdCod), 4, 0)));
         context.setWebReturnParms(new Object[] {(short)AV13pstockAnio,(short)AV14pstockMes,(short)AV15pEmpID,(short)AV16pAgeID,(short)AV17pBodCod,(short)AV18pPrdCod});
         context.setWebReturnParmsMetadata(new Object[] {"AV13pstockAnio","AV14pstockMes","AV15pEmpID","AV16pAgeID","AV17pBodCod","AV18pPrdCod"});
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV16pAgeID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV16pAgeID), 4, 0)));
         AV17pBodCod = Convert.ToInt16(getParm(obj,4));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV17pBodCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV17pBodCod), 4, 0)));
         AV18pPrdCod = Convert.ToInt16(getParm(obj,5));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV18pPrdCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV18pPrdCod), 4, 0)));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202210300485993", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx02c0.js", "?202210300485994", false);
      ...
      protected void SubsflControlProps_842( )
      {
         ...
         edtprdStockDsc_Internalname = "PRDSTOCKDSC_"+sGXsfl_84_idx;
      ...
      protected void SubsflControlProps_fel_842( )
      {
         ...
         edtprdStockDsc_Internalname = "PRDSTOCKDSC_"+sGXsfl_84_fel_idx;
      ...
      protected void sendrow_842( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_84_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A290stockAnio), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A291stockMes), 2, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A1EmpID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A2AgeID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A42BodCod), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A286PrdCod), 4, 0, ",", "")))+"'"+"]);";
            ...
            edtprdStockDsc_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A290stockAnio), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A291stockMes), 2, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A1EmpID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A2AgeID), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A42BodCod), 4, 0, ",", "")))+"'"+", "+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A286PrdCod), 4, 0, ",", "")))+"'"+"]);";
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtprdStockDsc_Internalname, "Link", edtprdStockDsc_Link, !bGXsfl_84_Refreshing);
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtprdStockDsc_Internalname,(String)A307prdStockDsc,(String)"",(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)edtprdStockDsc_Link,(String)"",(String)"",(String)"",(String)edtprdStockDsc_Jsonclick,(short)0,(String)"DescriptionAttribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)80,(short)0,(short)0,(short)84,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtinvFisico_Internalname,StringUtil.LTrim( StringUtil.NToC( A293invFisico, 6, 2, ",", "")),context.localUtil.Format( A293invFisico, "ZZ9.99"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtinvFisico_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn OptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)6,(short)0,(short)0,(short)84,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
      ...
      protected void init_default_properties( )
      {
         ...
         lblLblprdstockdscfilter_Internalname = "LBLPRDSTOCKDSCFILTER";
         edtavCprdstockdsc_Internalname = "vCPRDSTOCKDSC";
         divPrdstockdscfiltercontainer_Internalname = "PRDSTOCKDSCFILTERCONTAINER";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavCprdstockdsc_Jsonclick = "";
         edtavCprdstockdsc_Enabled = 1;
         edtavCprdstockdsc_Visible = 1;
         ...
         divPrdstockdscfiltercontainer_Class = "AdvancedContainerItem";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockAnio',fld:'vCSTOCKANIO',pic:'ZZZ9'},{av:'AV7cstockMes',fld:'vCSTOCKMES',pic:'Z9'},{av:'AV8cEmpID',fld:'vCEMPID',pic:'ZZZ9'},{av:'AV9cAgeID',fld:'vCAGEID',pic:'ZZZ9'},{av:'AV10cBodCod',fld:'vCBODCOD',pic:'ZZZ9'},{av:'AV11cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV12cprdStockDsc',fld:'vCPRDSTOCKDSC',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E185J1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLSTOCKANIOFILTER.CLICK","{handler:'E115J1',iparms:[{av:'divStockaniofiltercontainer_Class',ctrl:'STOCKANIOFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLSTOCKMESFILTER.CLICK","{handler:'E125J1',iparms:[{av:'divStockmesfiltercontainer_Class',ctrl:'STOCKMESFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLEMPIDFILTER.CLICK","{handler:'E135J1',iparms:[{av:'divEmpidfiltercontainer_Class',ctrl:'EMPIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLAGEIDFILTER.CLICK","{handler:'E145J1',iparms:[{av:'divAgeidfiltercontainer_Class',ctrl:'AGEIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLBODCODFILTER.CLICK","{handler:'E155J1',iparms:[{av:'divBodcodfiltercontainer_Class',ctrl:'BODCODFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRDCODFILTER.CLICK","{handler:'E165J1',iparms:[{av:'divPrdcodfiltercontainer_Class',ctrl:'PRDCODFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLPRDSTOCKDSCFILTER.CLICK","{handler:'E175J1',iparms:[{av:'divPrdstockdscfiltercontainer_Class',ctrl:'PRDSTOCKDSCFILTERCONTAINER',prop:'Class'}]");
         setEventMetadata("LBLPRDSTOCKDSCFILTER.CLICK",",oparms:[{av:'divPrdstockdscfiltercontainer_Class',ctrl:'PRDSTOCKDSCFILTERCONTAINER',prop:'Class'},{av:'edtavCprdstockdsc_Visible',ctrl:'vCPRDSTOCKDSC',prop:'Visible'}]}");
         setEventMetadata("ENTER","{handler:'E215J2',iparms:[{av:'A290stockAnio',fld:'STOCKANIO',pic:'ZZZ9',hsh:true},{av:'A291stockMes',fld:'STOCKMES',pic:'Z9',hsh:true},{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A2AgeID',fld:'AGEID',pic:'ZZZ9',hsh:true},{av:'A42BodCod',fld:'BODCOD',pic:'ZZZ9',hsh:true},{av:'A286PrdCod',fld:'PRDCOD',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV13pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV14pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV15pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV16pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV17pBodCod',fld:'vPBODCOD',pic:'ZZZ9'},{av:'AV18pPrdCod',fld:'vPPRDCOD',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockAnio',fld:'vCSTOCKANIO',pic:'ZZZ9'},{av:'AV7cstockMes',fld:'vCSTOCKMES',pic:'Z9'},{av:'AV8cEmpID',fld:'vCEMPID',pic:'ZZZ9'},{av:'AV9cAgeID',fld:'vCAGEID',pic:'ZZZ9'},{av:'AV10cBodCod',fld:'vCBODCOD',pic:'ZZZ9'},{av:'AV11cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV12cprdStockDsc',fld:'vCPRDSTOCKDSC',pic:''}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockAnio',fld:'vCSTOCKANIO',pic:'ZZZ9'},{av:'AV7cstockMes',fld:'vCSTOCKMES',pic:'Z9'},{av:'AV8cEmpID',fld:'vCEMPID',pic:'ZZZ9'},{av:'AV9cAgeID',fld:'vCAGEID',pic:'ZZZ9'},{av:'AV10cBodCod',fld:'vCBODCOD',pic:'ZZZ9'},{av:'AV11cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV12cprdStockDsc',fld:'vCPRDSTOCKDSC',pic:''}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockAnio',fld:'vCSTOCKANIO',pic:'ZZZ9'},{av:'AV7cstockMes',fld:'vCSTOCKMES',pic:'Z9'},{av:'AV8cEmpID',fld:'vCEMPID',pic:'ZZZ9'},{av:'AV9cAgeID',fld:'vCAGEID',pic:'ZZZ9'},{av:'AV10cBodCod',fld:'vCBODCOD',pic:'ZZZ9'},{av:'AV11cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV12cprdStockDsc',fld:'vCPRDSTOCKDSC',pic:''}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockAnio',fld:'vCSTOCKANIO',pic:'ZZZ9'},{av:'AV7cstockMes',fld:'vCSTOCKMES',pic:'Z9'},{av:'AV8cEmpID',fld:'vCEMPID',pic:'ZZZ9'},{av:'AV9cAgeID',fld:'vCAGEID',pic:'ZZZ9'},{av:'AV10cBodCod',fld:'vCBODCOD',pic:'ZZZ9'},{av:'AV11cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV12cprdStockDsc',fld:'vCPRDSTOCKDSC',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         lblLblprdstockdscfilter_Jsonclick = "";
         ClassString = "";
         StyleString = "";
         ...
         scmdbuf = "";
         lV12cprdStockDsc = "";
         H005J2_A293invFisico = new decimal[1] ;
         H005J2_n293invFisico = new bool[] {false} ;
         H005J2_A307prdStockDsc = new String[] {""} ;
         H005J2_n307prdStockDsc = new bool[] {false} ;
         H005J2_A286PrdCod = new short[1] ;
         H005J2_A42BodCod = new short[1] ;
         H005J2_A2AgeID = new short[1] ;
         H005J2_A1EmpID = new short[1] ;
         H005J2_A291stockMes = new short[1] ;
         H005J2_A290stockAnio = new short[1] ;
         H005J3_AGRID1_nRecordCount = new long[1] ;
         ...
         sImgUrl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx02c0__default(),
            new Object[][] {
                new Object[] {
               H005J2_A293invFisico, H005J2_n293invFisico, H005J2_A307prdStockDsc, H005J2_n307prdStockDsc, H005J2_A286PrdCod, H005J2_A42BodCod, H005J2_A2AgeID, H005J2_A1EmpID, H005J2_A291stockMes, H005J2_A290stockAnio
               }
               , new Object[] {
      ...
      private int edtavCprdstockdsc_Visible ;
      private int edtavCprdstockdsc_Enabled ;
      ...
      private String divPrdstockdscfiltercontainer_Class ;
      ...
      private String divPrdstockdscfiltercontainer_Internalname ;
      private String lblLblprdstockdscfilter_Internalname ;
      private String lblLblprdstockdscfilter_Jsonclick ;
      private String edtavCprdstockdsc_Internalname ;
      private String edtavCprdstockdsc_Jsonclick ;
      ...
      private String edtprdStockDsc_Link ;
      ...
      private decimal[] H005J2_A293invFisico ;
      private bool[] H005J2_n293invFisico ;
      private String[] H005J2_A307prdStockDsc ;
      private bool[] H005J2_n307prdStockDsc ;
      private short[] H005J2_A286PrdCod ;
      private short[] H005J2_A42BodCod ;
      private short[] H005J2_A2AgeID ;
      private short[] H005J2_A1EmpID ;
      private short[] H005J2_A291stockMes ;
      private short[] H005J2_A290stockAnio ;
      private long[] H005J3_AGRID1_nRecordCount ;
      ...
      private short aP4_pBodCod ;
      private short aP5_pPrdCod ;
      private GXWebForm Form ;
   }

   public class gx02c0__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H005J2( IGxContext context ,
                                             String AV12cprdStockDsc ,
                                             String A307prdStockDsc ,
                                             short AV6cstockAnio ,
                                             short AV7cstockMes ,
                                             short AV8cEmpID ,
                                             short AV9cAgeID ,
                                             ...
                                             short AV11cPrdCod )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " [invFisico], [prdStockDsc], [PrdCod], [BodCod], [AgeID], [EmpID], [stockMes], [stockAnio]";
         sFromString = " FROM [ProdxBodega] WITH (NOLOCK)";
         sOrderString = "";
         sWhereString = sWhereString + " WHERE ([stockAnio] >= @AV6cstockAnio and [stockMes] >= @AV7cstockMes and [EmpID] >= @AV8cEmpID and [AgeID] >= @AV9cAgeID and [BodCod] >= @AV10cBodCod and [PrdCod] >= @AV11cPrdCod)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV12cprdStockDsc)) )
         {
            sWhereString = sWhereString + " and ([prdStockDsc] like @lV12cprdStockDsc)";
         }
         else
         {
            GXv_int1[6] = 1;
         }
         sOrderString = sOrderString + " ORDER BY [stockAnio], [stockMes], [EmpID], [AgeID], [BodCod], [PrdCod]";
                                             ...
                                             short AV11cPrdCod )
      {
         ...
         scmdbuf = scmdbuf + " WHERE ([stockAnio] >= @AV6cstockAnio and [stockMes] >= @AV7cstockMes and [EmpID] >= @AV8cEmpID and [AgeID] >= @AV9cAgeID and [BodCod] >= @AV10cBodCod and [PrdCod] >= @AV11cPrdCod)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV12cprdStockDsc)) )
         {
            sWhereString = sWhereString + " and ([prdStockDsc] like @lV12cprdStockDsc)";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005J2(context, (String)dynConstraints[0] , (String)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] );
               case 1 :
                     return conditional_H005J3(context, (String)dynConstraints[0] , (String)dynConstraints[1] , (short)dynConstraints[2] , (short)dynConstraints[3] , (short)dynConstraints[4] , (short)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV11cPrdCod",SqlDbType.SmallInt,4,0} ,
          new Object[] {"@lV12cprdStockDsc",SqlDbType.VarChar,80,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H005J2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005J2,11,0,false,false )
             ,new CursorDef("H005J3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005J3,1,0,false,false )
          };
       }
    }
