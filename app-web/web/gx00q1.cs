...
namespace GeneXus.Programs {
   public class gx00q1 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx00q1( )
      {
      ...
      public gx00q1( IGxContext context )
      {
                           ...
                           out short aP1_pcategID )
      {
         ...
         this.AV11pcategID = 0 ;
         executePrivate();
         aP1_pcategID=this.AV11pcategID;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV6ccategID = (short)(NumberUtil.Val( GetNextPar( ), "."));
               AV7ccategDsc = GetNextPar( );
               AV8ctipoProdID = (short)(NumberUtil.Val( GetNextPar( ), "."));
               AV9ccategEst = GetNextPar( );
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6ccategID, AV7ccategDsc, AV8ctipoProdID, AV9ccategEst, AV10pEmpID) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102620152923", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00q1.aspx") + "?" + UrlEncode("" +AV10pEmpID) + "," + UrlEncode("" +AV11pcategID)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCCATEGID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6ccategID), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCCATEGDSC", StringUtil.RTrim( AV7ccategDsc));
         GxWebStd.gx_hidden_field( context, "GXH_vCTIPOPRODID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8ctipoProdID), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCCATEGEST", StringUtil.RTrim( AV9ccategEst));
         /* Send saved values. */
      ...
      {
         return formatLink("gx00q1.aspx") + "?" + UrlEncode("" +AV10pEmpID) + "," + UrlEncode("" +AV11pcategID) ;
      }
      ...
      protected void WB2Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcategidfilter_Internalname, "Categ.ID", "", "", lblLblcategidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e112y1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx00Q1.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcategid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6ccategID), 4, 0, ",", "")), ((edtavCcategid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6ccategID), "ZZZ9")) : context.localUtil.Format( (decimal)(AV6ccategID), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcategid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcategid_Visible, edtavCcategid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx00Q1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcategdscfilter_Internalname, "Categoria", "", "", lblLblcategdscfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e122y1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx00Q1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcategdsc_Internalname, StringUtil.RTrim( AV7ccategDsc), StringUtil.RTrim( context.localUtil.Format( AV7ccategDsc, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,26);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcategdsc_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcategdsc_Visible, edtavCcategdsc_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_Gx00Q1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbltipoprodidfilter_Internalname, "tipo Prod ID", "", "", lblLbltipoprodidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e132y1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx00Q1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCtipoprodid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8ctipoProdID), 4, 0, ",", "")), ((edtavCtipoprodid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV8ctipoProdID), "ZZZ9")) : context.localUtil.Format( (decimal)(AV8ctipoProdID), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCtipoprodid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCtipoprodid_Visible, edtavCtipoprodid_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx00Q1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblcategestfilter_Internalname, "Estado", "", "", lblLblcategestfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e142y1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx00Q1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCcategest_Internalname, StringUtil.RTrim( AV9ccategEst), StringUtil.RTrim( context.localUtil.Format( AV9ccategEst, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCcategest_Jsonclick, 0, "Attribute", "", "", "", "", edtavCcategest_Visible, edtavCcategest_Enabled, 0, "text", "", 1, "chr", 1, "row", 1, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_Gx00Q1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(54), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e152y1_client"+"'", TempTags, "", 2, "HLP_Gx00Q1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 54 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(54), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx00Q1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCCATEGID"), ",", ".") != Convert.ToDecimal( AV6ccategID )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Ccategdsc Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCCATEGDSC"), AV7ccategDsc) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Ctipoprodid Changed */
                                       if ( ( context.localUtil.CToN( cgiGet( "GXH_vCTIPOPRODID"), ",", ".") != Convert.ToDecimal( AV8ctipoProdID )) )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Ccategest Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCCATEGEST"), AV9ccategEst) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void RF2Y2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV7ccategDsc = StringUtil.PadR( StringUtil.RTrim( AV7ccategDsc), 40, "%");
            lV9ccategEst = StringUtil.PadR( StringUtil.RTrim( AV9ccategEst), 1, "%");
            /* Using cursor H002Y2 */
            pr_default.execute(0, new Object[] {AV10pEmpID, AV6ccategID, lV7ccategDsc, AV8ctipoProdID, lV9ccategEst, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_54_idx = 1;
            sGXsfl_54_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_54_idx), 4, 0)), 4, "0");
            SubsflControlProps_542( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A1EmpID = H002Y2_A1EmpID[0];
               A147categEst = H002Y2_A147categEst[0];
               n147categEst = H002Y2_n147categEst[0];
               A31tipoProdID = H002Y2_A31tipoProdID[0];
               A146categDsc = H002Y2_A146categDsc[0];
               n146categDsc = H002Y2_n146categDsc[0];
               A32categID = H002Y2_A32categID[0];
               /* Execute user event: Load */
               E172Y2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_CATEGID"+"_"+sGXsfl_54_idx, GetSecureSignedToken( sGXsfl_54_idx, context.localUtil.Format( (decimal)(A32categID), "ZZZ9"), context));
      }
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         lV9ccategEst = StringUtil.PadR( StringUtil.RTrim( AV9ccategEst), 1, "%");
         /* Using cursor H002Y3 */
         pr_default.execute(1, new Object[] {AV10pEmpID, AV6ccategID, lV7ccategDsc, AV8ctipoProdID, lV9ccategEst});
      ...
      protected void STRUP2Y0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCcategid_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCcategid_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV6ccategID = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6ccategID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV6ccategID), 4, 0)));
            }
            else
            {
               AV6ccategID = (short)(context.localUtil.CToN( cgiGet( edtavCcategid_Internalname), ",", "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV6ccategID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV6ccategID), 4, 0)));
            }
            AV7ccategDsc = StringUtil.Upper( cgiGet( edtavCcategdsc_Internalname));
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7ccategDsc", AV7ccategDsc);
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCtipoprodid_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCtipoprodid_Internalname), ",", ".") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV8ctipoProdID = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8ctipoProdID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV8ctipoProdID), 4, 0)));
            }
            else
            {
               AV8ctipoProdID = (short)(context.localUtil.CToN( cgiGet( edtavCtipoprodid_Internalname), ",", "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8ctipoProdID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV8ctipoProdID), 4, 0)));
            }
            AV9ccategEst = cgiGet( edtavCcategest_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9ccategEst", AV9ccategEst);
            /* Read saved values. */
      ...
      {
         /* Enter Routine */
         AV11pcategID = A32categID;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11pcategID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11pcategID), 4, 0)));
         context.setWebReturnParms(new Object[] {(short)AV11pcategID});
         context.setWebReturnParmsMetadata(new Object[] {"AV11pcategID"});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022102620153183", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00q1.js", "?2022102620153185", false);
      ...
      protected void SubsflControlProps_542( )
      {
         ...
         edtcategDsc_Internalname = "CATEGDSC_"+sGXsfl_54_idx;
         edttipoProdID_Internalname = "TIPOPRODID_"+sGXsfl_54_idx;
         edtcategEst_Internalname = "CATEGEST_"+sGXsfl_54_idx;
      ...
      protected void SubsflControlProps_fel_542( )
      {
         ...
         edtcategDsc_Internalname = "CATEGDSC_"+sGXsfl_54_fel_idx;
         edttipoProdID_Internalname = "TIPOPRODID_"+sGXsfl_54_fel_idx;
         edtcategEst_Internalname = "CATEGEST_"+sGXsfl_54_fel_idx;
      ...
      protected void sendrow_542( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_54_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtavLinkselection_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A32categID), 4, 0, ",", "")))+"'"+"]);";
            ...
            edtcategDsc_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A32categID), 4, 0, ",", "")))+"'"+"]);";
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtcategDsc_Internalname, "Link", edtcategDsc_Link, !bGXsfl_54_Refreshing);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6ccategID',fld:'vCCATEGID',pic:'ZZZ9'},{av:'AV7ccategDsc',fld:'vCCATEGDSC',pic:'@!'},{av:'AV8ctipoProdID',fld:'vCTIPOPRODID',pic:'ZZZ9'},{av:'AV9ccategEst',fld:'vCCATEGEST',pic:''},{av:'AV10pEmpID',fld:'vPEMPID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E152Y1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLCATEGIDFILTER.CLICK","{handler:'E112Y1',iparms:[{av:'divCategidfiltercontainer_Class',ctrl:'CATEGIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLCATEGDSCFILTER.CLICK","{handler:'E122Y1',iparms:[{av:'divCategdscfiltercontainer_Class',ctrl:'CATEGDSCFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLTIPOPRODIDFILTER.CLICK","{handler:'E132Y1',iparms:[{av:'divTipoprodidfiltercontainer_Class',ctrl:'TIPOPRODIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLCATEGESTFILTER.CLICK","{handler:'E142Y1',iparms:[{av:'divCategestfiltercontainer_Class',ctrl:'CATEGESTFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E182Y2',iparms:[{av:'A32categID',fld:'CATEGID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV11pcategID',fld:'vPCATEGID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6ccategID',fld:'vCCATEGID',pic:'ZZZ9'},{av:'AV7ccategDsc',fld:'vCCATEGDSC',pic:'@!'},{av:'AV8ctipoProdID',fld:'vCTIPOPRODID',pic:'ZZZ9'},{av:'AV9ccategEst',fld:'vCCATEGEST',pic:''},{av:'AV10pEmpID',fld:'vPEMPID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6ccategID',fld:'vCCATEGID',pic:'ZZZ9'},{av:'AV7ccategDsc',fld:'vCCATEGDSC',pic:'@!'},{av:'AV8ctipoProdID',fld:'vCTIPOPRODID',pic:'ZZZ9'},{av:'AV9ccategEst',fld:'vCCATEGEST',pic:''},{av:'AV10pEmpID',fld:'vPEMPID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6ccategID',fld:'vCCATEGID',pic:'ZZZ9'},{av:'AV7ccategDsc',fld:'vCCATEGDSC',pic:'@!'},{av:'AV8ctipoProdID',fld:'vCTIPOPRODID',pic:'ZZZ9'},{av:'AV9ccategEst',fld:'vCCATEGEST',pic:''},{av:'AV10pEmpID',fld:'vPEMPID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6ccategID',fld:'vCCATEGID',pic:'ZZZ9'},{av:'AV7ccategDsc',fld:'vCCATEGDSC',pic:'@!'},{av:'AV8ctipoProdID',fld:'vCTIPOPRODID',pic:'ZZZ9'},{av:'AV9ccategEst',fld:'vCCATEGEST',pic:''},{av:'AV10pEmpID',fld:'vPEMPID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         lV7ccategDsc = "";
         lV9ccategEst = "";
         H002Y2_A1EmpID = new short[1] ;
         H002Y2_A147categEst = new String[] {""} ;
         H002Y2_n147categEst = new bool[] {false} ;
         H002Y2_A31tipoProdID = new short[1] ;
         H002Y2_A146categDsc = new String[] {""} ;
         H002Y2_n146categDsc = new bool[] {false} ;
         H002Y2_A32categID = new short[1] ;
         H002Y3_AGRID1_nRecordCount = new long[1] ;
         ...
         sImgUrl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00q1__default(),
            new Object[][] {
                new Object[] {
               H002Y2_A1EmpID, H002Y2_A147categEst, H002Y2_n147categEst, H002Y2_A31tipoProdID, H002Y2_A146categDsc, H002Y2_n146categDsc, H002Y2_A32categID
               }
               , new Object[] {
      ...
      private short AV6ccategID ;
      private short AV8ctipoProdID ;
      ...
      private String AV7ccategDsc ;
      private String AV9ccategEst ;
      ...
      private String lV7ccategDsc ;
      private String lV9ccategEst ;
      ...
      private short[] H002Y2_A1EmpID ;
      private String[] H002Y2_A147categEst ;
      private bool[] H002Y2_n147categEst ;
      private short[] H002Y2_A31tipoProdID ;
      private String[] H002Y2_A146categDsc ;
      private bool[] H002Y2_n146categDsc ;
      private short[] H002Y2_A32categID ;
      private long[] H002Y3_AGRID1_nRecordCount ;
   ...
   public class gx00q1__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A1EmpID )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " [EmpID], [categEst], [tipoProdID], [categDsc], [categID]";
         sFromString = " FROM [Categorias] WITH (NOLOCK)";
         sOrderString = "";
         sWhereString = sWhereString + " WHERE ([EmpID] = @AV10pEmpID and [categID] >= @AV6ccategID)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV7ccategDsc)) )
         {
            sWhereString = sWhereString + " and ([categDsc] like @lV7ccategDsc)";
         }
         else
         {
            GXv_int1[2] = 1;
         ...
         if ( ! (0==AV8ctipoProdID) )
         {
            sWhereString = sWhereString + " and ([tipoProdID] >= @AV8ctipoProdID)";
         }
         else
         {
            GXv_int1[3] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV9ccategEst)) )
         {
            sWhereString = sWhereString + " and ([categEst] like @lV9ccategEst)";
         }
         else
         {
            GXv_int1[4] = 1;
                                             ...
                                             short A1EmpID )
      {
         ...
         scmdbuf = scmdbuf + " WHERE ([EmpID] = @AV10pEmpID and [categID] >= @AV6ccategID)";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV7ccategDsc)) )
         {
            sWhereString = sWhereString + " and ([categDsc] like @lV7ccategDsc)";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H002Y2(context, (String)dynConstraints[0] , (short)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (short)dynConstraints[4] , (String)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] );
               case 1 :
                     return conditional_H002Y3(context, (String)dynConstraints[0] , (short)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (short)dynConstraints[4] , (String)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV6ccategID",SqlDbType.SmallInt,4,0} ,
          new Object[] {"@lV7ccategDsc",SqlDbType.Char,40,0} ,
          new Object[] {"@AV8ctipoProdID",SqlDbType.SmallInt,4,0} ,
          new Object[] {"@lV9ccategEst",SqlDbType.Char,1,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H002Y2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002Y2,11,0,false,false )
             ,new CursorDef("H002Y3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002Y3,1,0,false,false )
          };
       }
    }
