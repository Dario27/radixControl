/*
               File: ViewAgencias
        Description: View Agencias
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 11/19/2022 22:53:57.29
...
namespace GeneXus.Programs {
   public class viewagencias : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      public viewagencias( )
      {
      ...
      public viewagencias( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               {
                  AV13AgeID = (short)(NumberUtil.Val( GetNextPar( ), "."));
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13AgeID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13AgeID), 4, 0)));
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vAGEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13AgeID), "ZZZ9"), context));
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022111922535731", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewagencias.aspx") + "?" + UrlEncode("" +AV12EmpID) + "," + UrlEncode("" +AV13AgeID) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens = "hsh" + "ViewAgencias";
         forbiddenHiddens = forbiddenHiddens + StringUtil.RTrim( context.localUtil.Format( A46AgeDsc, ""));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens, GXKey));
         GXUtil.WriteLog("viewagencias:[SendSecurityCheck value for]"+"AgeDsc:"+StringUtil.RTrim( context.localUtil.Format( A46AgeDsc, "")));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vAGEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13AgeID), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vAGEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13AgeID), "ZZZ9"), context));
      ...
      protected void WB0V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Agencias Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewAgencias.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Agencias", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewAgencias.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtAgeDsc_Internalname, StringUtil.RTrim( A46AgeDsc), StringUtil.RTrim( context.localUtil.Format( A46AgeDsc, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtAgeDsc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtAgeDsc_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "Descripcion", "left", true, "HLP_ViewAgencias.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewAgencias.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblInventario_title_Internalname, "Movimientos Inventario", "", "", lblInventario_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewAgencias.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void START0V2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Agencias", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0V2( )
      {
         ...
         {
            /* Using cursor H000V2 */
            pr_default.execute(0, new Object[] {AV12EmpID, AV13AgeID});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A2AgeID = H000V2_A2AgeID[0];
               A1EmpID = H000V2_A1EmpID[0];
               A46AgeDsc = H000V2_A46AgeDsc[0];
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A46AgeDsc", A46AgeDsc);
               n46AgeDsc = H000V2_n46AgeDsc[0];
               /* Execute user event: Load */
               E120V2 ();
      ...
      protected void STRUP0V0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13AgeID = (short)(context.localUtil.CToN( cgiGet( "vAGEID"), ",", "."));
            ...
            {
               GXUtil.WriteLog("viewagencias:[SecurityCheckFailed value for]"+"AgeDsc:"+StringUtil.RTrim( context.localUtil.Format( A46AgeDsc, "")));
               GxWebError = 1;
      ...
      protected void E110V2( )
      {
         ...
         AV17GXLvl6 = 0;
         /* Using cursor H000V3 */
         pr_default.execute(1, new Object[] {AV12EmpID, AV13AgeID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A2AgeID = H000V3_A2AgeID[0];
            A1EmpID = H000V3_A1EmpID[0];
            A46AgeDsc = H000V3_A46AgeDsc[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A46AgeDsc", A46AgeDsc);
            n46AgeDsc = H000V3_n46AgeDsc[0];
            AV17GXLvl6 = 1;
            Form.Caption = A46AgeDsc;
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwagencias.aspx") ;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "AgenciasGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "agenciasgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "AgenciasGeneral";
               WebComp_Generalwc_Component = "AgenciasGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0030",(String)"",(short)AV12EmpID,(short)AV13AgeID});
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Inventariowc_Component), StringUtil.Lower( "AgenciasInventarioWC")) != 0 )
            {
               WebComp_Inventariowc = getWebComponent(GetType(), "GeneXus.Programs", "agenciasinventariowc", new Object[] {context} );
               WebComp_Inventariowc.ComponentInit();
               WebComp_Inventariowc.Name = "AgenciasInventarioWC";
               WebComp_Inventariowc_Component = "AgenciasInventarioWC";
            }
            if ( StringUtil.Len( WebComp_Inventariowc_Component) != 0 )
            {
               WebComp_Inventariowc.setjustcreated();
               WebComp_Inventariowc.componentprepare(new Object[] {(String)"W0038",(String)"",(short)AV12EmpID,(short)AV13AgeID});
               WebComp_Inventariowc.componentbind(new Object[] {(String)"",(String)""});
            }
            if ( isFullAjaxMode( ) )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0038"+"");
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12EmpID), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vEMPID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12EmpID), "ZZZ9"), context));
         AV13AgeID = Convert.ToInt16(getParm(obj,1));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13AgeID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13AgeID), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vAGEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV13AgeID), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022111922535762", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewagencias.js", "?2022111922535762", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12EmpID',fld:'vEMPID',pic:'ZZZ9',hsh:true},{av:'AV13AgeID',fld:'vAGEID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A46AgeDsc',fld:'AGEDSC',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000V2_A2AgeID = new short[1] ;
         H000V2_A1EmpID = new short[1] ;
         H000V2_A46AgeDsc = new String[] {""} ;
         H000V2_n46AgeDsc = new bool[] {false} ;
         hsh = "";
         H000V3_A2AgeID = new short[1] ;
         H000V3_A1EmpID = new short[1] ;
         H000V3_A46AgeDsc = new String[] {""} ;
         H000V3_n46AgeDsc = new bool[] {false} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewagencias__default(),
            new Object[][] {
                new Object[] {
               H000V2_A2AgeID, H000V2_A1EmpID, H000V2_A46AgeDsc, H000V2_n46AgeDsc
               }
               , new Object[] {
               H000V3_A2AgeID, H000V3_A1EmpID, H000V3_A46AgeDsc, H000V3_n46AgeDsc
               }
            }
         );
      ...
      private short AV13AgeID ;
      private short wcpOAV12EmpID ;
      private short wcpOAV13AgeID ;
      ...
      private short[] H000V2_A2AgeID ;
      private short[] H000V2_A1EmpID ;
      private String[] H000V2_A46AgeDsc ;
      private bool[] H000V2_n46AgeDsc ;
      private short[] H000V3_A2AgeID ;
      private short[] H000V3_A1EmpID ;
      private String[] H000V3_A46AgeDsc ;
      private bool[] H000V3_n46AgeDsc ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
   }

   public class viewagencias__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV13AgeID",SqlDbType.SmallInt,4,0}
          } ;
          Object[] prmH000V3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000V2", "SELECT [AgeID], [EmpID], [AgeDsc] FROM [Agencias] WITH (NOLOCK) WHERE [EmpID] = @AV12EmpID and [AgeID] = @AV13AgeID ORDER BY [EmpID], [AgeID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000V2,1,0,true,true )
             ,new CursorDef("H000V3", "SELECT [AgeID], [EmpID], [AgeDsc] FROM [Agencias] WITH (NOLOCK) WHERE ([EmpID] = @AV12EmpID and [AgeID] = @AV13AgeID) AND ([EmpID] = @AV12EmpID and [AgeID] = @AV13AgeID) ORDER BY [EmpID], [AgeID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000V3,1,0,false,true )
          };
       }
    }
