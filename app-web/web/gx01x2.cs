/*
       ...
       Generated on: 9/11/2022 0:26:48.23
...
namespace GeneXus.Programs {
   public class gx01x2 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx01x2( )
      {
      ...
      public gx01x2( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV8cvalAnt = NumberUtil.Val( GetNextPar( ), ".");
               AV9cvaloAct = NumberUtil.Val( GetNextPar( ), ".");
               AV10cUsuCod = GetNextPar( );
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cPrdCod, AV7cfecha, AV8cvalAnt, AV9cvaloAct, AV10cUsuCod, AV11pEmpID, AV12pAgeID) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20229110264827", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx01x2.aspx") + "?" + UrlEncode("" +AV11pEmpID) + "," + UrlEncode("" +AV12pAgeID) + "," + UrlEncode("" +AV13pPrdCod)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCVALANT", StringUtil.LTrim( StringUtil.NToC( AV8cvalAnt, 10, 2, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCVALOACT", StringUtil.LTrim( StringUtil.NToC( AV9cvaloAct, 10, 2, ",", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vCUSUCOD", StringUtil.RTrim( AV10cUsuCod));
         /* Send saved values. */
      ...
      {
         return formatLink("gx01x2.aspx") + "?" + UrlEncode("" +AV11pEmpID) + "," + UrlEncode("" +AV12pAgeID) + "," + UrlEncode("" +AV13pPrdCod) ;
      }
      ...
      protected void WB4S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblprdcodfilter_Internalname, "ID", "", "", lblLblprdcodfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e114s1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01X2.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCprdcod_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cPrdCod), 4, 0, ",", "")), ((edtavCprdcod_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6cPrdCod), "ZZZ9")) : context.localUtil.Format( (decimal)(AV6cPrdCod), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCprdcod_Jsonclick, 0, "Attribute", "", "", "", "", edtavCprdcod_Visible, edtavCprdcod_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01X2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblfechafilter_Internalname, "fecha", "", "", lblLblfechafilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e124s1_client"+"'", "", "WWAdvancedLabel WWDateFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01X2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblvalantfilter_Internalname, "Precio Anterior", "", "", lblLblvalantfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e134s1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01X2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCvalant_Internalname, StringUtil.LTrim( StringUtil.NToC( AV8cvalAnt, 13, 2, ",", "")), ((edtavCvalant_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( AV8cvalAnt, "ZZ,ZZZ,ZZZ.ZZ")) : context.localUtil.Format( AV8cvalAnt, "ZZ,ZZZ,ZZZ.ZZ")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, '.',',','2');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCvalant_Jsonclick, 0, "Attribute", "", "", "", "", edtavCvalant_Visible, edtavCvalant_Enabled, 0, "text", "", 13, "chr", 1, "row", 13, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01X2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblvaloactfilter_Internalname, "Precio Actual", "", "", lblLblvaloactfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e144s1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01X2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCvaloact_Internalname, StringUtil.LTrim( StringUtil.NToC( AV9cvaloAct, 13, 2, ",", "")), ((edtavCvaloact_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( AV9cvaloAct, "ZZ,ZZZ,ZZZ.ZZ")) : context.localUtil.Format( AV9cvaloAct, "ZZ,ZZZ,ZZZ.ZZ")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_decimal( this, '.',',','2');"+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCvaloact_Jsonclick, 0, "Attribute", "", "", "", "", edtavCvaloact_Visible, edtavCvaloact_Enabled, 0, "text", "", 13, "chr", 1, "row", 13, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01X2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblusucodfilter_Internalname, "Nombre de Usuario", "", "", lblLblusucodfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e154s1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01X2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCusucod_Internalname, StringUtil.RTrim( AV10cUsuCod), StringUtil.RTrim( context.localUtil.Format( AV10cUsuCod, "")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCusucod_Jsonclick, 0, "Attribute", "", "", "", "", edtavCusucod_Visible, edtavCusucod_Enabled, 0, "text", "", 15, "chr", 1, "row", 15, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_Gx01X2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(64), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e164s1_client"+"'", TempTags, "", 2, "HLP_Gx01X2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            else
            {
               ...
               Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtfecha_Link));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 64 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(64), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx01X2.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( context.localUtil.CToN( cgiGet( "GXH_vCVALANT"), ",", ".") != AV8cvalAnt )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Cvaloact Changed */
                                       if ( context.localUtil.CToN( cgiGet( "GXH_vCVALOACT"), ",", ".") != AV9cvaloAct )
                                       {
                                          Rfr0gs = true;
                                       }
                                       /* Set Refresh If Cusucod Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vCUSUCOD"), AV10cUsuCod) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void RF4S2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 A2AgeID } ,
                                                 new int[]{
                                                 TypeConstants.DATE, TypeConstants.DECIMAL, TypeConstants.DECIMAL, TypeConstants.STRING, TypeConstants.DATE, TypeConstants.BOOLEAN, TypeConstants.DECIMAL, TypeConstants.BOOLEAN, TypeConstants.DECIMAL, TypeConstants.BOOLEAN,
                                                 TypeConstants.STRING, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT, TypeConstants.SHORT
                                                 }
            } ) ;
            lV10cUsuCod = StringUtil.PadR( StringUtil.RTrim( AV10cUsuCod), 15, "%");
            /* Using cursor H004S2 */
            pr_default.execute(0, new Object[] {AV11pEmpID, AV12pAgeID, AV6cPrdCod, AV7cfecha, AV8cvalAnt, AV9cvaloAct, lV10cUsuCod, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_64_idx = 1;
            sGXsfl_64_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_64_idx), 4, 0)), 4, "0");
            SubsflControlProps_642( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A2AgeID = H004S2_A2AgeID[0];
               A1EmpID = H004S2_A1EmpID[0];
               A3UsuCod = H004S2_A3UsuCod[0];
               A304valoAct = H004S2_A304valoAct[0];
               n304valoAct = H004S2_n304valoAct[0];
               A303valAnt = H004S2_A303valAnt[0];
               n303valAnt = H004S2_n303valAnt[0];
               A302fecha = H004S2_A302fecha[0];
               n302fecha = H004S2_n302fecha[0];
               A286PrdCod = H004S2_A286PrdCod[0];
               /* Execute user event: Load */
               E184S2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         lV10cUsuCod = StringUtil.PadR( StringUtil.RTrim( AV10cUsuCod), 15, "%");
         /* Using cursor H004S3 */
         pr_default.execute(1, new Object[] {AV11pEmpID, AV12pAgeID, AV6cPrdCod, AV7cfecha, AV8cvalAnt, AV9cvaloAct, lV10cUsuCod});
      ...
      protected void STRUP4S0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCvalant_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCvalant_Internalname), ",", ".") > 9999999.99m ) ) )
            {
               ...
               wbErr = true;
               AV8cvalAnt = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cvalAnt", StringUtil.LTrim( StringUtil.Str( AV8cvalAnt, 10, 2)));
            }
            else
            {
               AV8cvalAnt = context.localUtil.CToN( cgiGet( edtavCvalant_Internalname), ",", ".");
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8cvalAnt", StringUtil.LTrim( StringUtil.Str( AV8cvalAnt, 10, 2)));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavCvaloact_Internalname), ",", ".") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavCvaloact_Internalname), ",", ".") > 9999999.99m ) ) )
            {
               ...
               wbErr = true;
               AV9cvaloAct = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9cvaloAct", StringUtil.LTrim( StringUtil.Str( AV9cvaloAct, 10, 2)));
            }
            else
            {
               AV9cvaloAct = context.localUtil.CToN( cgiGet( edtavCvaloact_Internalname), ",", ".");
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV9cvaloAct", StringUtil.LTrim( StringUtil.Str( AV9cvaloAct, 10, 2)));
            }
            AV10cUsuCod = cgiGet( edtavCusucod_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10cUsuCod", AV10cUsuCod);
            /* Read saved values. */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20229110264912", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx01x2.js", "?20229110264912", false);
      ...
      protected void SubsflControlProps_642( )
      {
         ...
         edtfecha_Internalname = "FECHA_"+sGXsfl_64_idx;
         edtvalAnt_Internalname = "VALANT_"+sGXsfl_64_idx;
         edtvaloAct_Internalname = "VALOACT_"+sGXsfl_64_idx;
         edtUsuCod_Internalname = "USUCOD_"+sGXsfl_64_idx;
      ...
      protected void SubsflControlProps_fel_642( )
      {
         ...
         edtfecha_Internalname = "FECHA_"+sGXsfl_64_fel_idx;
         edtvalAnt_Internalname = "VALANT_"+sGXsfl_64_fel_idx;
         edtvaloAct_Internalname = "VALOACT_"+sGXsfl_64_fel_idx;
         edtUsuCod_Internalname = "USUCOD_"+sGXsfl_64_fel_idx;
      ...
      protected void sendrow_642( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_64_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtfecha_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A286PrdCod), 4, 0, ",", "")))+"'"+"]);";
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtfecha_Internalname, "Link", edtfecha_Link, !bGXsfl_64_Refreshing);
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtfecha_Internalname,context.localUtil.Format(A302fecha, "99/99/99"),context.localUtil.Format( A302fecha, "99/99/99"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)edtfecha_Link,(String)"",(String)"",(String)"",(String)edtfecha_Jsonclick,(short)0,(String)"DescriptionAttribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)8,(short)0,(short)0,(short)64,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV7cfecha',fld:'vCFECHA',pic:''},{av:'AV8cvalAnt',fld:'vCVALANT',pic:'ZZ,ZZZ,ZZZ.ZZ'},{av:'AV9cvaloAct',fld:'vCVALOACT',pic:'ZZ,ZZZ,ZZZ.ZZ'},{av:'AV10cUsuCod',fld:'vCUSUCOD',pic:''},{av:'AV11pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV12pAgeID',fld:'vPAGEID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E164S1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLPRDCODFILTER.CLICK","{handler:'E114S1',iparms:[{av:'divPrdcodfiltercontainer_Class',ctrl:'PRDCODFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLFECHAFILTER.CLICK","{handler:'E124S1',iparms:[{av:'divFechafiltercontainer_Class',ctrl:'FECHAFILTERCONTAINER',prop:'Class'}]");
         setEventMetadata("LBLFECHAFILTER.CLICK",",oparms:[{av:'divFechafiltercontainer_Class',ctrl:'FECHAFILTERCONTAINER',prop:'Class'}]}");
         setEventMetadata("LBLVALANTFILTER.CLICK","{handler:'E134S1',iparms:[{av:'divValantfiltercontainer_Class',ctrl:'VALANTFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLVALOACTFILTER.CLICK","{handler:'E144S1',iparms:[{av:'divValoactfiltercontainer_Class',ctrl:'VALOACTFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLUSUCODFILTER.CLICK","{handler:'E154S1',iparms:[{av:'divUsucodfiltercontainer_Class',ctrl:'USUCODFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E194S2',iparms:[{av:'A286PrdCod',fld:'PRDCOD',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV13pPrdCod',fld:'vPPRDCOD',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV7cfecha',fld:'vCFECHA',pic:''},{av:'AV8cvalAnt',fld:'vCVALANT',pic:'ZZ,ZZZ,ZZZ.ZZ'},{av:'AV9cvaloAct',fld:'vCVALOACT',pic:'ZZ,ZZZ,ZZZ.ZZ'},{av:'AV10cUsuCod',fld:'vCUSUCOD',pic:''},{av:'AV11pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV12pAgeID',fld:'vPAGEID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV7cfecha',fld:'vCFECHA',pic:''},{av:'AV8cvalAnt',fld:'vCVALANT',pic:'ZZ,ZZZ,ZZZ.ZZ'},{av:'AV9cvaloAct',fld:'vCVALOACT',pic:'ZZ,ZZZ,ZZZ.ZZ'},{av:'AV10cUsuCod',fld:'vCUSUCOD',pic:''},{av:'AV11pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV12pAgeID',fld:'vPAGEID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV7cfecha',fld:'vCFECHA',pic:''},{av:'AV8cvalAnt',fld:'vCVALANT',pic:'ZZ,ZZZ,ZZZ.ZZ'},{av:'AV9cvaloAct',fld:'vCVALOACT',pic:'ZZ,ZZZ,ZZZ.ZZ'},{av:'AV10cUsuCod',fld:'vCUSUCOD',pic:''},{av:'AV11pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV12pAgeID',fld:'vPAGEID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cPrdCod',fld:'vCPRDCOD',pic:'ZZZ9'},{av:'AV7cfecha',fld:'vCFECHA',pic:''},{av:'AV8cvalAnt',fld:'vCVALANT',pic:'ZZ,ZZZ,ZZZ.ZZ'},{av:'AV9cvaloAct',fld:'vCVALOACT',pic:'ZZ,ZZZ,ZZZ.ZZ'},{av:'AV10cUsuCod',fld:'vCUSUCOD',pic:''},{av:'AV11pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV12pAgeID',fld:'vPAGEID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV10cUsuCod = "";
         H004S2_A2AgeID = new short[1] ;
         H004S2_A1EmpID = new short[1] ;
         H004S2_A3UsuCod = new String[] {""} ;
         H004S2_A304valoAct = new decimal[1] ;
         H004S2_n304valoAct = new bool[] {false} ;
         H004S2_A303valAnt = new decimal[1] ;
         H004S2_n303valAnt = new bool[] {false} ;
         H004S2_A302fecha = new DateTime[] {DateTime.MinValue} ;
         H004S2_n302fecha = new bool[] {false} ;
         H004S2_A286PrdCod = new short[1] ;
         H004S3_AGRID1_nRecordCount = new long[1] ;
         ...
         sImgUrl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx01x2__default(),
            new Object[][] {
                new Object[] {
               H004S2_A2AgeID, H004S2_A1EmpID, H004S2_A3UsuCod, H004S2_A304valoAct, H004S2_n304valoAct, H004S2_A303valAnt, H004S2_n303valAnt, H004S2_A302fecha, H004S2_n302fecha, H004S2_A286PrdCod
               }
               , new Object[] {
      ...
      private decimal AV8cvalAnt ;
      private decimal AV9cvaloAct ;
      ...
      private short[] H004S2_A2AgeID ;
      private short[] H004S2_A1EmpID ;
      private String[] H004S2_A3UsuCod ;
      private decimal[] H004S2_A304valoAct ;
      private bool[] H004S2_n304valoAct ;
      private decimal[] H004S2_A303valAnt ;
      private bool[] H004S2_n303valAnt ;
      private DateTime[] H004S2_A302fecha ;
      private bool[] H004S2_n302fecha ;
      private short[] H004S2_A286PrdCod ;
      private long[] H004S3_AGRID1_nRecordCount ;
   ...
   public class gx01x2__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short A2AgeID )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " [AgeID], [EmpID], [UsuCod], [valoAct], [valAnt], [fecha], [PrdCod]";
         ...
         if ( ! (DateTime.MinValue==AV7cfecha) )
         {
            sWhereString = sWhereString + " and ([fecha] >= @AV7cfecha)";
         }
         else
         {
            GXv_int1[3] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV8cvalAnt) )
         {
            sWhereString = sWhereString + " and ([valAnt] >= @AV8cvalAnt)";
         }
         else
         {
            GXv_int1[4] = 1;
         }
         if ( ! (Convert.ToDecimal(0)==AV9cvaloAct) )
         {
            sWhereString = sWhereString + " and ([valoAct] >= @AV9cvaloAct)";
         }
         else
         {
            GXv_int1[5] = 1;
         }
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV10cUsuCod)) )
         {
            sWhereString = sWhereString + " and ([UsuCod] like @lV10cUsuCod)";
         }
         else
         {
            GXv_int1[6] = 1;
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004S2(context, (DateTime)dynConstraints[0] , (decimal)dynConstraints[1] , (decimal)dynConstraints[2] , (String)dynConstraints[3] , (DateTime)dynConstraints[4] , (decimal)dynConstraints[5] , (decimal)dynConstraints[6] , (String)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] , (short)dynConstraints[10] , (short)dynConstraints[11] , (short)dynConstraints[12] );
               case 1 :
                     return conditional_H004S3(context, (DateTime)dynConstraints[0] , (decimal)dynConstraints[1] , (decimal)dynConstraints[2] , (String)dynConstraints[3] , (DateTime)dynConstraints[4] , (decimal)dynConstraints[5] , (decimal)dynConstraints[6] , (String)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] , (short)dynConstraints[10] , (short)dynConstraints[11] , (short)dynConstraints[12] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV8cvalAnt",SqlDbType.Decimal,10,2} ,
          new Object[] {"@AV9cvaloAct",SqlDbType.Decimal,10,2} ,
          new Object[] {"@lV10cUsuCod",SqlDbType.Char,15,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H004S2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004S2,11,0,false,false )
             ,new CursorDef("H004S3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004S3,1,0,false,false )
          };
       }
    }
