/*
               File: Gx02D6
        Description: Selection List TipoInv
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 1/9/2023 12:20:52.50
...
namespace GeneXus.Programs {
   public class gx02d6 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx02d6( )
      {
      ...
      public gx02d6( IGxContext context )
      {
                           ...
                           out short aP6_pstockDetID )
      {
         ...
         executePrivate();
         aP6_pstockDetID=this.AV13pstockDetID;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cstockDetID, AV7pstockAnio, AV8pstockMes, AV9pEmpID, AV10pAgeID, AV11pBodCod, AV12pPrdCod) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231912205276", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx02d6.aspx") + "?" + UrlEncode("" +AV7pstockAnio) + "," + UrlEncode("" +AV8pstockMes) + "," + UrlEncode("" +AV9pEmpID) + "," + UrlEncode("" +AV10pAgeID) + "," + UrlEncode("" +AV11pBodCod) + "," + UrlEncode("" +AV12pPrdCod) + "," + UrlEncode("" +AV13pstockDetID)+"\">") ;
      ...
      {
         return formatLink("gx02d6.aspx") + "?" + UrlEncode("" +AV7pstockAnio) + "," + UrlEncode("" +AV8pstockMes) + "," + UrlEncode("" +AV9pEmpID) + "," + UrlEncode("" +AV10pAgeID) + "," + UrlEncode("" +AV11pBodCod) + "," + UrlEncode("" +AV12pPrdCod) + "," + UrlEncode("" +AV13pstockDetID) ;
      }
      ...
      protected void WB5K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblstockdetidfilter_Internalname, "stock Det ID", "", "", lblLblstockdetidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e115k1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx02D6.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e125k1_client"+"'", TempTags, "", 2, "HLP_Gx02D6.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            else
            {
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( A296cantidad, 10, 2, ".", "")));
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A351stockDetNroDoc), 4, 0, ".", "")));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.RTrim( A352stockdetTipo));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A5ClienteID), 4, 0, ".", "")));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", context.localUtil.Format(A374fchMovStock, "99/99/9999"));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", context.localUtil.TToC( A375hraMovStock, 10, 8, 0, 3, "/", ":", " "));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 24 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx02D6.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START5K2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Selection List TipoInv", 0) ;
         }
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              A374fchMovStock = DateTimeUtil.ResetTime(context.localUtil.CToT( cgiGet( edtfchMovStock_Internalname), 0));
                              n374fchMovStock = false;
                              A375hraMovStock = DateTimeUtil.ResetDate(context.localUtil.CToT( cgiGet( edthraMovStock_Internalname), 0));
      ...
      protected void RF5K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H005K2 */
            pr_default.execute(0, new Object[] {AV7pstockAnio, AV8pstockMes, AV9pEmpID, AV10pAgeID, AV11pBodCod, AV12pPrdCod, AV6cstockDetID, GXPagingFrom2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_24_idx), 4, 0)), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A286PrdCod = H005K2_A286PrdCod[0];
               A42BodCod = H005K2_A42BodCod[0];
               A2AgeID = H005K2_A2AgeID[0];
               A1EmpID = H005K2_A1EmpID[0];
               A291stockMes = H005K2_A291stockMes[0];
               A290stockAnio = H005K2_A290stockAnio[0];
               A375hraMovStock = H005K2_A375hraMovStock[0];
               n375hraMovStock = H005K2_n375hraMovStock[0];
               A374fchMovStock = H005K2_A374fchMovStock[0];
               n374fchMovStock = H005K2_n374fchMovStock[0];
               A5ClienteID = H005K2_A5ClienteID[0];
               A352stockdetTipo = H005K2_A352stockdetTipo[0];
               n352stockdetTipo = H005K2_n352stockdetTipo[0];
               A351stockDetNroDoc = H005K2_A351stockDetNroDoc[0];
               n351stockDetNroDoc = H005K2_n351stockDetNroDoc[0];
               A298costo = H005K2_A298costo[0];
               n298costo = H005K2_n298costo[0];
               A297stock = H005K2_A297stock[0];
               n297stock = H005K2_n297stock[0];
               A296cantidad = H005K2_A296cantidad[0];
               n296cantidad = H005K2_n296cantidad[0];
               A43TipoInv = H005K2_A43TipoInv[0];
               A348stockDetID = H005K2_A348stockDetID[0];
               /* Execute user event: Load */
               E145K2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_STOCKDETID"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, context.localUtil.Format( (decimal)(A348stockDetID), "ZZZ9"), context));
      }
      ...
      {
         /* Using cursor H005K3 */
         pr_default.execute(1, new Object[] {AV7pstockAnio, AV8pstockMes, AV9pEmpID, AV10pAgeID, AV11pBodCod, AV12pPrdCod, AV6cstockDetID});
         GRID1_nRecordCount = H005K3_AGRID1_nRecordCount[0];
         pr_default.close(1);
      ...
      {
         /* Start Routine */
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "TipoInv", "", "", "", "", "", "", "", "");
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12pPrdCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12pPrdCod), 4, 0)));
         AV13pstockDetID = Convert.ToInt16(getParm(obj,6));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13pstockDetID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV13pstockDetID), 4, 0)));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20231912205574", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx02d6.js", "?20231912205575", false);
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtstockDetID_Internalname = "STOCKDETID_"+sGXsfl_24_idx;
         edtTipoInv_Internalname = "TIPOINV_"+sGXsfl_24_idx;
         edtcantidad_Internalname = "CANTIDAD_"+sGXsfl_24_idx;
         edtstock_Internalname = "STOCK_"+sGXsfl_24_idx;
         edtcosto_Internalname = "COSTO_"+sGXsfl_24_idx;
         edtstockDetNroDoc_Internalname = "STOCKDETNRODOC_"+sGXsfl_24_idx;
         edtstockdetTipo_Internalname = "STOCKDETTIPO_"+sGXsfl_24_idx;
         edtClienteID_Internalname = "CLIENTEID_"+sGXsfl_24_idx;
         edtfchMovStock_Internalname = "FCHMOVSTOCK_"+sGXsfl_24_idx;
         edthraMovStock_Internalname = "HRAMOVSTOCK_"+sGXsfl_24_idx;
      ...
      protected void SubsflControlProps_fel_242( )
      {
         ...
         edtstockDetID_Internalname = "STOCKDETID_"+sGXsfl_24_fel_idx;
         edtTipoInv_Internalname = "TIPOINV_"+sGXsfl_24_fel_idx;
         edtcantidad_Internalname = "CANTIDAD_"+sGXsfl_24_fel_idx;
         edtstock_Internalname = "STOCK_"+sGXsfl_24_fel_idx;
         edtcosto_Internalname = "COSTO_"+sGXsfl_24_fel_idx;
         edtstockDetNroDoc_Internalname = "STOCKDETNRODOC_"+sGXsfl_24_fel_idx;
         edtstockdetTipo_Internalname = "STOCKDETTIPO_"+sGXsfl_24_fel_idx;
         edtClienteID_Internalname = "CLIENTEID_"+sGXsfl_24_fel_idx;
         edtfchMovStock_Internalname = "FCHMOVSTOCK_"+sGXsfl_24_fel_idx;
         edthraMovStock_Internalname = "HRAMOVSTOCK_"+sGXsfl_24_fel_idx;
      ...
      protected void sendrow_242( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_24_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtcantidad_Internalname, "Link", edtcantidad_Link, !bGXsfl_24_Refreshing);
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtcantidad_Internalname,StringUtil.LTrim( StringUtil.NToC( A296cantidad, 10, 2, ",", "")),context.localUtil.Format( A296cantidad, "ZZZ.ZZ9.99"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)edtcantidad_Link,(String)"",(String)"",(String)"",(String)edtcantidad_Jsonclick,(short)0,(String)"DescriptionAttribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)10,(short)0,(short)0,(short)24,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtstockDetNroDoc_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A351stockDetNroDoc), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A351stockDetNroDoc), "ZZZ9"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtstockDetNroDoc_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn OptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)24,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtstockdetTipo_Internalname,StringUtil.RTrim( A352stockdetTipo),(String)"",(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtstockdetTipo_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn OptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)24,(short)1,(short)-1,(short)-1,(bool)true,(String)"",(String)"left",(bool)true});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edthraMovStock_Internalname,context.localUtil.TToC( A375hraMovStock, 10, 8, 0, 3, "/", ":", " "),context.localUtil.Format( A375hraMovStock, "99:99"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edthraMovStock_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn OptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)5,(short)0,(short)0,(short)24,(short)1,(short)-1,(short)0,(bool)true,(String)"GeneXus\\Time",(String)"right",(bool)false});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List TipoInv";
         subGrid1_Rows = 10;
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockDetID',fld:'vCSTOCKDETID',pic:'ZZZ9'},{av:'AV7pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV8pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV9pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV10pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV11pBodCod',fld:'vPBODCOD',pic:'ZZZ9'},{av:'AV12pPrdCod',fld:'vPPRDCOD',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E125K1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLSTOCKDETIDFILTER.CLICK","{handler:'E115K1',iparms:[{av:'divStockdetidfiltercontainer_Class',ctrl:'STOCKDETIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E155K2',iparms:[{av:'A348stockDetID',fld:'STOCKDETID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV13pstockDetID',fld:'vPSTOCKDETID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockDetID',fld:'vCSTOCKDETID',pic:'ZZZ9'},{av:'AV7pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV8pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV9pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV10pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV11pBodCod',fld:'vPBODCOD',pic:'ZZZ9'},{av:'AV12pPrdCod',fld:'vPPRDCOD',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockDetID',fld:'vCSTOCKDETID',pic:'ZZZ9'},{av:'AV7pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV8pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV9pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV10pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV11pBodCod',fld:'vPBODCOD',pic:'ZZZ9'},{av:'AV12pPrdCod',fld:'vPPRDCOD',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockDetID',fld:'vCSTOCKDETID',pic:'ZZZ9'},{av:'AV7pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV8pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV9pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV10pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV11pBodCod',fld:'vPBODCOD',pic:'ZZZ9'},{av:'AV12pPrdCod',fld:'vPPRDCOD',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cstockDetID',fld:'vCSTOCKDETID',pic:'ZZZ9'},{av:'AV7pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV8pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV9pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV10pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV11pBodCod',fld:'vPBODCOD',pic:'ZZZ9'},{av:'AV12pPrdCod',fld:'vPPRDCOD',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H005K2_A286PrdCod = new short[1] ;
         H005K2_A42BodCod = new short[1] ;
         H005K2_A2AgeID = new short[1] ;
         H005K2_A1EmpID = new short[1] ;
         H005K2_A291stockMes = new short[1] ;
         H005K2_A290stockAnio = new short[1] ;
         H005K2_A375hraMovStock = new DateTime[] {DateTime.MinValue} ;
         H005K2_n375hraMovStock = new bool[] {false} ;
         H005K2_A374fchMovStock = new DateTime[] {DateTime.MinValue} ;
         H005K2_n374fchMovStock = new bool[] {false} ;
         H005K2_A5ClienteID = new short[1] ;
         H005K2_A352stockdetTipo = new String[] {""} ;
         H005K2_n352stockdetTipo = new bool[] {false} ;
         H005K2_A351stockDetNroDoc = new short[1] ;
         H005K2_n351stockDetNroDoc = new bool[] {false} ;
         H005K2_A298costo = new decimal[1] ;
         H005K2_n298costo = new bool[] {false} ;
         H005K2_A297stock = new decimal[1] ;
         H005K2_n297stock = new bool[] {false} ;
         H005K2_A296cantidad = new decimal[1] ;
         H005K2_n296cantidad = new bool[] {false} ;
         H005K2_A43TipoInv = new String[] {""} ;
         H005K2_A348stockDetID = new short[1] ;
         H005K3_AGRID1_nRecordCount = new long[1] ;
         ...
         sImgUrl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx02d6__default(),
            new Object[][] {
                new Object[] {
               H005K2_A286PrdCod, H005K2_A42BodCod, H005K2_A2AgeID, H005K2_A1EmpID, H005K2_A291stockMes, H005K2_A290stockAnio, H005K2_A375hraMovStock, H005K2_n375hraMovStock, H005K2_A374fchMovStock, H005K2_n374fchMovStock,
               H005K2_A5ClienteID, H005K2_A352stockdetTipo, H005K2_n352stockdetTipo, H005K2_A351stockDetNroDoc, H005K2_n351stockDetNroDoc, H005K2_A298costo, H005K2_n298costo, H005K2_A297stock, H005K2_n297stock, H005K2_A296cantidad,
               H005K2_n296cantidad, H005K2_A43TipoInv, H005K2_A348stockDetID
               }
               , new Object[] {
               H005K3_AGRID1_nRecordCount
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] H005K2_A286PrdCod ;
      private short[] H005K2_A42BodCod ;
      private short[] H005K2_A2AgeID ;
      private short[] H005K2_A1EmpID ;
      private short[] H005K2_A291stockMes ;
      private short[] H005K2_A290stockAnio ;
      private DateTime[] H005K2_A375hraMovStock ;
      private bool[] H005K2_n375hraMovStock ;
      private DateTime[] H005K2_A374fchMovStock ;
      private bool[] H005K2_n374fchMovStock ;
      private short[] H005K2_A5ClienteID ;
      private String[] H005K2_A352stockdetTipo ;
      private bool[] H005K2_n352stockdetTipo ;
      private short[] H005K2_A351stockDetNroDoc ;
      private bool[] H005K2_n351stockDetNroDoc ;
      private decimal[] H005K2_A298costo ;
      private bool[] H005K2_n298costo ;
      private decimal[] H005K2_A297stock ;
      private bool[] H005K2_n297stock ;
      private decimal[] H005K2_A296cantidad ;
      private bool[] H005K2_n296cantidad ;
      private String[] H005K2_A43TipoInv ;
      private short[] H005K2_A348stockDetID ;
      private long[] H005K3_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short aP6_pstockDetID ;
      private GXWebForm Form ;
   }

   public class gx02d6__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H005K2", "SELECT [PrdCod], [BodCod], [AgeID], [EmpID], [stockMes], [stockAnio], [hraMovStock], [fchMovStock], [ClienteID], [stockdetTipo], [stockDetNroDoc], [costo], [stock], [cantidad], [TipoInv], [stockDetID] FROM [ProdxBodegaTipoInv] WITH (NOLOCK) WHERE [stockAnio] = @AV7pstockAnio and [stockMes] = @AV8pstockMes and [EmpID] = @AV9pEmpID and [AgeID] = @AV10pAgeID and [BodCod] = @AV11pBodCod and [PrdCod] = @AV12pPrdCod and [stockDetID] >= @AV6cstockDetID ORDER BY [stockAnio], [stockMes], [EmpID], [AgeID], [BodCod], [PrdCod], [stockDetID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005K2,11,0,false,false )
             ,new CursorDef("H005K3", "SELECT COUNT(*) FROM [ProdxBodegaTipoInv] WITH (NOLOCK) WHERE [stockAnio] = @AV7pstockAnio and [stockMes] = @AV8pstockMes and [EmpID] = @AV9pEmpID and [AgeID] = @AV10pAgeID and [BodCod] = @AV11pBodCod and [PrdCod] = @AV12pPrdCod and [stockDetID] >= @AV6cstockDetID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005K3,1,0,false,false )
          };
       }
    }
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((String[]) buf[21])[0] = rslt.getString(15, 4) ;
