/*
               File: EmpresasMarcaWC
        Description: Empresas Marca WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/26/2022 20:13:21.81
...
namespace GeneXus.Programs {
   public class empresasmarcawc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public empresasmarcawc( )
      {
      ...
      public empresasmarcawc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  GXKey = Decrypt64( context.GetCookie( "GX_SESSION_ID"), Crypto.GetServerKey( ));
                  forbiddenHiddens = sPrefix + "hsh" + "EmpresasMarcaWC";
                  ...
                  GXUtil.WriteLog("empresasmarcawc:[SendSecurityCheck value for]"+"EmpID:"+context.localUtil.Format( (decimal)(A1EmpID), "ZZZ9"));
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Empresas Marca WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102620132185", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("empresasmarcawc.aspx") + "?" + UrlEncode("" +AV6EmpID)+"\">") ;
      ...
      protected void RenderHtmlCloseForm0F2( )
      {
         ...
         {
            context.AddJavascriptSource("empresasmarcawc.js", "?2022102620132186", false);
         }
      ...
      {
         return "EmpresasMarcaWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Empresas Marca WC" ;
      }
      ...
      protected void WB0F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "empresasmarcawc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EmpresasMarcaWC.htm");
      ...
      protected void START0F2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Empresas Marca WC", 0) ;
            }
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_MARCAID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A6MarcaID), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"MARCAID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A6MarcaID), 4, 0, ".", "")));
      }
      ...
      protected void RF0F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1EmpID = H000F2_A1EmpID[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A1EmpID", StringUtil.LTrim( StringUtil.Str( (decimal)(A1EmpID), 4, 0)));
               A63MarcaEst = H000F2_A63MarcaEst[0];
               n63MarcaEst = H000F2_n63MarcaEst[0];
               A62MarcaDsc = H000F2_A62MarcaDsc[0];
               n62MarcaDsc = H000F2_n62MarcaDsc[0];
               A6MarcaID = H000F2_A6MarcaID[0];
               E130F2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_MARCAID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A6MarcaID), "ZZZ9"), context));
      }
      ...
      protected void STRUP0F0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            {
               GXUtil.WriteLog("empresasmarcawc:[SecurityCheckFailed value for]"+"EmpID:"+context.localUtil.Format( (decimal)(A1EmpID), "ZZZ9"));
               GxWebError = 1;
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("marca.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A6MarcaID);
         edtavDelete_Link = formatLink("marca.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +A6MarcaID);
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("marca.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +AV6EmpID) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Marca";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "empresasmarcawc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022102620132231", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("empresasmarcawc.js", "?2022102620132231", false);
         }
      ...
      {
         edtMarcaID_Internalname = sPrefix+"MARCAID_"+sGXsfl_20_idx;
         edtMarcaDsc_Internalname = sPrefix+"MARCADSC_"+sGXsfl_20_idx;
         edtMarcaEst_Internalname = sPrefix+"MARCAEST_"+sGXsfl_20_idx;
      ...
      {
         edtMarcaID_Internalname = sPrefix+"MARCAID_"+sGXsfl_20_fel_idx;
         edtMarcaDsc_Internalname = sPrefix+"MARCADSC_"+sGXsfl_20_fel_idx;
         edtMarcaEst_Internalname = sPrefix+"MARCAEST_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtMarcaID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A6MarcaID), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A6MarcaID), "ZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtMarcaID_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"Id",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void init_default_properties( )
      {
         ...
         edtMarcaEst_Internalname = sPrefix+"MARCAEST";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130F2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A6MarcaID',fld:'MARCAID',pic:'ZZZ9',hsh:true},{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9'}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110F2',iparms:[{av:'AV6EmpID',fld:'vEMPID',pic:'ZZZ9'},{av:'A6MarcaID',fld:'MARCAID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV18Delete_GXI = "";
         scmdbuf = "";
         H000F2_A1EmpID = new short[1] ;
         H000F2_A63MarcaEst = new String[] {""} ;
         H000F2_n63MarcaEst = new bool[] {false} ;
         H000F2_A62MarcaDsc = new String[] {""} ;
         H000F2_n62MarcaDsc = new bool[] {false} ;
         H000F2_A6MarcaID = new short[1] ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.empresasmarcawc__default(),
            new Object[][] {
                new Object[] {
               H000F2_A1EmpID, H000F2_A63MarcaEst, H000F2_n63MarcaEst, H000F2_A62MarcaDsc, H000F2_n62MarcaDsc, H000F2_A6MarcaID
               }
               , new Object[] {
      ...
      private short[] H000F2_A1EmpID ;
      private String[] H000F2_A63MarcaEst ;
      private bool[] H000F2_n63MarcaEst ;
      private String[] H000F2_A62MarcaDsc ;
      private bool[] H000F2_n62MarcaDsc ;
      private short[] H000F2_A6MarcaID ;
   ...
   public class empresasmarcawc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000F2", "SELECT [EmpID], [MarcaEst], [MarcaDsc], [MarcaID] FROM [Marca] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ORDER BY [EmpID]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F2,11,0,true,false )
             ,new CursorDef("H000F3", "SELECT COUNT(*) FROM [Marca] WITH (NOLOCK) WHERE [EmpID] = @AV6EmpID ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F3,1,0,true,false )
          };
       }
    }
