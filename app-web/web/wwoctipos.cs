/*
               File: WWOctipos
        Description: Octiposs
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 11/19/2022 22:54:10.62
...
namespace GeneXus.Programs {
   public class wwoctipos : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      public wwoctipos( )
      {
      ...
      public wwoctipos( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13OctipDsc, AV19Pgmname, AV14Update, AV15Delete) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022111922541066", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwoctipos.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vOCTIPDSC", StringUtil.RTrim( AV13OctipDsc));
         /* Send saved values. */
      ...
      protected void WB4Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Octiposs", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_WWOctipos.htm");
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWOctipos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavOctipdsc_Internalname, "Octip Dsc", "col-sm-3 FilterSearchAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOctipdsc_Internalname, StringUtil.RTrim( AV13OctipDsc), StringUtil.RTrim( context.localUtil.Format( AV13OctipDsc, "@!")), TempTags+" onchange=\""+"this.value=this.value.toUpperCase();"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Dsc", edtavOctipdsc_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavOctipdsc_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_WWOctipos.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A313OctipDsc));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A314OctipEst));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START4Z2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Octiposs", 0) ;
         }
         context.wjLoc = "";
                        ...
                        if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false;
                                    /* Set Refresh If Octipdsc Changed */
                                    if ( StringUtil.StrCmp(cgiGet( "GXH_vOCTIPDSC"), AV13OctipDsc) != 0 )
                                    {
                                       Rfr0gs = true;
                                    }
                                    if ( ! Rfr0gs )
      ...
      protected void PA4Z2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavOctipdsc_Internalname;
      ...
      protected void RF4Z2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13OctipDsc = StringUtil.PadR( StringUtil.RTrim( AV13OctipDsc), 40, "%");
            /* Using cursor H004Z2 */
            pr_default.execute(0, new Object[] {lV13OctipDsc, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_25_idx), 4, 0)), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               A314OctipEst = H004Z2_A314OctipEst[0];
               n314OctipEst = H004Z2_n314OctipEst[0];
               A313OctipDsc = H004Z2_A313OctipDsc[0];
               n313OctipDsc = H004Z2_n313OctipDsc[0];
               A311OcTipoCod = H004Z2_A311OcTipoCod[0];
               A46AgeDsc = H004Z2_A46AgeDsc[0];
               n46AgeDsc = H004Z2_n46AgeDsc[0];
               A2AgeID = H004Z2_A2AgeID[0];
               A44empdsc = H004Z2_A44empdsc[0];
               n44empdsc = H004Z2_n44empdsc[0];
               A1EmpID = H004Z2_A1EmpID[0];
               A44empdsc = H004Z2_A44empdsc[0];
               n44empdsc = H004Z2_n44empdsc[0];
               A46AgeDsc = H004Z2_A46AgeDsc[0];
               n46AgeDsc = H004Z2_n46AgeDsc[0];
      ...
      protected void send_integrity_lvl_hashes4Z2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_OCTIPOCOD"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, StringUtil.RTrim( context.localUtil.Format( A311OcTipoCod, "")), context));
      }
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         lV13OctipDsc = StringUtil.PadR( StringUtil.RTrim( AV13OctipDsc), 40, "%");
         /* Using cursor H004Z3 */
         pr_default.execute(1, new Object[] {lV13OctipDsc});
      ...
      protected void STRUP4Z0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13OctipDsc = StringUtil.Upper( cgiGet( edtavOctipdsc_Internalname));
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13OctipDsc", AV13OctipDsc);
            /* Read saved values. */
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("octipos.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A2AgeID) + "," + UrlEncode(StringUtil.RTrim(A311OcTipoCod));
         edtavDelete_Link = formatLink("octipos.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A2AgeID) + "," + UrlEncode(StringUtil.RTrim(A311OcTipoCod));
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 25;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("octipos.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0) + "," + UrlEncode("" +0) + "," + UrlEncode(StringUtil.RTrim("")));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13OctipDsc = ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13OctipDsc", AV13OctipDsc);
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = AV13OctipDsc;
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext.gxTpr_Transactionname = "Octipos";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202211192254117", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwoctipos.js", "?202211192254117", false);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtOcTipoCod_Internalname = "OCTIPOCOD_"+sGXsfl_25_idx;
         edtOctipDsc_Internalname = "OCTIPDSC_"+sGXsfl_25_idx;
         edtOctipEst_Internalname = "OCTIPEST_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtOcTipoCod_Internalname = "OCTIPOCOD_"+sGXsfl_25_fel_idx;
         edtOctipDsc_Internalname = "OCTIPDSC_"+sGXsfl_25_fel_idx;
         edtOctipEst_Internalname = "OCTIPEST_"+sGXsfl_25_fel_idx;
      ...
      protected void init_default_properties( )
      {
         ...
         edtavOctipdsc_Internalname = "vOCTIPDSC";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavOctipdsc_Jsonclick = "";
         edtavOctipdsc_Enabled = 1;
         Form.Caption = "Octiposs";
         subGrid_Rows = 10;
         edtavDelete_Tooltiptext = "Eliminar";
         edtavUpdate_Tooltiptext = "Modificar";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13OctipDsc',fld:'vOCTIPDSC',pic:'@!'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E144Z2',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A2AgeID',fld:'AGEID',pic:'ZZZ9',hsh:true},{av:'A311OcTipoCod',fld:'OCTIPOCOD',pic:'',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E114Z2',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A2AgeID',fld:'AGEID',pic:'ZZZ9',hsh:true},{av:'A311OcTipoCod',fld:'OCTIPOCOD',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13OctipDsc = "";
         H004Z2_A314OctipEst = new String[] {""} ;
         H004Z2_n314OctipEst = new bool[] {false} ;
         H004Z2_A313OctipDsc = new String[] {""} ;
         H004Z2_n313OctipDsc = new bool[] {false} ;
         H004Z2_A311OcTipoCod = new String[] {""} ;
         H004Z2_A46AgeDsc = new String[] {""} ;
         H004Z2_n46AgeDsc = new bool[] {false} ;
         H004Z2_A2AgeID = new short[1] ;
         H004Z2_A44empdsc = new String[] {""} ;
         H004Z2_n44empdsc = new bool[] {false} ;
         H004Z2_A1EmpID = new short[1] ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwoctipos__default(),
            new Object[][] {
                new Object[] {
               H004Z2_A314OctipEst, H004Z2_n314OctipEst, H004Z2_A313OctipDsc, H004Z2_n313OctipDsc, H004Z2_A311OcTipoCod, H004Z2_A46AgeDsc, H004Z2_n46AgeDsc, H004Z2_A2AgeID, H004Z2_A44empdsc, H004Z2_n44empdsc,
               H004Z2_A1EmpID
               }
               , new Object[] {
      ...
      private int edtavOctipdsc_Enabled ;
      ...
      private String edtavOctipdsc_Internalname ;
      private String edtavOctipdsc_Jsonclick ;
      ...
      private String[] H004Z2_A314OctipEst ;
      private bool[] H004Z2_n314OctipEst ;
      private String[] H004Z2_A313OctipDsc ;
      private bool[] H004Z2_n313OctipDsc ;
      private String[] H004Z2_A311OcTipoCod ;
      private String[] H004Z2_A46AgeDsc ;
      private bool[] H004Z2_n46AgeDsc ;
      private short[] H004Z2_A2AgeID ;
      private String[] H004Z2_A44empdsc ;
      private bool[] H004Z2_n44empdsc ;
      private short[] H004Z2_A1EmpID ;
   ...
   public class wwoctipos__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A313OctipDsc )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " T1.[OctipEst], T1.[OctipDsc], T1.[OcTipoCod], T3.[AgeDsc], T1.[AgeID], T2.[empdsc], T1.[EmpID]";
         sFromString = " FROM (([Octipos] T1 WITH (NOLOCK) INNER JOIN [Empresas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID]) INNER JOIN [Agencias] T3 WITH (NOLOCK) ON T3.[EmpID] = T1.[EmpID] AND T3.[AgeID] = T1.[AgeID])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13OctipDsc)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and (T1.[OctipDsc] like @lV13OctipDsc)";
            }
            else
            {
               sWhereString = sWhereString + " (T1.[OctipDsc] like @lV13OctipDsc)";
            }
         }
         else
         {
         ...
         sOrderString = sOrderString + " ORDER BY T1.[OctipDsc]";
                                             ...
                                             String A313OctipDsc )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (([Octipos] T1 WITH (NOLOCK) INNER JOIN [Empresas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID]) INNER JOIN [Agencias] T3 WITH (NOLOCK) ON T3.[EmpID] = T1.[EmpID] AND T3.[AgeID] = T1.[AgeID])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13OctipDsc)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004Z2(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
               case 1 :
                     return conditional_H004Z3(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV13OctipDsc",SqlDbType.Char,40,0} ,
