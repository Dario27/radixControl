/*
               File: WWMarca
        Description: Work With Marca
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 1/14/2023 1:15:49.57
...
namespace GeneXus.Programs {
   public class wwmarca : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      public wwmarca( )
      {
      ...
      public wwmarca( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13MarcaDsc, AV19Pgmname, AV14Update, AV15Delete) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231141154964", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwmarca.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vMARCADSC", StringUtil.RTrim( AV13MarcaDsc));
         /* Send saved values. */
      ...
      protected void WB110( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Marcas", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_WWMarca.htm");
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWMarca.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavMarcadsc_Internalname, "Marca Dsc", "col-sm-3 FilterSearchAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavMarcadsc_Internalname, StringUtil.RTrim( AV13MarcaDsc), StringUtil.RTrim( context.localUtil.Format( AV13MarcaDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Dsc", edtavMarcadsc_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavMarcadsc_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_WWMarca.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"TextActionAttribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtMarcaDsc_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A63MarcaEst));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START112( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Work With Marca", 0) ;
         }
         context.wjLoc = "";
                        ...
                        if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false;
                                    /* Set Refresh If Marcadsc Changed */
                                    if ( StringUtil.StrCmp(cgiGet( "GXH_vMARCADSC"), AV13MarcaDsc) != 0 )
                                    {
                                       Rfr0gs = true;
                                    }
                                    if ( ! Rfr0gs )
      ...
      protected void PA112( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavMarcadsc_Internalname;
      ...
      protected void RF112( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13MarcaDsc = StringUtil.PadR( StringUtil.RTrim( AV13MarcaDsc), 50, "%");
            /* Using cursor H00112 */
            pr_default.execute(0, new Object[] {lV13MarcaDsc, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_25_idx), 4, 0)), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               A63MarcaEst = H00112_A63MarcaEst[0];
               n63MarcaEst = H00112_n63MarcaEst[0];
               A62MarcaDsc = H00112_A62MarcaDsc[0];
               n62MarcaDsc = H00112_n62MarcaDsc[0];
               A6MarcaID = H00112_A6MarcaID[0];
               A44empdsc = H00112_A44empdsc[0];
               n44empdsc = H00112_n44empdsc[0];
               A1EmpID = H00112_A1EmpID[0];
               A44empdsc = H00112_A44empdsc[0];
               n44empdsc = H00112_n44empdsc[0];
               E14112 ();
      ...
      protected void send_integrity_lvl_hashes112( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_MARCAID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A6MarcaID), "ZZZ9"), context));
      }
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         lV13MarcaDsc = StringUtil.PadR( StringUtil.RTrim( AV13MarcaDsc), 50, "%");
         /* Using cursor H00113 */
         pr_default.execute(1, new Object[] {lV13MarcaDsc});
      ...
      protected void STRUP110( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13MarcaDsc = cgiGet( edtavMarcadsc_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13MarcaDsc", AV13MarcaDsc);
            /* Read saved values. */
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("marca.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A6MarcaID);
         edtavDelete_Link = formatLink("marca.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A6MarcaID);
         edtMarcaDsc_Link = formatLink("viewmarca.aspx") + "?" + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A6MarcaID) + "," + UrlEncode(StringUtil.RTrim(""));
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 25;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("marca.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13MarcaDsc = ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13MarcaDsc", AV13MarcaDsc);
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = AV13MarcaDsc;
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext.gxTpr_Transactionname = "Marca";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20231141155024", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwmarca.js", "?20231141155024", false);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtMarcaID_Internalname = "MARCAID_"+sGXsfl_25_idx;
         edtMarcaDsc_Internalname = "MARCADSC_"+sGXsfl_25_idx;
         edtMarcaEst_Internalname = "MARCAEST_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtMarcaID_Internalname = "MARCAID_"+sGXsfl_25_fel_idx;
         edtMarcaDsc_Internalname = "MARCADSC_"+sGXsfl_25_fel_idx;
         edtMarcaEst_Internalname = "MARCAEST_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavUpdate_Internalname,(String)sImgUrl,(String)edtavUpdate_Link,(String)"",(String)"",context.GetTheme( ),(short)-1,(short)1,(String)"",(String)edtavUpdate_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)"WWTextActionColumn",(String)"",(String)"",(String)"",(String)"",(String)"",(String)"",(short)1,(bool)AV14Update_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+""+"\">") ;
            ...
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavDelete_Internalname,(String)sImgUrl,(String)edtavDelete_Link,(String)"",(String)"",context.GetTheme( ),(short)-1,(short)1,(String)"",(String)edtavDelete_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)"WWTextActionColumn",(String)"",(String)"",(String)"",(String)"",(String)"",(String)"",(short)1,(bool)AV15Delete_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
      ...
      protected void init_default_properties( )
      {
         ...
         edtavMarcadsc_Internalname = "vMARCADSC";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavMarcadsc_Jsonclick = "";
         edtavMarcadsc_Enabled = 1;
         Form.Caption = "Work With Marca";
         subGrid_Rows = 10;
         edtavDelete_Tooltiptext = "Eliminar";
         edtavUpdate_Tooltiptext = "Modificar";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13MarcaDsc',fld:'vMARCADSC',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E14112',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A6MarcaID',fld:'MARCAID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtMarcaDsc_Link',ctrl:'MARCADSC',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E11112',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A6MarcaID',fld:'MARCAID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13MarcaDsc = "";
         H00112_A63MarcaEst = new String[] {""} ;
         H00112_n63MarcaEst = new bool[] {false} ;
         H00112_A62MarcaDsc = new String[] {""} ;
         H00112_n62MarcaDsc = new bool[] {false} ;
         H00112_A6MarcaID = new short[1] ;
         H00112_A44empdsc = new String[] {""} ;
         H00112_n44empdsc = new bool[] {false} ;
         H00112_A1EmpID = new short[1] ;
         ...
         ROClassString = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwmarca__default(),
            new Object[][] {
                new Object[] {
               H00112_A63MarcaEst, H00112_n63MarcaEst, H00112_A62MarcaDsc, H00112_n62MarcaDsc, H00112_A6MarcaID, H00112_A44empdsc, H00112_n44empdsc, H00112_A1EmpID
               }
               , new Object[] {
      ...
      private int edtavMarcadsc_Enabled ;
      ...
      private String edtavMarcadsc_Internalname ;
      private String edtavMarcadsc_Jsonclick ;
      ...
      private String[] H00112_A63MarcaEst ;
      private bool[] H00112_n63MarcaEst ;
      private String[] H00112_A62MarcaDsc ;
      private bool[] H00112_n62MarcaDsc ;
      private short[] H00112_A6MarcaID ;
      private String[] H00112_A44empdsc ;
      private bool[] H00112_n44empdsc ;
      private short[] H00112_A1EmpID ;
   ...
   public class wwmarca__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A62MarcaDsc )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " T1.[MarcaEst], T1.[MarcaDsc], T1.[MarcaID], T2.[empdsc], T1.[EmpID]";
         sFromString = " FROM ([Marca] T1 WITH (NOLOCK) INNER JOIN [Empresas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13MarcaDsc)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and (T1.[MarcaDsc] like @lV13MarcaDsc)";
            }
            else
            {
               sWhereString = sWhereString + " (T1.[MarcaDsc] like @lV13MarcaDsc)";
            }
         }
         else
         {
         ...
         sOrderString = sOrderString + " ORDER BY T1.[MarcaDsc]";
                                             ...
                                             String A62MarcaDsc )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([Marca] T1 WITH (NOLOCK) INNER JOIN [Empresas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13MarcaDsc)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV13MarcaDsc",SqlDbType.Char,50,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00112", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00112,11,0,true,false )
             ,new CursorDef("H00113", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00113,1,0,true,false )
          };
       }
    }
