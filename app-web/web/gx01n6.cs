/*
       ...
       Generated on: 9/7/2022 14:7:11.85
...
namespace GeneXus.Programs {
   public class gx01n6 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx01n6( )
      {
      ...
      public gx01n6( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV11pPrdCod = (short)(NumberUtil.Val( GetNextPar( ), "."));
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cTipoInv, AV7pstockAnio, AV8pstockMes, AV9pEmpID, AV10pAgeID, AV11pPrdCod, AV12pBodCod) ;
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  ...
                  AV11pPrdCod = (short)(NumberUtil.Val( GetNextPar( ), "."));
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11pPrdCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11pPrdCod), 4, 0)));
                  AV12pBodCod = (short)(NumberUtil.Val( GetNextPar( ), "."));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022971471189", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx01n6.aspx") + "?" + UrlEncode("" +AV7pstockAnio) + "," + UrlEncode("" +AV8pstockMes) + "," + UrlEncode("" +AV9pEmpID) + "," + UrlEncode("" +AV10pAgeID) + "," + UrlEncode("" +AV11pPrdCod) + "," + UrlEncode("" +AV12pBodCod) + "," + UrlEncode(StringUtil.RTrim(AV13pTipoInv))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPPRDCOD", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11pPrdCod), 4, 0, ",", "")));
      ...
      {
         return formatLink("gx01n6.aspx") + "?" + UrlEncode("" +AV7pstockAnio) + "," + UrlEncode("" +AV8pstockMes) + "," + UrlEncode("" +AV9pEmpID) + "," + UrlEncode("" +AV10pAgeID) + "," + UrlEncode("" +AV11pPrdCod) + "," + UrlEncode("" +AV12pBodCod) + "," + UrlEncode(StringUtil.RTrim(AV13pTipoInv)) ;
      }
      ...
      protected void WB4H0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbltipoinvfilter_Internalname, "Codigo", "", "", lblLbltipoinvfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e114h1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01N6.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e124h1_client"+"'", TempTags, "", 2, "HLP_Gx01N6.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            else
            {
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A296cantidad), 9, 0, ".", "")));
               Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtcantidad_Link));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A297stock), 9, 0, ".", "")));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 24 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx01N6.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 4), "LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                           {
                              ...
                              A296cantidad = (int)(context.localUtil.CToN( cgiGet( edtcantidad_Internalname), ",", "."));
                              n296cantidad = false;
                              A297stock = (int)(context.localUtil.CToN( cgiGet( edtstock_Internalname), ",", "."));
                              n297stock = false;
      ...
      protected void RF4H2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H004H2 */
            pr_default.execute(0, new Object[] {AV7pstockAnio, AV8pstockMes, AV9pEmpID, AV10pAgeID, AV11pPrdCod, AV12pBodCod, lV6cTipoInv, GXPagingFrom2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_24_idx), 4, 0)), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A42BodCod = H004H2_A42BodCod[0];
               A286PrdCod = H004H2_A286PrdCod[0];
               A2AgeID = H004H2_A2AgeID[0];
               A1EmpID = H004H2_A1EmpID[0];
               A291stockMes = H004H2_A291stockMes[0];
               A290stockAnio = H004H2_A290stockAnio[0];
               A298costo = H004H2_A298costo[0];
               n298costo = H004H2_n298costo[0];
               A297stock = H004H2_A297stock[0];
               n297stock = H004H2_n297stock[0];
               A296cantidad = H004H2_A296cantidad[0];
               n296cantidad = H004H2_n296cantidad[0];
               A43TipoInv = H004H2_A43TipoInv[0];
               /* Execute user event: Load */
               E144H2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_TIPOINV"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, StringUtil.RTrim( context.localUtil.Format( A43TipoInv, "")), context));
      }
      ...
      protected int subGrid1_Recordcount( )
      {
         lV6cTipoInv = StringUtil.PadR( StringUtil.RTrim( AV6cTipoInv), 4, "%");
         /* Using cursor H004H3 */
         pr_default.execute(1, new Object[] {AV7pstockAnio, AV8pstockMes, AV9pEmpID, AV10pAgeID, AV11pPrdCod, AV12pBodCod, lV6cTipoInv});
      ...
      {
         /* Start Routine */
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "Tipo", "", "", "", "", "", "", "", "");
      ...
      public override void setparameters( Object[] obj )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10pAgeID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10pAgeID), 4, 0)));
         AV11pPrdCod = Convert.ToInt16(getParm(obj,4));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11pPrdCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11pPrdCod), 4, 0)));
         AV12pBodCod = Convert.ToInt16(getParm(obj,5));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12pBodCod", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12pBodCod), 4, 0)));
         AV13pTipoInv = (String)getParm(obj,6);
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13pTipoInv", AV13pTipoInv);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022971471227", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx01n6.js", "?2022971471227", false);
      ...
      protected void sendrow_242( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_24_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtcantidad_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A296cantidad), 9, 0, ",", "")),context.localUtil.Format( (decimal)(A296cantidad), "ZZZZZZZZ9"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)edtcantidad_Link,(String)"",(String)"",(String)"",(String)edtcantidad_Jsonclick,(short)0,(String)"DescriptionAttribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)9,(short)0,(short)0,(short)24,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtstock_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A297stock), 9, 0, ",", "")),context.localUtil.Format( (decimal)(A297stock), "ZZZZZZZZ9"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtstock_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn OptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)9,(short)0,(short)0,(short)24,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
            /* Subfile cell */
            if ( Grid1Container.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cTipoInv',fld:'vCTIPOINV',pic:''},{av:'AV7pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV8pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV9pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV10pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV11pPrdCod',fld:'vPPRDCOD',pic:'ZZZ9'},{av:'AV12pBodCod',fld:'vPBODCOD',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E124H1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLTIPOINVFILTER.CLICK","{handler:'E114H1',iparms:[{av:'divTipoinvfiltercontainer_Class',ctrl:'TIPOINVFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E154H2',iparms:[{av:'A43TipoInv',fld:'TIPOINV',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV13pTipoInv',fld:'vPTIPOINV',pic:''}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cTipoInv',fld:'vCTIPOINV',pic:''},{av:'AV7pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV8pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV9pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV10pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV11pPrdCod',fld:'vPPRDCOD',pic:'ZZZ9'},{av:'AV12pBodCod',fld:'vPBODCOD',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cTipoInv',fld:'vCTIPOINV',pic:''},{av:'AV7pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV8pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV9pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV10pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV11pPrdCod',fld:'vPPRDCOD',pic:'ZZZ9'},{av:'AV12pBodCod',fld:'vPBODCOD',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cTipoInv',fld:'vCTIPOINV',pic:''},{av:'AV7pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV8pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV9pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV10pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV11pPrdCod',fld:'vPPRDCOD',pic:'ZZZ9'},{av:'AV12pBodCod',fld:'vPBODCOD',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cTipoInv',fld:'vCTIPOINV',pic:''},{av:'AV7pstockAnio',fld:'vPSTOCKANIO',pic:'ZZZ9'},{av:'AV8pstockMes',fld:'vPSTOCKMES',pic:'Z9'},{av:'AV9pEmpID',fld:'vPEMPID',pic:'ZZZ9'},{av:'AV10pAgeID',fld:'vPAGEID',pic:'ZZZ9'},{av:'AV11pPrdCod',fld:'vPPRDCOD',pic:'ZZZ9'},{av:'AV12pBodCod',fld:'vPBODCOD',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV6cTipoInv = "";
         H004H2_A42BodCod = new short[1] ;
         H004H2_A286PrdCod = new short[1] ;
         H004H2_A2AgeID = new short[1] ;
         H004H2_A1EmpID = new short[1] ;
         H004H2_A291stockMes = new short[1] ;
         H004H2_A290stockAnio = new short[1] ;
         H004H2_A298costo = new decimal[1] ;
         H004H2_n298costo = new bool[] {false} ;
         H004H2_A297stock = new int[1] ;
         H004H2_n297stock = new bool[] {false} ;
         H004H2_A296cantidad = new int[1] ;
         H004H2_n296cantidad = new bool[] {false} ;
         H004H2_A43TipoInv = new String[] {""} ;
         H004H3_AGRID1_nRecordCount = new long[1] ;
         ...
         sImgUrl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx01n6__default(),
            new Object[][] {
                new Object[] {
               H004H2_A42BodCod, H004H2_A286PrdCod, H004H2_A2AgeID, H004H2_A1EmpID, H004H2_A291stockMes, H004H2_A290stockAnio, H004H2_A298costo, H004H2_n298costo, H004H2_A297stock, H004H2_n297stock,
               H004H2_A296cantidad, H004H2_n296cantidad, H004H2_A43TipoInv
               }
               , new Object[] {
      ...
      private int A296cantidad ;
      private int A297stock ;
      ...
      private short[] H004H2_A42BodCod ;
      private short[] H004H2_A286PrdCod ;
      private short[] H004H2_A2AgeID ;
      private short[] H004H2_A1EmpID ;
      private short[] H004H2_A291stockMes ;
      private short[] H004H2_A290stockAnio ;
      private decimal[] H004H2_A298costo ;
      private bool[] H004H2_n298costo ;
      private int[] H004H2_A297stock ;
      private bool[] H004H2_n297stock ;
      private int[] H004H2_A296cantidad ;
      private bool[] H004H2_n296cantidad ;
      private String[] H004H2_A43TipoInv ;
      private long[] H004H3_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private String aP6_pTipoInv ;
      private GXWebForm Form ;
   }

   public class gx01n6__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV11pPrdCod",SqlDbType.SmallInt,4,0} ,
          ...
          def= new CursorDef[] {
              new CursorDef("H004H2", "SELECT [BodCod], [PrdCod], [AgeID], [EmpID], [stockMes], [stockAnio], [costo], [stock], [cantidad], [TipoInv] FROM [ProdxBodegaTipo] WITH (NOLOCK) WHERE ([stockAnio] = @AV7pstockAnio and [stockMes] = @AV8pstockMes and [EmpID] = @AV9pEmpID and [AgeID] = @AV10pAgeID and [PrdCod] = @AV11pPrdCod and [BodCod] = @AV12pBodCod) AND ([TipoInv] like @lV6cTipoInv) ORDER BY [stockAnio], [stockMes], [EmpID], [AgeID], [PrdCod], [BodCod], [TipoInv]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004H2,11,0,false,false )
             ,new CursorDef("H004H3", "SELECT COUNT(*) FROM [ProdxBodegaTipo] WITH (NOLOCK) WHERE ([stockAnio] = @AV7pstockAnio and [stockMes] = @AV8pstockMes and [EmpID] = @AV9pEmpID and [AgeID] = @AV10pAgeID and [PrdCod] = @AV11pPrdCod and [BodCod] = @AV12pBodCod) AND ([TipoInv] like @lV6cTipoInv) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004H3,1,0,false,false )
          };
       }
    }
