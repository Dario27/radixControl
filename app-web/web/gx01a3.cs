/*
       ...
       Generated on: 8/20/2022 20:49:37.33
...
namespace GeneXus.Programs {
   public class gx01a3 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx01a3( )
      {
      ...
      public gx01a3( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202282020493744", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx01a3.aspx") + "?" + UrlEncode("" +AV10pEmpID) + "," + UrlEncode("" +AV11pcategID) + "," + UrlEncode("" +AV12psubCatID) + "," + UrlEncode("" +AV13pdetSubID)+"\">") ;
      ...
      {
         return formatLink("gx01a3.aspx") + "?" + UrlEncode("" +AV10pEmpID) + "," + UrlEncode("" +AV11pcategID) + "," + UrlEncode("" +AV12psubCatID) + "," + UrlEncode("" +AV13pdetSubID) ;
      }
      ...
      protected void WB3Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbldetsubidfilter_Internalname, "det Sub ID", "", "", lblLbldetsubidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e113y1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01A3.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCdetsubid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6cdetSubID), 4, 0, ",", "")), ((edtavCdetsubid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6cdetSubID), "ZZZ9")) : context.localUtil.Format( (decimal)(AV6cdetSubID), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCdetsubid_Jsonclick, 0, "Attribute", "", "", "", "", edtavCdetsubid_Visible, edtavCdetsubid_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01A3.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbldetsubdscfilter_Internalname, "Observacion", "", "", lblLbldetsubdscfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e123y1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01A3.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbldetsubaniofilter_Internalname, "Año", "", "", lblLbldetsubaniofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e133y1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01A3.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCdetsubanio_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8cdetSubAnio), 4, 0, ",", "")), ((edtavCdetsubanio_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV8cdetSubAnio), "ZZZ9")) : context.localUtil.Format( (decimal)(AV8cdetSubAnio), "ZZZ9")), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.num.valid_integer( this,'.');"+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCdetsubanio_Jsonclick, 0, "Attribute", "", "", "", "", edtavCdetsubanio_Visible, edtavCdetsubanio_Enabled, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01A3.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbldetsubfchfilter_Internalname, "Fecha", "", "", lblLbldetsubfchfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e143y1_client"+"'", "", "WWAdvancedLabel WWDateFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01A3.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCdetsubfch_Internalname, context.localUtil.Format(AV9cdetSubFch, "99/99/9999"), context.localUtil.Format( AV9cdetSubFch, "99/99/9999"), TempTags+" onchange=\"gx.evt.onchange(this, event)\" "+" onblur=\""+"gx.date.valid_date(this, 10,'DMY',0,24,'spa',false,0);"+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCdetsubfch_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCdetsubfch_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx01A3.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(54), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e153y1_client"+"'", TempTags, "", 2, "HLP_Gx01A3.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 54 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(54), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx01A3.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF3Y2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A33subCatID = H003Y2_A33subCatID[0];
               A32categID = H003Y2_A32categID[0];
               A1EmpID = H003Y2_A1EmpID[0];
               A261detSubActivo = H003Y2_A261detSubActivo[0];
               n261detSubActivo = H003Y2_n261detSubActivo[0];
               A260detSubSldoIni = H003Y2_A260detSubSldoIni[0];
               n260detSubSldoIni = H003Y2_n260detSubSldoIni[0];
               A259detSubFch = H003Y2_A259detSubFch[0];
               n259detSubFch = H003Y2_n259detSubFch[0];
               A262detSubAnio = H003Y2_A262detSubAnio[0];
               n262detSubAnio = H003Y2_n262detSubAnio[0];
               A258detSubDsc = H003Y2_A258detSubDsc[0];
               n258detSubDsc = H003Y2_n258detSubDsc[0];
               A257detSubID = H003Y2_A257detSubID[0];
               /* Execute user event: Load */
               E173Y2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         GRID1_nRecordCount = H003Y3_AGRID1_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202282020493822", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx01a3.js", "?202282020493822", false);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'TOGGLE'","{handler:'E153Y1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLDETSUBIDFILTER.CLICK","{handler:'E113Y1',iparms:[{av:'divDetsubidfiltercontainer_Class',ctrl:'DETSUBIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLDETSUBDSCFILTER.CLICK","{handler:'E123Y1',iparms:[{av:'divDetsubdscfiltercontainer_Class',ctrl:'DETSUBDSCFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLDETSUBANIOFILTER.CLICK","{handler:'E133Y1',iparms:[{av:'divDetsubaniofiltercontainer_Class',ctrl:'DETSUBANIOFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLDETSUBFCHFILTER.CLICK","{handler:'E143Y1',iparms:[{av:'divDetsubfchfiltercontainer_Class',ctrl:'DETSUBFCHFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E183Y2',iparms:[{av:'A257detSubID',fld:'DETSUBID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV7cdetSubDsc = "";
         H003Y2_A33subCatID = new short[1] ;
         H003Y2_A32categID = new short[1] ;
         H003Y2_A1EmpID = new short[1] ;
         H003Y2_A261detSubActivo = new String[] {""} ;
         H003Y2_n261detSubActivo = new bool[] {false} ;
         H003Y2_A260detSubSldoIni = new decimal[1] ;
         H003Y2_n260detSubSldoIni = new bool[] {false} ;
         H003Y2_A259detSubFch = new DateTime[] {DateTime.MinValue} ;
         H003Y2_n259detSubFch = new bool[] {false} ;
         H003Y2_A262detSubAnio = new short[1] ;
         H003Y2_n262detSubAnio = new bool[] {false} ;
         H003Y2_A258detSubDsc = new String[] {""} ;
         H003Y2_n258detSubDsc = new bool[] {false} ;
         H003Y2_A257detSubID = new short[1] ;
         H003Y3_AGRID1_nRecordCount = new long[1] ;
         ...
         sImgUrl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx01a3__default(),
            new Object[][] {
                new Object[] {
               H003Y2_A33subCatID, H003Y2_A32categID, H003Y2_A1EmpID, H003Y2_A261detSubActivo, H003Y2_n261detSubActivo, H003Y2_A260detSubSldoIni, H003Y2_n260detSubSldoIni, H003Y2_A259detSubFch, H003Y2_n259detSubFch, H003Y2_A262detSubAnio,
               H003Y2_n262detSubAnio, H003Y2_A258detSubDsc, H003Y2_n258detSubDsc, H003Y2_A257detSubID
               }
               , new Object[] {
               H003Y3_AGRID1_nRecordCount
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private short[] H003Y2_A33subCatID ;
      private short[] H003Y2_A32categID ;
      private short[] H003Y2_A1EmpID ;
      private String[] H003Y2_A261detSubActivo ;
      private bool[] H003Y2_n261detSubActivo ;
      private decimal[] H003Y2_A260detSubSldoIni ;
      private bool[] H003Y2_n260detSubSldoIni ;
      private DateTime[] H003Y2_A259detSubFch ;
      private bool[] H003Y2_n259detSubFch ;
      private short[] H003Y2_A262detSubAnio ;
      private bool[] H003Y2_n262detSubAnio ;
      private String[] H003Y2_A258detSubDsc ;
      private bool[] H003Y2_n258detSubDsc ;
      private short[] H003Y2_A257detSubID ;
      private long[] H003Y3_AGRID1_nRecordCount ;
   ...
   public class gx01a3__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H003Y2(context, (String)dynConstraints[0] , (short)dynConstraints[1] , (DateTime)dynConstraints[2] , (String)dynConstraints[3] , (short)dynConstraints[4] , (DateTime)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] , (short)dynConstraints[10] , (short)dynConstraints[11] , (short)dynConstraints[12] );
               case 1 :
                     return conditional_H003Y3(context, (String)dynConstraints[0] , (short)dynConstraints[1] , (DateTime)dynConstraints[2] , (String)dynConstraints[3] , (short)dynConstraints[4] , (DateTime)dynConstraints[5] , (short)dynConstraints[6] , (short)dynConstraints[7] , (short)dynConstraints[8] , (short)dynConstraints[9] , (short)dynConstraints[10] , (short)dynConstraints[11] , (short)dynConstraints[12] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H003Y2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003Y2,11,0,false,false )
             ,new CursorDef("H003Y3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003Y3,1,0,false,false )
          };
       }
    }
