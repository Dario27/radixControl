...
this.transitionType=this.transformType=this.$slidesCache=null;this.visibilityChange="visibilitychange";this.windowWidth=0;this.windowTimer=null;f=e(b).data("slick")||{};this.options=e.extend({},this.defaults,f,d);this.currentSlide=this.options.initialSlide;this.originalSettings=this.options;"undefined"!==typeof document.mozHidden?(this.hidden="mozHidden",this.visibilityChange="mozvisibilitychange"):"undefined"!==typeof document.webkitHidden&&(this.hidden="webkitHidden",this.visibilityChange="webkitvisibilitychange");
...
a++;this.htmlExpr=/^(?:\s*(<[\w\W]+>)[^>]*)$/;this.registerBreakpoints();this.init(!0);this.checkResponsive(!0)}}();c.prototype.addSlide=c.prototype.slickAdd=function(a,b,d){if("boolean"===typeof b)d=b,b=null;else if(0>b||b>=this.slideCount)return!1;this.unload();"number"===typeof b?0===b&&0===this.$slides.length?e(a).appendTo(this.$slideTrack):d?e(a).insertBefore(this.$slides.eq(b)):e(a).insertAfter(this.$slides.eq(b)):!0===d?e(a).prependTo(this.$slideTrack):e(a).appendTo(this.$slideTrack);this.$slides=
...
function(a,b){var d={},f=this;f.animateHeight();!0===f.options.rtl&&!1===f.options.vertical&&(a=-a);!1===f.transformsEnabled?!1===f.options.vertical?f.$slideTrack.animate({left:a},f.options.speed,f.options.easing,b):f.$slideTrack.animate({top:a},f.options.speed,f.options.easing,b):!1===f.cssTransitions?(!0===f.options.rtl&&(f.currentLeft=-f.currentLeft),e({animStart:f.currentLeft}).animate({animStart:a},{duration:f.options.speed,easing:f.options.easing,step:function(a){a=Math.ceil(a);d[f.animType]=
!1===f.options.vertical?"translate("+a+"px, 0px)":"translate(0px,"+a+"px)";f.$slideTrack.css(d)},complete:function(){b&&b.call()}})):(f.applyTransition(),a=Math.ceil(a),d[f.animType]=!1===f.options.vertical?"translate3d("+a+"px, 0px, 0px)":"translate3d(0px,"+a+"px, 0px)",f.$slideTrack.css(d),b&&setTimeout(function(){f.disableTransition();b.call()},f.options.speed))};c.prototype.asNavFor=function(a){var b=this.options.asNavFor;b&&null!==b&&(b=e(b).not(this.$slider));null!==b&&"object"===typeof b&&
...
this.$slider).not("[src]").addClass("slick-loading");this.setupInfinite();this.buildArrows();this.buildDots();this.updateDots();this.setSlideClasses("number"===typeof this.currentSlide?this.currentSlide:0);!0===this.options.draggable&&this.$list.addClass("draggable")};c.prototype.buildRows=function(){var a,b,d,f,c,e,g;f=document.createDocumentFragment();e=this.$slider.children();if(1<this.options.rows){g=this.options.slidesPerRow*this.options.rows;c=Math.ceil(e.length/g);for(a=0;a<c;a++){var l=document.createElement("div");
for(b=0;b<this.options.rows;b++){var m=document.createElement("div");for(d=0;d<this.options.slidesPerRow;d++){var n=a*g+(b*this.options.slidesPerRow+d);e.get(n)&&m.appendChild(e.get(n))}l.appendChild(m)}f.appendChild(l)}this.$slider.html(f);this.$slider.children().children().children().css({width:100/this.options.slidesPerRow+"%",display:"inline-block"})}};c.prototype.checkResponsive=function(a,b){var d,f,c,h=!1;f=this.$slider.width();var g=window.innerWidth||e(window).width();"window"===this.respondTo?
c=g:"slider"===this.respondTo?c=f:"min"===this.respondTo&&(c=Math.min(g,f));if(this.options.responsive&&this.options.responsive.length&&null!==this.options.responsive){f=null;for(d in this.breakpoints)this.breakpoints.hasOwnProperty(d)&&(!1===this.originalSettings.mobileFirst?c<this.breakpoints[d]&&(f=this.breakpoints[d]):c>this.breakpoints[d]&&(f=this.breakpoints[d]));if(null!==f)if(null!==this.activeBreakpoint){if(f!==this.activeBreakpoint||b)this.activeBreakpoint=f,"unslick"===this.breakpointSettings[f]?
this.unslick(f):(this.options=e.extend({},this.originalSettings,this.breakpointSettings[f]),!0===a&&(this.currentSlide=this.options.initialSlide),this.refresh(a)),h=f}else this.activeBreakpoint=f,"unslick"===this.breakpointSettings[f]?this.unslick(f):(this.options=e.extend({},this.originalSettings,this.breakpointSettings[f]),!0===a&&(this.currentSlide=this.options.initialSlide),this.refresh(a)),h=f;else null!==this.activeBreakpoint&&(this.activeBreakpoint=null,this.options=this.originalSettings,!0===
a&&(this.currentSlide=this.options.initialSlide),this.refresh(a),h=f);a||!1===h||this.$slider.trigger("breakpoint",[this,h])}};c.prototype.changeSlide=function(a,b){var d=e(a.target),f;d.is("a")&&a.preventDefault();d.is("li")||(d=d.closest("li"));f=0!==this.slideCount%this.options.slidesToScroll?0:(this.slideCount-this.currentSlide)%this.options.slidesToScroll;switch(a.data.message){case "previous":d=0===f?this.options.slidesToScroll:this.options.slidesToShow-f;this.slideCount>this.options.slidesToShow&&
this.slideHandler(this.currentSlide-d,!1,b);break;case "next":d=0===f?this.options.slidesToScroll:f;this.slideCount>this.options.slidesToShow&&this.slideHandler(this.currentSlide+d,!1,b);break;case "index":f=0===a.data.index?0:a.data.index||d.index()*this.options.slidesToScroll,this.slideHandler(this.checkNavigable(f),!1,b),d.children().trigger("focus")}};c.prototype.checkNavigable=function(a){var b,d;b=this.getNavigableIndexes();d=0;if(a>b[b.length-1])a=b[b.length-1];else for(var f in b){if(a<b[f]){a=
d;break}d=b[f]}return a};c.prototype.cleanUpEvents=function(){this.options.dots&&null!==this.$dots&&(e("li",this.$dots).off("click.slick",this.changeSlide),!0===this.options.pauseOnDotsHover&&!0===this.options.autoplay&&e("li",this.$dots).off("mouseenter.slick",e.proxy(this.setPaused,this,!0)).off("mouseleave.slick",e.proxy(this.setPaused,this,!1)));!0===this.options.arrows&&this.slideCount>this.options.slidesToShow&&(this.$prevArrow&&this.$prevArrow.off("click.slick",this.changeSlide),this.$nextArrow&&
...
a.progressiveLazyLoad()}))};c.prototype.refresh=function(a){var b=this.currentSlide;this.destroy(!0);e.extend(this,this.initials,{currentSlide:b});this.init();a||this.changeSlide({data:{message:"index",index:b}},!1)};c.prototype.registerBreakpoints=function(){var a=this,b,d,f,c=a.options.responsive||null;if("array"===e.type(c)&&c.length){a.respondTo=a.options.respondTo||"window";for(b in c)if(f=a.breakpoints.length-1,d=c[b].breakpoint,c.hasOwnProperty(b)){for(;0<=f;)a.breakpoints[f]&&a.breakpoints[f]===
d&&a.breakpoints.splice(f,1),f--;a.breakpoints.push(d);a.breakpointSettings[d]=c[b].settings}a.breakpoints.sort(function(b,d){return a.options.mobileFirst?b-d:d-b})}};c.prototype.reinit=function(){this.$slides=this.$slideTrack.children(this.options.slide).addClass("slick-slide");this.slideCount=this.$slides.length;this.currentSlide>=this.slideCount&&0!==this.currentSlide&&(this.currentSlide-=this.options.slidesToScroll);this.slideCount<=this.options.slidesToShow&&(this.currentSlide=0);this.registerBreakpoints();
...
this,b;a.$slides.each(function(d,c){b=a.slideWidth*d*-1;!0===a.options.rtl?e(c).css({position:"relative",right:b,top:0,zIndex:a.options.zIndex-2,opacity:0}):e(c).css({position:"relative",left:b,top:0,zIndex:a.options.zIndex-2,opacity:0})});a.$slides.eq(a.currentSlide).css({zIndex:a.options.zIndex-1,opacity:1})};c.prototype.setHeight=function(){if(1===this.options.slidesToShow&&!0===this.options.adaptiveHeight&&!1===this.options.vertical){var a=this.$slides.eq(this.currentSlide).outerHeight(!0);this.$list.css("height",
a)}};c.prototype.setOption=c.prototype.slickSetOption=function(a,b,d){var c;if("responsive"===a&&"array"===e.type(b))for(c in b)if("array"!==e.type(this.options.responsive))this.options.responsive=[b[c]];else{for(a=this.options.responsive.length-1;0<=a;)this.options.responsive[a].breakpoint===b[c].breakpoint&&this.options.responsive.splice(a,1),a--;this.options.responsive.push(b[c])}else this.options[a]=b;!0===d&&(this.unload(),this.reinit())};c.prototype.setPosition=function(){this.setDimensions();
...
"transition");this.transformsEnabled=null!==this.animType&&!1!==this.animType};c.prototype.setSlideClasses=function(a){var b,d,c;d=this.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden","true");this.$slides.eq(a).addClass("slick-current");!0===this.options.centerMode?(b=Math.floor(this.options.slidesToShow/2),!0===this.options.infinite&&(a>=b&&a<=this.slideCount-1-b?this.$slides.slice(a-b,a+b+1).addClass("slick-active").attr("aria-hidden","false"):
(c=this.options.slidesToShow+a,d.slice(c-b+1,c+b+2).addClass("slick-active").attr("aria-hidden","false")),0===a?d.eq(d.length-1-this.options.slidesToShow).addClass("slick-center"):a===this.slideCount-1&&d.eq(this.options.slidesToShow).addClass("slick-center")),this.$slides.eq(a).addClass("slick-center")):0<=a&&a<=this.slideCount-this.options.slidesToShow?this.$slides.slice(a,a+this.options.slidesToShow).addClass("slick-active").attr("aria-hidden","false"):d.length<=this.options.slidesToShow?d.addClass("slick-active").attr("aria-hidden",
"false"):(b=this.slideCount%this.options.slidesToShow,c=!0===this.options.infinite?this.options.slidesToShow+a:a,this.options.slidesToShow==this.options.slidesToScroll&&this.slideCount-a<this.options.slidesToShow?d.slice(c-(this.options.slidesToShow-b),c+b).addClass("slick-active").attr("aria-hidden","false"):d.slice(c,c+this.options.slidesToShow).addClass("slick-active").attr("aria-hidden","false"));"ondemand"===this.options.lazyLoad&&this.lazyLoad()};c.prototype.setupInfinite=function(){var a,b,
d;!0===this.options.fade&&(this.options.centerMode=!1);if(!0===this.options.infinite&&!1===this.options.fade&&(b=null,this.slideCount>this.options.slidesToShow)){d=!0===this.options.centerMode?this.options.slidesToShow+1:this.options.slidesToShow;for(a=this.slideCount;a>this.slideCount-d;--a)b=a-1,e(this.$slides[b]).clone(!0).attr("id","").attr("data-slick-index",b-this.slideCount).prependTo(this.$slideTrack).addClass("slick-cloned");for(a=0;a<d;a+=1)b=a,e(this.$slides[b]).clone(!0).attr("id","").attr("data-slick-index",
...
(this.setSlideClasses(a),this.asNavFor(a)):this.slideHandler(a)};c.prototype.slideHandler=function(a,b,d){var c,e,h=null,g=this;!0===g.animating&&!0===g.options.waitForAnimate||!0===g.options.fade&&g.currentSlide===a||g.slideCount<=g.options.slidesToShow||(!1===(b||!1)&&g.asNavFor(a),c=a,h=g.getLeft(c),b=g.getLeft(g.currentSlide),g.currentLeft=null===g.swipeLeft?b:g.swipeLeft,!1===g.options.infinite&&!1===g.options.centerMode&&(0>a||a>g.getDotCount()*g.options.slidesToScroll)?!1===g.options.fade&&
...
this.touchObject.startY,2))));c=this.swipeDirection();if("vertical"!==c){void 0!==a.originalEvent&&4<this.touchObject.swipeLength&&a.preventDefault();e=(!1===this.options.rtl?1:-1)*(this.touchObject.curX>this.touchObject.startX?1:-1);!0===this.options.verticalSwiping&&(e=this.touchObject.curY>this.touchObject.startY?1:-1);a=this.touchObject.swipeLength;this.touchObject.edgeHit=!1;!1===this.options.infinite&&(0===this.currentSlide&&"right"===c||this.currentSlide>=this.getDotCount()&&"left"===c)&&(a=
this.touchObject.swipeLength*this.options.edgeFriction,this.touchObject.edgeHit=!0);this.swipeLeft=!1===this.options.vertical?b+a*e:b+a*(this.$list.height()/this.listWidth)*e;!0===this.options.verticalSwiping&&(this.swipeLeft=b+a*e);if(!0===this.options.fade||!1===this.options.touchMove)return!1;if(!0===this.animating)return this.swipeLeft=null,!1;this.setCSS(this.swipeLeft)}};c.prototype.swipeStart=function(a){var b;if(1!==this.touchObject.fingerCount||this.slideCount<=this.options.slidesToShow)return this.touchObject=
...
!0):(a.paused=!1,a.autoPlay()))},0)})};e.fn.slick=function(){var a=arguments[0],b=Array.prototype.slice.call(arguments,1),d=this.length,e=0,k;for(e;e<d;e++)if("object"==typeof a||"undefined"==typeof a?this[e].slick=new c(this[e],a):k=this[e].slick[a].apply(this[e].slick,b),"undefined"!=typeof k)return k;return this}});gx.uc.HorizontalGrid=function(e){var c,a=gx.lang.gxBoolean,b=gx.dom;this.getCurrentPage=function(){return this.CurrentPage=c?c.slick("slickCurrentSlide")+1:1};this.setCurrentPage=function(a){this.CurrentPage=a;c&&c.slick("slickGoTo",a-1,!0)};this.show=function(){var d;d=this.gxGridResponsiveCols;var f=d[0],k=d[1],h=d[2],g=d[3],l=this.MultiRowsExtraSmall,m=this.MultiRowsSmall,n=this.MultiRowsMedium,q=this.MultiRowsLarge,p=a(this.Paged)?!1:1;c=e(this.getContainerControl());d=c.attr("id");c.css("opacity",
0);d=this.drawGrid(d+"Tbl",!this.IsPostBack);c.hasClass("slick-slider")&&c.slick("unslick");this.checkUnsupportedTableNesting();a(this.ShowArrows)&&c.css("margin-left",10).css("margin-right",10);c.html(d);this.gxWidth&&c.width(b.addUnits(this.gxWidth,this.gxWidthUnit));this.gxHeight&&c.height(b.addUnits(this.gxHeight,this.gxHeightUnit));gx.fx.obs.addObserver("gx.plugdesign.onafterapplytemplate",this,function(){gx.lang.requestAnimationFrame(function(){c.on("init",function(){setTimeout(function(){c.css("opacity",
1)},10)});c.slick({arrows:a(this.ShowArrows),adaptiveHeight:!1,autoplay:a(this.AutoPlay),autoplaySpeed:this.AutoPlaySpeed,centerMode:!1,dots:a(this.ShowPageController),infinite:a(this.Infinite),variableWidth:a(this.VariableWidth),initialSlide:(this.CurrentPage||1)-1,speed:500,slidesToShow:g,slidesToScroll:p||g,rows:q,responsive:[{breakpoint:768,settings:{rows:l,slidesToShow:f,slidesToScroll:p||f}},{breakpoint:992,settings:{rows:m,slidesToShow:k,slidesToScroll:p||k}},{breakpoint:1200,settings:{rows:n,
slidesToShow:h,slidesToScroll:p||h}}]});this.PageControllerClass&&c.addClass(this.PageControllerClass)}.closure(this))},{single:!0})};this.destroy=function(){c&&c.slick("unslick")};this.checkUnsupportedTableNesting=function(){for(var a=this.getContainerControl(),b=!1;a;){if(b="TABLE"==a.tagName||"DIV"==a.tagName&&null!==a.getAttribute("data-align-inner")||"DIV"==a.tagName&&null!==a.getAttribute("data-align-outer")){gx.dbg.write("Important: Web Horizontal Grid does not support being nested neither inside aligned cells nor Table controls.",
!0);break}a=a.parentNode}};this.appendRowEnd=this.appendRowStart=this.appendContainerEnd=this.appendContainerStart=gx.emptyFn;this.getRowRenderingProps=function(){return{cls:"",tag:"div"}};this.appendRowPrefix=this.appendFooterWrapperEnd=this.appendFooterWrapperStart=gx.emptyFn};
