...
using System.IO;
public class bldapdfprevopitems : GxBaseBuilder
{
   string cs_path = "." ;
   public bldapdfprevopitems( ) : base()
   {
   }
   ...
   {
      bldapdfprevopitems x = new bldapdfprevopitems() ;
      x.SetMainSourceFile( "apdfprevopitems.cs");
