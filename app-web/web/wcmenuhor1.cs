/*
               File: WCMenuHor1
        Description: WCMenu Hor1
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/26/2022 20:12:58.52
...
namespace GeneXus.Programs {
   public class wcmenuhor1 : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public wcmenuhor1( )
      {
      ...
      public wcmenuhor1( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "WCMenu Hor1") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2022102620125856", false);
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("wcmenuhor1.aspx") + "?" + UrlEncode("" +AV5empcod) + "," + UrlEncode("" +AV6agecod) + "," + UrlEncode(StringUtil.RTrim(AV7UsuCod))+"\">") ;
      ...
      protected void RenderHtmlCloseForm4C2( )
      {
         ...
         {
            context.AddJavascriptSource("wcmenuhor1.js", "?2022102620125857", false);
         }
      ...
      protected void WB4C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "wcmenuhor1.aspx");
            }
      ...
      protected void START4C2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "WCMenu Hor1", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void wb_table1_2_4C2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblMenuhor_Internalname, lblMenuhor_Caption, "", "", lblMenuhor_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "background-color:#00FFFFFF;", "TextBlock", 0, "", 1, 1, 2, "HLP_WCMenuHor1.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "wcmenuhor1", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2022102620125869", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wcmenuhor1.js", "?2022102620125869", false);
         }
