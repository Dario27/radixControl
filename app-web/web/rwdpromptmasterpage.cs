/*
       ...
       Generated on: 10/26/2022 20:14:49.82
...
namespace GeneXus.Programs {
   public class rwdpromptmasterpage : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm062( )
      {
         ...
         context.AddJavascriptSource("rwdpromptmasterpage.js", "?2022102620144982", false);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?2022102620144987", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("rwdpromptmasterpage.js", "?2022102620144987", false);
         }
