/*
       ...
       Generated on: 9/10/2022 16:31:33.20
...
namespace GeneXus.Programs {
   public class gx01t6 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gx01t6( )
      {
      ...
      public gx01t6( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202291016313323", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx01t6.aspx") + "?" + UrlEncode("" +AV7pstockAnio) + "," + UrlEncode("" +AV8pstockMes) + "," + UrlEncode("" +AV9pEmpID) + "," + UrlEncode("" +AV10pAgeID) + "," + UrlEncode("" +AV11pPrdCod) + "," + UrlEncode("" +AV12pBodCod) + "," + UrlEncode(StringUtil.RTrim(AV13pTipoInv))+"\">") ;
      ...
      {
         return formatLink("gx01t6.aspx") + "?" + UrlEncode("" +AV7pstockAnio) + "," + UrlEncode("" +AV8pstockMes) + "," + UrlEncode("" +AV9pEmpID) + "," + UrlEncode("" +AV10pAgeID) + "," + UrlEncode("" +AV11pPrdCod) + "," + UrlEncode("" +AV12pBodCod) + "," + UrlEncode(StringUtil.RTrim(AV13pTipoInv)) ;
      }
      ...
      protected void WB4N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLbltipoinvfilter_Internalname, "Codigo", "", "", lblLbltipoinvfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e114n1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx01T6.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e124n1_client"+"'", TempTags, "", 2, "HLP_Gx01T6.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
         ...
         if ( wbEnd == 24 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx01T6.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF4N2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A42BodCod = H004N2_A42BodCod[0];
               A286PrdCod = H004N2_A286PrdCod[0];
               A2AgeID = H004N2_A2AgeID[0];
               A1EmpID = H004N2_A1EmpID[0];
               A291stockMes = H004N2_A291stockMes[0];
               A290stockAnio = H004N2_A290stockAnio[0];
               A298costo = H004N2_A298costo[0];
               n298costo = H004N2_n298costo[0];
               A297stock = H004N2_A297stock[0];
               n297stock = H004N2_n297stock[0];
               A296cantidad = H004N2_A296cantidad[0];
               n296cantidad = H004N2_n296cantidad[0];
               A43TipoInv = H004N2_A43TipoInv[0];
               /* Execute user event: Load */
               E144N2 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202291016313357", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx01t6.js", "?202291016313357", false);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'TOGGLE'","{handler:'E124N1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLTIPOINVFILTER.CLICK","{handler:'E114N1',iparms:[{av:'divTipoinvfiltercontainer_Class',ctrl:'TIPOINVFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E154N2',iparms:[{av:'A43TipoInv',fld:'TIPOINV',pic:'',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV6cTipoInv = "";
         H004N2_A42BodCod = new short[1] ;
         H004N2_A286PrdCod = new short[1] ;
         H004N2_A2AgeID = new short[1] ;
         H004N2_A1EmpID = new short[1] ;
         H004N2_A291stockMes = new short[1] ;
         H004N2_A290stockAnio = new short[1] ;
         H004N2_A298costo = new decimal[1] ;
         H004N2_n298costo = new bool[] {false} ;
         H004N2_A297stock = new int[1] ;
         H004N2_n297stock = new bool[] {false} ;
         H004N2_A296cantidad = new int[1] ;
         H004N2_n296cantidad = new bool[] {false} ;
         H004N2_A43TipoInv = new String[] {""} ;
         ...
         sImgUrl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx01t6__default(),
            new Object[][] {
                new Object[] {
               H004N2_A42BodCod, H004N2_A286PrdCod, H004N2_A2AgeID, H004N2_A1EmpID, H004N2_A291stockMes, H004N2_A290stockAnio, H004N2_A298costo, H004N2_n298costo, H004N2_A297stock, H004N2_n297stock,
               H004N2_A296cantidad, H004N2_n296cantidad, H004N2_A43TipoInv
               }
               , new Object[] {
      ...
      private short[] H004N2_A42BodCod ;
      private short[] H004N2_A286PrdCod ;
      private short[] H004N2_A2AgeID ;
      private short[] H004N2_A1EmpID ;
      private short[] H004N2_A291stockMes ;
      private short[] H004N2_A290stockAnio ;
      private decimal[] H004N2_A298costo ;
      private bool[] H004N2_n298costo ;
      private int[] H004N2_A297stock ;
      private bool[] H004N2_n297stock ;
      private int[] H004N2_A296cantidad ;
      private bool[] H004N2_n296cantidad ;
      private String[] H004N2_A43TipoInv ;
   ...
   public class gx01t6__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H004N2", "SELECT [BodCod], [PrdCod], [AgeID], [EmpID], [stockMes], [stockAnio], [costo], [stock], [cantidad], [TipoInv] FROM [ProdxBodegaTipo] WITH (NOLOCK) WHERE ([stockAnio] = @AV7pstockAnio and [stockMes] = @AV8pstockMes and [EmpID] = @AV9pEmpID and [AgeID] = @AV10pAgeID and [PrdCod] = @AV11pPrdCod and [BodCod] = @AV12pBodCod) AND ([TipoInv] like @lV6cTipoInv) ORDER BY [stockAnio], [stockMes], [EmpID], [AgeID], [PrdCod], [BodCod], [TipoInv]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004N2,11,0,false,false )
             ,new CursorDef("H004N3", "SELECT COUNT(*) FROM [ProdxBodegaTipo] WITH (NOLOCK) WHERE ([stockAnio] = @AV7pstockAnio and [stockMes] = @AV8pstockMes and [EmpID] = @AV9pEmpID and [AgeID] = @AV10pAgeID and [PrdCod] = @AV11pPrdCod and [BodCod] = @AV12pBodCod) AND ([TipoInv] like @lV6cTipoInv) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004N3,1,0,false,false )
          };
       }
    }
