/*
               File: WWVendedor
        Description: Work With Vendedor
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 1/14/2023 1:15:50.78
...
namespace GeneXus.Programs {
   public class wwvendedor : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      public wwvendedor( )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13vendedorDsc, AV19Pgmname, AV14Update, AV15Delete) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20231141155085", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vVENDEDORDSC", StringUtil.RTrim( AV13vendedorDsc));
         /* Send saved values. */
      ...
      protected void WB170( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Vendedors", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_WWVendedor.htm");
            ...
            ClassString = "BtnNew";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWVendedor.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavVendedordsc_Internalname, "vendedor Dsc", "col-sm-3 FilterSearchAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavVendedordsc_Internalname, StringUtil.RTrim( AV13vendedorDsc), StringUtil.RTrim( context.localUtil.Format( AV13vendedorDsc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "vendedor", edtavVendedordsc_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavVendedordsc_Enabled, 0, "text", "", 50, "chr", 1, "row", 50, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_WWVendedor.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START172( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Work With Vendedor", 0) ;
         }
         context.wjLoc = "";
                        ...
                        if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                        {
                           ...
                           if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 {
                                    Rfr0gs = false;
                                    /* Set Refresh If Vendedordsc Changed */
                                    if ( StringUtil.StrCmp(cgiGet( "GXH_vVENDEDORDSC"), AV13vendedorDsc) != 0 )
                                    {
                                       Rfr0gs = true;
                                    }
                                    if ( ! Rfr0gs )
      ...
      protected void PA172( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavVendedordsc_Internalname;
      ...
      protected void RF172( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13vendedorDsc = StringUtil.PadR( StringUtil.RTrim( AV13vendedorDsc), 50, "%");
            /* Using cursor H00172 */
            pr_default.execute(0, new Object[] {lV13vendedorDsc, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_25_idx), 4, 0)), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               A73vendedorEst = H00172_A73vendedorEst[0];
               n73vendedorEst = H00172_n73vendedorEst[0];
               A72vendedorDsc = H00172_A72vendedorDsc[0];
               n72vendedorDsc = H00172_n72vendedorDsc[0];
               A9vendedorID = H00172_A9vendedorID[0];
               A44empdsc = H00172_A44empdsc[0];
               n44empdsc = H00172_n44empdsc[0];
               A1EmpID = H00172_A1EmpID[0];
               A44empdsc = H00172_A44empdsc[0];
               n44empdsc = H00172_n44empdsc[0];
               E14172 ();
      ...
      protected void send_integrity_lvl_hashes172( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_VENDEDORID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A9vendedorID), "ZZZ9"), context));
      }
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         lV13vendedorDsc = StringUtil.PadR( StringUtil.RTrim( AV13vendedorDsc), 50, "%");
         /* Using cursor H00173 */
         pr_default.execute(1, new Object[] {lV13vendedorDsc});
      ...
      protected void STRUP170( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13vendedorDsc = cgiGet( edtavVendedordsc_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13vendedorDsc", AV13vendedorDsc);
            /* Read saved values. */
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("vendedor.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A9vendedorID);
         edtavDelete_Link = formatLink("vendedor.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A1EmpID) + "," + UrlEncode("" +A9vendedorID);
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 25;
      ...
      {
         /* 'DoInsert' Routine */
         CallWebObject(formatLink("vendedor.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0) + "," + UrlEncode("" +0));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13vendedorDsc = ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13vendedorDsc", AV13vendedorDsc);
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = AV13vendedorDsc;
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext.gxTpr_Transactionname = "Vendedor";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20231141155142", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwvendedor.js", "?20231141155142", false);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtvendedorID_Internalname = "VENDEDORID_"+sGXsfl_25_idx;
         edtvendedorDsc_Internalname = "VENDEDORDSC_"+sGXsfl_25_idx;
         edtvendedorEst_Internalname = "VENDEDOREST_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtvendedorID_Internalname = "VENDEDORID_"+sGXsfl_25_fel_idx;
         edtvendedorDsc_Internalname = "VENDEDORDSC_"+sGXsfl_25_fel_idx;
         edtvendedorEst_Internalname = "VENDEDOREST_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtvendedorID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A9vendedorID), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A9vendedorID), "ZZZ9"),(String)"",(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtvendedorID_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(String)"Id",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void init_default_properties( )
      {
         ...
         edtavVendedordsc_Internalname = "vVENDEDORDSC";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavVendedordsc_Jsonclick = "";
         edtavVendedordsc_Enabled = 1;
         Form.Caption = "Work With Vendedor";
         subGrid_Rows = 10;
         edtavDelete_Tooltiptext = "Eliminar";
         edtavUpdate_Tooltiptext = "Modificar";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'edtavDelete_Tooltiptext',ctrl:'vDELETE',prop:'Tooltiptext'},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13vendedorDsc',fld:'vVENDEDORDSC',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E14172',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A9vendedorID',fld:'VENDEDORID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E11172',iparms:[{av:'A1EmpID',fld:'EMPID',pic:'ZZZ9',hsh:true},{av:'A9vendedorID',fld:'VENDEDORID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13vendedorDsc = "";
         H00172_A73vendedorEst = new String[] {""} ;
         H00172_n73vendedorEst = new bool[] {false} ;
         H00172_A72vendedorDsc = new String[] {""} ;
         H00172_n72vendedorDsc = new bool[] {false} ;
         H00172_A9vendedorID = new short[1] ;
         H00172_A44empdsc = new String[] {""} ;
         H00172_n44empdsc = new bool[] {false} ;
         H00172_A1EmpID = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwvendedor__default(),
            new Object[][] {
                new Object[] {
               H00172_A73vendedorEst, H00172_n73vendedorEst, H00172_A72vendedorDsc, H00172_n72vendedorDsc, H00172_A9vendedorID, H00172_A44empdsc, H00172_n44empdsc, H00172_A1EmpID
               }
               , new Object[] {
      ...
      private int edtavVendedordsc_Enabled ;
      ...
      private String AV13vendedorDsc ;
      ...
      private String edtavVendedordsc_Internalname ;
      private String edtavVendedordsc_Jsonclick ;
      ...
      private String lV13vendedorDsc ;
      ...
      private String[] H00172_A73vendedorEst ;
      private bool[] H00172_n73vendedorEst ;
      private String[] H00172_A72vendedorDsc ;
      private bool[] H00172_n72vendedorDsc ;
      private short[] H00172_A9vendedorID ;
      private String[] H00172_A44empdsc ;
      private bool[] H00172_n44empdsc ;
      private short[] H00172_A1EmpID ;
   ...
   public class wwvendedor__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A72vendedorDsc )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " T1.[vendedorEst], T1.[vendedorDsc], T1.[vendedorID], T2.[empdsc], T1.[EmpID]";
         sFromString = " FROM ([Vendedor] T1 WITH (NOLOCK) INNER JOIN [Empresas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13vendedorDsc)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and (T1.[vendedorDsc] like @lV13vendedorDsc)";
            }
            else
            {
               sWhereString = sWhereString + " (T1.[vendedorDsc] like @lV13vendedorDsc)";
            }
         }
         else
         {
         ...
         sOrderString = sOrderString + " ORDER BY T1.[vendedorID]";
                                             ...
                                             String A72vendedorDsc )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([Vendedor] T1 WITH (NOLOCK) INNER JOIN [Empresas] T2 WITH (NOLOCK) ON T2.[EmpID] = T1.[EmpID])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13vendedorDsc)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00172(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
               case 1 :
                     return conditional_H00173(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV13vendedorDsc",SqlDbType.Char,50,0} ,
