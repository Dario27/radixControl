/*
       ...
       Generated on: 10/26/2022 20:14:49.63
...
namespace GeneXus.Programs {
   public class promptmasterpage : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm032( )
      {
         ...
         context.AddJavascriptSource("promptmasterpage.js", "?2022102620144963", false);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?2022102620144973", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("promptmasterpage.js", "?2022102620144973", false);
         }
